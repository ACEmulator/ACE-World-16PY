...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1886449671'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1886449667'; /* linkmonstergen5minutes <- Helcan Margul */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1886449668'; /* linkmonstergen5minutes <- Helcan Margul */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1886449669'; /* linkmonstergen5minutes <- Graal Margul */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1886449670'; /* linkmonstergen5minutes <- Graal Margul */
