...
VALUES (1215, 2053828610, 2796486912, 152.54, 57.756, 48.005, -0.0220572, 0, 0, -0.999757) /* Chest */
     ...
     , (7925, 2053828614, 2796486912, 156.14, 56.9367, 48.005, -0.23531, 0, 0, 0.97192) /* Linkable Monster Generator ( 10 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2053828614'; /* Linkable Monster Generator ( 10 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2053828615'; /* Linkable Monster Generator ( 10 Min.) <- Drudge Servant */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2053828616'; /* Linkable Monster Generator ( 10 Min.) <- Drudge Robber */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2053828617'; /* Linkable Monster Generator ( 10 Min.) <- Drudge Servant */
