...
VALUES (412, 2078801921, 3196059912, 128.861, 42.8621, 30, -4.37114E-08, 0, 0, -1) /* Door */
     , (7923, 2078801922, 3196059914, 136.316, 35.9708, 30.005, 0.275266, 0, 0, -0.961368) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2078801922'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2078801923'; /* Linkable Monster Generator ( 3 Min.) <- Agent of the Arcanum */
