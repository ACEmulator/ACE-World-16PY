...
VALUES (0x701B0000,  1612, 0x01B00110, 20, -20, 0.005, 0, 0, 0, -1,  True, '2005-02-09 10:00:00'); /* Azure Gromnie */
/* @teleloc 0x01B00110 [20.000000 -20.000000 0.005000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701B0001,  1612, 0x01B00110, 17.1153, -21.5751, 0.005, 0, 0, 0, -1,  True, '2005-02-09 10:00:00'); /* Azure Gromnie */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701B0004,  1016, 0x01B0011D, 39.8882, -69.9696, 0.190042, 0, 0, 0, -1, False, '2005-02-09 10:00:00'); /* Eastham Portal */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701B0008,  1612, 0x01B00128, 56.693, -23.63, 0.149, 1, 0, 0, 0,  True, '2005-02-09 10:00:00'); /* Azure Gromnie */
