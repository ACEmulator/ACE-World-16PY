...
UPDATE `landblock_instances` SET `link_Slot`='7', `link_Controller`=True WHERE `guid`='1880956970'; /* Magic trap */
UPDATE `landblock_instances` SET `link_Slot`='8', `link_Controller`=True WHERE `guid`='1880956975'; /* Magic trap */
...
UPDATE `landblock_instances` SET `link_Slot`='7' WHERE `guid`='1880956971'; /* Magic trap <- Pressure Plate */
UPDATE `landblock_instances` SET `link_Slot`='8' WHERE `guid`='1880956974'; /* Magic trap <- Pressure Plate */
