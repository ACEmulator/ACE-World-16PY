...
VALUES (21282, 2073489498, 3111059456, 62.8831, 91.666, 10.004, -0.558599, 0, 0, 0.829438) /* Destroyed Statue of a Reedshark */
     , (7924, 2073489508, 3111059456, 91.976, 118.847, 10.005, 0.518971, 0, 0, 0.854792) /* Linkable Monster Generator ( 5 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2073489508'; /* Linkable Monster Generator ( 5 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2073489509'; /* Linkable Monster Generator ( 5 Min.) <- Emissary of Asheron */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2073489510'; /* Linkable Monster Generator ( 5 Min.) <- Vincadi */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2073489511'; /* Linkable Monster Generator ( 5 Min.) <- Issk */
