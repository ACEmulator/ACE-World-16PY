...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2120540163'; /* linkmonstergen3minutes */
UPDATE `landblock_instances` SET `link_Slot`='2', `link_Controller`=True WHERE `guid`='2120540169'; /* linkmonstergen3minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2120540162'; /* linkmonstergen3minutes <- Agent of the Arcanum */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2120540168'; /* linkmonstergen3minutes <- Jubei Minawoto */
