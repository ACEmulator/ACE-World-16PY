...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1948573699'; /* linkmonstergen15minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1948573697'; /* linkmonstergen15minutes <- Se Sclavus */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1948573698'; /* linkmonstergen15minutes <- Aste Sclavus */
