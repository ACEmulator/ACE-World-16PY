...
VALUES (171, 2042081281, 2608529665, 15.4891, 63.9802, 21.705, -0.733635, 0, 0, 0.679544) /* Vat */
     , (7923, 2042081282, 2608529665, 10.3362, 66.2962, 21.705, -0.197269, 0, 0, 0.980349) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2042081282'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2042081289'; /* Linkable Monster Generator ( 3 Min.) <- Saqat */
