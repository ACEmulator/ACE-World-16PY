...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2101690376'; /* linkmonstergen */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690380'; /* linkmonstergen <- Hunter Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690379'; /* linkmonstergen <- Hunter Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690377'; /* linkmonstergen <- Hunter Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690378'; /* linkmonstergen <- Hunter Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690380'; /* linkmonstergen <- Hunter Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690381'; /* linkmonstergen <- Hunter Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690382'; /* linkmonstergen <- Vorous Shreth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2101690383'; /* linkmonstergen <- Vorous Shreth */
