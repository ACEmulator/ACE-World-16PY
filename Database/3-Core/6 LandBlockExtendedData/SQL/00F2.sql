...
VALUES (29713, 1880039424, 15859985, 10, 0, -5.995, 0, 0, 0, -1) /* Enchanted Dais */
     ...
     , (29671, 1880039428, 15860038, 9.87563, -80.015, 0.005, 0.0109524, 0, 0, 0.99994) /* Crown Browerk Defender Generator */
     ...
     , (7923, 1880039431, 15860049, 10, -120, 0.005, 1, 0, 0, 0) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='3', `link_Controller`=True WHERE `guid`='1880039431'; /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='1880039424'; /* Linkable Monster Generator ( 3 Min.) <- Enchanted Dais */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='1880039429'; /* Linkable Monster Generator ( 3 Min.) <- Ensorcelled Dais */
