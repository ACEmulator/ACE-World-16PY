...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2109980674'; /* linkmonstergen15minutes */
UPDATE `landblock_instances` SET `link_Slot`='2', `link_Controller`=True WHERE `guid`='2109980675'; /* linkitemgen25seconds */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2109980673'; /* linkmonstergen15minutes <- Jaizen Tan */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2109980676'; /* linkitemgen25seconds <- Skill Puzzle Base Piece */
