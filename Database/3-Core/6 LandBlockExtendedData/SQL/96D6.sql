...
UPDATE `landblock_instances` SET `link_Slot`='3', `link_Controller`=True WHERE `guid`='2037211149'; /* linkmonstergen30minutes */
...
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211137'; /* linkmonstergen30minutes <- Green Phyntos Wasp */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211138'; /* linkmonstergen30minutes <- Green Phyntos Wasp */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211139'; /* linkmonstergen30minutes <- Green Phyntos Wasp */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211140'; /* linkmonstergen30minutes <- Red Rat */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211144'; /* linkmonstergen30minutes <- Tumerok Scout */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211145'; /* linkmonstergen30minutes <- Tumerok Worker */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211146'; /* linkmonstergen30minutes <- Tumerok Worker */
UPDATE `landblock_instances` SET `link_Slot`='3' WHERE `guid`='2037211147'; /* linkmonstergen30minutes <- Tumerok Worker */
