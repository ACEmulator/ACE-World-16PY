...
VALUES (12050, 2107990017, 3663069452, 11.2948, 137.561, 20.005, 0.190456, 0, 0, -0.981696) /* Agent of the Arcanum */
     ...
     , (7923, 2107990018, 3663069452, 12.434, 136.56, 20.005, 0.946279, 0, 0, 0.323351) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2107990018'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2107990017'; /* Linkable Monster Generator ( 3 Min.) <- Agent of the Arcanum */
