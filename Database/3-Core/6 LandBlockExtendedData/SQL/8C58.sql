...
VALUES (4688, 2026209285, 2354577680, 172.408, 61.2951, 30.005, -0.53095, 0, 0, -0.847403) /* Shopkeeper Tirua */
     , (1154, 2026209283, 2354577689, 179.304, 57.8139, 30.005, -0.698926, 0, 0, 0.715194) /* Linkable Monster Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2026209283'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2026209290'; /* Linkable Monster Generator <- Nurbaha bint Dah */
