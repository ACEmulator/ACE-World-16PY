...
VALUES (1387, 2007801858, 2060058896, 34.0357, 36.0242, 200.005, 0.728293, 0, 0, -0.685266) /* Merchant */
     ...
     , (1154, 2007801867, 2060058933, 68.3721, 15.9495, 200.005, -0.151709, 0, 0, 0.988425) /* Linkable Monster Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2007801867'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2007801866'; /* Linkable Monster Generator <- Collector */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2007801869'; /* Linkable Monster Generator <- Ulgrim the Unpleasant */
