...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74031004, 24215, 0x40310000, 81.3965, 128.485, 163.205, 0.999989, 0, 0, -0.004594,  True, '2005-02-09 10:00:00'); /* Black Hill Collector */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74031006,  7923, 0x40310100, 86.3901, 130.739, 148.005, -0.024329, 0, 0, -0.999704, False, '2005-02-09 10:00:00'); /* Linkable Monster Generator ( 3 Min.) */
