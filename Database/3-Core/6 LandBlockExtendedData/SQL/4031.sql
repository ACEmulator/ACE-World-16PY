...
VALUES (7923, 1946357766, 1076953344, 86.3901, 130.739, 148.005, -0.0243289, 0, 0, -0.999704) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1946357766'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1946357764'; /* Linkable Monster Generator ( 3 Min.) <- Black Hill Collector */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1946357765'; /* Linkable Monster Generator ( 3 Min.) <- Black Hill Trophy Smith */
