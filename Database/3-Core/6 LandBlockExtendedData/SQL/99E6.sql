...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2040422404'; /* linkmonstergen3minutes */
UPDATE `landblock_instances` SET `link_Slot`='2', `link_Controller`=True WHERE `guid`='2040422413'; /* linkitemgen10seconds */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2040422406'; /* linkmonstergen3minutes <- Aun Tikakhe */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2040422408'; /* linkmonstergen3minutes <- Aun Aulakhe */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2040422412'; /* linkmonstergen3minutes <- Aun Saritea */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2040422414'; /* linkitemgen10seconds <- Akiekie Ember */
