...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1900367874'; /* linkmonstergen30minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1900367877'; /* linkmonstergen30minutes <- Flamma */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1900367875'; /* linkmonstergen30minutes <- Flare */
