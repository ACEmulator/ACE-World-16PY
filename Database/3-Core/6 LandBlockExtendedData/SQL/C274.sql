...
VALUES (1154, 2082947078, 3262382339, 109.065, 87.7252, 24.005, 0.994564, 0, 0, -0.104126) /* Linkable Monster Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2082947078'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2082947079'; /* Linkable Monster Generator <- Raxanza Folthid */
