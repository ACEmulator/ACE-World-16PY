...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790AF003,  1930, 0x90AF0000, 21.3742, 6.21625, 47.555, -0.068125, 0, 0, 0.997677, False, '2005-02-09 10:00:00'); /* Chest */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790AF006,   953, 0x90AF0000, 60.1848, 99.5044, 48.2528, 0.99563, 0, 0, 0.093383, False, '2005-02-09 10:00:00'); /* Young Banderling Generator */
