...
VALUES (30794, 1884303363, 84082947, 84.129, 40.076, 225.005, 0.707107, 0, 0, -0.707107) /* Black Marrow Reliquary */
     ...
     , (7924, 1884303368, 84082688, 83.8216, 39.7014, 233.805, 0.999999, 0, 0, -0.00172104) /* linkmonstergen5minutes */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1884303368'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1884303364'; /* linkmonstergen5minutes <- Stalking Margul */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1884303365'; /* linkmonstergen5minutes <- Stalking Margul */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1884303366'; /* linkmonstergen5minutes <- Creeping Margul */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1884303367'; /* linkmonstergen5minutes <- Creeping Margul */
