...
VALUES (12050, 2049589250, 2728657155, 30.9222, 105.51, 50.005, -0.799642, 0, 0, 0.600477) /* Agent of the Arcanum */
     , (7923, 2049589251, 2728657155, 30.8563, 106.687, 50.005, -0.0266955, 0, 0, 0.999644) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2049589251'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049589250'; /* Linkable Monster Generator ( 3 Min.) <- Agent of the Arcanum */
