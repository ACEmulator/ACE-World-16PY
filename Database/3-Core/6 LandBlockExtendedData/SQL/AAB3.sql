...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2058039298'; /* linkmonstergen3minutes */
UPDATE `landblock_instances` SET `link_Slot`='2', `link_Controller`=True WHERE `guid`='2058039303'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2058039297'; /* linkmonstergen3minutes <- Sir Rylanan */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2058039299'; /* linkmonstergen3minutes <- Sentry */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2058039300'; /* linkmonstergen3minutes <- Sentry */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2058039302'; /* linkmonstergen5minutes <- Sentry */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2058039304'; /* linkmonstergen5minutes <- Aun Kielerea */
