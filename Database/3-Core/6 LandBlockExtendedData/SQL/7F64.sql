...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2012626952'; /* linkmonstergen7minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2012626949'; /* linkmonstergen7minutes <- Drudge Servant */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2012626948'; /* linkmonstergen7minutes <- Drudge Servant */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2012626950'; /* linkmonstergen7minutes <- Drudge Slave */
