...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7133A004,  1130, 0x133A0000, 49.4703, 141.421, -0.445, 0.027946, 0, 0, 0.999609, False, '2005-02-09 10:00:00'); /* Item Talisman Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7133A007,  7125, 0x133A0000, 52.7749, 99.2223, 0.4, -0.999718, 0, 0, 0.023743,  True, '2005-02-09 10:00:00'); /* Affliction Wisp */
