...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7828E001,  2181, 0x828E0100, 80.9392, 128.015, 124.082, -0, 0, 0, -1, False, '2005-02-09 10:00:00'); /* Door */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7828E002,  3956, 0x828E0000, 66.3802, 190.522, 124.005, -0.02238, 0, 0, 0.99975, False, '2005-02-09 10:00:00'); /* Four Towers Entrance */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7828E005,  3957, 0x828E0000, 69.2759, 113.065, 124.005, 0.049192, 0, 0, -0.998789, False, '2005-02-09 10:00:00'); /* Exit */
