...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1895329795'; /* linkmonstergen20minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1895329793'; /* linkmonstergen20minutes <- Nomad Mu-miyah */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1895329794'; /* linkmonstergen20minutes <- Nomad Mu-miyah */
