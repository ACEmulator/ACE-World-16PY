...
UPDATE `ace_landblock` SET `linkSlot`='1', `linkSource`='1' WHERE `preassignedGuid`='1895329795'; /* linkmonstergen20minutes */

UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='1895329793'; /* linkmonstergen20minutes <- Nomad Mu-miyah */
UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='1895329794'; /* linkmonstergen20minutes <- Nomad Mu-miyah */
