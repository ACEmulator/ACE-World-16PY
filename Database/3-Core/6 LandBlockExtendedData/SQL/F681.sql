...
VALUES (22725, 2137526272, 4135649280, 174.363, 174.604, 63.8756, -0.880913, 0, 0, -0.473278) /* Healer */
     , (7923, 2137526273, 4135649280, 63.487, 158.222, 50.4579, -0.93271, 0, 0, 0.360628) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2137526273'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2137526274'; /* Linkable Monster Generator ( 3 Min.) <- Town Crier */
