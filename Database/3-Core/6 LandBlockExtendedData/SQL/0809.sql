...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1887473675'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1887473669'; /* linkmonstergen5minutes <- Biaka */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1887473670'; /* linkmonstergen5minutes <- Biaka */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1887473671'; /* linkmonstergen5minutes <- Hellion */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1887473672'; /* linkmonstergen5minutes <- Hellion */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1887473673'; /* linkmonstergen5minutes <- Hellion */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1887473674'; /* linkmonstergen5minutes <- The Black Breath */
