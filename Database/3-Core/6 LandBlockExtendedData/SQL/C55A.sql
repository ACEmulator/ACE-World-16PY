...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2085986309'; /* linkmonstergen */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2085986304'; /* linkmonstergen <- Mud Golem */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2085986305'; /* linkmonstergen <- Mud Golem */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2085986306'; /* linkmonstergen <- Mud Golem */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2085986307'; /* linkmonstergen <- Mud Golem */
