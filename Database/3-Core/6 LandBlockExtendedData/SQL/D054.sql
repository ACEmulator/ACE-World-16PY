...
VALUES (720, 2097496064, 3495166216, 84.025, 87, 238, 0.707107, 0, 0, -0.707107) /* Sliding Door */
     ...
     , (27676, 2097496097, 3495166216, 87.0872, 89.6804, 238.005, 0.695983, 0, 0, 0.718059) /* Renegade Shoushi Portal */
     ...
     , (4219, 2097496096, 3495165952, 86.2542, 67.3827, 238.005, -0.998063, 0, 0, 0.0622061) /* Linkable Monster Generator ( 7 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2097496096'; /* Linkable Monster Generator ( 7 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496081'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496082'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Laigus */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496083'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Laigus */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496084'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Laigus */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496085'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496086'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496087'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496088'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Obeloth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496089'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Obeloth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496090'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Obeloth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496091'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Obeloth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496092'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Lithos */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496093'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Lithos */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2097496095'; /* Linkable Monster Generator ( 7 Min.) <- Gotrok Amploth */
