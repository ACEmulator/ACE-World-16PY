...
VALUES (0x7C2D4000,  2611, 0xC2D40000, 116.029, 87.4832, 138.399, -0.998568, 0, 0, -0.053499,  True, '2005-02-09 10:00:00'); /* Zofrit Zefir */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C2D4004,  2611, 0xC2D40000, 146.73, 67.8252, 143.67, 0.031356, 0, 0, 0.999508,  True, '2005-02-09 10:00:00'); /* Zofrit Zefir */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C2D4006,  2611, 0xC2D40000, 139.021, 84.3655, 142.168, 0.99584, 0, 0, -0.09112,  True, '2005-02-09 10:00:00'); /* Zofrit Zefir */
/* @teleloc 0xC2D40000 [139.020996 84.365501 142.167999] 0.995840 0.000000 0.000000 -0.091120 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C2D4007,  3955, 0xC2D40000, 116.029, 87.4832, 138.387, -0.998568, 0, 0, -0.053499, False, '2005-02-09 10:00:00'); /* Linkable Monster Gen (15 min.) */
