...
VALUES (1148, 1903894528, 397541632, 130.885, 60.5018, 41.205, 0.999557, 0, 0, -0.0297741) /* Door */
     ...
     , (5086, 1903894532, 397541646, 127.03, 54.5464, 41.205, 0.765243, 0, 0, 0.643742) /* Linkable Monster Gen - 30 sec. */
     ...
     , (720, 1903894529, 397541376, 53.4993, 89.8703, 46, -0.361725, 0, 0, -0.932285) /* Sliding Door */
     , (11322, 1903894544, 397541376, 127.606, 65.2235, 49.205, -0.531658, 0, 0, -0.846959) /* Bachus Flufens */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1903894532'; /* Linkable Monster Gen - 30 sec. */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1903894543'; /* Linkable Monster Gen - 30 sec. <- Town Crier */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1903894535'; /* Linkable Monster Gen - 30 sec. <- Behdo Yii */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1903894531'; /* Linkable Monster Gen - 30 sec. <- Ling Xiao the Collector */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1903894544'; /* Linkable Monster Gen - 30 sec. <- Bachus Flufens */
