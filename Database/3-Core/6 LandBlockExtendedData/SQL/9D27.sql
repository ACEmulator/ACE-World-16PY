...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2043834369'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2043834375'; /* linkmonstergen5minutes <- Gotrok Montok */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2043834371'; /* linkmonstergen5minutes <- Gotrok Montok */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2043834372'; /* linkmonstergen5minutes <- Gotrok Montok */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2043834373'; /* linkmonstergen5minutes <- Gotrok Montok */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2043834374'; /* linkmonstergen5minutes <- Gotrok Montok */
