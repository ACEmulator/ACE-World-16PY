...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2050678787'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2050678789'; /* linkmonstergen5minutes <- Scrawed Grievver */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2050678791'; /* linkmonstergen5minutes <- Scrawed Grievver */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2050678790'; /* linkmonstergen5minutes <- Scrawed Grievver */
