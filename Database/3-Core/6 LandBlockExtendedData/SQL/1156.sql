...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1897226241'; /* linkmonstergen5minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1897226242'; /* linkmonstergen5minutes <- Falatacot Consort */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1897226243'; /* linkmonstergen5minutes <- Falatacot Patrician */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1897226244'; /* linkmonstergen5minutes <- Falatacot Patrician */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1897226245'; /* linkmonstergen5minutes <- Falatacot Matriarch */
