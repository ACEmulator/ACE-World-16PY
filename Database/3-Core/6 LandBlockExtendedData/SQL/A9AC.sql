...
VALUES (3951, 2056962055, 2846621957, 35.0556, 16.3168, 78.005, 0.704387, 0, 0, 0.709816) /* Linkable Monster Gen (1 hour) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2056962055'; /* Linkable Monster Gen (1 hour) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2056962056'; /* Linkable Monster Gen (1 hour) <- Eldrista the Adventurer */
