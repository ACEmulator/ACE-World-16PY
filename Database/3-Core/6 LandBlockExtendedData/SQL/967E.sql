...
VALUES (5202, 2036850694, 2524840192, 147.821, 38.9203, 29.205, -0.653452, 0, 0, -0.756968) /* Musansayn's Vaults Portal */
     ...
     , (7923, 2036850691, 2524840193, 158.899, 44.4054, 29.205, -0.994636, 0, 0, -0.103435) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2036850691'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2036850692'; /* Linkable Monster Generator ( 3 Min.) <- Drudge Skulker */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2036850693'; /* Linkable Monster Generator ( 3 Min.) <- Drudge Skulker */
