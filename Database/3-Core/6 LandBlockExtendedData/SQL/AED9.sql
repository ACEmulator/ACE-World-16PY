...
VALUES (1378, 2062389251, 2933457154, 178.368, 29.9465, 16.005, -0.0382559, 0, 0, -0.999268) /* Roaming Bowyer */
     ...
     , (1154, 2062389253, 2933457156, 177.991, 32.3132, 19.005, -0.585838, 0, 0, -0.810428) /* Linkable Monster Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2062389253'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2062389252'; /* Linkable Monster Generator <- Tan Rat */
