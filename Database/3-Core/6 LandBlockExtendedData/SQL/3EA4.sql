...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73EA4002,   618, 0x3EA40000, 88.7234, 45.1535, 0.0057, 0.394835, 0, 0, -0.918752,  True, '2005-02-09 10:00:00'); /* Cow */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73EA4006,  4042, 0x3EA40000, 93.0624, 22.1705, 0.157455, 0.532675, 0, 0, -0.84632, False, '2005-02-09 10:00:00'); /* Plateau Portal */
