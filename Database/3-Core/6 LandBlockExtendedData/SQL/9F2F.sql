...
VALUES (387, 2045964288, 2670657536, 78.539, 34.5712, 64.005, -0.867483, 0, 0, -0.497467) /* Lugian Generator */
     ...
     , (1154, 2045964298, 2670657536, 46.6406, 49.2597, 64.005, -0.343254, 0, 0, 0.939243) /* Linkable Monster Generator */;

UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2045964298'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2045964291'; /* Linkable Monster Generator <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2045964292'; /* Linkable Monster Generator <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2045964293'; /* Linkable Monster Generator <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2045964294'; /* Linkable Monster Generator <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2045964295'; /* Linkable Monster Generator <- Gotrok Obeloth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2045964296'; /* Linkable Monster Generator <- Gotrok Obeloth */
