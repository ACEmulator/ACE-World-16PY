...
VALUES (4548, 2119421958, 3845980416, 182.822, 175.592, 96.005, -0.881957, 0, 0, 0.471329) /* Wah Chon the Barkeep */
     ...
     , (1154, 2119421963, 3845980416, 175.52, 175.199, 96.005, -0.235641, 0, 0, 0.97184) /* Linkable Monster Generator */
     ...
     , (7923, 2119421966, 3845980435, 176.396, 155.359, 96.005, -0.949231, 0, 0, 0.314581) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2119421966'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2119421965'; /* Linkable Monster Generator ( 3 Min.) <- Miyako Nujou-Wah  */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2119421962'; /* Linkable Monster Generator ( 3 Min.) <- Wa Shi */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2119421972'; /* Linkable Monster Generator ( 3 Min.) <- Apprentice Cook */
