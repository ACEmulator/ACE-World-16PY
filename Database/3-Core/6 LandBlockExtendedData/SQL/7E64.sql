...
VALUES (9499, 2011578377, 2120483089, 107, 114, 12.005, -4.37114E-08, 0, 0, -1) /* Gharu'ndim Low-Stakes Gamesmaster */
     ...
     , (3955, 2011578375, 2120483097, 112.061, 107.916, 12.005, 0.707107, 0, 0, -0.707107) /* Linkable Monster Gen (15 min.) */
     ...
     , (794, 2011578368, 2120482816, 16.8134, 2.98519, 17.0177, -0.967679, 0, 0, 0.252184) /* Apple Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2011578375'; /* Linkable Monster Gen (15 min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578373'; /* Linkable Monster Gen (15 min.) <- Gharu'ndim Mid-Stakes Gamesmaster */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578374'; /* Linkable Monster Gen (15 min.) <- Gharu'ndim Mid-Stakes Gamesmaster */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578377'; /* Linkable Monster Gen (15 min.) <- Gharu'ndim Low-Stakes Gamesmaster */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578376'; /* Linkable Monster Gen (15 min.) <- Gharu'ndim Low-Stakes Gamesmaster */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578378'; /* Linkable Monster Gen (15 min.) <- Gharu'ndim High-Stakes Gamesmaster */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578379'; /* Linkable Monster Gen (15 min.) <- Gharu'ndim High-Stakes Gamesmaster */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2011578380'; /* Linkable Monster Gen (15 min.) <- Arshid al-Qiyid */
