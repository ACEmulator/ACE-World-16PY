...
VALUES (412, 2112163840, 3729850629, 84.95, 133.76, 16.01, 0, 0, 0, -1) /* Door */
     ...
     , (7923, 2112163856, 3729850368, 110.997, 81.0953, 29.205, -0.734135, 0, 0, 0.679004) /* Linkable Monster Generator ( 3 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2112163856'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2112163857'; /* Linkable Monster Generator ( 3 Min.) <- Sentry */
