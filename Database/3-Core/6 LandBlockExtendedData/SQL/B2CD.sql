...
VALUES (167, 2066534400, 2999779584, 68.5356, 30.3735, 109.66, -0.735155, 0, 0, -0.677899) /* Sarcophagus */
     , (1154, 2066534410, 2999779584, 76.2083, 33.5567, 109.66, -0.732346, 0, 0, 0.680933) /* Linkable Monster Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2066534410'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2066534406'; /* Linkable Monster Generator <- Skeleton Captain */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2066534409'; /* Linkable Monster Generator <- Skeleton */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2066534407'; /* Linkable Monster Generator <- Skeleton */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2066534408'; /* Linkable Monster Generator <- Skeleton */
