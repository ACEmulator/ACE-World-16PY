...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A3AD005,  2585, 0xA3AD0000, 148.558, 62.1264, 44.005, 0.051523, 0, 0, -0.998672,  True, '2005-02-09 10:00:00'); /* Essa Sclavus */
/* @teleloc 0xA3AD0000 [148.557999 62.126400 44.005001] 0.051523 0.000000 0.000000 -0.998672 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A3AD006,  2585, 0xA3AD0000, 146.648, 65.2426, 44.005, 0.051523, 0, 0, -0.998672,  True, '2005-02-09 10:00:00'); /* Essa Sclavus */
/* @teleloc 0xA3AD0000 [146.647995 65.242599 44.005001] 0.051523 0.000000 0.000000 -0.998672 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A3AD007,  2585, 0xA3AD0000, 147.512, 63.0284, 44.005, 0.051523, 0, 0, -0.998672,  True, '2005-02-09 10:00:00'); /* Essa Sclavus */
/* @teleloc 0xA3AD0000 [147.511993 63.028400 44.005001] 0.051523 0.000000 0.000000 -0.998672 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A3AD008,  2585, 0xA3AD0000, 145.953, 63.0493, 44.005, 0.051523, 0, 0, -0.998672,  True, '2005-02-09 10:00:00'); /* Essa Sclavus */
/* @teleloc 0xA3AD0000 [145.953003 63.049301 44.005001] 0.051523 0.000000 0.000000 -0.998672 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A3AD009,  2586, 0xA3AD0000, 147.005, 60.9485, 44.005, 0.051523, 0, 0, -0.998672,  True, '2005-02-09 10:00:00'); /* Sata Sclavus */
