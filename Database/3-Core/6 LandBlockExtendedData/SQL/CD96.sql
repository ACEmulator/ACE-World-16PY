...
VALUES (1331, 2094620672, 3449159680, 13.3, 73.9, 31, 0.833886, 0, 0, -0.551937) /* Cave */
     ...
     , (3951, 2094620675, 3449159680, 177.868, 117.425, 20.005, -0.999308, 0, 0, -0.0371882) /* Linkable Monster Gen (1 hour) */
     , (14865, 2094620676, 3449159680, 180.514, 124.01, 19.6708, 0.246045, 0, 0, 0.969258) /* Maere the Dyepot Peddlar */;

UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2094620675'; /* Linkable Monster Gen (1 hour) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2094620674'; /* Linkable Monster Gen (1 hour) <- Alean the Steel Forger */
