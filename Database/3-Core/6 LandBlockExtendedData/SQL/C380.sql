...
VALUES (4446, 2084044809, 3279945985, 36.6029, 128.646, 34.005, -0.510865, 0, 0, -0.859661) /* Riflyffa the Shopkeeper */
     ...
     , (1154, 2084044807, 3279945993, 58.9318, 130.872, 34.005, 0.716519, 0, 0, 0.697568) /* Linkable Monster Generator */
     ...
     , (794, 2084044806, 3279945728, 34.8937, 140.446, 36.2654, -0.441395, 0, 0, 0.897313) /* Apple Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2084044807'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2084044815'; /* Linkable Monster Generator <- Ercel */
