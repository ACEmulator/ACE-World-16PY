...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1969569807'; /* linkmonstergen20minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1969569805'; /* linkmonstergen20minutes <- Gaerlan's Phylacteric Prison */
