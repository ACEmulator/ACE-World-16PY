...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2037526530'; /* linkmonstergen10minutes */
UPDATE `landblock_instances` SET `link_Slot`='2', `link_Controller`=True WHERE `guid`='2037526528'; /* linkitemgen25seconds */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2037526531'; /* linkmonstergen10minutes <- Darsida al-Qawa */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2037526529'; /* linkitemgen25seconds <- Skill Puzzle Base Piece */
