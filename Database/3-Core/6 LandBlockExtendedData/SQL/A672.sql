...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A672005,  6771, 0xA6720100, 105.667, 153.294, 19.6605, 0.024024, 0, 0, -0.999711,  True, '2005-02-09 10:00:00'); /* Leikotha */
/* @teleloc 0xA6720100 [105.667000 153.294006 19.660500] 0.024024 0.000000 0.000000 -0.999711 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A672006,  5485, 0xA6720000, 110.515, 123.404, 26.005, 0.997801, 0, 0, -0.066282, False, '2005-02-09 10:00:00'); /* Linkable Newbie Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A672009,  1764, 0xA6720100, 109.703, 144.899, 19.6605, -0.096504, 0, 0, -0.995333,  True, '2005-02-09 10:00:00'); /* Greater Mu-miyah */
