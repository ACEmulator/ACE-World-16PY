...
VALUES (1148, 2049310720, 2724200704, 179.975, 35.9985, 17.205, 0.728072, 0, 0, -0.685501) /* Door */
     , (4778, 2049310728, 2724200714, 187.569, 36.0679, 20.005, 0.971893, 0, 0, 0.235421) /* Gharundim Ivory Collector Gen */
     ...
     , (3597, 2049310730, 2724200722, 180.592, 41.5653, 17.205, -0.257205, 0, 0, 0.966357) /* Linkable Item Scatter Generator */
     , (412, 2049310732, 2724200731, 136.424, 17.2689, 20, -0.707107, 0, 0, -0.707107) /* Door */
     , (7923, 2049310734, 2724200733, 126.809, 9.58321, 20.005, -0.998101, 0, 0, -0.0615962) /* Linkable Monster Generator ( 3 Min.) */
     ...
     , (19457, 2049310744, 2724200448, 162.585, 7.32, 27, -0.688228, 0, 0, -0.725494) /* Fireworks Generator */
     ...
     , (4770, 2049310729, 2724200448, 185.333, 42.331, 25.205, -0.516656, 0, 0, -0.856193) /* Collector Gharundim Gen */
     , (1908, 2049310731, 2724200448, 179.38, 84.1221, 20.005, 0.92388, 0, 0, -0.382683) /* Uziz */;

UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2049310730'; /* Linkable Item Scatter Generator */
UPDATE `landblock_instances` SET `link_Slot`='2', `link_Controller`=True WHERE `guid`='2049310734'; /* Linkable Monster Generator ( 3 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049310721'; /* Linkable Item Scatter Generator <- Brimstone-cap Mushroom */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049310722'; /* Linkable Item Scatter Generator <- Brimstone-cap Mushroom */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049310723'; /* Linkable Item Scatter Generator <- Brimstone-cap Mushroom */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049310724'; /* Linkable Item Scatter Generator <- Brimstone-cap Mushroom */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049310725'; /* Linkable Item Scatter Generator <- Brimstone-cap Mushroom */
UPDATE `landblock_instances` SET `link_Slot`='2' WHERE `guid`='2049310733'; /* Linkable Monster Generator ( 3 Min.) <- Agent of the Arcanum */
