...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2049134601'; /* linkmonstergen */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049134592'; /* linkmonstergen <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049134593'; /* linkmonstergen <- Gotrok Amploth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049134594'; /* linkmonstergen <- Gotrok Laigus */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049134595'; /* linkmonstergen <- Gotrok Laigus */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049134596'; /* linkmonstergen <- Gotrok Obeloth */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2049134602'; /* linkmonstergen <- Gotrok Lithos */
