...
VALUES (1369, 1949163520, 1121845248, 17.8754, 66.9698, 0.005, -0.976146, 0, 0, 0.217117) /* Archmage */
     ...
     , (3953, 1949163525, 1121845248, 16.8755, 88.5354, 0.005, 0.64814, 0, 0, -0.761522) /* Linkable Monster Gen (30 min.) */
     , (30386, 1949163526, 1121845248, 12.8004, 74.3821, 4.005, -0.957745, 0, 0, -0.28762) /* Suzuhara Sheshumi */;

UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1949163525'; /* Linkable Monster Gen (30 min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1949163524'; /* Linkable Monster Gen (30 min.) <- Feruza ibn Salaq */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1949163526'; /* Linkable Monster Gen (30 min.) <- Suzuhara Sheshumi */
