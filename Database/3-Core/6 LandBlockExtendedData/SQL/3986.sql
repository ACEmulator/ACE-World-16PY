...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1939365891'; /* linkmonstergen3minutes */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1939365892'; /* linkmonstergen3minutes <- Coral Golem */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1939365893'; /* linkmonstergen3minutes <- Coral Golem */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1939365894'; /* linkmonstergen3minutes <- Coral Golem */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1939365895'; /* linkmonstergen3minutes <- Coral Golem */
