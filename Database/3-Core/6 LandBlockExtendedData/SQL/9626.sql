...
UPDATE `landblock_instances` SET `link_Slot`='6' WHERE `guid`='2036490268'; /* Magic trap <- Pressure Plate */
UPDATE `landblock_instances` SET `link_Slot`='7' WHERE `guid`='2036490264'; /* Magic trap <- Pressure Plate */
