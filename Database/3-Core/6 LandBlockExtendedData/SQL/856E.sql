...
VALUES (1815, 2018959364, 2238578944, 129.679, 14.2732, 14.005, -0.37542, 0, 0, 0.926855) /* Maqura al-Waryah the Blacksmith */
     ...
     , (1154, 2018959367, 2238578959, 159.128, 155.519, 9.705, -0.866949, 0, 0, 0.498396) /* Linkable Monster Generator */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='2018959367'; /* Linkable Monster Generator */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2018959368'; /* Linkable Monster Generator <- Ya-Bint-Al-Hawa */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2018959369'; /* Linkable Monster Generator <- Anid Al-Fadee */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='2018959370'; /* Linkable Monster Generator <- Gabal Feteh */
