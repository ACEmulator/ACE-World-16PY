...
VALUES (8377, 1894490124, 247070976, 131.722, 64.308, 2.65237, 0.782777, 0, 0, -0.622303) /* Beer Keg */
     ...
     , (4219, 1894490113, 247070720, 102.698, 66.6581, 2.005, -0.959978, 0, 0, -0.280077) /* Linkable Monster Generator ( 7 Min.) */
...
UPDATE `landblock_instances` SET `link_Slot`='1', `link_Controller`=True WHERE `guid`='1894490113'; /* Linkable Monster Generator ( 7 Min.) */

UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1894490112'; /* Linkable Monster Generator ( 7 Min.) <- Hea Arantah */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1894490123'; /* Linkable Monster Generator ( 7 Min.) <- Hea Ihipura the Crafter */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1894490122'; /* Linkable Monster Generator ( 7 Min.) <- Hea Riketura the Collector */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1894490120'; /* Linkable Monster Generator ( 7 Min.) <- Hea Kiriona the Shopkeep */
UPDATE `landblock_instances` SET `link_Slot`='1' WHERE `guid`='1894490129'; /* Linkable Monster Generator ( 7 Min.) <- Hea Mutuona */
