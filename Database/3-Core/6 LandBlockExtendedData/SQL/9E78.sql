...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79E78003,  1760, 0x9E780100, 83.8598, 81.5327, 27.605, -0.999396, 0, 0, -0.034753,  True, '2005-02-09 10:00:00'); /* Skeleton Warrior */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79E78007,  1760, 0x9E780000, 86.8678, 85.9208, 41.205, -0.054215, 0, 0, -0.998529,  True, '2005-02-09 10:00:00'); /* Skeleton Warrior */
/* @teleloc 0x9E780000 [86.867798 85.920799 41.205002] -0.054215 0.000000 0.000000 -0.998529 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79E78008,  1154, 0x9E780000, 83.2461, 95.2574, 26.005, -0.03355, 0, 0, -0.999437, False, '2005-02-09 10:00:00'); /* Linkable Monster Generator */
