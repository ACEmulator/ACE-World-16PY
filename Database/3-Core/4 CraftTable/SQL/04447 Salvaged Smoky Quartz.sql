DELETE FROM `recipe` WHERE `recipe_Id` = 4447;
...
VALUES (4447, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (4447, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (4447, 179, 1, 3, 'The target item has been imbued already!') /* ImbuedEffect - CriticalStrike */
     , (4447, 108, 1, 2, 'The target item must be magical!') /* ItemMaxMana */
     , (4447,  92, 100, 2, 'The material is not complete!') /* Structure */;
