...
VALUES (3842, 0, 35 /* Leadership */, 150, 0, 0, 0, 'You stamp the flag with the Olthoi symbol.', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436415, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `unknown_1`)
VALUES (@parent_id,   1, 'Olthoi Flag', 1, 1) /* Name */;
...
VALUES (3842, 20862 /* Olthoi Stamp */, 16920 /* Flag */);
