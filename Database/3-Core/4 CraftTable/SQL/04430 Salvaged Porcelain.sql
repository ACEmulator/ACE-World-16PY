...
VALUES (4430, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (4430, 0, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (4430, 0,  47, 32, 3, 'You cannot tinker hilted weapons!') /* AttackType - DoubleSlash */
     , (4430, 1,  92, 100, 2, 'The material is not complete!') /* Structure */;

INSERT INTO `recipe_requirements_string` (`recipe_Id`, `index`, `stat`, `value`, `enum`, `message`)
VALUES (4430, 0,  19, '', 7, 'The target item does not have a heritage restriction to change!') /* ItemHeritageGroupRestriction */
     , (4430, 0,  19, 'Sho', 6, 'The target item is already restricted to Sho! ') /* ItemHeritageGroupRestriction */;
...
VALUES (@parent_id, 0,  19, 'Sho', 1, 0) /* ItemHeritageGroupRestriction */;
