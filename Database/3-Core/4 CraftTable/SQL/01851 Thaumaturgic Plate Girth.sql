...
DELETE FROM `cook_book` WHERE `recipe_Id` = 1851;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (1851, 9076 /* Sea Blue Kindling Stone */,  9095 /* Unkindled Thaumaturgic Plate Girth */, '2005-02-09 10:00:00');
