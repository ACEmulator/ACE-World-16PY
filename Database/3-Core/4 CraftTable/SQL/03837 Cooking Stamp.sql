...
VALUES (3837, 0, 39 /* Cooking */, 200, 0, 0, 0, 'You stamp the flag with the Cooking symbol!', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436410, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `unknown_1`)
VALUES (@parent_id,   1, 'Cooking Flag', 1, 1) /* Name */;
...
VALUES (3837, 20857 /* Cooking Stamp */, 16920 /* Flag */);
