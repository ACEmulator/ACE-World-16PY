...
VALUES (3915, 0, 21 /* Healing */, 150, 0, 0, 0, 'You stamp the flag with the Vitae Symbol!', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);

INSERT INTO `recipe_requirements_int` (`recipe_Id`, `stat`, `value`, `enum`, `message`)
VALUES (3915,  43, 500, 2, 'You do not yet merit this flag.') /* NumDeaths */;
...
VALUES (@parent_id,   7, 268436495, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `unknown_1`)
VALUES (@parent_id,   1, 'Wi Flag', 1, 1) /* Name */;
...
VALUES (3915, 22101 /* Wi Stamp */, 16920 /* Flag */);
