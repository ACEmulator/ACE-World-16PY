...
VALUES (3862, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (3862, 0, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (3862, 1,  92, 100, 2, 'The material is not complete!') /* Structure */;
