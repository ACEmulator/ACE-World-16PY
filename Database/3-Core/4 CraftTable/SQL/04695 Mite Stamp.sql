...
VALUES (4695, 0, 18 /* ItemTinkering */, 150, 0, 0, 0, 'You emboss the shield with the emblem of the royal symbol of the Mite Queen!', 0, 0, 'Your attempt to emboss the shield fails. As you remove the stamp from its surface, the dye chips and peels off the shield.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436766, 1, 1) /* ClothingBase */;
...
INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (4695, False, 0, 0, 0, True, 939524111, 1, 0);
...
VALUES (4695, 23958 /* Mite Stamp */, 25843 /* Nefane Shield */);
