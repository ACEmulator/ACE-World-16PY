...
VALUES (3858, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (3858, 0, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (3858, 0,  47, 32, 3, 'You cannot tinker hilted weapons!') /* AttackType - DoubleSlash */
     , (3858, 1,  92, 100, 2, 'The material is not complete!') /* Structure */;
