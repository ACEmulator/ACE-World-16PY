...
VALUES (3859, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (3859, 0, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (3859, 1,  92, 100, 2, 'The material is not complete!') /* Structure */;
