...
VALUES (4674, 0, 18 /* ItemTinkering */, 100, 0, 0, 0, 'You emboss the shield with the emblem of the Herald!', 0, 0, 'Your attempt to emboss the shield fails. As you remove the stamp from its surface, the dye chips and peels off the shield.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (4674, 20860 /* Herald Stamp */, 25811 /* Shield of Power */);
