...
VALUES (4686, 2, 134, 4, 2, 'You need to be a Player Killer to use this stamp.') /* PlayerKillerStatus - PK */;
...
VALUES (@parent_id, 0,   7, 268436771, 1, 1) /* ClothingBase */;
...
INSERT INTO `recipe_mods_d_i_d` (`recipe_Mod_Id`, `index`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id, 4,   7, 268436771, 1, 1) /* ClothingBase */;
