...
VALUES (4427, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (4427, 0, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (4427, 0,  47, 32, 3, 'You cannot tinker hilted weapons!') /* AttackType - DoubleSlash */
     , (4427, 1,  92, 100, 2, 'The material is not complete!') /* Structure */;

INSERT INTO `recipe_requirements_d_i_d` (`recipe_Id`, `index`, `stat`, `value`, `enum`, `message`)
VALUES (4427, 0,  37, 6, 5, 'The target item does not have a Melee Defense requirement!') /* ItemSkillLimit */;
