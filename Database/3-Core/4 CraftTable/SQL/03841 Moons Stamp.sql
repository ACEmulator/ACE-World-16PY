DELETE FROM `recipe` WHERE `id` = 3841;
...
VALUES (@parent_id, 0,   7, 268436414, 1, 1) /* On Source.SuccessTarget SetValue ClothingBase to Target */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `index`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id, 0,   1, 'Moons Flag', 1, 1) /* On Source.SuccessTarget SetValue Name to Target */;
