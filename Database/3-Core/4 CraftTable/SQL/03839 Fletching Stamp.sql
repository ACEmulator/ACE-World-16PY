...
VALUES (3839, 0, 37 /* Fletching */, 200, 0, 0, 0, 'You stamp the flag with the Fletching symbol.', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436412, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id,   1, 'Fletching Flag', 1, 1) /* Name */;
...
VALUES (3839, 20859 /* Fletching Stamp */, 16920 /* Flag */);
