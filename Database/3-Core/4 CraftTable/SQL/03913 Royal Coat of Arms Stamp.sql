...
VALUES (3913, 0, 36 /* Loyalty */, 127, 0, 0, 0, 'You stamp the flag with the Royal Coat of Arms!', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436492, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `unknown_1`)
VALUES (@parent_id,   1, 'Royal Coat of Arms Flag', 1, 1) /* Name */;
...
VALUES (3913, 22099 /* Royal Coat of Arms Stamp */, 16920 /* Flag */);
