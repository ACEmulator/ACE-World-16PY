...
VALUES (@parent_id, 0,   7, 268436416, 1, 1) /* On Source.SuccessTarget SetValue ClothingBase to Target */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `index`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id, 0,   1, 'Virindi Flag', 1, 1) /* On Source.SuccessTarget SetValue Name to Target */;
...
DELETE FROM `cook_book` WHERE `recipe_Id` = 3843;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (3843, 20863 /* Virindi Stamp */, 16920 /* Flag */, '2005-02-09 10:00:00');
