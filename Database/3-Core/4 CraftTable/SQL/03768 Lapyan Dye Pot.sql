...
VALUES (3768, 0, 39 /* Cooking */, 50, 0, 4759 /* Cooking Pot */, 1, 'You apply the fair blue dye.', 4759 /* Cooking Pot */, 1, 'You fail to properly apply the dye.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,  50, 100673116, 1, 1) /* IconOverlay */
...
VALUES (3768, 8650 /* Lapyan Dye Pot */, 20856 /* Bael'Zharon Stamp */);
