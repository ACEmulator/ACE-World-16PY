...
VALUES (3835, 0, 38 /* Alchemy */, 200, 0, 0, 0, 'You stamp the flag with the Alchemy symbol!', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436408, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `unknown_1`)
VALUES (@parent_id,   1, 'Alchemy Flag', 1, 1) /* Name */;
...
VALUES (3835, 20855 /* Alchemy Stamp */, 16920 /* Flag */);
