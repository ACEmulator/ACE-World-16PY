...
VALUES (4440, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* ItemWorkmanship */
     , (4440, 0, 171, 10, 3, 'The target item has been tinkered too many times already!') /* NumTimesTinkered */
     , (4440, 0, 179, 1, 3, 'The target item has been imbued already!') /* ImbuedEffect - CriticalStrike */
     , (4440, 0, 108, 1, 2, 'The target item must be magical!') /* ItemMaxMana */
     , (4440, 1,  92, 100, 2, 'The material is not complete!') /* Structure */;
