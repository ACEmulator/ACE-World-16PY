...
VALUES (3838, 0, 18 /* ItemTinkering */, 100, 0, 0, 0, 'You stamp the flag with the Fish symbol!', 0, 0, 'You smear the dye on the flag with your stamp. That can''t be how it''s done.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0);
...
VALUES (@parent_id,   7, 268436411, 1, 1) /* ClothingBase */;

INSERT INTO `recipe_mods_string` (`recipe_Mod_Id`, `stat`, `value`, `enum`, `unknown_1`)
VALUES (@parent_id,   1, 'Fish Flag', 1, 1) /* Name */;
...
VALUES (3838, 20858 /* Fish Stamp */, 16920 /* Flag */);
