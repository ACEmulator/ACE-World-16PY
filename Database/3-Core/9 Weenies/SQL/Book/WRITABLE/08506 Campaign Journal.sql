...
VALUES (8506, 272, 8506);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8506, 16, 'A partial translation of the personal journal of the Sand King Anadil.') /* LONG_DESC_STRING */
     , (8506, 1, 'Campaign Journal') /* NAME_STRING */
     , (8506, 15, 'A partial translation of a personal journal found on the body of an undead.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8506, 1, 33554771) /* SETUP_DID */
     , (8506, 3, 536870932) /* SOUND_TABLE_DID */
     , (8506, 8, 100668117) /* ICON_DID */
     , (8506, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8506, 9, 0) /* LOCATIONS_INT */
     ...
     , (8506, 174, 25) /* APPRAISAL_PAGES_INT */
...
VALUES (8506, 22, False) /* INSCRIBABLE_BOOL */
     , (8506, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (8506, 0, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
* *
...
')
     , (8506, 1, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 2, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, 'Asmolum''s divinations brought us the location of the final piece of the Array. Fortuitously enough, it was near at hand. However, my forces were prepared to move on should the Enemy appear, not defend the ground. This field of combat is not one I would have chosen.
...
')
     , (8506, 5, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 6, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 9, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 10, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 11, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 12, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 13, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '* *
...
')
     , (8506, 16, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, 'If you wish to have power over earth and sea, so be it. Be honest about your goal. Do not seek it through duplicity and doubletalk. My father taught me at the council fire that all our gods demand of us is honesty - all other judgements are those of men. The Nali of Haebrous claimed that Adja''s daughters were tainted by the beliefs of the Falatacot. He said their accordance of equal respect to the earth as well as the stars was heretical. What he truly sought was the silencing of a voice other than his own, in a war for the hearts of men. In this, I think, he was the greatest sinner of his time. Men may claim the earth and sea, yet never the stars nor the souls of their brothers.
')
     , (8506, 17, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 18, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 19, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 20, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
* *
...
')
     , (8506, 21, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 22, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
...
')
     , (8506, 23, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '* *
...
')
     , (8506, 24, 'Anadil of Shakrassekor', 'prewritten', 4294967295, False, '
