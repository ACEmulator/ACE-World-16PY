...
VALUES (9122, 272, 9122);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9122, 1, 'Interlude') /* NAME_STRING */
     , (9122, 15, 'The fifth installment of a tale by Martine') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9122, 1, 33554771) /* SETUP_DID */
     , (9122, 3, 536870932) /* SOUND_TABLE_DID */
     , (9122, 8, 100668117) /* ICON_DID */
     , (9122, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9122, 9, 0) /* LOCATIONS_INT */
     ...
     , (9122, 174, 18) /* APPRAISAL_PAGES_INT */
     , (9122, 175, 18) /* APPRAISAL_MAX_PAGES_INT */
     , (9122, 22, 1000) /* AVAILABLE_CHARACTER_INT */
...
VALUES (9122, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (9122, 0, '', 'prewritten', 4294967295, False, 'Interlude
