/* Weenie - A Crumpled Letter (24126) */
...
VALUES (24126, 16, 'A gnawed and crumpled letter. It has been torn, folded, mutilated, and bears the marks of mite teeth, but the elegant handwriting is still legible.') /* LONG_DESC_STRING */
     , (24126, 1, 'A Crumpled Letter') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24126, 1, 33554773) /* SETUP_DID */
     , (24126, 3, 536870932) /* SOUND_TABLE_DID */
     , (24126, 8, 100667503) /* ICON_DID */
     , (24126, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24126, 9, 0) /* LOCATIONS_INT */
...
VALUES (24126, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (24126, 0, 'Elysa', 'prewritten', 4294967295, False, '
My dear Alatar!
...
')
     , (24126, 1, 'Elysa', 'prewritten', 4294967295, False, '
...
')
     , (24126, 2, 'Elysa', 'prewritten', 4294967295, False, '
...
')
     , (24126, 3, 'Elysa', 'prewritten', 4294967295, False, '
...
')
     , (24126, 4, 'Elysa', 'prewritten', 4294967295, False, '
...
')
     , (24126, 5, 'Elysa', 'prewritten', 4294967295, False, '
...
')
     , (24126, 6, 'Elysa', 'prewritten', 4294967295, False, '
...
')
     , (24126, 7, 'Elysa', 'prewritten', 4294967295, False, '
