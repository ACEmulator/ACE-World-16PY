...
VALUES (8086, 16, 'A translated missive, taken from the hands of an undead at the Fenmalain Facility.') /* LONG_DESC_STRING */
     , (8086, 1, 'Urgent Dispatch') /* NAME_STRING */
     , (8086, 14, 'Use this item to read it.') /* USE_STRING */
     , (8086, 15, 'A translated note.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8086, 1, 33554773) /* SETUP_DID */
     , (8086, 3, 536870932) /* SOUND_TABLE_DID */
     , (8086, 8, 100668176) /* ICON_DID */
     , (8086, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8086, 9, 0) /* LOCATIONS_INT */
...
VALUES (8086, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (8086, 0, 'Sahoni Arsanc', 'prewritten', 4294967295, False, '
My lord Anadil,
...
')
     , (8086, 1, 'Sahoni Arsanc', 'prewritten', 4294967295, False, '
...
')
     , (8086, 2, 'Sahoni Arsanc', 'prewritten', 4294967295, False, '
...
')
     , (8086, 5, 'Sahoni Arsanc', 'prewritten', 4294967295, False, 'My lord, I now command a much-depleted force, consisting of the weaker and wounded common soldiery. I do fear we no longer have sufficient force to hold this facility from the servants of the Enemy. I pray you to speed reinforcement, lest the next sally dislodge us utterly. We expect a fresh assault from the upper levels at any moment. I will send this note to you through our last surviving enchanter, Lord Pleridarc of-

I hear now the clatter of renewed combat. The shouts are foreign. They may be in the tongue of the outlanders.
')
     , (8086, 6, 'Sahoni Arsanc', 'prewritten', 4294967295, False, '
