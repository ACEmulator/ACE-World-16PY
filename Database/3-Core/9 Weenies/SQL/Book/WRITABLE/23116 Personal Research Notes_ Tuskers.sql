...
DELETE FROM ace_weenie_class WHERE weenieClassId = 23116;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (23116, 'writingaerbaxtusker');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (23116, 272, 23116);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23116, 1, 'Personal Research Notes: Tuskers') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23116, 1, 33554771) /* SETUP_DID */
     , (23116, 3, 536870932) /* SOUND_TABLE_DID */
     , (23116, 8, 100668117) /* ICON_DID */
     , (23116, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23116, 9, 0) /* LOCATIONS_INT */
     , (23116, 1, 8192) /* ITEM_TYPE_INT */
     , (23116, 93, 1044) /* PHYSICS_STATE_INT */
     , (23116, 5, 160) /* ENCUMB_VAL_INT */
     , (23116, 16, 8) /* ITEM_USEABLE_INT */
     , (23116, 8, 200) /* MASS_INT */
     , (23116, 19, 90) /* VALUE_INT */
     , (23116, 174, 16) /* APPRAISAL_PAGES_INT */
     , (23116, 175, 16) /* APPRAISAL_MAX_PAGES_INT */
     , (23116, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (23116, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (23116, 39, 1.22) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (23116, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (23116, 0, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker.
...
')
     , (23116, 1, 'Aerbax', 'prewritten', 4294967295, False, 'Stimuli will be introduced to the grey matter through contact of a physical nature, visual stimuli, and audial stimuli. Should these methods fail, introduction of grey matter will continue until goals are achieved or the subject destroys itself.
...
')
     , (23116, 2, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker.
...
')
     , (23116, 3, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker.
...
')
     , (23116, 4, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 5, 'Aerbax', 'prewritten', 4294967295, False, 'Test subject: Alpha male tusker
...
')
     , (23116, 6, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 7, 'Aerbax', 'prewritten', 4294967295, False, 'Test subject: Alpha male tusker
...
')
     , (23116, 8, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 9, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 10, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 11, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 12, 'Aerbax', 'prewritten', 4294967295, False, 'invited the "outlanders" to my laboratory to let them bear witness to my creation. Yet I wonder now if there will be time.
...
')
     , (23116, 13, 'Aerbax', 'prewritten', 4294967295, False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 14, 'Aerbax', 'prewritten', 4294967295, False, 'until I have faced them and returned without cleansing.
...
')
     , (23116, 15, 'Aerbax', 'prewritten', 4294967295, False, 'Conclusion:
