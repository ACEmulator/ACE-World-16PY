/* Weenie - A Battered Leather Journal (8360) */
...
VALUES (8360, 272, 8360);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8360, 1, 'A Battered Leather Journal') /* NAME_STRING */
     , (8360, 15, 'A journal written by Sir Candeth Martine') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8360, 1, 33554771) /* SETUP_DID */
     , (8360, 3, 536870932) /* SOUND_TABLE_DID */
     , (8360, 8, 100668117) /* ICON_DID */
     , (8360, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8360, 9, 0) /* LOCATIONS_INT */
...
VALUES (8360, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (8360, 0, '', 'prewritten', 4294967295, False, 'To whomever may find this, please give to Olivier Rognath.  The last I saw of him, he resided in Eastham:
...
')
     , (8360, 1, '', 'prewritten', 4294967295, False, 'Who could have imagined a world in which death is no longer the end of one''s thoughts and experiences but merely a temporary stage in between?  Unless, one day, it changes...but useless for me to think of that now.
...
')
     , (8360, 2, '', 'prewritten', 4294967295, False, 'Sir Alayne had sent me to a relatively new Mosswart outpost to take notes on general Mosswart life, and to see if I could verify whether there were any sort of organized movement amongst the creatures, and if so, why.
