/* Weenie - Tome of the Elements (15796) */
...
VALUES (15796, 0, 'Translator', 'prewritten', 4294967295, False, 'Where it is applicable I have added notes in paranthesis to highlight words as we would speak them in everyday tongue.
')
     , (15796, 1, 'Gaerlan', 'prewritten', 4294967295, False, 'The Falatacot, studied the art of Geomancy with an unquenchable thirst. They called upon the resonance that echoed from within the world at the structures erected in the time before. They found that it was here, on Ireth Lassel, that mana was most concentrated, and plentiful.
...
')
     , (15796, 3, 'Gaerlan', 'prewritten', 4294967295, False, 'Scholars all, some to a fault. They watched from afar and in time fell further into the darkness. They uncovered arcane arts that even they would not enact, as the cost for such was too high. Blood was life, and without blood there was only death.
...
')
     , (15796, 6, 'Gaerlan ', 'prewritten', 4294967295, False, 'they were the prey to an oppresive hunter/brother. 
...
')
     , (15796, 7, 'Gaerlan', 'prewritten', 4294967295, False, 'Some have speculated that the only ones who would know the truths of the Falatacot were driven from this world long ago. They flew into seclusion or were hunted by the remnants of the Falatacot/Dericost in the time of the one that shall remain unnamed.
...
')
     , (15796, 8, 'Gaerlan', 'prewritten', 4294967295, False, 'Now, there is something to be said for ages. For we live in the time of the great seaborne kingdom and though I have left that place, I am still of this age. But there is one that I have learned is not, of my age.

In a time when the Unnamed walked this world, and brought his army of the dark against Lord Atlan, he lived.

He lives still.
')
     , (15796, 9, 'Gaerlan', 'prewritten', 4294967295, False, 'The Gelid
...
')
     , (15796, 10, 'Gaerlan', 'prewritten', 4294967295, False, 'Nestled in the remains of their ancestors homes the Gelid studied their arts on the Plateau of Gelid.
...
')
     , (15796, 11, 'Gaerlan', 'prewritten', 4294967295, False, 'during this epoch the Yalain tortured the Gelid, while the Haebrous hunted them to near extinction.
...
')
     , (15796, 12, 'Gaerlan', 'prewritten', 4294967295, False, 'Introduction
...
')
     , (15796, 14, 'Gaerlan', 'prewritten', 4294967295, False, 'into beings that could exist for all of time, without the fear of death. Thereby they allowed themselves the freedom to study their arts at their leisure and with as much depth as they could withstand. The main body of the Gelid had other plans however. 
...
')
     , (15796, 15, 'Gaerlan', 'prewritten', 4294967295, False, 'With the extinction of their kind, this information would have been lost to time. Never uncovered and looked on a fable of a hidden library...
...
')
     , (15796, 16, 'Gaerlan', 'prewritten', 4294967295, False, 'Mana (The Blood of the World)
...
')
     , (15796, 17, 'Gaerlan', 'prewritten', 4294967295, False, 'into the earth and created, large stone structures. But the progress there was muted as they hit a point at which they were rebuffed by the Blood''s own essence.
...
')
     , (15796, 18, 'Gaerlan', 'prewritten', 4294967295, False, 'I have visited each of these devices and felt the surge from within the world itself, and will attest that there is a palpable feeling of power within those places. But there is a problem with direct access to the cisterns.
...
')
     , (15796, 19, 'Gaerlan', 'prewritten', 4294967295, False, 'their very veins. They would bloodlet, and sacrifice all in the name of their Old Gods, to draw themselves closer to the Blood of the World.
...
')
     , (15796, 20, 'Gaerlan', 'prewritten', 4294967295, False, 'could harness through teaching and craft.
...
')
     , (15796, 21, 'Gaerlan', 'prewritten', 4294967295, False, 'from within a mountain was nothing more than an aspect of the Blood of the World. The began studying and collecting evidence as such and toyed with the effects of Geomancy upon it.
...
')
     , (15796, 22, 'Gaerlan', 'prewritten', 4294967295, False, 'If the the Blood of the World is represented in one aspect as a pool of liquid magma, why is it not possible for there to be more than one of these types of tangible representations.
...
Decay/Entropy - Acid
')
     , (15796, 23, 'Gaerlan', 'prewritten', 4294967295, False, 'Consumption - Fire
...
')
     , (15796, 24, 'Gaerlan', 'prewritten', 4294967295, False, 'concentrated pool of blood.
...
')
     , (15796, 25, 'Gaerlan', 'prewritten', 4294967295, False, 'use of all three former magical aspects. They were further refined over the decades and became as swift as calling forth a being to serve you by simply finding the an area attuned to the basic type you needed at a moment.
...
')
     , (15796, 26, 'Gaerlan', 'prewritten', 4294967295, False, 'much of themselves in the process.
...
')
     , (15796, 27, 'Gaerlan', 'prewritten', 4294967295, False, 'predominantly intact and saw the form of an element composed of lightning kneeling before me. However, the process still left me drained.
...
')
     , (15796, 28, 'Gaerlan', 'prewritten', 4294967295, False, 'Though there is no written text to support the theory, I have surmised that they feared that they would be locked into a stasis that would damn their undead forms forever.
...
')
     , (15796, 29, 'Gaerlan', 'prewritten', 4294967295, False, 'to the smallest detail. They were true artisans these, Disciples, and though they were never able to achieve the end goal of their constructions they provided valuable blueprints for any that would follow in their path.
...
')
     , (15796, 30, 'Gaerlan', 'prewritten', 4294967295, False, 'these cisterns, quarters were developed for the overseer. Though they were never used they were stocked with magical devices that would grant the overseer protection from the harshness of being in such close proximity to the distilled Blood (mana). There was a minor cost, but it was a pittance when compared to what these overseers would command in terms of power.
...
')
     , (15796, 32, 'Gaerlan', 'prewritten', 4294967295, False, 'Each of these Cisterns would be capable of creating an army of aspected beings that listen to the clarion call of one mind. Four minds that would control the embodiment of the Blood of the World.
...
')
     , (15796, 33, 'Gaerlan', 'prewritten', 4294967295, False, 'contrary.
...
')
     , (15796, 34, 'Gaerlan', 'prewritten', 4294967295, False, 'pacts drawn long ago with their Disciple masters.
...
')
     , (15796, 35, 'Gaerlan', 'prewritten', 4294967295, False, 'of caution until a time I saw fit to test their arts to see what would come of it.
...
')
     , (15796, 36, 'Gaerlan', 'prewritten', 4294967295, False, 'cisterns into functional use and thereby create an army of these beings that will heed my call and do my whim.
...
')
     , (15796, 38, 'Gaerlan', 'prewritten', 4294967295, False, 'lightning aspects of the mana have proven most beneficial. They call me by name upon their summoning now and are beginning to show some indication of being linked to the Blood even though they are separated from it.
...
')
     , (15796, 39, 'Gaerlan', 'prewritten', 4294967295, False, 'I have spent many years now within these cisterns, preparing for the revenge that is do my brother. I grow in power each day and though the frost and acid beings are slow to mature, I have seen progress.
...
He shall pay.
')
     , (15796, 40, 'Translator''s Notes', 'prewritten', 4294967295, False, '(Again there is a discrepancy of time, this seems to allude to the period just before what we have come to know as the flight of the Empyrean.)
')
     , (15796, 41, 'Gaerlan', 'prewritten', 4294967295, False, 'Pretentious fool. They come because of him. My brothers killers, they have begun pouring over our lands devouring all that comes in their way. 
...
')
     , (15796, 42, 'Gaerlan', 'prewritten', 4294967295, False, 'I must strike now, while the iron is hot, drive my hate into him and see him brought low to be justly accused of his transgression. His crime. His murder.
...
')
     , (15796, 43, 'Translator''s Notes', 'prewritten', 4294967295, False, 'begun but there is no way to determine what the intended word was to to be. A proper name, perhaps a named crime. Regardless, the abrupt break suggests that the author simply stopped writing, was forced to stop writing or other foul befell them.)
');
