...
VALUES (5703, 1, True) /* STUCK_BOOL */
     , (5703, 13, False) /* ETHEREAL_BOOL */
     , (5703, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (5703, 0, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'This was one of my favorite stories back in the homelands, that warned of the dangers of attachment.  I learned it from my grandmother, and now that I am an old man, it is time that I teach future generations this tale.  Here it is as best as I remember.
')
     , (5703, 1, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'Once upon a time, there was a young man named Ken-gou.  He lived on Chiran-tou, the Island of the Unicorn.  Some said that Ken-gou was taught by the Unicorn in his dreams, for he had grown to become a most gracious person, kind to everyone, and loved by children.  Some said the Ken-gou was trained by the Dragon, for he was ever disciplined and strong.  But his mind was ever on the things beyond the world, and so his parents said that his path must surely be with the Firebird.
')
     , (5703, 2, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'When he came of age he said goodbye to his parents and traveled to the Washui Iiwah Jou, the Temple of the Splendor of the Firebird.  There, he prostrated himself before the Abbess Joutou, and said,
...
')
     , (5703, 3, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'But Abbess Joutou said with a smile,
...
')
     , (5703, 6, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'Ken-gou bowed and said, I will do as you ask.
...
')
     , (5703, 7, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'I will show you the pillar myself, said the Emperor.  And so the three were led down many dark steps until they came to a crude room, at the center of which, surrounded by many unreadable writings, stood the gold pillar.  They could sense the angry spirit of the snake, still wrapped around the pillar.
...
')
     , (5703, 8, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'The disciple of the Dragon was the first to act.  Drawing upon his disciplined powers, he called upon the very Dragon to destroy the snake spirit.  But the Dragon''s voice said, 
...
')
     , (5703, 9, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'The disciple of the Unicorn was the next to try.  Spirit snake, she said, let go the pillar and go to Heaven.  There is peace and Grace there, awaiting you.
...
')
     , (5703, 10, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'The disciple of the Unicorn then said, I will give the spirit my peace, and I will let the spirit stay.  If we do not disturb it, it can rest until the end of the world.
...
')
     , (5703, 11, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'He called the Emperor''s servants to him and said,  We must melt the pillar, right here within this room.  
...
')
     , (5703, 12, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'The Disciple of the Dragon did as he was told, and the servants rushed to do as was suggested.  Before long, the pillar was being melted down at the center of the room.  Then, when it was melted down to a fiery liquid, Ken-gou said,

Now, divide up the gold into a thousand sections, and make from them a thousand coins.
')
     , (5703, 13, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'This too was done.  The Emperor clapped his hands and said, Yes, I see now!  You are a disciple of the Firebird of Splendor, who knows the value of detaching from desires.  Now that the pillar is no longer a pillar and is scattered into a thousand pieces, surely the snake will give up and go to Heaven of its own accord.  In reward for breaking the curse of the serpent, I shall give you half of the gold as I promised!
')
     , (5703, 14, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'But Ken-gou said, That is not sufficient to break the curse.  The coins must not be given to anyone within this room; they must be blessed by the Unicorn and given to the poor throughout the country.  The Unicorn will have compassion on the poor, and they will suffer no harm.  In this way the curse shall be broken.
')
     , (5703, 15, 'Ken-gou and the Curse of Attachment', 'prewritten', 4294967295, False, 'The Emperor was amazed and said, Can it be that you do not want any of the gold?
