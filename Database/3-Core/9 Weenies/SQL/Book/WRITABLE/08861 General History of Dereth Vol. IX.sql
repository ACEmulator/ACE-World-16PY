...
VALUES (8861, 9, 0) /* LOCATIONS_INT */
     ...
     , (8861, 8, 10) /* MASS_INT */
     , (8861, 19, 0) /* VALUE_INT */
     , (8861, 174, 13) /* APPRAISAL_PAGES_INT */
...
VALUES (8861, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (8861, 0, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, '
...
')
     , (8861, 1, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, '
...
')
     , (8861, 2, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, '
...
')
     , (8861, 3, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, '
...
')
     , (8861, 6, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, '
...
')
     , (8861, 9, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, 'Khallayne and Raynie of Thistledown provided chocolate milk. Rhiannon Morgana and Touryan Kurigsun of Frostfell supplied chocolate cake. Betty Crocker of Leafcull, one of the famous chefs of Cragstone Farms Catering, created chocolate ice cream. Chen Kenichi of Frostfell, part of the ill-starred adventuring troupe Vitae Rising, produced the chocolate bar, known colloquially as the "Vitae Bar." Chen proudly noted that infamous beating-magnet Wi loved his creation. Ho Chun and Theran Bakagin of Frostfell, meanwhile, leavened the somewhat bitter Vitae Bar into a creamy milk chocolate bar.
')
     , (8861, 10, 'Jaiph Rainshadow', 'prewritten', 4294967295, False, '
