/* Weenie - Scrawled Note (9195) */
DELETE FROM ace_weenie_class WHERE weenieClassId = 9195;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (9195, 'noteundeadaerbaxtranslated');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (9195, 272, 9195);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9195, 16, 'A piece of parchment, written in blood.  It is obvious that the paper is very worn, and brittle, as if from ages past.') /* LONG_DESC_STRING */
     , (9195, 1, 'Scrawled Note') /* NAME_STRING */
     , (9195, 14, 'Use this item to read it.') /* USE_STRING */
     , (9195, 15, 'A piece of parchment, written in blood.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9195, 1, 33554773) /* SETUP_DID */
     , (9195, 3, 536870932) /* SOUND_TABLE_DID */
     , (9195, 8, 100668176) /* ICON_DID */
     , (9195, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9195, 9, 0) /* LOCATIONS_INT */
     , (9195, 1, 8192) /* ITEM_TYPE_INT */
     , (9195, 93, 1044) /* PHYSICS_STATE_INT */
     , (9195, 5, 5) /* ENCUMB_VAL_INT */
     , (9195, 16, 8) /* ITEM_USEABLE_INT */
     , (9195, 8, 5) /* MASS_INT */
     , (9195, 19, 0) /* VALUE_INT */
     , (9195, 174, 30) /* APPRAISAL_PAGES_INT */
     , (9195, 175, 30) /* APPRAISAL_MAX_PAGES_INT */
     , (9195, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (9195, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (9195, 39, 1.22) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (9195, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (9195, 0, 'Talaagran Sarian', 'prewritten', 4294967295, False, 'Members of delegation:
...
')
     , (9195, 3, '', 'prewritten', 4294967295, False, 'Firstborn begin parlay.
...
')
     , (9195, 4, '', 'prewritten', 4294967295, False, 'Lord outlines Dame Tolani''s expedition to Dericost, recovery of skull. Lady outlines the bindings.
...
')
     , (9195, 5, '', 'prewritten', 4294967295, False, '----
...
')
     , (9195, 23, '', 'prewritten', 4294967295, False, ' I do not have the courage to imagine how things may change when we are no longer of use to them, or, still worse, if we should become an obstacle to them. I do fear that they would make us useful to them again, in the way they have the scavengers.
--
...
')
     , (9195, 28, '', 'prewritten', 4294967295, False, 'I saw the first altered yesterday. I think they caught her in the desert. She had a Dayanic accent. The Watchers just let me wander into the lab. I saw what they did to her. I ran, but they caught me quickly. "Material," they said. They manifested the same tongs they use to drag the scavengers around by the neck, and brought me here. These are my last few sheets of paper. I write with my own precious blood, the only ink I have available.

')
     , (9195, 29, '', 'prewritten', 4294967295, False, 'After I am gone, it will be as if my family had never been. After ten millennia. None shall remember. I pray someone saves this little memory of us.
