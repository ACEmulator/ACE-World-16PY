...
DELETE FROM ace_weenie_class WHERE weenieClassId = 8733;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (8733, 'letterstampedyaraqgold');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (8733, 272, 8733);
...
VALUES (8733, 33, 1) /* BONDED_INT */
     ...
     , (8733, 174, 2) /* APPRAISAL_PAGES_INT */
     , (8733, 175, 2) /* APPRAISAL_MAX_PAGES_INT */
     , (8733, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (8733, 9007, 8) /* Book_WeenieType */;
...
VALUES (8733, 0, '', 'prewritten', 4294967295, False, 'Once this rare Gold Letter is stamped with a Town Stamp, it can be turned into an authorized Society Agent for a reward. Look in the Book of Quests for New Explorers to start on your way. Any of the Society Agents who are catering to new arrivals  in the nine Nexus towns maybe be contacted to obtain this guide
')
     , (8733, 1, '', 'prewritten', 4294967295, False, '"There are Members of my Society who do not understand that we must all stick together in these most trying circumstances.  But they will come to understand.  Of that I feel certain."
