...
DELETE FROM ace_weenie_class WHERE weenieClassId = 29327;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (29327, 'booksalvagingacademy');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (29327, 272, 29327);
...
VALUES (29327, 9, 0) /* LOCATIONS_INT */
     ...
     , (29327, 174, 5) /* APPRAISAL_PAGES_INT */
     , (29327, 175, 5) /* APPRAISAL_MAX_PAGES_INT */
     , (29327, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (29327, 9007, 8) /* Book_WeenieType */;
...
VALUES (29327, 0, 'Training Master', 'prewritten', 4294967295, False, 'COMBAT
...
')
     , (29327, 1, 'Training Master', 'prewritten', 4294967295, False, 'Select a target by clicking on it or its dot on the compass.
...
(Click on the green arrow to read more!)
')
     , (29327, 2, 'Training Master', 'prewritten', 4294967295, False, 'Your target''s health is displayed below its name in the bottom-right corner of the screen. When your target runs out of health, it will die. Double-click on its corpse to check for loot!
...
(Click on the green arrow to read more!)
')
     , (29327, 3, 'Training Master', 'prewritten', 4294967295, False, 'To see what a spell does, appraise it with the magnifying glass, or right-click on it.
...
(Click on the green arrow to read more!)
')
     , (29327, 4, 'Training Master', 'prewritten', 4294967295, False, 'Watch the blue mana bar at the top of the screen. If it runs out, you can''t cast spells.
