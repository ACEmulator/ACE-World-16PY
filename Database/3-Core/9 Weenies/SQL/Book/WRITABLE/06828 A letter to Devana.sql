...
VALUES (6828, 276, 6828);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6828, 16, 'A letter from Hamud ibn Rafik to his daughter, Devana.') /* LONG_DESC_STRING */
     , (6828, 1, 'A letter to Devana') /* NAME_STRING */
     , (6828, 15, 'A letter from Hamud ibn Rafik to his daughter, Devana.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (6828, 1, 33554773) /* SETUP_DID */
     , (6828, 3, 536870932) /* SOUND_TABLE_DID */
     , (6828, 8, 100668176) /* ICON_DID */
     , (6828, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (6828, 9, 0) /* LOCATIONS_INT */
     ...
     , (6828, 22, 1000) /* AVAILABLE_CHARACTER_INT */
...
VALUES (6828, 1, True) /* STUCK_BOOL */
     , (6828, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (6828, 0, '', 'prewritten', 4294967295, False, 'My daughter,
...
')
     , (6828, 1, '', 'prewritten', 4294967295, False, 'Enough of my maunderings.  The real reason I write to you is to send you a warning, my daughter.
