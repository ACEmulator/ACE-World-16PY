...
VALUES (7775, 272, 7775);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7775, 16, 'A book on the uses of anti-magic ore.') /* LONG_DESC_STRING */
     , (7775, 1, 'Practical Applications of Chorizite') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7775, 1, 33554771) /* SETUP_DID */
     , (7775, 3, 536870932) /* SOUND_TABLE_DID */
     , (7775, 8, 100668117) /* ICON_DID */
     , (7775, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7775, 9, 0) /* LOCATIONS_INT */
