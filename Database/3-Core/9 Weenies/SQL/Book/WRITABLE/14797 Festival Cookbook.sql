...
VALUES (14797, 16, 'A collection of recipes created during the Festival Season, PY 13.') /* LONG_DESC_STRING */
     , (14797, 1, 'Festival Cookbook') /* NAME_STRING */
     , (14797, 15, 'A collection of recipes created during the Festival Season, PY.13.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14797, 1, 33554771) /* SETUP_DID */
     , (14797, 3, 536870932) /* SOUND_TABLE_DID */
     , (14797, 8, 100668117) /* ICON_DID */
     , (14797, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14797, 9, 0) /* LOCATIONS_INT */
     , (14797, 1, 8192) /* ITEM_TYPE_INT */
     , (14797, 93, 1044) /* PHYSICS_STATE_INT */
     , (14797, 5, 200) /* ENCUMB_VAL_INT */
     , (14797, 16, 8) /* ITEM_USEABLE_INT */
     , (14797, 8, 100) /* MASS_INT */
     , (14797, 19, 15) /* VALUE_INT */
     , (14797, 174, 15) /* APPRAISAL_PAGES_INT */
     , (14797, 175, 15) /* APPRAISAL_MAX_PAGES_INT */
     , (14797, 22, 1000) /* AVAILABLE_CHARACTER_INT */
...
VALUES (14797, 22, True) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (14797, 0, 'FESTIVAL FOODS                      ', 'prewritten', 4294967295, False, 'FESTIVAL FOODS
...
')
     , (14797, 1, 'INGREDIENTS: Peppermint                  ', 'prewritten', 4294967295, False, 'NEW INGREDIENTS
...
')
     , (14797, 2, 'INGREDIENTS: Nutmeg & Ginger                   ', 'prewritten', 4294967295, False, 'NEW INGREDIENTS (Cont.)
...
')
     , (14797, 3, 'SANDWICHES                                   ', 'prewritten', 4294967295, False, 'SANDWICHES
...
')
     , (14797, 4, 'DINNER: Mac&Cheese                           ', 'prewritten', 4294967295, False, 'DINNER FOODS
...
')
     , (14797, 5, 'DINNER: Cragstonanoff                          ', 'prewritten', 4294967295, False, 'DINNER FOODS
...
')
     , (14797, 6, 'DINNER: Dumplings                               ', 'prewritten', 4294967295, False, 'DINNER FOODS
...
')
     , (14797, 7, 'DRINKS: Hot Chocolate                           ', 'prewritten', 4294967295, False, 'WINTER DRINKS
...
')
     , (14797, 8, 'DRINKS: Eggnog                                  ', 'prewritten', 4294967295, False, 'WINTER DRINKS
...
')
     , (14797, 9, 'SNACKS: Stuffed Mushrooms                         ', 'prewritten', 4294967295, False, 'SNACKS
...
')
     , (14797, 10, 'TREATS: Peppermint Treats                             ', 'prewritten', 4294967295, False, 'TREATS
...
')
     , (14797, 11, 'DESSERTS: Cookies                                   ', 'prewritten', 4294967295, False, 'DESSERTS
...
')
     , (14797, 12, 'DESSERTS: Ice Cream                               ', 'prewritten', 4294967295, False, 'DESSERTS
...
')
     , (14797, 13, 'DESSERTS: Ginger Bread                               ', 'prewritten', 4294967295, False, 'DESSERTS
...
')
     , (14797, 14, 'REACTIONS                                       ', 'prewritten', 4294967295, False, 'REACTIONS
