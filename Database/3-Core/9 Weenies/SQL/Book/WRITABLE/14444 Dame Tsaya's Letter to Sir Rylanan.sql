...
VALUES (14444, 1, False) /* STUCK_BOOL */
     , (14444, 22, False) /* INSCRIBABLE_BOOL */
     , (14444, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (14444, 0, 'Dame Tsaya', 'prewritten', 4294967295, False, 'Sir Rylanan,
...
')
     , (14444, 2, 'Dame Tsaya', 'prewritten', 4294967295, False, 'What''s more, Sir Tenshin has written me with news from Shoushi. It seems strange happenings are not unique to Yaraq at this time. I include the text from his message below.
...
***
')
     , (14444, 3, 'Dame Tsaya', 'prewritten', 4294967295, False, '(Copy of a letter to Dame Tsaya from Sir Tenshin)
...
')
     , (14444, 4, 'Dame Tsaya', 'prewritten', 4294967295, False, 'After interviewing the farmer, the bearer of this message found a trap door towards the rear of his house, leading down to a seeminly innocuous cellar. However, a large cache of weapons was found behind a hidden doorway as well as stacks of Guard uniforms.
