...
VALUES (25680, 22, False) /* INSCRIBABLE_BOOL */
     , (25680, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (25680, 0, 'Jaeget', 'prewritten', 4294967295, False, 'Yesterday my brother and I began our usual hunts of the Marescent Plateau. We usually did this in search of pelts and hide from the carenzi and gromnie found there. It''s not a very fulfilling living, but it pays the maintenance on the cottage my family owns.
...
')
     , (25680, 1, 'Jaeget', 'prewritten', 4294967295, False, 'He promised something meaningful and worthwhile out of life. I have to admit that sounds a deal more satisfying than how my brother and I are living now.
...
')
     , (25680, 2, 'Jaeget', 'prewritten', 4294967295, False, 'So, when Bewren wasn''t looking, I pocketed the pamphlet and attached jewel, and my brother and I continued on past the initiate.
---
...
')
     , (25680, 3, 'Jaeget', 'prewritten', 4294967295, False, 'I have made up my mind; I am going to crush this calling stone and invite the Raven Hand to take me. And, I think while they are here I will ask him to take my brother as well. 
...
---
')
     , (25680, 4, 'Jaeget', 'prewritten', 4294967295, False, 'Last night I crushed the calling stone and several members of the Raven Hand arrived shortly there after. 
...
')
     , (25680, 5, 'Jaeget', 'prewritten', 4294967295, False, 'After I had time to place the few belongings the Order allowed me to bring, they began to question me, to get a feel for where my skills would best be put to use, no doubt.
...
---
')
     , (25680, 6, 'Jaeget', 'prewritten', 4294967295, False, 'Today one of the priests pulled me aside and told me my purpose. Since I had a lot of skill with hides and curing, I was set to the task of flask crafting. 
...
')
     , (25680, 7, 'Jaeget', 'prewritten', 4294967295, False, 'They issued me a kerchief to cover my mouth and nose with and tasked me with creating a flask that could hold a potently enchanted beaker of Olthoi Ichor.
...
---
')
     , (25680, 8, 'Jaeget', 'prewritten', 4294967295, False, 'The past week has been exhausting, but fun. So much fun I can''t remember why I even second-guessed coming here in the first place. 
...
')
     , (25680, 9, 'Jaeget', 'prewritten', 4294967295, False, 'During our mid-day meal, the High Priests told us of the capture an interloper named Bewren. They said he was trying to escape with our sculpting secrets.
...
')
     , (25680, 10, 'Jaeget', 'prewritten', 4294967295, False, 'They said the intruder, Bewren, would be properly punished and then released from our home. That is enough for me, and none of my concern. 
