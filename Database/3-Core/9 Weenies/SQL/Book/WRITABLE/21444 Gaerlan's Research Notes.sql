/* Weenie - Gaerlan's Research Notes (21444) */
DELETE FROM ace_weenie_class WHERE weenieClassId = 21444;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (21444, 'tomegaerlanresearch');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (21444, 272, 21444);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (21444, 1, 'Gaerlan''s Research Notes') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (21444, 1, 33556929) /* SETUP_DID */
     , (21444, 3, 536870932) /* SOUND_TABLE_DID */
     , (21444, 7, 268436459) /* CLOTHINGBASE_DID */
     , (21444, 8, 100673477) /* ICON_DID */
     , (21444, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21444, 9, 0) /* LOCATIONS_INT */
     , (21444, 1, 8192) /* ITEM_TYPE_INT */
     , (21444, 93, 1044) /* PHYSICS_STATE_INT */
     , (21444, 5, 160) /* ENCUMB_VAL_INT */
     , (21444, 16, 8) /* ITEM_USEABLE_INT */
     , (21444, 8, 200) /* MASS_INT */
     , (21444, 19, 90) /* VALUE_INT */
     , (21444, 174, 40) /* APPRAISAL_PAGES_INT */
     , (21444, 175, 40) /* APPRAISAL_MAX_PAGES_INT */
     , (21444, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (21444, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (21444, 39, 1.22) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (21444, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (21444, 0, 'Gaerlan', 'prewritten', 4294967295, False, 'Entry 1
...
')
     , (21444, 1, 'Gaerlan', 'prewritten', 4294967295, False, 'for them. However seeing as it likely they were fully aware of the consequences, there is nothing within me that would lend itself toward compassion.
...
')
     , (21444, 2, 'Gaerlan', 'prewritten', 4294967295, False, 'It has taken some time to master the intricacies of writing in such a fashion, but I think that my efforts have progressed well.
...
')
     , (21444, 5, 'Gaerlan', 'prewritten', 4294967295, False, 'your mind. 
...
')
     , (21444, 6, 'Gaerlan', 'prewritten', 4294967295, False, 'timid.
...
')
     , (21444, 7, 'Gaerlan', 'prewritten', 4294967295, False, 'The three books of Falatacot design I had left on my desk were placed neatly back into the shelves where they had been originally found. My inspection of the area gave no trace of any other person''s passage, so I can only assume that the spirits that dwell within this place decided that they must act as caretakers. Quite the oddity, perhaps I shall set a golem to watch the goings-on here.

Entry 5

')
     , (21444, 8, 'Gaerlan', 'prewritten', 4294967295, False, 'After the discovery of the other library on the mainland of Ireth Lassel, this place has seemed pale by comparison. The tomes within this place are mostly rote history, with no flare for originality. That was until today.
...
')
     , (21444, 11, 'Gaerlan', 'prewritten', 4294967295, False, 'While the intentions of the undead are plainly the eradication of the Yalain and Haebrous people, my cause is far tamer. Thus I am free of the taint that they called upon themselves.
...
')
     , (21444, 16, 'Gaerlan', 'prewritten', 4294967295, False, 'Entry 7
...
')
     , (21444, 17, 'Gaerlan', 'prewritten', 4294967295, False, 'There must be anchors set in the citadel to draw upon the mana streams when I have harnessed their energy. Then I will be able to set about finding the remnants of the Disciples.
...
')
     , (21444, 19, 'Gaerlan', 'prewritten', 4294967295, False, 'Entry 9
...
')
     , (21444, 20, 'Gaerlan', 'prewritten', 4294967295, False, 'At their head I have placed myself, a commander that will use them as the forward guard of the Cerulean Throne''s armies.
...
')
     , (21444, 21, 'Gaerlan', 'prewritten', 4294967295, False, 'Yes dust has gathered and cobwebs have climbed into areas that were once clear, but unlike so many other things, it is just as I remember it. The wailing of the spirits here brings me a calm now and a remembrance of the work I started long ago.
...
')
     , (21444, 27, 'Gaerlan', 'prewritten', 4294967295, False, 'They are feeble, but among them then I found one that had taken up the mantle of the Falatacot. She was devious and cruel, deserving of a most severe punishment. So I set about finding her. She was easily found and, with the assistance of one of Martine''s minions, I have been able to lead her to the library in the mountains. I go to greet her today.
')
     , (21444, 28, 'Gaerlan', 'prewritten', 4294967295, False, '(Translator''s Note: This account did not appear until brought near candlelight. As I passed the pages closer to the flame they came into view. I have taken the liberty of tracing them for you. It is unlikely that the author realized it was penned.)
...
')
     , (21444, 30, 'Gaerlan', 'prewritten', 4294967295, False, 'the wall. Her bones snap and begin to liquefy. She stifles a scream for a moment and then wails like the vermin she is. As I approach closer I smile. She weeps.
...
')
     , (21444, 31, 'Gaerlan', 'prewritten', 4294967295, False, 'These books long ago became purposeless to me and their destruction will be no great loss. Kai cries at the doorway until I command him to return to the outer foyer, to welcome more... guests.
...
')
     , (21444, 32, 'Gaerlan', 'prewritten', 4294967295, False, 'The moment it places her form on the top of the column, it crumples to the ground. The draining has begun. It will take longer should people choose to save her, but that divine torture is my reward for removing such a threat from the world.
')
     , (21444, 33, 'Gaerlan', 'prewritten', 4294967295, False, 'Entry 11
...
')
     , (21444, 34, 'Gaerlan', 'prewritten', 4294967295, False, 'The power can no longer be contained within that tiny essence. Now they will rise and serve their master, and then when the time is right, their forms will weakened by the vermin. I will take them into the Elemental Hall and draw them into the one that existed at the dawn of time.
...
')
     , (21444, 35, 'Gaerlan', 'prewritten', 4294967295, False, 'To think that the Emperor believed that Asheron would be the salvation of our race is laughable. His greatest spell locked us away in the world between worlds. He is nothing more than a charlatan with a weakness to be exploited by wretched creatures that would make better pets than masters of this world.
...
')
     , (21444, 36, 'Gaerlan', 'prewritten', 4294967295, False, 'It is unimaginable that her people could have decided to let the woman live. Such pity is the thing of folly.
...
')
     , (21444, 37, 'Gaerlan', 'prewritten', 4294967295, False, 'How could they have done this? Now we are all doomed. It will grow, and it will manifest into a being that is like a god spoken of as founding this world. There will be no force that will stand before it that will not fall. Without a master, it will unravel this world.
...
')
     , (21444, 38, 'Gaerlan', 'prewritten', 4294967295, False, 'Armed with Iasparailaun I will cleave their flesh when they arrive. Amusing how their people are responsible for the creation of these weapons. Once I hace dispatched them I will make an attempt to right was has been undone.
')
     , (21444, 39, 'Gaerlan', 'prewritten', 4294967295, False, 'But I can sense Martine coming for me. I can sense Asheron lives, even though I cannot see him.
