...
VALUES (5856, 9, 0) /* LOCATIONS_INT */
     ...
     , (5856, 174, 13) /* APPRAISAL_PAGES_INT */
     , (5856, 175, 13) /* APPRAISAL_MAX_PAGES_INT */
     , (5856, 22, 1000) /* AVAILABLE_CHARACTER_INT */
...
VALUES (5856, 0, '', 'prewritten', 4294967295, False, 'This book is dedicated to aspiring chefs who are tired of the basics.
...
')
     , (5856, 1, 'Carrot Soup', 'prewritten', 4294967295, False, 'CAROL''S CARROT SOUP
...
')
     , (5856, 2, 'Carrot Cake', 'prewritten', 4294967295, False, 'KAKORI''S CARROT CAKE
...
')
     , (5856, 3, 'Famous Pizza', 'prewritten', 4294967295, False, 'DANI THE CRAZED''S FAMOUS PIZZA
...
')
     , (5856, 4, 'Hot Sauce & Cinnamon', 'prewritten', 4294967295, False, 'REGARDING HOT SAUCE AND CINNAMON
...
')
     , (5856, 5, 'Hot Kimchi', 'prewritten', 4294967295, False, 'RASZAGAL AND TASSADAR''S HOT KIMCHI
...
')
     , (5856, 6, 'Spiced Apple Pie', 'prewritten', 4294967295, False, 'FIREDEMON''S SPICED APPLE PIE
...
')
     , (5856, 7, 'Fruitcake (Seasonal)', 'prewritten', 4294967295, False, 'BORTIN''S FRUITCAKE (SEASONAL)
...
(cont''d)
')
     , (5856, 8, 'Fruitcake (Seasonal)', 'prewritten', 4294967295, False, 'BORTIN''S FRUITCAKE (cont''d)
...
')
     , (5856, 9, 'Holtburgers', 'prewritten', 4294967295, False, 'FOSTER''S FAVORITE: HOLTBURGERS
...
')
     , (5856, 10, 'Applesauce', 'prewritten', 4294967295, False, 'SCHOLARS'' APPLESAUCE
...
')
     , (5856, 11, 'Ice Cream', 'prewritten', 4294967295, False, 'EVERYONE LOVES ICE CREAM
...
')
     , (5856, 12, 'Pumpkin Soup and Pie', 'prewritten', 4294967295, False, 'FESTIVE PUMPKIN SOUP AND PIE
