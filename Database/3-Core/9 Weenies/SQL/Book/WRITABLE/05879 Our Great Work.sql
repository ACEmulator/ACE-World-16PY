...
VALUES (5879, 272, 5879);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5879, 16, 'A translation of a book taken from the animated corpse of Lord Joffre Tremblant, in the Lost City of Frore.') /* LONG_DESC_STRING */
     , (5879, 1, 'Our Great Work') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5879, 1, 33554771) /* SETUP_DID */
     , (5879, 3, 536870932) /* SOUND_TABLE_DID */
     , (5879, 8, 100668117) /* ICON_DID */
     , (5879, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5879, 9, 0) /* LOCATIONS_INT */
     , (5879, 1, 8192) /* ITEM_TYPE_INT */
     , (5879, 93, 1044) /* PHYSICS_STATE_INT */
     , (5879, 5, 200) /* ENCUMB_VAL_INT */
     , (5879, 16, 8) /* ITEM_USEABLE_INT */
     , (5879, 8, 100) /* MASS_INT */
     , (5879, 19, 400) /* VALUE_INT */
     , (5879, 174, 20) /* APPRAISAL_PAGES_INT */
     , (5879, 175, 20) /* APPRAISAL_MAX_PAGES_INT */
     , (5879, 22, 1000) /* AVAILABLE_CHARACTER_INT */
...
VALUES (5879, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (5879, 0, 'Kuyiza bint Zayi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 1, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 2, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 3, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 4, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 5, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 6, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 7, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 8, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 9, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 10, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 11, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 12, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 13, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 14, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 15, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 16, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 17, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 18, 'Ferundi', 'prewritten', 4294967295, False, '
...
')
     , (5879, 19, 'Ferundi', 'prewritten', 4294967295, False, '
