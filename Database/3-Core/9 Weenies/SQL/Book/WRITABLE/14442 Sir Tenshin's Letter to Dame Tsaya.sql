...
VALUES (14442, 0, 'Sir Tenshin', 'prewritten', 4294967295, False, 'Dame Tsaya,
...
')
     , (14442, 1, 'Sir Tenshin', 'prewritten', 4294967295, False, 'After interviewing the farmer, the bearer of this message found a trap door towards the rear of his house, leading down to a seeminly innocuous cellar. However, a large cache of weapons was found behind a hidden doorway as well as stacks of Guard uniforms.
...
')
     , (14442, 2, 'Sir Tenshin', 'prewritten', 4294967295, False, 'present nervous state I do not trust myself to summarize his words correctly, so I will add his words below. 
...
***
')
     , (14442, 3, 'Sir Tenshin', 'prewritten', 4294967295, False, 'Copy of the letter from Sir Rylanan to Sir Tenshin)
