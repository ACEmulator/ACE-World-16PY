...
VALUES (11975, 22, True) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (11975, 0, 'Bachus Flufens', 'prewritten', 4294967295, False, 'Taiaha.  A beautiful word.  I think of farewells on a sandy beach, the sun setting into a blue on blue horizon.  "Taiaha," they would say.  "Taiaha," I would return, the last words spoken before night and sleep came upon us.
...
')
     , (11975, 1, 'Bachus Flufens', 'prewritten', 4294967295, False, 'But really, at its essence, it is a tool of war.  Used to kill people.  A thousand people on one end of a field, a thousand different people at the other end.  They shout at each other in excitement as they rush towards the middle of the field to greet each other.  But the pleasantries they exchange are their taiahas, sticking them into each other as fast and hard as they can.   The point of the taiaha is transformation: to transform live beings into dead bodies.    
')
     , (11975, 2, 'Bachus Flufens', 'prewritten', 4294967295, False, 'Such a poor juxtaposition of word and meaning proves one important point: that stupidity in a species is not limited to just us humans.
