...
DELETE FROM ace_weenie_class WHERE weenieClassId = 23353;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (23353, 'tamianjournal');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (23353, 272, 23353);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23353, 1, 'Journal of Tamian Wilmot') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23353, 1, 33554771) /* SETUP_DID */
     , (23353, 3, 536870932) /* SOUND_TABLE_DID */
     , (23353, 8, 100674007) /* ICON_DID */
     , (23353, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23353, 33, 1) /* BONDED_INT */
     , (23353, 9, 0) /* LOCATIONS_INT */
     , (23353, 1, 8192) /* ITEM_TYPE_INT */
     , (23353, 93, 1044) /* PHYSICS_STATE_INT */
     , (23353, 5, 20) /* ENCUMB_VAL_INT */
     , (23353, 16, 8) /* ITEM_USEABLE_INT */
     , (23353, 8, 50) /* MASS_INT */
     , (23353, 19, 25) /* VALUE_INT */
     , (23353, 114, 1) /* ATTUNED_INT */
     , (23353, 174, 11) /* APPRAISAL_PAGES_INT */
     , (23353, 175, 11) /* APPRAISAL_MAX_PAGES_INT */
     , (23353, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (23353, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (23353, 39, 1.22) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (23353, 22, False) /* INSCRIBABLE_BOOL */
     , (23353, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (23353, 0, 'Tamian Wilmot', 'prewritten', 4294967295, False, 'I love to draw and for this reason she will never love me.  I favor the sketching of designs over the heft of a blade. Thus, she will not love me.
...
')
     , (23353, 1, 'Tamian Wilmot', 'prewritten', 4294967295, False, ' I jumped in after you. I could hear our parent''s cries fading behind me as if smothered by a down blanket.  Fortunately for us, they followed soon after.
...
')
     , (23353, 2, 'Tamian Wilmot', 'prewritten', 4294967295, False, 'smell of your hair. They say love is of the heart, but why is it whenever you are close my stomach jumps like it is filled with all the rabbits that dwell around Rithwic? Yet, I could never tell you.
...
')
     , (23353, 3, 'Tamian Wilmot', 'prewritten', 4294967295, False, 'buildings. Fate has denied me this. This world values not such a skill.
...
')
     , (23353, 6, 'Tamian Wilmot', 'prewritten', 4294967295, False, 'can only be imagined now! You had to go then, but for the remainder of that day my happiness knew no bounds.
...
')
     , (23353, 7, 'Tamian Wilmot', 'prewritten', 4294967295, False, 'looked at him...
...
')
     , (23353, 10, 'Tamian Wilmot', 'prewritten', 4294967295, False, 'Did you even know I had left?
