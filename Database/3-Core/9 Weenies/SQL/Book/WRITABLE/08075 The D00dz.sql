...
VALUES (8075, 9, 0) /* LOCATIONS_INT */
     ...
     , (8075, 174, 29) /* APPRAISAL_PAGES_INT */
     , (8075, 175, 29) /* APPRAISAL_MAX_PAGES_INT */
     , (8075, 22, 1000) /* AVAILABLE_CHARACTER_INT */
...
VALUES (8075, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (8075, 0, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 1, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 2, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 6, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '"I know it''s possible," I interrupted. "Before I entered the portal to this land, I had witnessed much of the barbarism of the Viamonters firsthand, and such traits as their love of bloodshed, pillage and plunder do seem indicative of possible Viamonter orgin. Nonetheless, their names and language conform to no Isparian culture that I know of. And what little I know of the Souia-Vey and Silverans tends to eliminate those possibilities. I doubt that even Asheron would have the patience to tolerate the presence of the Souia-vey in  Dereth. Their tempers would make even the Tumeroks look friendly in comparison."
')
     , (8075, 7, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 8, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'It was at this point that I was startled by the clank of a shouken bouncing off my armor. As mindless and feeble as these Drudges were, at least they were determined. Having regained my stamina from the lifestone, I stood up and got down off the roof, with Hakin following close behind. Normally, a visit to Arwic for me only lasted long enough to sell stuff and hop the nearest portal to somewhere else, but this time, I would have to tarry in Arwic for a time, although I dreaded the prospect of this visit. I know not for how long one can keep their sanity within the town of Arwic, and I do not particularly care to find out.
')
     , (8075, 9, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
                                * * *
...
')
     , (8075, 10, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'My attention was quickly redirected as I saw before me a man, even less experienced than Hakin Slash, yet wearing an expensive-looking set of Amuli armor. As soon as he saw that he had my attention, he spoke: "Can u open a portal to Teth?"
...
')
     , (8075, 13, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'As we observed from our perch, it didn''t take long to spot what we were looking for. In the town square, there were to be found several so-called "Mules", named after a rather unpleasant beast of burden found within the Roulean lands. Generally, these Mules acted as servants to the warriors and mages of the land. Although some had gained a degree of renown in the trades of cooking, fletching and alchemy, most were simple traders and bearers of their master''s wares. I had a couple of these servants myself, who made their permanent home in the Library of Cragstone. I found that as a rule, these servants reflect the personalities of their masters quite well. So I found little
')
     , (8075, 14, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'surprise that those who serve masters who lack the basic principles of decency and integrity tend to be the ones who get marked as thieves, often by their victims.
...
')
     , (8075, 17, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'I arrived back at the tavern just in time to see Hakin surrounded by several unsavory looking individuals. Almost instinctively, I drew a sword and charged toward the balcony. As I caught their attention, Hakin saw a break and took off running back toward the lifestone. One of the individuals shouted in Hakin''s direction, "D00d, 3y3 g0t d4 Ph@t l3w+ c0m3 b@ck!!!111" but Hakin paid him no heed. Fortunately, I could see that none of these people followed Bael''Zharon, and proceeded to follow Hakin, this time with phrases such as, "j00 r 4 l@m@h v3x0rg!!!111" and, "j00 sux0r!" being shouted in my direction.
')
     , (8075, 18, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'As I followed the path toward the lifestone, I caught a glimpse of the young Gharu''ndim I encountered earlier, missing his Amuli coat. Off in the distance, I could hear him shout, "Anyone got a portal to teth I lost a corpse..," and did not pay heed to the rest. I had seen enough of Arwic for quite a while at this point, and was glad to be clear of the disgrace to the Aluvian lands of Dereth.
...
')
     , (8075, 19, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 20, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '"Yes, yes, go on."
...
')
     , (8075, 21, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 22, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 23, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '"I am well aware.  Take care and be well," I replied, and with a bow, I set off upon my journey to seek the one person who I might be able to obtain more info from.
...
')
     , (8075, 24, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, 'same time incredibly dangerous.  Nonetheless, it was with caution and experience that I walked these lands, and before I knew it, I could see my destination, the Gharu''ndim outpost of Ayan Baqur.
...
')
     , (8075, 25, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
"Yes," I replied.
')
     , (8075, 27, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '
...
')
     , (8075, 28, 'Vexorg of Thistledown', 'prewritten', 4294967295, False, '"Yes, and they ride Ash Gromnies, and have wild parties where they tip cows, and they all drink Turpeth and eat Hawthorn, then they shoot fire out of their mouths, and they..."
