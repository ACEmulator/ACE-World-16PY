...
VALUES (21093, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (21093, 0, 'Ciandra', 'prewritten', 4294967295, False, 'When Asheron first came into the Consortium, I was amazed. He offered us knowledge beyond everything we had begun to comprehend thus far and he directed our attentions to some shortcomings. 
...
')
     , (21093, 1, 'Ciandra', 'prewritten', 4294967295, False, 'language as explained to us by Asheron. It means; that which reduces, or at least that is the closest conversion in Roulean.
...
')
     , (21093, 2, 'Ciandra', 'prewritten', 4294967295, False, 'Basics
...
')
     , (21093, 3, 'Ciandra', 'prewritten', 4294967295, False, 'Qualities
...
')
     , (21093, 4, 'Ciandra', 'prewritten', 4294967295, False, 'was used to craft the object. Typically these are metals, stones, cloths and gems.
...
')
     , (21093, 5, 'Ciandra', 'prewritten', 4294967295, False, 'Ust would mean that all other objects placed within would need to be made of wool in order for the process to work.
...
')
     , (21093, 7, 'Ciandra', 'prewritten', 4294967295, False, 'amazing thing about this process is that the Ust recognizes when there are items mixed with materials. When instances such as this arise it will obtain the quantity and average workmansip quality of the items and add them to the existing materials. 
...
')
     , (21093, 8, 'Ciandra', 'prewritten', 4294967295, False, 'amount of items used. 
...
')
     , (21093, 9, 'Ciandra', 'prewritten', 4294967295, False, 'for example is an excellent source of insulation from the cold. It''s no surprise then that it will affect the level of cold protection that armor offers. 
...
')
     , (21093, 10, 'Ciandra', 'prewritten', 4294967295, False, 'working on direct applications, and item tinkerers work with the generic applications such as weight, and value of objects. Again without training in one of these areas, it will not be possible for a person to apply materials.
...
')
     , (21093, 11, 'Ciandra', 'prewritten', 4294967295, False, 'the application.
...
')
     , (21093, 12, 'Ciandra', 'prewritten', 4294967295, False, 'Second, lesser quality wokrmanship items are easier to improve as they were not that well crafted to begin with. The more close to perfect an item is the harder it will be to improve.
...
')
     , (21093, 13, 'Ciandra', 'prewritten', 4294967295, False, '
');
