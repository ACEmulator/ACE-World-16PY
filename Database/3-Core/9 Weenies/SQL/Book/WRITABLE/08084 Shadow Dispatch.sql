...
VALUES (8084, 16, 'A translated missive, taken from the hands of a Shadow at the Fenmalain Facility.') /* LONG_DESC_STRING */
     , (8084, 1, 'Shadow Dispatch') /* NAME_STRING */
     , (8084, 14, 'Use this item to read it.') /* USE_STRING */
     , (8084, 15, 'A translated note.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8084, 1, 33554773) /* SETUP_DID */
     , (8084, 3, 536870932) /* SOUND_TABLE_DID */
     , (8084, 8, 100668176) /* ICON_DID */
     , (8084, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8084, 9, 0) /* LOCATIONS_INT */
...
VALUES (8084, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (8084, 0, 'Unknown', 'prewritten', 4294967295, False, '
