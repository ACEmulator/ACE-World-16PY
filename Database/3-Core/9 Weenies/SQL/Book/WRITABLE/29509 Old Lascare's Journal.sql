...
VALUES (29509, 272, 29509);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (29509, 16, 'A book written by Yuan Hanzu regarding composite bows. ') /* LONG_DESC_STRING */
     , (29509, 1, 'Old Lascare''s Journal') /* NAME_STRING */
     , (29509, 15, 'A book.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (29509, 1, 33554771) /* SETUP_DID */
     , (29509, 3, 536870932) /* SOUND_TABLE_DID */
     , (29509, 8, 100668117) /* ICON_DID */
     , (29509, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (29509, 9, 0) /* LOCATIONS_INT */
     , (29509, 1, 8192) /* ITEM_TYPE_INT */
     , (29509, 93, 1044) /* PHYSICS_STATE_INT */
     , (29509, 5, 160) /* ENCUMB_VAL_INT */
     , (29509, 16, 8) /* ITEM_USEABLE_INT */
     , (29509, 8, 230) /* MASS_INT */
     , (29509, 19, 0) /* VALUE_INT */
     , (29509, 174, 6) /* APPRAISAL_PAGES_INT */
     , (29509, 175, 6) /* APPRAISAL_MAX_PAGES_INT */
     , (29509, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (29509, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (29509, 39, 1.22) /* DEFAULT_SCALE_FLOAT */
     , (29509, 54, 0.3) /* USE_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (29509, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (29509, 0, '', 'prewritten', 4294967295, False, 'Yuan Hanzu
