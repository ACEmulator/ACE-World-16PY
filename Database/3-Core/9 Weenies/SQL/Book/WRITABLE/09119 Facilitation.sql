...
VALUES (9119, 272, 9119);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9119, 1, 'Facilitation') /* NAME_STRING */
     , (9119, 15, 'The second installment of a tale by Martine') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9119, 1, 33554771) /* SETUP_DID */
     , (9119, 3, 536870932) /* SOUND_TABLE_DID */
     , (9119, 8, 100668117) /* ICON_DID */
     , (9119, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9119, 9, 0) /* LOCATIONS_INT */
...
')
     , (9119, 4, '', 'prewritten', 4294967295, False, '"And even luckier for you that our plans differ from the Directive''s."  Its body had stopped heaving, and I wondered if one day it would decide it had told me too much.  And if it...
')
     , (9119, 5, '', 'prewritten', 4294967295, False, '"Focus!" The word thrust into my mind, obliterating all other thought.  "You think that you have mastered causing pain?  Each race has a different point where the soul joins the meat, remember this.  And even for each specimen of an individual race, it can take time to find the specific junction.  Time which you may not have.  Further, sometimes pain is insufficient for what you wish to accomplish.  Sometimes one wants..."
')
     , (9119, 6, '', 'prewritten', 4294967295, False, 'The Tusker exploded.  Had I been watching Jean, I would have seen the blue spark leap from it to the unlucky meat.  But I no longer needed to see the energy to know it was there.
')
     , (9119, 7, '', 'prewritten', 4294967295, False, 'Jean turned to me, and the permanently etched smile on its face seemed somehow wider.  The freshly spattered blood on each of its scythes glistened in the dull light that flickered from the few torches in the large, empty room.  I noticed that the emptiness of the room made what was left of the Tusker even more prominent.  Before Jean could continue its lecture, an Overseer glided into the room, followed by a Hollow Tumideon.
')
     , (9119, 8, '', 'prewritten', 4294967295, False, 'Despite my attempts at restraint, I could not help the shuddering.  I could feel Jean''s displeasure about my lack of self-control.  The shuddering became worse.  
...
')
     , (9119, 9, '', 'prewritten', 4294967295, False, 'I had become used to Jean and Master''s different style of thought-speaking depending on to whom they were talking.  I enjoyed watching their caution, their uncertainty.  The Overseer seemed to forget me instantly.
')
     , (9119, 10, '', 'prewritten', 4294967295, False, '"Difficulties increase.  Portal energy signature blooms on southern coast.  The humans-magic.  As for the Experiment, she produces inadequate broods.  Much uncertainity over whether to allow the brood access to the Singularity.  Situation unstable.  The Directive concerned."  The Overseer paused and turned to me, and then turned back to Jean.  "The Mite situation also under conversation.  Attend this one after experimentation ceases."  The Overseer turned around and left the room, his Minion trailing in his wake. 
')
     , (9119, 11, '', 'prewritten', 4294967295, False, 'Fear and rage warred for control inside my brain.  Whatever human remnant that existed screamed for succor, while the other part of me clamored for the destruction of the Minion. 
')
     , (9119, 12, '', 'prewritten', 4294967295, False, 'Jean came closer to me, "Puppet is a lesser, but is he so very stupid?  Such a fitting word you lessers have."  Its scythe traced a thin outline of red along my cheek.  My trembling did not stop, but the rage had drained, the fear now ascendant.  The scar itself was merely one more to add to my collection, but what they could do to my mind was far worse than what they could do to my body.  Jean continued, "Patience, Puppet.  Martine.  You will have your outlet when you find our renegade Mosswart. Until then..."
')
     , (9119, 13, '', 'prewritten', 4294967295, False, 'He sent out a signal to the Guards stationed outside the room.  They dragged between them a young Slave who was mostly quiet until he caught a whiff of what was left of his former comrade.  He started to resist the Guards, until a strong mindblast from Jean left him paralyzed.
')
     , (9119, 14, '', 'prewritten', 4294967295, False, '"Now, youngling, this time I want you to try and manipulate two soul points at once.  The goal is to squeeze the first one even as you are locating a second.  Ready?  Locate, grip, squeeze.  By playing with multiple junctions, one can achieve much finer distinctions of pain and control.  It was one of our most successful techniques in breaking you, in fact."
...
')
     , (9119, 15, '', 'prewritten', 4294967295, False, '"You have come along far, Puppet.  Jean is pleased.  Now, again! Locate! Grip! Squeeze!"
