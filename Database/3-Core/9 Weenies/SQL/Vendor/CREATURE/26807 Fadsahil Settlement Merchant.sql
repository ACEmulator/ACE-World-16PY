...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26807;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26807, 'fadsahilsettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26807, 516, 26807);
...
VALUES (26807, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26807, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26807, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26807, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26807, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26807, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26807, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26807, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26807, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26807, 4, 26172, -1, 0) /* Create Fadsahil Settlement Portal Gem for Shop_DestinationType */;
