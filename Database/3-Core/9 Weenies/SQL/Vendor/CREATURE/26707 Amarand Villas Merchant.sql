...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26707;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26707, 'amarandvillasvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26707, 516, 26707);
...
VALUES (26707, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26707, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26707, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26707, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26707, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26707, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26707, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26707, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26707, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26707, 4, 26072, -1, 0) /* Create Amarand Villas Portal Gem for Shop_DestinationType */;
