...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26922;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26922, 'newcoliervendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26922, 516, 26922);
...
VALUES (26922, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26922, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26922, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26922, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26922, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26922, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26922, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26922, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26922, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26922, 4, 26287, -1, 0) /* Create New Colier Portal Gem for Shop_DestinationType */;
