...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27057;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27057, 'villalabarvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27057, 516, 27057);
...
VALUES (27057, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27057, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27057, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27057, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27057, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27057, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27057, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27057, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27057, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27057, 4, 26422, -1, 0) /* Create Villalabar Portal Gem for Shop_DestinationType */;
