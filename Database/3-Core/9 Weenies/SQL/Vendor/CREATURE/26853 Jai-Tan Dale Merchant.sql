...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26853;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26853, 'jaitandalevendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26853, 516, 26853);
...
VALUES (26853, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26853, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26853, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26853, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26853, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26853, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26853, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26853, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26853, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26853, 4, 26218, -1, 0) /* Create Jai-Tan Dale Portal Gem for Shop_DestinationType */;
