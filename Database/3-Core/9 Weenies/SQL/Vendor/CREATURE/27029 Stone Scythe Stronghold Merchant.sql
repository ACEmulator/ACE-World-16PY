...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27029;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27029, 'stonescythestrongholdvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27029, 516, 27029);
...
VALUES (27029, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27029, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27029, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27029, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27029, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27029, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27029, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27029, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27029, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27029, 4, 26394, -1, 0) /* Create Stone Scythe Stronghold Portal Gem for Shop_DestinationType */;
