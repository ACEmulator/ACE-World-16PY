...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26942;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26942, 'onghauvillagevendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26942, 516, 26942);
...
VALUES (26942, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26942, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26942, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26942, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26942, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26942, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26942, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26942, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26942, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26942, 4, 26307, -1, 0) /* Create Ong-Hau Village Portal Gem for Shop_DestinationType */;
