...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27061;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27061, 'westnorsteadvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27061, 516, 27061);
...
VALUES (27061, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27061, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27061, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27061, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27061, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27061, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27061, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27061, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27061, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27061, 4, 26426, -1, 0) /* Create West Norstead Portal Gem for Shop_DestinationType */;
