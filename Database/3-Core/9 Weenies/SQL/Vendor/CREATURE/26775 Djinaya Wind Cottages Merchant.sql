...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26775;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26775, 'djinayawindcottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26775, 516, 26775);
...
VALUES (26775, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26775, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26775, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26775, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26775, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26775, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26775, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26775, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26775, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26775, 4, 26140, -1, 0) /* Create Djinaya Wind Cottages Portal Gem for Shop_DestinationType */;
