...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26765;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26765, 'desertboundarycottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26765, 516, 26765);
...
VALUES (26765, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26765, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26765, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26765, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26765, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26765, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26765, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26765, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26765, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26765, 4, 26130, -1, 0) /* Create Desert Boundary Cottages Portal Gem for Shop_DestinationType */;
