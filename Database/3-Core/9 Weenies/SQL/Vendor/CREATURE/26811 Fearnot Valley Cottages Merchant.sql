...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26811;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26811, 'fearnotvalleycottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26811, 516, 26811);
...
VALUES (26811, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26811, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26811, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26811, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26811, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26811, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26811, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26811, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26811, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26811, 4, 26176, -1, 0) /* Create Fearnot Valley Cottages Portal Gem for Shop_DestinationType */;
