...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27040;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27040, 'tatteredridgevendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27040, 516, 27040);
...
VALUES (27040, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27040, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27040, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27040, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27040, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27040, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27040, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27040, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27040, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27040, 4, 26405, -1, 0) /* Create Tattered Ridge Portal Gem for Shop_DestinationType */;
