...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26839;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26839, 'howlingwolfvillasvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26839, 516, 26839);
...
VALUES (26839, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26839, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26839, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26839, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26839, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26839, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26839, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26839, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26839, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26839, 4, 26204, -1, 0) /* Create Howling Wolf Villas Portal Gem for Shop_DestinationType */;
