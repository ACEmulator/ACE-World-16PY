...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26989;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26989, 'sharvalevendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26989, 516, 26989);
...
VALUES (26989, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26989, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26989, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26989, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26989, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26989, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26989, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26989, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26989, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26989, 4, 26354, -1, 0) /* Create Sharvale Portal Gem for Shop_DestinationType */;
