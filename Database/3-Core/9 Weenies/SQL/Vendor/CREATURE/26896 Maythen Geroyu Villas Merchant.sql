...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26896;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26896, 'maythengeroyuvillasvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26896, 516, 26896);
...
VALUES (26896, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26896, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26896, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26896, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26896, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26896, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26896, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26896, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26896, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26896, 4, 26261, -1, 0) /* Create Maythen Geroyu Villas Portal Gem for Shop_DestinationType */;
