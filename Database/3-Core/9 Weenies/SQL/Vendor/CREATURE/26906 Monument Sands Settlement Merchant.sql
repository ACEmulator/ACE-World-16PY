...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26906;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26906, 'monumentsandssettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26906, 516, 26906);
...
VALUES (26906, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26906, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26906, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (26906, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (26906, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (26906, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26906, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26906, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26906, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26906, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26906, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26906, 4, 26271, -1, 0) /* Create Monument Sands Settlement Portal Gem for Shop_DestinationType */;
