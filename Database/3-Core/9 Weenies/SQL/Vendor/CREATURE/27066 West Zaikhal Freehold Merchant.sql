...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27066;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27066, 'westzaikhalfreeholdvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27066, 516, 27066);
...
VALUES (27066, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27066, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27066, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27066, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27066, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27066, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27066, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27066, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27066, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27066, 4, 26431, -1, 0) /* Create West Zaikhal Freehold Portal Gem for Shop_DestinationType */;
