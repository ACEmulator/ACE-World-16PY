...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26723;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26723, 'ayntayanvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26723, 516, 26723);
...
VALUES (26723, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26723, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26723, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26723, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26723, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26723, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26723, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26723, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26723, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26723, 4, 26088, -1, 0) /* Create Ayn Tayan Portal Gem for Shop_DestinationType */;
