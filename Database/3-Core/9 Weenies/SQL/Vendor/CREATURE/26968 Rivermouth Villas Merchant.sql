...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26968;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26968, 'rivermouthvillasvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26968, 516, 26968);
...
VALUES (26968, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26968, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26968, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26968, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26968, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26968, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26968, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26968, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26968, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26968, 4, 26333, -1, 0) /* Create Rivermouth Villas Portal Gem for Shop_DestinationType */;
