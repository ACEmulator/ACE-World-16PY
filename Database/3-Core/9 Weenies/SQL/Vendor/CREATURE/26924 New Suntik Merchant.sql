...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26924;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26924, 'newsuntikvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26924, 516, 26924);
...
VALUES (26924, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26924, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26924, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26924, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26924, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26924, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26924, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26924, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26924, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26924, 4, 26289, -1, 0) /* Create New Suntik Portal Gem for Shop_DestinationType */;
