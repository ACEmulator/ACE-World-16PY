...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27052;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27052, 'tyrrincottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27052, 516, 27052);
...
VALUES (27052, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27052, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27052, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (27052, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (27052, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (27052, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27052, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27052, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27052, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27052, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27052, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27052, 4, 26417, -1, 0) /* Create Tyrrin Cottages Portal Gem for Shop_DestinationType */;
