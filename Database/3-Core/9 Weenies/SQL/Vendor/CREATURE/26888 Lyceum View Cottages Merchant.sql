...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26888;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26888, 'lyceumviewcottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26888, 516, 26888);
...
VALUES (26888, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26888, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26888, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26888, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26888, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26888, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26888, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26888, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26888, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26888, 4, 26253, -1, 0) /* Create Lyceum View Cottages Portal Gem for Shop_DestinationType */;
