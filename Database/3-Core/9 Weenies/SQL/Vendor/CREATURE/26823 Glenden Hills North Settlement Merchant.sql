...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26823;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26823, 'glendenhillsnorthsettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26823, 516, 26823);
...
VALUES (26823, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26823, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26823, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26823, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26823, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26823, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26823, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26823, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26823, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26823, 4, 26188, -1, 0) /* Create Glenden Hills North Settlement Portal Gem for Shop_DestinationType */;
