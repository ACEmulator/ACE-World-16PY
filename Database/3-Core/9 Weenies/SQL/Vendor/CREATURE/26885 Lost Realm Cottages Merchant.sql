...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26885;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26885, 'lostrealmcottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26885, 516, 26885);
...
VALUES (26885, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26885, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26885, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26885, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26885, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26885, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26885, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26885, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26885, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26885, 4, 26250, -1, 0) /* Create Lost Realm Cottages Portal Gem for Shop_DestinationType */;
