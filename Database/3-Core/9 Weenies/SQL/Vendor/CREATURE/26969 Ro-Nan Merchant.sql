...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26969;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26969, 'ronanvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26969, 516, 26969);
...
VALUES (26969, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26969, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26969, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26969, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26969, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26969, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26969, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26969, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26969, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26969, 4, 26334, -1, 0) /* Create Ro-Nan Portal Gem for Shop_DestinationType */;
