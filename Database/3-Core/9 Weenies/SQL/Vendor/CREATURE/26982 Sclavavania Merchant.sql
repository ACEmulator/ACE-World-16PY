...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26982;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26982, 'sclavavaniavendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26982, 516, 26982);
...
VALUES (26982, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26982, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26982, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26982, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26982, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26982, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26982, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26982, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26982, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26982, 4, 26347, -1, 0) /* Create Sclavavania Portal Gem for Shop_DestinationType */;
