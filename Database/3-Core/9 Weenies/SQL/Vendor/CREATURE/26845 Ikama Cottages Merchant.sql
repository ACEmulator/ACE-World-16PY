...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26845;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26845, 'ikamacottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26845, 516, 26845);
...
VALUES (26845, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26845, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26845, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26845, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26845, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26845, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26845, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26845, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26845, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26845, 4, 26210, -1, 0) /* Create Ikama Cottages Portal Gem for Shop_DestinationType */;
