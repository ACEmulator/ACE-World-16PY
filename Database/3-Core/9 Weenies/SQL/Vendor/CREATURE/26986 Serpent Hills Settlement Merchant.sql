...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26986;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26986, 'serpenthillssettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26986, 516, 26986);
...
VALUES (26986, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26986, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26986, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26986, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26986, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26986, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26986, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26986, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26986, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26986, 4, 26351, -1, 0) /* Create Serpent Hills Settlement Portal Gem for Shop_DestinationType */;
