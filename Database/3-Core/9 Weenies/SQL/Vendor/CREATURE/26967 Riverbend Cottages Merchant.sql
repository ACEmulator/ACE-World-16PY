...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26967;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26967, 'riverbendcottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26967, 516, 26967);
...
VALUES (26967, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26967, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26967, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26967, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26967, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26967, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26967, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26967, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26967, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26967, 4, 26332, -1, 0) /* Create Riverbend Cottages Portal Gem for Shop_DestinationType */;
