...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26704;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26704, 'alnosajvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26704, 516, 26704);
...
VALUES (26704, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26704, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26704, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26704, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26704, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26704, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26704, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26704, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26704, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26704, 4, 26069, -1, 0) /* Create Al-Nosaj Portal Gem for Shop_DestinationType */;
