...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26934;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26934, 'northreachvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26934, 516, 26934);
...
VALUES (26934, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26934, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26934, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26934, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26934, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26934, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26934, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26934, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26934, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26934, 4, 26299, -1, 0) /* Create Northreach Portal Gem for Shop_DestinationType */;
