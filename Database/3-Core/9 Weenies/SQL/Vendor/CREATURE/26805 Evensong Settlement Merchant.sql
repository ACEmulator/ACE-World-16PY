...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26805;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26805, 'evensongsettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26805, 516, 26805);
...
VALUES (26805, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26805, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26805, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26805, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26805, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26805, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26805, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26805, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26805, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26805, 4, 26170, -1, 0) /* Create Evensong Settlement Portal Gem for Shop_DestinationType */;
