...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27004;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27004, 'soltanvillasvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27004, 516, 27004);
...
VALUES (27004, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27004, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27004, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (27004, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (27004, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (27004, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27004, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27004, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27004, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27004, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27004, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27004, 4, 26369, -1, 0) /* Create Soltan Villas Portal Gem for Shop_DestinationType */;
