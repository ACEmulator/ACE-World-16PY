...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27055;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27055, 'vesayanoverlookvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27055, 516, 27055);
...
VALUES (27055, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27055, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27055, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (27055, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (27055, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (27055, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27055, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27055, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27055, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27055, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27055, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27055, 4, 26420, -1, 0) /* Create Vesayan Overlook Portal Gem for Shop_DestinationType */;
