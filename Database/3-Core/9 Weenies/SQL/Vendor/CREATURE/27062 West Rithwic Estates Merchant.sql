...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27062;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27062, 'westrithwicestatesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27062, 516, 27062);
...
VALUES (27062, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27062, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27062, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (27062, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (27062, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (27062, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27062, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27062, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27062, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27062, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27062, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27062, 4, 26427, -1, 0) /* Create West Rithwic Estates Portal Gem for Shop_DestinationType */;
