...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27037;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27037, 'tanshivendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27037, 516, 27037);
...
VALUES (27037, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27037, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27037, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27037, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27037, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27037, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27037, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27037, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27037, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27037, 4, 26402, -1, 0) /* Create Tanshi Portal Gem for Shop_DestinationType */;
