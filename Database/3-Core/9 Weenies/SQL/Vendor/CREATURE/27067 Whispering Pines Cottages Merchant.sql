...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27067;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27067, 'whisperingpinescottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27067, 516, 27067);
...
VALUES (27067, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27067, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27067, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (27067, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (27067, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (27067, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27067, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27067, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27067, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27067, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27067, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27067, 4, 26432, -1, 0) /* Create Whispering Pines Cottages Portal Gem for Shop_DestinationType */;
