...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26810;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26810, 'farhorizoncottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26810, 516, 26810);
...
VALUES (26810, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26810, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26810, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26810, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26810, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26810, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26810, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26810, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26810, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26810, 4, 26175, -1, 0) /* Create Far Horizon Cottages Portal Gem for Shop_DestinationType */;
