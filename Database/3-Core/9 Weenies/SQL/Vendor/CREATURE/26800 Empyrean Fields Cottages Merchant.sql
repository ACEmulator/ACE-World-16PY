...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26800;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26800, 'empyreanfieldscottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26800, 516, 26800);
...
VALUES (26800, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26800, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26800, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26800, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26800, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26800, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26800, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26800, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26800, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26800, 4, 26165, -1, 0) /* Create Empyrean Fields Cottages Portal Gem for Shop_DestinationType */;
