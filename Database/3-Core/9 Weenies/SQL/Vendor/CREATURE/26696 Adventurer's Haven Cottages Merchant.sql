...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26696;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26696, 'adventurershavencottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26696, 516, 26696);
...
VALUES (26696, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26696, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26696, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26696, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26696, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26696, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26696, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26696, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26696, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26696, 4, 26061, -1, 0) /* Create Adventurer's Haven Cottages Portal Gem for Shop_DestinationType */;
