...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26916;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26916, 'nanzarivendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26916, 516, 26916);
...
VALUES (26916, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26916, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26916, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26916, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26916, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26916, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26916, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26916, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26916, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26916, 4, 26281, -1, 0) /* Create Nan-Zari Portal Gem for Shop_DestinationType */;
