...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26955;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26955, 'prosperriverheadwatersvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26955, 516, 26955);
...
VALUES (26955, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26955, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26955, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26955, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26955, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26955, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26955, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26955, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26955, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26955, 4, 26320, -1, 0) /* Create Prosper River Headwaters Portal Gem for Shop_DestinationType */;
