...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26769;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26769, 'devanavendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26769, 516, 26769);
...
VALUES (26769, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26769, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26769, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26769, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26769, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26769, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26769, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26769, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26769, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26769, 4, 26134, -1, 0) /* Create Devana Portal Gem for Shop_DestinationType */;
