...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27033;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27033, 'strathelarswatchcottagesvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27033, 516, 27033);
...
VALUES (27033, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27033, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27033, 1, 90) /* STRENGTH_ATTRIBUTE */
     , (27033, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (27033, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (27033, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27033, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27033, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27033, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27033, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27033, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27033, 4, 26398, -1, 0) /* Create Strathelar's Watch Cottages Portal Gem for Shop_DestinationType */;
