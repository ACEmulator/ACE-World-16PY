...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27030;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27030, 'stonetriaddellvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27030, 516, 27030);
...
VALUES (27030, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27030, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27030, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27030, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27030, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27030, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27030, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27030, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27030, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27030, 4, 26395, -1, 0) /* Create Stone Triad Dell Portal Gem for Shop_DestinationType */;
