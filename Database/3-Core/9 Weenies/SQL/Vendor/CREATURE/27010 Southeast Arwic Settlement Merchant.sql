...
DELETE FROM ace_weenie_class WHERE weenieClassId = 27010;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (27010, 'southeastarwicsettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (27010, 516, 27010);
...
VALUES (27010, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (27010, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (27010, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (27010, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (27010, 16, 40) /* FOCUS_ATTRIBUTE */
     , (27010, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (27010, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (27010, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (27010, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (27010, 4, 26375, -1, 0) /* Create Southeast Arwic Settlement Portal Gem for Shop_DestinationType */;
