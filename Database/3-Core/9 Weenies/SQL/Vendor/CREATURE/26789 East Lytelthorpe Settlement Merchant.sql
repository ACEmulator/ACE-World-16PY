...
DELETE FROM ace_weenie_class WHERE weenieClassId = 26789;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (26789, 'eastlytelthorpesettlementvendor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (26789, 516, 26789);
...
VALUES (26789, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (26789, 9007, 12) /* Vendor_WeenieType */;
...
VALUES (26789, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (26789, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (26789, 16, 40) /* FOCUS_ATTRIBUTE */
     , (26789, 32, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (26789, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (26789, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (26789, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (26789, 4, 26154, -1, 0) /* Create East Lytelthorpe Settlement Portal Gem for Shop_DestinationType */;
