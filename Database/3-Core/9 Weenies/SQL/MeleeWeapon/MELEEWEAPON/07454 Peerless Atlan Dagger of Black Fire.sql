...
VALUES (7454, 1, 33557400) /* SETUP_DID */
     , (7454, 3, 536870932) /* SOUND_TABLE_DID */
     , (7454, 37, 4) /* ITEM_SKILL_LIMIT_DID */
     , (7454, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (7454, 6, 67111919) /* PALETTE_BASE_DID */
     , (7454, 7, 268435888) /* CLOTHINGBASE_DID */
     , (7454, 8, 100670523) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7454, 9, 1048576) /* LOCATIONS_INT */
     , (7454, 1, 1) /* ITEM_TYPE_INT */
     , (7454, 19, 5000) /* VALUE_INT */
     , (7454, 3, 39) /* PALETTE_TEMPLATE_INT */
     ...
     , (7454, 107, 750) /* ITEM_CUR_MANA_INT */
     , (7454, 44, 24) /* DAMAGE_INT */
     , (7454, 108, 750) /* ITEM_MAX_MANA_INT */
     , (7454, 45, 3) /* DAMAGE_TYPE_INT */
     , (7454, 46, 2) /* DEFAULT_COMBAT_STYLE_INT */
     , (7454, 47, 6) /* ATTACK_TYPE_INT */
     , (7454, 48, 4) /* WEAPON_SKILL_INT */
     , (7454, 49, 15) /* WEAPON_TIME_INT */
     , (7454, 114, 1) /* ATTUNED_INT */
     , (7454, 51, 1) /* COMBAT_USE_INT */
     , (7454, 115, 225) /* ITEM_SKILL_LEVEL_LIMIT_INT */
     , (7454, 9007, 6) /* MeleeWeapon_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (7454, 29, 1.07) /* WEAPON_DEFENSE_FLOAT */
     , (7454, 21, 0.4) /* WEAPON_LENGTH_FLOAT */
     , (7454, 5, -0.033) /* MANA_RATE_FLOAT */
     , (7454, 39, 1) /* DEFAULT_SCALE_FLOAT */
     , (7454, 62, 1.07) /* WEAPON_OFFENSE_FLOAT */
     , (7454, 22, 0.45) /* DAMAGE_VARIANCE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (7454, 99, True) /* IVORYABLE_BOOL */
     , (7454, 69, False) /* IS_SELLABLE_BOOL */
     , (7454, 22, True) /* INSCRIBABLE_BOOL */
     , (7454, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (7454, 1846) /* MagicYieldBlackFire_SpellID */
     , (7454, 1605) /* Defender6_SpellID */
