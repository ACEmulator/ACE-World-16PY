/* Weenie - Thyrinn Cant Cottages (15262) */
...
VALUES (15262, 20, 15262);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15262, 16, 'Welcome to Thyrinn Cant Cottages') /* LONG_DESC_STRING */
     , (15262, 1, 'Thyrinn Cant Cottages') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15262, 1, 33557463) /* SETUP_DID */
     , (15262, 8, 100668115) /* ICON_DID */;
...
VALUES (15262, 1, 128) /* ITEM_TYPE_INT */
     ...
     , (15262, 8, 1800) /* MASS_INT */
     , (15262, 19, 125) /* VALUE_INT */
     , (15262, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (15262, 1, True) /* STUCK_BOOL */
     , (15262, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15262, 13, False) /* ETHEREAL_BOOL */
     , (15262, 22, False) /* INSCRIBABLE_BOOL */;
