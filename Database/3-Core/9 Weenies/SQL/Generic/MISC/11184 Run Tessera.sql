...
VALUES (11184, 16, 'A small, squarish piece of glass. This can be turned into the Tah of Timaru for a free one-point boost to your Run skill. There are tesserae available for each skill in the game. If you don''t want a point of Run, trade this tessera for another. You may only turn in five per character - so choose carefully!') /* LONG_DESC_STRING */
     , (11184, 1, 'Run Tessera') /* NAME_STRING */
     , (11184, 15, 'A small, squarish piece of glass. This can be turned into the Tah of Timaru for a free one-point boost to your Run skill. There are tesserae available for each skill in the game. If you don''t want a point of Run, trade this tessera for another. You may only turn in five per character - so choose carefully!') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (11184, 1, 33557218) /* SETUP_DID */
     , (11184, 3, 536870932) /* SOUND_TABLE_DID */
     , (11184, 36, 234881046) /* MUTATE_FILTER_DID */
     , (11184, 8, 100672017) /* ICON_DID */
     , (11184, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (11184, 9, 0) /* LOCATIONS_INT */
     ...
     , (11184, 150, 103) /* HOOK_PLACEMENT_INT */
     , (11184, 151, 2) /* HOOK_TYPE_INT */
     , (11184, 33, 1) /* BONDED_INT */
...
VALUES (11184, 22, True) /* INSCRIBABLE_BOOL */
     , (11184, 23, True) /* DESTROY_ON_SELL_BOOL */;
