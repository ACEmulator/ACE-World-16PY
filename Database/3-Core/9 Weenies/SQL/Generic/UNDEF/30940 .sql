...
DELETE FROM ace_weenie_class WHERE weenieClassId = 30940;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (30940, 'genmixedliveopspreactduber');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (30940, 20, 30940);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30940, 1, 'genmixedliveopspreactduber') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (30940, 1, 33555051) /* SETUP_DID */
     , (30940, 8, 100667494) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30940, 81, 15) /* MAX_GENERATED_OBJECTS_INT */
     , (30940, 82, 15) /* INIT_GENERATED_OBJECTS_INT */
     , (30940, 93, 1044) /* PHYSICS_STATE_INT */
     , (30940, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (30940, 41, 300) /* REGENERATION_INTERVAL_FLOAT */
     , (30940, 43, 15) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (30940, 1, True) /* STUCK_BOOL */
     , (30940, 18, True) /* VISIBILITY_BOOL */
     , (30940, 74, True) /* GENERATOR_AUTOMATIC_DESTRUCTION_BOOL */
     , (30940, 11, True) /* IGNORE_COLLISIONS_BOOL */;
