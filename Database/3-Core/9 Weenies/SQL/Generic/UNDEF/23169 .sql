...
DELETE FROM ace_weenie_class WHERE weenieClassId = 23169;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (23169, 'midsouthmountainsundeadgen');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (23169, 20, 23169);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23169, 1, 'midsouthmountainsundeadgen') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23169, 1, 33555051) /* SETUP_DID */
     , (23169, 8, 100667494) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23169, 81, 1) /* MAX_GENERATED_OBJECTS_INT */
     , (23169, 82, 1) /* INIT_GENERATED_OBJECTS_INT */
     , (23169, 93, 1044) /* PHYSICS_STATE_INT */
     , (23169, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (23169, 41, 600) /* REGENERATION_INTERVAL_FLOAT */
     , (23169, 43, 15) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (23169, 1, True) /* STUCK_BOOL */
     , (23169, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (23169, 18, True) /* VISIBILITY_BOOL */;
