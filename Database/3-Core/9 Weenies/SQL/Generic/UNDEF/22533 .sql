...
DELETE FROM ace_weenie_class WHERE weenieClassId = 22533;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (22533, 'tuskerisland-highbeachlandgen');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (22533, 20, 22533);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22533, 1, 'tuskerisland-highbeachlandgen') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22533, 1, 33555051) /* SETUP_DID */
     , (22533, 8, 100667494) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22533, 81, 1) /* MAX_GENERATED_OBJECTS_INT */
     , (22533, 82, 1) /* INIT_GENERATED_OBJECTS_INT */
     , (22533, 93, 1044) /* PHYSICS_STATE_INT */
     , (22533, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (22533, 41, 600) /* REGENERATION_INTERVAL_FLOAT */
     , (22533, 43, 5) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (22533, 1, True) /* STUCK_BOOL */
     , (22533, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (22533, 18, True) /* VISIBILITY_BOOL */;
