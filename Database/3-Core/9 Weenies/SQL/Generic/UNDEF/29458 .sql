/* Weenie - generatoreventplatinumkeepboss1 (29458) */
DELETE FROM ace_weenie_class WHERE weenieClassId = 29458;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (29458, 'generatoreventplatinumkeepboss1');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (29458, 20, 29458);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (29458, 1, 'generatoreventplatinumkeepboss1') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (29458, 1, 33555051) /* SETUP_DID */
     , (29458, 8, 100667494) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (29458, 81, 5) /* MAX_GENERATED_OBJECTS_INT */
     , (29458, 82, 5) /* INIT_GENERATED_OBJECTS_INT */
     , (29458, 93, 1044) /* PHYSICS_STATE_INT */
     , (29458, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (29458, 41, 60) /* REGENERATION_INTERVAL_FLOAT */
     , (29458, 43, 3) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (29458, 1, True) /* STUCK_BOOL */
     , (29458, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (29458, 18, True) /* VISIBILITY_BOOL */;
