/* Weenie - mattekardirecampgen (12001) */
DELETE FROM ace_weenie_class WHERE weenieClassId = 12001;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (12001, 'mattekardirecampgen');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (12001, 20, 12001);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12001, 1, 'mattekardirecampgen') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12001, 1, 33555051) /* SETUP_DID */
     , (12001, 8, 100667494) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12001, 81, 2) /* MAX_GENERATED_OBJECTS_INT */
     , (12001, 82, 2) /* INIT_GENERATED_OBJECTS_INT */
     , (12001, 93, 1044) /* PHYSICS_STATE_INT */
     , (12001, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (12001, 41, 60) /* REGENERATION_INTERVAL_FLOAT */
     , (12001, 43, 3) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (12001, 1, True) /* STUCK_BOOL */
     , (12001, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (12001, 18, True) /* VISIBILITY_BOOL */;
