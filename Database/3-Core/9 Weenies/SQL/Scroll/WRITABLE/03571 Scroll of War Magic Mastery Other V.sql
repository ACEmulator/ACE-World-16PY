...
VALUES (3571, 16, 'When learned, this spell increases the target''s War Magic skill by 100%.') /* LONG_DESC_STRING */
     , (3571, 1, 'Scroll of War Magic Mastery Other V') /* NAME_STRING */
     , (3571, 15, 'A magic scroll.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (3571, 1, 33554826) /* SETUP_DID */
     , (3571, 8, 100676479) /* ICON_DID */
     , (3571, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (3571, 28, 639) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3571, 9, 0) /* LOCATIONS_INT */
...
VALUES (3571, 22, True) /* INSCRIBABLE_BOOL */
     , (3571, 23, True) /* DESTROY_ON_SELL_BOOL */;
