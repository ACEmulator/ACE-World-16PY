...
VALUES (3232, 16, 'When learned, this spell increases the caster''s Dagger skill by 150%.') /* LONG_DESC_STRING */
     , (3232, 1, 'Scroll of Dagger Mastery Self VI') /* NAME_STRING */
     , (3232, 15, 'A magic scroll.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (3232, 1, 33554826) /* SETUP_DID */
     , (3232, 8, 100676455) /* ICON_DID */
     , (3232, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (3232, 28, 327) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3232, 9, 0) /* LOCATIONS_INT */
...
VALUES (3232, 22, True) /* INSCRIBABLE_BOOL */
     , (3232, 23, True) /* DESTROY_ON_SELL_BOOL */;
