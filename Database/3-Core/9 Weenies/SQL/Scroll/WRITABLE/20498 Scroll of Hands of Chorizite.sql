...
VALUES (20498, 18, 20498);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20498, 1, 'Scroll of Hands of Chorizite') /* NAME_STRING */
     , (20498, 15, 'When learned, this spell decreases the target''s Arcane Lore skill by 40 points.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20498, 1, 33554826) /* SETUP_DID */
     , (20498, 8, 100676447) /* ICON_DID */
     , (20498, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (20498, 28, 2192) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20498, 9, 0) /* LOCATIONS_INT */
...
VALUES (20498, 22, True) /* INSCRIBABLE_BOOL */
     , (20498, 23, True) /* DESTROY_ON_SELL_BOOL */;
