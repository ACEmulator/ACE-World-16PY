...
VALUES (20566, 18, 20566);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20566, 1, 'Scroll of Nuhmudira''s Blessing') /* NAME_STRING */
     , (20566, 15, 'When learned, this spell increases the caster''s Mana Conversion skill by 40 points.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20566, 1, 33554826) /* SETUP_DID */
     , (20566, 8, 100676466) /* ICON_DID */
     , (20566, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (20566, 28, 2287) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20566, 9, 0) /* LOCATIONS_INT */
...
VALUES (20566, 22, True) /* INSCRIBABLE_BOOL */
     , (20566, 23, True) /* DESTROY_ON_SELL_BOOL */;
