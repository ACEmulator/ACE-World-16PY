...
VALUES (20619, 18, 20619);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20619, 1, 'Scroll of Secondary Portal Tie') /* NAME_STRING */
     , (20619, 15, 'When learned, this spell links the caster to a targeted portal.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20619, 1, 33554826) /* SETUP_DID */
     , (20619, 8, 100676673) /* ICON_DID */
     , (20619, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (20619, 28, 2646) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20619, 9, 0) /* LOCATIONS_INT */
...
VALUES (20619, 22, True) /* INSCRIBABLE_BOOL */
     , (20619, 23, True) /* DESTROY_ON_SELL_BOOL */;
