...
VALUES (27236, 18, 27236);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27236, 1, 'Scroll of Eradicate Life Magic Other') /* NAME_STRING */
     , (27236, 15, 'When learned, this spell dispels 3-6 negative Life Magic enchantments of level 7 or lower from the target.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (27236, 1, 33554826) /* SETUP_DID */
     , (27236, 8, 100676935) /* ICON_DID */
     , (27236, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (27236, 28, 3193) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (27236, 9, 0) /* LOCATIONS_INT */
...
VALUES (27236, 22, True) /* INSCRIBABLE_BOOL */
     , (27236, 23, True) /* DESTROY_ON_SELL_BOOL */;
