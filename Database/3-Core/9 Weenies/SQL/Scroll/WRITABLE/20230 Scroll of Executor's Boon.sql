...
VALUES (20230, 18, 20230);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20230, 1, 'Scroll of Executor''s Boon') /* NAME_STRING */
     , (20230, 15, 'When learned, this spell increases the target''s natural armor by 225 points.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20230, 1, 33554826) /* SETUP_DID */
     , (20230, 8, 100676928) /* ICON_DID */
     , (20230, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (20230, 28, 2052) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20230, 9, 0) /* LOCATIONS_INT */
...
VALUES (20230, 22, True) /* INSCRIBABLE_BOOL */
     , (20230, 23, True) /* DESTROY_ON_SELL_BOOL */;
