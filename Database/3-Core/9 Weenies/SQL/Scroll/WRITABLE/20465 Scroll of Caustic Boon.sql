...
VALUES (20465, 18, 20465);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20465, 1, 'Scroll of Caustic Boon') /* NAME_STRING */
     , (20465, 15, 'When learned, this spell reduces damage the target takes from acid by 65%.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20465, 1, 33554826) /* SETUP_DID */
     , (20465, 8, 100676951) /* ICON_DID */
     , (20465, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (20465, 28, 2148) /* SPELL_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20465, 9, 0) /* LOCATIONS_INT */
...
VALUES (20465, 22, True) /* INSCRIBABLE_BOOL */
     , (20465, 23, True) /* DESTROY_ON_SELL_BOOL */;
