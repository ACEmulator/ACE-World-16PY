...
VALUES (9895, 148, 9895);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9895, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9895, 1, 33557058) /* SETUP_DID */
     , (9895, 8, 100671873) /* ICON_DID */
     , (9895, 42, 203) /* HOUSEID_DID */
     , (9895, 44, 151) /* RESTRICTION_EFFECT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9895, 9, 0) /* LOCATIONS_INT */
     , (9895, 1, 128) /* ITEM_TYPE_INT */
     , (9895, 93, 52) /* PHYSICS_STATE_INT */
     , (9895, 5, 10) /* ENCUMB_VAL_INT */
     , (9895, 16, 1) /* ITEM_USEABLE_INT */
     , (9895, 8, 10) /* MASS_INT */
     , (9895, 155, 1) /* HOUSE_TYPE_INT */
     , (9895, 19, 0) /* VALUE_INT */
...
VALUES (9895, 1, True) /* STUCK_BOOL */
     , (9895, 71, True) /* NODRAW_BOOL */
     , (9895, 13, True) /* ETHEREAL_BOOL */
     , (9895, 14, False) /* GRAVITY_STATUS_BOOL */
