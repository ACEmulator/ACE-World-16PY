...
VALUES (9810, 148, 9810);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9810, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9810, 1, 33557058) /* SETUP_DID */
     , (9810, 8, 100671873) /* ICON_DID */
     , (9810, 42, 118) /* HOUSEID_DID */
     , (9810, 44, 151) /* RESTRICTION_EFFECT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9810, 9, 0) /* LOCATIONS_INT */
     , (9810, 1, 128) /* ITEM_TYPE_INT */
     , (9810, 93, 52) /* PHYSICS_STATE_INT */
     , (9810, 5, 10) /* ENCUMB_VAL_INT */
     , (9810, 16, 1) /* ITEM_USEABLE_INT */
     , (9810, 8, 10) /* MASS_INT */
     , (9810, 155, 1) /* HOUSE_TYPE_INT */
     , (9810, 19, 0) /* VALUE_INT */
...
VALUES (9810, 1, True) /* STUCK_BOOL */
     , (9810, 71, True) /* NODRAW_BOOL */
     , (9810, 13, True) /* ETHEREAL_BOOL */
     , (9810, 14, False) /* GRAVITY_STATUS_BOOL */
