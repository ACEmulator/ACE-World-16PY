...
VALUES (9985, 148, 9985);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9985, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9985, 1, 33557058) /* SETUP_DID */
     , (9985, 8, 100671873) /* ICON_DID */
     , (9985, 42, 293) /* HOUSEID_DID */
     , (9985, 44, 151) /* RESTRICTION_EFFECT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9985, 9, 0) /* LOCATIONS_INT */
     , (9985, 1, 128) /* ITEM_TYPE_INT */
     , (9985, 93, 52) /* PHYSICS_STATE_INT */
     , (9985, 5, 10) /* ENCUMB_VAL_INT */
     , (9985, 16, 1) /* ITEM_USEABLE_INT */
     , (9985, 8, 10) /* MASS_INT */
     , (9985, 155, 1) /* HOUSE_TYPE_INT */
     , (9985, 19, 0) /* VALUE_INT */
...
VALUES (9985, 1, True) /* STUCK_BOOL */
     , (9985, 71, True) /* NODRAW_BOOL */
     , (9985, 13, True) /* ETHEREAL_BOOL */
     , (9985, 14, False) /* GRAVITY_STATUS_BOOL */
