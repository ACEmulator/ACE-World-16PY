...
VALUES (9756, 148, 9756);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9756, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9756, 1, 33557058) /* SETUP_DID */
     , (9756, 8, 100671873) /* ICON_DID */
     , (9756, 42, 64) /* HOUSEID_DID */
     , (9756, 44, 151) /* RESTRICTION_EFFECT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9756, 9, 0) /* LOCATIONS_INT */
     , (9756, 1, 128) /* ITEM_TYPE_INT */
     , (9756, 93, 52) /* PHYSICS_STATE_INT */
     , (9756, 5, 10) /* ENCUMB_VAL_INT */
     , (9756, 16, 1) /* ITEM_USEABLE_INT */
     , (9756, 8, 10) /* MASS_INT */
     , (9756, 155, 1) /* HOUSE_TYPE_INT */
     , (9756, 19, 0) /* VALUE_INT */
...
VALUES (9756, 1, True) /* STUCK_BOOL */
     , (9756, 71, True) /* NODRAW_BOOL */
     , (9756, 13, True) /* ETHEREAL_BOOL */
     , (9756, 14, False) /* GRAVITY_STATUS_BOOL */
