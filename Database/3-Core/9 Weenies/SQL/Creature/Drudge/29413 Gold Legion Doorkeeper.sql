...
DELETE FROM ace_weenie_class WHERE weenieClassId = 29413;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (29413, 'knightdoorkeepergold');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (29413, 20, 29413);
...
VALUES (29413, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (29413, 9007, 10) /* Creature_WeenieType */;
...
VALUES (29413, 1, 30) /* STRENGTH_ATTRIBUTE */
     , (29413, 2, 40) /* ENDURANCE_ATTRIBUTE */
     , (29413, 4, 60) /* COORDINATION_ATTRIBUTE */
     , (29413, 8, 45) /* QUICKNESS_ATTRIBUTE */
     , (29413, 16, 30) /* FOCUS_ATTRIBUTE */
     , (29413, 32, 20) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (29413, 64, 25) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (29413, 128, 50) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (29413, 256, 0) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (29413, 9, 3669, 0, 0) /* Create Drudge Charm for ContainTreasure_DestinationType */
     , (29413, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (29413, 9, 7825, 0, 0) /* Create Brown Beans for ContainTreasure_DestinationType */
     , (29413, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (29413, 9, 8701, 0, 0) /* Create Lucky Gold Letter for ContainTreasure_DestinationType */
     , (29413, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (29413, 9, 8702, 0, 0) /* Create Scarlet Red Letter for ContainTreasure_DestinationType */
     , (29413, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (29413, 9, 13222, 0, 0) /* Create Peppermint Stick for ContainTreasure_DestinationType */
     , (29413, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (29413, 9, 20854, 0, 0) /* Create Academy Stamp for ContainTreasure_DestinationType */
     , (29413, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */;
