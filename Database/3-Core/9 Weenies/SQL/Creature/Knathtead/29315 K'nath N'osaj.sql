...
VALUES (29315, 1097) /* Nullmissile_SpellID */
     , (29315, 1481) /* Nullmissilevolley_SpellID */;

INSERT INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (29315, 1, 50) /* STRENGTH_ATTRIBUTE */
     , (29315, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (29315, 4, 170) /* COORDINATION_ATTRIBUTE */
     , (29315, 8, 50) /* QUICKNESS_ATTRIBUTE */
     , (29315, 16, 60) /* FOCUS_ATTRIBUTE */
     , (29315, 32, 60) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (29315, 64, 15) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (29315, 128, 10) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (29315, 256, 0) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (29315, 9, 5789, 0, 0) /* Create Brown Lump for ContainTreasure_DestinationType */
     , (29315, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */;
