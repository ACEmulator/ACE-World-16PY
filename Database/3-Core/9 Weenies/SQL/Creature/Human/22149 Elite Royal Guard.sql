...
DELETE FROM ace_weenie_class WHERE weenieClassId = 22149;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (22149, 'royalguardyanshiparade4');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (22149, 4, 22149);
...
VALUES (22149, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (22149, 9007, 10) /* Creature_WeenieType */;
...
VALUES (22149, 1, 230) /* STRENGTH_ATTRIBUTE */
     ...
     , (22149, 8, 210) /* QUICKNESS_ATTRIBUTE */
     , (22149, 16, 150) /* FOCUS_ATTRIBUTE */
     , (22149, 32, 140) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (22149, 64, 125) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (22149, 128, 180) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (22149, 256, 55) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (22149, 2, 10870, 0, 17) /* Create Canescent Mattekar Robe for Wield_DestinationType */
     , (22149, 2, 118, 0, 14) /* Create Cap for Wield_DestinationType */;
