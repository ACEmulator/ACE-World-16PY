...
VALUES (25717, 2, 10870, 0, 17) /* Create Canescent Mattekar Robe for Wield_DestinationType */
     , (25717, 2, 118, 0, 14) /* Create Cap for Wield_DestinationType */;
