...
DELETE FROM ace_weenie_class WHERE weenieClassId = 29711;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (29711, 'crownbrowerkstopgap');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (29711, 4, 29711);
...
VALUES (29711, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (29711, 9007, 10) /* Creature_WeenieType */;
...
VALUES (29711, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (29711, 8, 75) /* QUICKNESS_ATTRIBUTE */
     , (29711, 16, 140) /* FOCUS_ATTRIBUTE */
     , (29711, 32, 130) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (29711, 64, 10) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (29711, 128, 10) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (29711, 256, 10) /* MAX_MANA_ATTRIBUTE_2ND */;
