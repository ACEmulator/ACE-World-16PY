...
DELETE FROM ace_weenie_class WHERE weenieClassId = 22148;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (22148, 'royalguardyanshiparade3');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (22148, 4, 22148);
...
VALUES (22148, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (22148, 9007, 10) /* Creature_WeenieType */;
...
VALUES (22148, 1, 230) /* STRENGTH_ATTRIBUTE */
     ...
     , (22148, 8, 210) /* QUICKNESS_ATTRIBUTE */
     , (22148, 16, 150) /* FOCUS_ATTRIBUTE */
     , (22148, 32, 140) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (22148, 64, 125) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (22148, 128, 180) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (22148, 256, 55) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (22148, 2, 10870, 0, 17) /* Create Canescent Mattekar Robe for Wield_DestinationType */
     , (22148, 2, 118, 0, 14) /* Create Cap for Wield_DestinationType */;
