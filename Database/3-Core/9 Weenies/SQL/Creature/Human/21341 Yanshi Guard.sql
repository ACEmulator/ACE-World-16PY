...
VALUES (21341, 2, 10870, 0, 17) /* Create Canescent Mattekar Robe for Wield_DestinationType */
     , (21341, 2, 118, 0, 14) /* Create Cap for Wield_DestinationType */;
