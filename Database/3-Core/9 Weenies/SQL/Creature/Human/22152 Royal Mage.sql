...
DELETE FROM ace_weenie_class WHERE weenieClassId = 22152;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (22152, 'royalmageqalabarparade');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (22152, 4, 22152);
...
VALUES (22152, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (22152, 9007, 10) /* Creature_WeenieType */;
...
VALUES (22152, 1, 150) /* STRENGTH_ATTRIBUTE */
     ...
     , (22152, 8, 110) /* QUICKNESS_ATTRIBUTE */
     , (22152, 16, 280) /* FOCUS_ATTRIBUTE */
     , (22152, 32, 310) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (22152, 64, 125) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (22152, 128, 110) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (22152, 256, 255) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (22152, 2, 5907, 0, 17) /* Create Dho Life Master Robe for Wield_DestinationType */;
