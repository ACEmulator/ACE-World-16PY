...
DELETE FROM ace_weenie_class WHERE weenieClassId = 21135;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (21135, 'antiusblackmoor');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (21135, 0, 21135);
...
VALUES (21135, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (21135, 9007, 10) /* Creature_WeenieType */;
...
VALUES (21135, 1, 220) /* STRENGTH_ATTRIBUTE */
     ...
     , (21135, 8, 150) /* QUICKNESS_ATTRIBUTE */
     , (21135, 16, 220) /* FOCUS_ATTRIBUTE */
     , (21135, 32, 200) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (21135, 64, 140) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (21135, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (21135, 256, 120) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (21135, 2, 130, 0, 2) /* Create Shirt for Wield_DestinationType */
     , (21135, 2, 127, 0, 2) /* Create Pants for Wield_DestinationType */
     , (21135, 2, 2606, 0, 2) /* Create Boots for Wield_DestinationType */;
