/* Weenie - Sentry (12733) */
DELETE FROM ace_weenie_class WHERE weenieClassId = 12733;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (12733, 'academyguard3holte');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (12733, 4, 12733);
...
VALUES (12733, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (12733, 9007, 10) /* Creature_WeenieType */;
...
VALUES (12733, 1, 145) /* STRENGTH_ATTRIBUTE */
     ...
     , (12733, 8, 130) /* QUICKNESS_ATTRIBUTE */
     , (12733, 16, 110) /* FOCUS_ATTRIBUTE */
     , (12733, 32, 115) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (12733, 64, 70) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (12733, 128, 70) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (12733, 256, 50) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (12733, 2, 10870, 0, 17) /* Create Canescent Mattekar Robe for Wield_DestinationType */
     , (12733, 2, 118, 0, 14) /* Create Cap for Wield_DestinationType */;
