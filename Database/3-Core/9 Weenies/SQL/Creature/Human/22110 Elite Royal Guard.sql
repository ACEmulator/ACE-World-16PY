...
DELETE FROM ace_weenie_class WHERE weenieClassId = 22110;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (22110, 'royalguardrithwicparade5');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (22110, 0, 22110);
...
VALUES (22110, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (22110, 9007, 10) /* Creature_WeenieType */;
...
VALUES (22110, 1, 230) /* STRENGTH_ATTRIBUTE */
     ...
     , (22110, 8, 210) /* QUICKNESS_ATTRIBUTE */
     , (22110, 16, 150) /* FOCUS_ATTRIBUTE */
     , (22110, 32, 140) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (22110, 64, 125) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (22110, 128, 180) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (22110, 256, 55) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (22110, 2, 10870, 0, 17) /* Create Canescent Mattekar Robe for Wield_DestinationType */
     , (22110, 2, 118, 0, 14) /* Create Cap for Wield_DestinationType */;
