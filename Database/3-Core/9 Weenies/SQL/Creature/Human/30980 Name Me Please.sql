...
DELETE FROM ace_weenie_class WHERE weenieClassId = 30980;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (30980, 'thungusbabynpc1');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (30980, 0, 30980);
...
VALUES (30980, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (30980, 9007, 10) /* Creature_WeenieType */;
...
VALUES (30980, 1, 60) /* STRENGTH_ATTRIBUTE */
     ...
     , (30980, 8, 80) /* QUICKNESS_ATTRIBUTE */
     , (30980, 16, 120) /* FOCUS_ATTRIBUTE */
     , (30980, 32, 130) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (30980, 64, 10) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (30980, 128, 10) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (30980, 256, 10) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (30980, 2, 2587, 0, 4) /* Create Shirt for Wield_DestinationType */
     , (30980, 2, 2601, 0, 9) /* Create Pants for Wield_DestinationType */
     , (30980, 2, 133, 0, 9) /* Create Slippers for Wield_DestinationType */;
