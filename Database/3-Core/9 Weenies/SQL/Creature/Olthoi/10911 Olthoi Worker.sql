...
DELETE FROM ace_weenie_class WHERE weenieClassId = 10911;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (10911, 'boygrubinfestedworker-xp');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (10911, 20, 10911);
...
VALUES (10911, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (10911, 9007, 10) /* Creature_WeenieType */;
...
VALUES (10911, 1, 170) /* STRENGTH_ATTRIBUTE */
     ...
     , (10911, 8, 90) /* QUICKNESS_ATTRIBUTE */
     , (10911, 16, 75) /* FOCUS_ATTRIBUTE */
     , (10911, 32, 20) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (10911, 64, 60) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (10911, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (10911, 256, 0) /* MAX_MANA_ATTRIBUTE_2ND */;
