...
DELETE FROM ace_weenie_class WHERE weenieClassId = 6810;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (6810, 'shadownexus');
...
VALUES (6810, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (6810, 9007, 10) /* Creature_WeenieType */;
...
VALUES (6810, 90) /* ForceBolt5_SpellID */
     , (6810, 656) /* ManaMasterySelf4_SpellID */
     , (6810, 608) /* LifeMagicMasterySelf4_SpellID */
     , (6810, 1158) /* HealSelf3_SpellID */
     , (6810, 145) /* FlameVolley5_SpellID */
     , (6810, 137) /* FrostVolley5_SpellID */
     , (6810, 73) /* FrostBolt5_SpellID */
     , (6810, 1419) /* SlownessOther5_SpellID */
     , (6810, 141) /* LightningVolley5_SpellID */
     , (6810, 79) /* LightningBolt5_SpellID */
     , (6810, 84) /* FlameBolt5_SpellID */
     , (6810, 149) /* ForceVolley5_SpellID */
     , (6810, 1174) /* HarmOther4_SpellID */
     , (6810, 278) /* MagicResistanceSelf5_SpellID */
     , (6810, 1240) /* DrainHealth4_SpellID */
     , (6810, 1241) /* DrainHealth5_SpellID */
     , (6810, 153) /* BladeVolley5_SpellID */
     , (6810, 284) /* MagicYieldOther5_SpellID */
     , (6810, 233) /* VulnerabilityOther5_SpellID */
     , (6810, 1310) /* ArmorSelf4_SpellID */
     , (6810, 96) /* WhirlingBlade5_SpellID */
     , (6810, 627) /* LifeMagicIneptitudeOther5_SpellID */
     , (6810, 1467) /* FeeblemindOther5_SpellID */;

INSERT INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (6810, 1, 190) /* STRENGTH_ATTRIBUTE */
     , (6810, 2, 220) /* ENDURANCE_ATTRIBUTE */
     , (6810, 4, 190) /* COORDINATION_ATTRIBUTE */
     , (6810, 8, 190) /* QUICKNESS_ATTRIBUTE */
     , (6810, 16, 225) /* FOCUS_ATTRIBUTE */
     , (6810, 32, 275) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (6810, 64, 300) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (6810, 128, 250) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (6810, 256, 400) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (6810, 9, 6058, 0, 0) /* Create Dark Shard for ContainTreasure_DestinationType */
     , (6810, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (6810, 9, 6876, 0, 0) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (6810, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */;
