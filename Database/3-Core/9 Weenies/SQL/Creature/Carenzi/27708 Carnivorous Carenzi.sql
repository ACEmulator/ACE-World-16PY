...
VALUES (27708, 9, 6876, 0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (27708, 9, 0, 0, 0, 0.98, False) /* Create  for ContainTreasure_DestinationType */;
