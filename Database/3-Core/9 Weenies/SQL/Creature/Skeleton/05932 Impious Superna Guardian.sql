...
DELETE FROM ace_weenie_class WHERE weenieClassId = 5932;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (5932, 'skeletonimpiousne');
...
VALUES (5932, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (5932, 9007, 10) /* Creature_WeenieType */;
...
VALUES (5932, 1465) /* FeeblemindOther3_SpellID */
     , (5932, 1393) /* ClumsinessOther3_SpellID */
     , (5932, 1441) /* BafflementOther3_SpellID */
     , (5932, 1369) /* FrailtyOther3_SpellID */
     , (5932, 1417) /* SlownessOther3_SpellID */
     , (5932, 99) /* AcidBlast3_SpellID */
     , (5932, 127) /* AcidVolley3_SpellID */
     , (5932, 1340) /* WeaknessOther3_SpellID */
     , (5932, 60) /* AcidStream3_SpellID */;

INSERT INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (5932, 1, 120) /* STRENGTH_ATTRIBUTE */
     , (5932, 2, 130) /* ENDURANCE_ATTRIBUTE */
     , (5932, 4, 100) /* COORDINATION_ATTRIBUTE */
     , (5932, 8, 100) /* QUICKNESS_ATTRIBUTE */
     , (5932, 16, 150) /* FOCUS_ATTRIBUTE */
     , (5932, 32, 150) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (5932, 64, 75) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (5932, 128, 100) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (5932, 256, 100) /* MAX_MANA_ATTRIBUTE_2ND */;

INSERT INTO `ace_object_inventory` (`aceObjectId`, `destinationType`, `weenieClassId`, `stackSize`, `palette`)
VALUES (5932, 9, 3687, 0, 0) /* Create Skeleton's Skull for ContainTreasure_DestinationType */
     , (5932, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (5932, 9, 5927, 0, 0) /* Create Superna Key for ContainTreasure_DestinationType */
     , (5932, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */
     , (5932, 9, 3751, 0, 0) /* Create Lightning Battle Axe for ContainTreasure_DestinationType */
     , (5932, 9, 3850, 0, 0) /* Create Lightning Scimitar for ContainTreasure_DestinationType */
     , (5932, 9, 3791, 0, 0) /* Create Lightning Djarid for ContainTreasure_DestinationType */
     , (5932, 9, 3914, 0, 0) /* Create Lightning Yari for ContainTreasure_DestinationType */
     , (5932, 9, 3839, 0, 0) /* Create Lightning Nabut for ContainTreasure_DestinationType */
     , (5932, 9, 0, 0, 0) /* Create  for ContainTreasure_DestinationType */;
