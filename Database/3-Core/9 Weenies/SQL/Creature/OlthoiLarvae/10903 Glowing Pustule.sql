...
DELETE FROM ace_weenie_class WHERE weenieClassId = 10903;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (10903, 'boygrubdoorpustule3-xp');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (10903, 20, 10903);
...
VALUES (10903, 25, 19) /* LEVEL_INT */
     ...
     , (10903, 9007, 10) /* Creature_WeenieType */;
...
VALUES (10903, 1, 130) /* STRENGTH_ATTRIBUTE */
     ...
     , (10903, 8, 90) /* QUICKNESS_ATTRIBUTE */
     , (10903, 16, 60) /* FOCUS_ATTRIBUTE */
     , (10903, 32, 30) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (10903, 64, 50) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (10903, 128, 150) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (10903, 256, 0) /* MAX_MANA_ATTRIBUTE_2ND */;
