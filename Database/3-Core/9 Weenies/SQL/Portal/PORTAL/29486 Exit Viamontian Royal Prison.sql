...
VALUES (29486, 262164, 29486);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (29486, 1, 'Exit Viamontian Royal Prison') /* NAME_STRING */
     , (29486, 37, 'HeartofInnocence') /* QUEST_RESTRICTION_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (29486, 1, 33555925) /* SETUP_DID */
     , (29486, 2, 150994947) /* MOTION_TABLE_DID */
     , (29486, 8, 100667499) /* ICON_DID */;
...
VALUES (29486, 1, True) /* STUCK_BOOL */
     , (29486, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29486, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29486, 13, True) /* ETHEREAL_BOOL */
