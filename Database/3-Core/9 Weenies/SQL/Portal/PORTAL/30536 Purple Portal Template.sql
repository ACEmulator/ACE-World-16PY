/* Weenie - Purple Portal Template (30536) */
...
VALUES (30536, 262164, 30536);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30536, 1, 'Purple Portal Template') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (30536, 1, 33554867) /* SETUP_DID */
     , (30536, 2, 150994947) /* MOTION_TABLE_DID */
     , (30536, 8, 100667499) /* ICON_DID */;
...
VALUES (30536, 1, True) /* STUCK_BOOL */
     , (30536, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (30536, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (30536, 13, True) /* ETHEREAL_BOOL */
     , (30536, 15, True) /* LIGHTS_STATUS_BOOL */;

INSERT INTO `ace_position` (`aceObjectId`, `positionType`, `landblockRaw`, `posX`, `posY`, `posZ`, `qW`, `qX`, `qY`, `qZ`)
VALUES (30536, 2, 27787606, 40, -10, 0, 0.004206243, 0, 0, -0.9999912) /* DESTINATION_POSITION */;
