...
VALUES (412, 2030399488, 2421620993, 56.6994, 185.482, 28, -4.37114E-08, 0, 0, -1) /* Door */
     ...
     , (12304, 2030399491, 2421620737, 62.552, 188.199, 28.005, 0.429429, 0, 0, -0.903101) /* Agent of the Arcanum  */;

UPDATE `ace_landblock` SET `linkSlot`='1', `linkSource`='1' WHERE `preassignedGuid`='2030399490';

UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='2030399489';
