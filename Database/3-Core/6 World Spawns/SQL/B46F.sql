...
UPDATE `ace_landblock` SET `linkSlot`='1', `linkSource`='1' WHERE `preassignedGuid`='2068246531'; /* linkmonstergen3minutes */

UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='2068246528'; /* linkmonstergen3minutes <- Oak Target Drudge */
UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='2068246529'; /* linkmonstergen3minutes <- Oak Target Drudge */
UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='2068246530'; /* linkmonstergen3minutes <- Oak Target Drudge */
UPDATE `ace_landblock` SET `linkSlot`='1' WHERE `preassignedGuid`='2068246532'; /* linkmonstergen3minutes <- Straw Target Drudge */
