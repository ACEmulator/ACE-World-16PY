...
VALUES (14250, 'slumlordmansion2441-2450', 55 /* SlumLord_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (14250, 001 /* NAME_STRING */, 'Mansion');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (14250, 001 /* SETUP_DID */, 33557167)
     , (14250, 002 /* MOTION_TABLE_DID */, 150995128)
     , (14250, 008 /* ICON_DID */, 100671884);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (14250, 016 /* ITEM_USEABLE_INT */, 32 /* USEABLE_REMOTE */)
     , (14250, 086 /* MIN_LEVEL_INT */, 50)
     , (14250, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */)
     , (14250, 163 /* ALLEGIANCE_MIN_LEVEL_INT */, 6);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (14250, 039 /* DEFAULT_SCALE_FLOAT */, 1.2)
     , (14250, 054 /* USE_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (14250, 001 /* STUCK_BOOL */, True)
     , (14250, 076 /* HOUSE_REQUIRES_MONARCH_BOOL */, True);
