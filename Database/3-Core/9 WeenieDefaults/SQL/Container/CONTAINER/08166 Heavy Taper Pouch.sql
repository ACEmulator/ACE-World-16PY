...
VALUES (8166, 'sacktapers75', 21 /* Container_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8166, 001 /* NAME_STRING */, 'Heavy Taper Pouch')
     , (8166, 014 /* USE_STRING */, 'Use this item to open it and see its contents.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8166, 001 /* SETUP_DID */, 33554817)
     , (8166, 003 /* SOUND_TABLE_DID */, 536870932)
     , (8166, 006 /* PALETTE_BASE_DID */, 67111919)
     , (8166, 007 /* CLOTHINGBASE_DID */, 268435833)
     , (8166, 008 /* ICON_DID */, 100667436)
     , (8166, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8166, 001 /* ITEM_TYPE_INT */, 512 /* TYPE_CONTAINER */)
     , (8166, 003 /* PALETTE_TEMPLATE_INT */, 21 /* GOLD_PALETTE_TEMPLATE */)
     , (8166, 005 /* ENCUMB_VAL_INT */, 15)
     , (8166, 006 /* ITEMS_CAPACITY_INT */, 24)
     , (8166, 007 /* CONTAINERS_CAPACITY_INT */, 0)
     , (8166, 008 /* MASS_INT */, 140)
     , (8166, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (8166, 016 /* ITEM_USEABLE_INT */, 56 /* USEABLE_CONTAINED_VIEWED_REMOTE */)
     , (8166, 019 /* VALUE_INT */, 5)
     , (8166, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */)
     , (8166, 096 /* ENCUMB_CAPACITY_INT */, 180);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8166, 039 /* DEFAULT_SCALE_FLOAT */, 1)
     , (8166, 054 /* USE_RADIUS_FLOAT */, 0.5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8166, 002 /* OPEN_BOOL */, False)
     , (8166, 022 /* INSCRIBABLE_BOOL */, True);
