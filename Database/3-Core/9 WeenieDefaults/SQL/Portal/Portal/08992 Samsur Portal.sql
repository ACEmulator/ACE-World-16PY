...
VALUES (8992,   1, 0x020001B3) /* Setup */
     , (8992,   2, 0x09000003) /* MotionTable */
     , (8992,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8992, 2, 0x977B000C, 25.811, 73.853, 0.005, 0.92995, 0, 0, -0.367686) /* Destination */
