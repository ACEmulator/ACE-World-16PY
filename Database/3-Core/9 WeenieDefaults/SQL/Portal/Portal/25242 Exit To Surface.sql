...
VALUES (25242,   1, 0x020001B3) /* Setup */
     , (25242,   2, 0x09000003) /* MotionTable */
     , (25242,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (25242, 2, 0x958A000C, 30.115, 86.103, 107.49, -0.045224, 0, 0, -0.998977) /* Destination */
