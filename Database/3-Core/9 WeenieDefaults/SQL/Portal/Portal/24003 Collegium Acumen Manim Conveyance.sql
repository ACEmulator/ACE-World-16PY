...
VALUES (24003, 'trapportal-knorracumen', 7, '2005-02-09 10:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24003,   1,      65536) /* ItemType - Portal */
     , (24003,   9,          0) /* ValidLocations - None */
     , (24003,  16,          1) /* ItemUseable - No */
     , (24003,  83,       4096) /* ActivationResponse - CastSpell */
     , (24003,  93,       2060) /* PhysicsState - Ethereal, ReportCollisions, LightingOn */
     , (24003, 111,         49) /* PortalBitmask - Unrestricted, NoSummon, NoRecall */
     , (24003, 133,          4) /* ShowableOnRadar - ShowAlways */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24003,   1, True ) /* Stuck */
     , (24003,  11, False) /* IgnoreCollisions */
     , (24003,  12, True ) /* ReportCollisions */
     , (24003,  13, True ) /* Ethereal */
     , (24003,  14, False) /* GravityStatus */
     , (24003,  15, True ) /* LightsStatus */
     , (24003,  89, True ) /* PortalIgnoresPkAttackTimer */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24003,  39,       1) /* DefaultScale */;
