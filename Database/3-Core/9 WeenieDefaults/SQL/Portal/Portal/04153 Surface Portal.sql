...
VALUES (4153,   1, 0x020001B3) /* Setup */
     , (4153,   2, 0x09000003) /* MotionTable */
     , (4153,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (4153, 2, 0x01E401AD, 38.4, -18.6, 6, -0.782608, 0, 0, -0.622515) /* Destination */
