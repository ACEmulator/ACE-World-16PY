...
VALUES (7814,   1, 0x020001B3) /* Setup */
     , (7814,   2, 0x09000003) /* MotionTable */
     , (7814,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (7814, 2, 0x011A039E, 169.9, -37.5, -6, 0.151261, 0, 0, -0.988494) /* Destination */
