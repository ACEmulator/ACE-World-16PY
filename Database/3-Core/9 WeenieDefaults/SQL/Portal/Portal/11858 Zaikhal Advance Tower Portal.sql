...
VALUES (11858,   1, 0x020005D3) /* Setup */
     , (11858,   2, 0x09000003) /* MotionTable */
     , (11858,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (11858, 2, 0x7D960101, 181.9, 129.9, 246, -0.965926, 0, 0, -0.258819) /* Destination */
