...
VALUES (24008, 'trapportal-knorrdivine', 7, '2005-02-09 10:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24008,   1,      65536) /* ItemType - Portal */
     , (24008,   9,          0) /* ValidLocations - None */
     , (24008,  16,          1) /* ItemUseable - No */
     , (24008,  83,       4096) /* ActivationResponse - CastSpell */
     , (24008,  93,       2060) /* PhysicsState - Ethereal, ReportCollisions, LightingOn */
     , (24008, 111,         49) /* PortalBitmask - Unrestricted, NoSummon, NoRecall */
     , (24008, 133,          4) /* ShowableOnRadar - ShowAlways */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24008,   1, True ) /* Stuck */
     , (24008,  11, False) /* IgnoreCollisions */
     , (24008,  12, True ) /* ReportCollisions */
     , (24008,  13, True ) /* Ethereal */
     , (24008,  14, False) /* GravityStatus */
     , (24008,  15, True ) /* LightsStatus */
     , (24008,  24, False) /* UiHidden */
     , (24008,  89, True ) /* PortalIgnoresPkAttackTimer */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24008,  39,       1) /* DefaultScale */;
...
VALUES (24008, 2, 0x64440144, 90, -300, -23.995, 1, 0, 0, 0) /* Destination */
/* @teleloc 0x64440144 [90.000000 -300.000000 -23.995001] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (24008,  7 /* Use */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
