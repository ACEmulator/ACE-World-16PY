...
VALUES (8459,   1, 0x020001B3) /* Setup */
     , (8459,   2, 0x09000003) /* MotionTable */
     , (8459,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8459, 2, 0xF5270014, 68.53, 80.87, 21.1, -0.999962, 0, 0, -0.008727) /* Destination */
