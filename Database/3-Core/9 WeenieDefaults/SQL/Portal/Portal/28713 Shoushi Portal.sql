...
VALUES (28713, 'portalviamontiantorturechamber', 7, '2005-02-09 10:00:00') /* Portal */;
...
VALUES (28713,   1, 'Shoushi Portal') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28713,   1,   33554867) /* Setup */
     , (28713,   2,  150994947) /* MotionTable */
     , (28713,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (28713, 2, 3663003656, 21, 170.4, 20, 0.30237004, 0, 0, -0.9531906) /* Destination */
