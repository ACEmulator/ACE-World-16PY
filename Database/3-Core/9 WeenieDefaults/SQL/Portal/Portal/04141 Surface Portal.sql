...
VALUES (4141,   1, 0x020001B3) /* Setup */
     , (4141,   2, 0x09000003) /* MotionTable */
     , (4141,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (4141, 2, 0x424E0040, 188.18, 177.261, 1.555, -0.21644, 0, 0, -0.976296) /* Destination */
