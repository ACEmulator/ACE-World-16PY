...
VALUES (3667,   1, 0x020001B3) /* Setup */
     , (3667,   2, 0x09000003) /* MotionTable */
     , (3667,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (3667, 2, 0x01890321, 139.792, -66.582, 6.005, 0.014817, 0, 0, -0.99989) /* Destination */
