...
VALUES (6827,   1, 0x020001B3) /* Setup */
     , (6827,   2, 0x09000003) /* MotionTable */
     , (6827,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (6827, 2, 0x018A024F, 120, -79.9, 0, -0.707107, 0, 0, -0.707107) /* Destination */
