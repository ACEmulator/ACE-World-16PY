...
VALUES (7415,   1, 0x020001B3) /* Setup */
     , (7415,   2, 0x09000003) /* MotionTable */
     , (7415,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (7415, 2, 0xB6EA0027, 99, 160, 32.967, 0.707107, 0, 0, -0.707107) /* Destination */
