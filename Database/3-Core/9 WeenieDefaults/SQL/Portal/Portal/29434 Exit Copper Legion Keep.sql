...
VALUES (29434,   1, 'Exit Copper Legion Keep') /* Name */
     , (29434,  37, 'HeartofInnocence') /* QuestRestriction */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29434,   1,   33555925) /* Setup */
     , (29434,   2,  150994947) /* MotionTable */
     , (29434,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (29434, 2, 0x5F460189, 39.247, 0.038, 0, -0.026770059, 0, -0, -0.9996416) /* Destination */
