...
VALUES (8994,   1, 0x020001B3) /* Setup */
     , (8994,   2, 0x09000003) /* MotionTable */
     , (8994,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8994, 2, 0xEA30002A, 126.5, 37, 121, 0.688355, 0, 0, -0.725374) /* Destination */
