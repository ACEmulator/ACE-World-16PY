...
VALUES (6553,   1, 0x020001B3) /* Setup */
     , (6553,   2, 0x09000003) /* MotionTable */
     , (6553,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (6553, 2, 0x26310103, 105, 81, 241.7, 0.843391, 0, 0, -0.5373) /* Destination */
