...
VALUES (30469,   1, 0x020001B3) /* Setup */
     , (30469,   2, 0x09000003) /* MotionTable */
     , (30469,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (30469, 2, 0x7A180025, 109.8, 110.5, 3.3, 0.897643, 0, 0, -0.440723) /* Destination */
