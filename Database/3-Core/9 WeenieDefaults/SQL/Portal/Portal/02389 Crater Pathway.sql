...
VALUES (2389,   1, 0x020001B3) /* Setup */
     , (2389,   2, 0x09000003) /* MotionTable */
     , (2389,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (2389, 2, 0xC6A9002A, 133.3, 32.3, 43.7, 0.989016, 0, 0, -0.147809) /* Destination */
