...
VALUES (30473,   1, 0x020001B3) /* Setup */
     , (30473,   2, 0x09000003) /* MotionTable */
     , (30473,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (30473, 2, 0x6296003B, 168.9, 70.9, 0, 0.900698, 0, 0, -0.434445) /* Destination */
