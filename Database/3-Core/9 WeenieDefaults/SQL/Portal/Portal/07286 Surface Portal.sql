...
VALUES (7286,   1, 0x020001B3) /* Setup */
     , (7286,   2, 0x09000003) /* MotionTable */
     , (7286,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (7286, 2, 0x0F690019, 95.7, 14.6, 0, 0.382683, 0, 0, -0.92388) /* Destination */
