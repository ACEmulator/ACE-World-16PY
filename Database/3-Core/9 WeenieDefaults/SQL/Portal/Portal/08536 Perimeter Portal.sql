...
VALUES (8536,   1, 0x020001B3) /* Setup */
     , (8536,   2, 0x09000003) /* MotionTable */
     , (8536,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8536, 2, 0xF924001C, 85.5, 85.5, 39, -0.382683, 0, 0, -0.92388) /* Destination */
