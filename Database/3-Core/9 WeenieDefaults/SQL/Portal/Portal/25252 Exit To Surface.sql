...
VALUES (25252,   1, 0x020001B3) /* Setup */
     , (25252,   2, 0x09000003) /* MotionTable */
     , (25252,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (25252, 2, 0xDA750035, 164.03, 99.661, 18, -0.122164, 0, 0, -0.99251) /* Destination */
