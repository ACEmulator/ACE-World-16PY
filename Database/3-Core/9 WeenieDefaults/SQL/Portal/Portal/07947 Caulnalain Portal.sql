...
VALUES (7947,   1, 0x020005D6) /* Setup */
     , (7947,   2, 0x09000003) /* MotionTable */
     , (7947,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (7947, 2, 0x02DF0375, 2.16, -63.34, -5.9, 0.707107, 0, 0, -0.707107) /* Destination */
