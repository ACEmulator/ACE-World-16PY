...
VALUES (8479,   1, 0x020001B3) /* Setup */
     , (8479,   2, 0x09000003) /* MotionTable */
     , (8479,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8479, 2, 0xF8190031, 147.29, 12.477, 21.731, -0.906308, 0, 0, -0.422618) /* Destination */
