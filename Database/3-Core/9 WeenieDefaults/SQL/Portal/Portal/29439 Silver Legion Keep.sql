...
VALUES (29439, 'portalinvaderkeepsilver', 7, '2005-02-09 10:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29439,   1,      65536) /* ItemType - Portal */
     , (29439,  16,         32) /* ItemUseable - Remote */
     , (29439,  86,         60) /* MinLevel */
...
VALUES (29439,   1, 'Silver Legion Keep') /* Name */
     , (29439,  37, 'HeartofInnocence') /* QuestRestriction */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29439,   1,   33555925) /* Setup */
     , (29439,   2,  150994947) /* MotionTable */
     , (29439,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (29439, 2, 0x5F460189, 39.247, 0.038, 0, -0.026770059, 0, -0, -0.9996416) /* Destination */
