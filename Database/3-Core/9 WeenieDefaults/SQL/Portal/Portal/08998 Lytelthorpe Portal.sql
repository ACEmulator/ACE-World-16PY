...
VALUES (8998,   1, 0x020001B3) /* Setup */
     , (8998,   2, 0x09000003) /* MotionTable */
     , (8998,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8998, 2, 0xC0800007, 11.723, 155.56, 33.028, -0.402363, 0, 0, -0.91548) /* Destination */
