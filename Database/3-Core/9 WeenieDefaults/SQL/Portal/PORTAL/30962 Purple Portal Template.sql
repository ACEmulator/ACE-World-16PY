...
VALUES (30962, 'portalthrungusholeexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (30962, 1, 'Purple Portal Template') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (30962, 1, 33554867) /* SETUP_DID */
     , (30962, 2, 150994947) /* MOTION_TABLE_DID */
     , (30962, 8, 100667499) /* ICON_DID */;
...
VALUES (30962, 1, True) /* STUCK_BOOL */
     , (30962, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (30962, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (30962, 13, True) /* ETHEREAL_BOOL */
