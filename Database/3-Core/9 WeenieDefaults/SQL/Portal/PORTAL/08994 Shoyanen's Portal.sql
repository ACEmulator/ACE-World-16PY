...
VALUES ('8994', 'portalshoyanen', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8994,   1,      65536) /* ItemType - Portal */
     , (8994,  16,         32) /* ItemUseable - Remote */
     , (8994,  93,       3084) /* PhysicsState */
     , (8994, 111,         49) /* PortalBitmask */
...
VALUES (8994, 2, 3929014314, 126.5, 37, 121, 0.6883546, 0, 0, -0.7253743) /* Destination */;
