...
VALUES ('7942', 'portalfenmalainvestibuleexit', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7942,   1,      65536) /* ItemType - Portal */
     , (7942,  16,         32) /* ItemUseable - Remote */
     , (7942,  93,       3084) /* PhysicsState */
...
VALUES (7942, 2, 3292790824, 103.8, 171.1, 248.8, -0.7071068, 0, 0, -0.7071068) /* Destination */;
