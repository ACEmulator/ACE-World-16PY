...
VALUES ('30730', 'portalassaultroyalvaultreinforced', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (30730,   1,      65536) /* ItemType - Portal */
     , (30730,  16,         32) /* ItemUseable - Remote */
     , (30730,  86,         80) /* MinLevel */
     , (30730,  93,       3084) /* PhysicsState */
     , (30730, 111,         17) /* PortalBitmask */
...
VALUES (30730,   1,   33555925) /* Setup */
     , (30730,   2,  150994947) /* MotionTable */
     , (30730,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (30730, 2, 1245910, 0, -10, 0.005, 1, 0, 0, 0) /* Destination */;
