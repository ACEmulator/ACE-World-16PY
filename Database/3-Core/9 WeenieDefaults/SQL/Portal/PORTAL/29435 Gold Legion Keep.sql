...
VALUES (29435, 'portalinvaderkeepgold', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29435, 1, 'Gold Legion Keep') /* NAME_STRING */
     , (29435, 37, 'HeartofInnocence') /* QUEST_RESTRICTION_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29435, 1, 33555925) /* SETUP_DID */
     , (29435, 2, 150994947) /* MOTION_TABLE_DID */
     , (29435, 8, 100667499) /* ICON_DID */;
...
VALUES (29435, 1, True) /* STUCK_BOOL */
     , (29435, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29435, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29435, 13, True) /* ETHEREAL_BOOL */
