...
VALUES (29496, 'portaleaterpit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29496, 1, 'Corcima Castle Central Ward') /* NAME_STRING */
     , (29496, 37, 'HeartofInnocence') /* QUEST_RESTRICTION_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29496, 1, 33555925) /* SETUP_DID */
     , (29496, 2, 150994947) /* MOTION_TABLE_DID */
     , (29496, 8, 100667499) /* ICON_DID */;
...
VALUES (29496, 1, True) /* STUCK_BOOL */
     , (29496, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29496, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29496, 13, True) /* ETHEREAL_BOOL */
