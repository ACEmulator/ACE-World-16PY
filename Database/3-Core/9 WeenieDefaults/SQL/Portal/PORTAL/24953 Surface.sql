...
VALUES (24953, 'portallugiancitadelsdiresexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24953, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24953, 1, 33554867) /* SETUP_DID */
     , (24953, 2, 150994947) /* MOTION_TABLE_DID */
     , (24953, 8, 100667499) /* ICON_DID */;
...
VALUES (24953, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (24953, 111, 1) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24953, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24953, 1, True) /* STUCK_BOOL */
     , (24953, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (24953, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24953, 13, True) /* ETHEREAL_BOOL */
