...
VALUES (2071, 'portaldungeonfernexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (2071, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2071, 1, 33554867) /* SETUP_DID */
     , (2071, 2, 150994947) /* MOTION_TABLE_DID */
     , (2071, 8, 100667499) /* ICON_DID */;
...
VALUES (2071, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (2071, 111, 1) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (2071, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2071, 1, True) /* STUCK_BOOL */
     , (2071, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (2071, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2071, 13, True) /* ETHEREAL_BOOL */
