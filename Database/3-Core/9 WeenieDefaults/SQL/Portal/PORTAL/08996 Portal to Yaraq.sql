...
VALUES ('8996', 'portalyaraqnotie', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8996,   1,      65536) /* ItemType - Portal */
     , (8996,  16,         32) /* ItemUseable - Remote */
     , (8996,  93,       3084) /* PhysicsState */
     , (8996, 111,         49) /* PortalBitmask */
...
VALUES (8996, 2, 2103705613, 31.9, 104.6, 11.9, 0.5771452, 0, 0, -0.8166416) /* Destination */;
