...
VALUES (29799, 'portalthreebagsexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29799, 1, 'Exit') /* NAME_STRING */
     , (29799, 37, 'BagPuzzleSolved') /* QUEST_RESTRICTION_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29799, 1, 33559046) /* SETUP_DID */
     , (29799, 2, 150995314) /* MOTION_TABLE_DID */
     , (29799, 8, 100667499) /* ICON_DID */;
...
VALUES (29799, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (29799, 111, 49) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29799, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29799, 1, True) /* STUCK_BOOL */
     , (29799, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29799, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29799, 13, True) /* ETHEREAL_BOOL */
