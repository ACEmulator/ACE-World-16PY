...
VALUES (9141,   1,   33555923) /* Setup */
     , (9141,   2,  150994947) /* MotionTable */
     , (9141,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (9141, 2, 44368534, 60, -680, 6, 0.7071068, 0, 0, -0.7071068) /* Destination */;
