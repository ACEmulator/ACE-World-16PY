...
VALUES ('30058', 'portalaugmentationrealmmain3', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (30058,   1,      65536) /* ItemType - Portal */
     , (30058,  16,         32) /* ItemUseable - Remote */
     , (30058,  93,       3084) /* PhysicsState */
...
VALUES (30058,   1,   33554867) /* Setup */
     , (30058,   2,  150994947) /* MotionTable */
     , (30058,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (30058, 2, 3663003656, 21, 170.4, 20, 0.30237, 0, 0, -0.9531906) /* Destination */;
