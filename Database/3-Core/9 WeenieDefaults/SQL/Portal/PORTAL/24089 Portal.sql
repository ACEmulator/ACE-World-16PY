...
VALUES (24089, 'portal-rb5', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24089, 1, 'Portal') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24089, 1, 33558262) /* SETUP_DID */
     , (24089, 2, 150994947) /* MOTION_TABLE_DID */
     , (24089, 8, 100667499) /* ICON_DID */;
...
VALUES (24089, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (24089, 111, 49) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24089, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24089, 1, True) /* STUCK_BOOL */
     , (24089, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (24089, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24089, 13, True) /* ETHEREAL_BOOL */
