...
VALUES (24076, 'portal-lb3', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24076, 1, 'Portal') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24076, 1, 33558318) /* SETUP_DID */
     , (24076, 2, 150994947) /* MOTION_TABLE_DID */
     , (24076, 8, 100667499) /* ICON_DID */;
...
VALUES (24076, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (24076, 111, 49) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24076, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24076, 1, True) /* STUCK_BOOL */
     , (24076, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (24076, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24076, 13, True) /* ETHEREAL_BOOL */
