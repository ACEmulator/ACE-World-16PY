...
VALUES (29339, 'portalnewbieexitsanamar', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29339, 1, 'Purple Portal Template') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29339, 1, 33554867) /* SETUP_DID */
     , (29339, 2, 150994947) /* MOTION_TABLE_DID */
     , (29339, 8, 100667499) /* ICON_DID */;
...
VALUES (29339, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (29339, 111, 1) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29339, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29339, 1, True) /* STUCK_BOOL */
     , (29339, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29339, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29339, 13, True) /* ETHEREAL_BOOL */
