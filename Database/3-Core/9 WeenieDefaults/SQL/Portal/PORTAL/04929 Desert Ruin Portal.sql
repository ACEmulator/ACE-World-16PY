...
VALUES (4929, 'portaldesertruin', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4929, 1, 'Desert Ruin Portal') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4929, 1, 33554867) /* SETUP_DID */
     , (4929, 2, 150994947) /* MOTION_TABLE_DID */
     , (4929, 8, 100667499) /* ICON_DID */;
...
VALUES (4929, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (4929, 111, 1) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4929, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4929, 1, True) /* STUCK_BOOL */
     , (4929, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (4929, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4929, 13, True) /* ETHEREAL_BOOL */
