...
VALUES ('14388', 'portaljumpshaft9x3', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (14388,   1,      65536) /* ItemType - Portal */
     , (14388,  16,         32) /* ItemUseable - Remote */
     , (14388,  93,       3084) /* PhysicsState */
     , (14388, 111,         49) /* PortalBitmask */
...
VALUES (14388,   1,   33554867) /* Setup */
     , (14388,   2,  150994947) /* MotionTable */
     , (14388,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (14388, 2, 3846111270, 0, 0, 0, 1, 0, 0, 0) /* Destination */;
