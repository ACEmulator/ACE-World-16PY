...
VALUES ('7416', 'portalreservoirexit2', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7416,   1,      65536) /* ItemType - Portal */
     , (7416,  16,         32) /* ItemUseable - Remote */
     , (7416,  93,       3084) /* PhysicsState */
     , (7416, 111,         17) /* PortalBitmask */
...
VALUES (7416, 2, 3068854332, 179.859, 80.599, 25.018, 0.9499066, 0, 0, -0.312534) /* Destination */;
