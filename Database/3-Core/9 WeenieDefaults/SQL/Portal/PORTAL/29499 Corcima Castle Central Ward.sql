...
VALUES (29499, 'portalheartofmadnessexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29499, 1, 'Corcima Castle Central Ward') /* NAME_STRING */
     , (29499, 37, 'HeartofInnocence') /* QUEST_RESTRICTION_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29499, 1, 33555925) /* SETUP_DID */
     , (29499, 2, 150994947) /* MOTION_TABLE_DID */
     , (29499, 8, 100667499) /* ICON_DID */;
...
VALUES (29499, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (29499, 86, 60) /* MIN_LEVEL_INT */
     , (29499, 111, 49) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29499, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29499, 1, True) /* STUCK_BOOL */
     , (29499, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29499, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29499, 13, True) /* ETHEREAL_BOOL */
