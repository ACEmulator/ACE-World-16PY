...
VALUES (28785, 'portalruschkicebergexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (28785, 1, 'Shoushi Portal') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28785, 1, 33554867) /* SETUP_DID */
     , (28785, 2, 150994947) /* MOTION_TABLE_DID */
     , (28785, 8, 100667499) /* ICON_DID */;
...
VALUES (28785, 1, True) /* STUCK_BOOL */
     , (28785, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (28785, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (28785, 13, True) /* ETHEREAL_BOOL */
