...
VALUES (29502, 'portalkarlunhall', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29502, 1, 'Corcima Castle Central Ward') /* NAME_STRING */
     , (29502, 37, 'HeartofInnocence') /* QUEST_RESTRICTION_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29502, 1, 33555925) /* SETUP_DID */
     , (29502, 2, 150994947) /* MOTION_TABLE_DID */
     , (29502, 8, 100667499) /* ICON_DID */;
...
VALUES (29502, 1, True) /* STUCK_BOOL */
     , (29502, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (29502, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29502, 13, True) /* ETHEREAL_BOOL */
