...
VALUES ('8992', 'portalsamsurnotie', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8992,   1,      65536) /* ItemType - Portal */
     , (8992,  16,         32) /* ItemUseable - Remote */
     , (8992,  93,       3084) /* PhysicsState */
     , (8992, 111,         49) /* PortalBitmask */
...
VALUES (8992, 2, 2541420556, 25.811, 73.853, 0.005, 0.9299499, 0, 0, -0.3676863) /* Destination */;
