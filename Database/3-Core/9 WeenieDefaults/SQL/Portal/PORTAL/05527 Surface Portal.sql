...
VALUES ('5527', 'portalmountletheexit', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5527,   1,      65536) /* ItemType - Portal */
     , (5527,  16,         32) /* ItemUseable - Remote */
     , (5527,  93,       3084) /* PhysicsState */
     , (5527, 111,         17) /* PortalBitmask */
...
VALUES (5527, 2, 341114930, 163.519, 28.263, 70.005, -0.9220929, 0, 0, -0.3869687) /* Destination */;
