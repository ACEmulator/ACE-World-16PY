...
VALUES ('7261', 'portalacroomcheese', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7261,   1,      65536) /* ItemType - Portal */
     , (7261,  16,         32) /* ItemUseable - Remote */
     , (7261,  93,       3084) /* PhysicsState */
     , (7261, 111,         17) /* PortalBitmask */
...
VALUES (7261,   1,   33554867) /* Setup */
     , (7261,   2,  150994947) /* MotionTable */
     , (7261,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (7261, 2, 49873152, 0, 0, 0, 1, 0, 0, 0) /* Destination */;
