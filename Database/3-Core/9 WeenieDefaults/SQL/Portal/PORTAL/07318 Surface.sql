...
VALUES (7318, 'portallugiancitadelaluexit', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7318, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7318, 1, 33554867) /* SETUP_DID */
     , (7318, 2, 150994947) /* MOTION_TABLE_DID */
     , (7318, 8, 100667499) /* ICON_DID */;
...
VALUES (7318, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (7318, 111, 1) /* PORTAL_BITMASK_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7318, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7318, 1, True) /* STUCK_BOOL */
     , (7318, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (7318, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7318, 13, True) /* ETHEREAL_BOOL */
