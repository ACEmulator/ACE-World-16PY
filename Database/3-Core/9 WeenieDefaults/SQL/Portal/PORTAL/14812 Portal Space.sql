...
VALUES ('14812', 'portalportalspaceempyreanb', 7) /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (14812,   1,      65536) /* ItemType - Portal */
     , (14812,  16,         32) /* ItemUseable - Remote */
     , (14812,  93,       2060) /* PhysicsState */
     , (14812, 111,         49) /* PortalBitmask */
...
VALUES (14812,   1,   33555923) /* Setup */
     , (14812,   2,  150994947) /* MotionTable */
     , (14812,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (14812, 2, 1382744551, 180, -90, -42, 1, 0, 0, 0) /* Destination */;
