...
VALUES (28798, 'portallolasden', /* Portal_WeenieType */ 7);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (28798, 1, 'Shoushi Portal') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28798, 1, 33554867) /* SETUP_DID */
     , (28798, 2, 150994947) /* MOTION_TABLE_DID */
     , (28798, 8, 100667499) /* ICON_DID */;
...
VALUES (28798, 1, True) /* STUCK_BOOL */
     , (28798, 11, False) /* IGNORE_COLLISIONS_BOOL */
     , (28798, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (28798, 13, True) /* ETHEREAL_BOOL */
