...
VALUES (9304, 0.2, 9256, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 1, 5, 0, 0.9238795, 0, 0, -0.38268346) /* Generate Dune Reaver (9256) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (9304, 0.4, 9256, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -1.4, -1.4, 0, 0.25881907, 0, 0, -0.9659258) /* Generate Dune Reaver (9256) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (9304, 0.6, 9257, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 5.4, 0, 0, -0.76604444, 0, -0, -0.64278764) /* Generate Silt Lurker (9257) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
