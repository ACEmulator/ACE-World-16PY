...
VALUES (4291, 0.3, 1608, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2, 1, 0, 0.7660444, 0, 0, -0.6427876) /* Generate Drudge Lurker (1608) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4291, 0.6, 1608, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -1.4, 2.4, 0, 0.7071068, 0, 0, -0.7071068) /* Generate Drudge Lurker (1608) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4291, 0.8, 1608, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 1, 2.4, 0, -0.6427876, 0, 0, -0.7660444) /* Generate Drudge Lurker (1608) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
