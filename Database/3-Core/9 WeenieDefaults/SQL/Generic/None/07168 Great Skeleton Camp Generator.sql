...
VALUES (7168, 0.25, 7122, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 3, 0, 0, 0.70710677, 0, 0, -0.70710677) /* Generate Great Skeleton (7122) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (7168, 0.7, 7121, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 0.5, -0.5, 0, 0.76604444, 0, 0, -0.6427876) /* Generate Skeleton Bone Lord (7121) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (7168, 0.95, 7121, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 1, -2, 0, 0.81915206, 0, 0, -0.57357645) /* Generate Skeleton Bone Lord (7121) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
