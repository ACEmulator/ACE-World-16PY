...
VALUES (8072, 0.5, 7991, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2, 0, 0, 0.81915206, 0, 0, -0.57357645) /* Generate Tiofor Ursuin (7991) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (8072, 0.95, 7991, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, 1.5, 0, 0.087155804, 0, 0, -0.9961947) /* Generate Tiofor Ursuin (7991) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
