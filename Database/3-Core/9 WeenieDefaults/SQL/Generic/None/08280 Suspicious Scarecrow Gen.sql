...
VALUES (8280, 0.3, 8272, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 5, -5.5, 0, 0.70710677, 0, 0, -0.70710677) /* Generate Suspicious Scarecrow (8272) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (8280, 1, 8276, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2, 8.5, 0, 0.70710677, 0, 0, -0.70710677) /* Generate Scarecrow (8276) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
