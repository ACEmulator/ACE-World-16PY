...
VALUES (4376,   1, 0x0200026B) /* Setup */
     , (4376,   8, 0x06001066) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (4376, 0.111, 1022, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 0, 4, 0, 0.953717, 0, 0, -0.300706) /* Generate Mayoi Portal (1022) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4376, 0.222, 4037, 2400, 1, 1, 1, 4, -1, 0, 0, 0, -0.4, 2.4, 0, 0.92388, 0, 0, -0.382684) /* Generate Baishi Portal (4037) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4376, 0.333, 4043, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, -2.4, 0, 0.887011, 0, 0, -0.461749) /* Generate Sawato Portal (4043) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4376, 0.444, 1018, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 0, -3, 0, 0.843391, 0, 0, -0.5373) /* Generate Portal to Hebian-To (1018) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4376, 0.666, 4041, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 0, -2, 0, 0.843391, 0, 0, -0.5373) /* Generate Portal to Kara (4041) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
