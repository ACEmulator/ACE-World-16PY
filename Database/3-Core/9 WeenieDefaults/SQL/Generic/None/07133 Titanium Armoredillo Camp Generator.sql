...
VALUES (7133, 0.4, 7083, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 1, 2, 0, 0.90630776, 0, 0, -0.42261827) /* Generate Titanium Armoredillo (7083) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (7133, 0.75, 7083, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2.4, 1.4, 0, 0.76604444, 0, 0, -0.6427876) /* Generate Titanium Armoredillo (7083) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
