...
VALUES ('4274', 'reedsharkpupcampgen', 1) /* Generic */;
...
VALUES (4274, 0.7, 223, 2700, 1, 4294967295, 1, 4, -1, 0, 0, 0, 3, 1, 0, 0.9537169, 0, 0, -0.3007058) /* Generate Reedshark Pup (223) (x1 up to max of 4,294,967,295) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4274, 1, 221, 2700, 1, 1, 1, 4, -1, 0, 0, 0, 1.4, -1.4, 0, 0.7071068, 0, 0, -0.7071068) /* Generate Adult Reedshark (221) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
