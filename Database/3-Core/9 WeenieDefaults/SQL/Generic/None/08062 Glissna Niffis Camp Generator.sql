...
VALUES (8062, 0.4, 7986, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 5, -2, 0, 0.81915206, 0, 0, -0.57357645) /* Generate Glissnal Niffis (7986) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (8062, 0.70000005, 7986, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, 2.5, 0, 0.64278764, 0, 0, -0.76604444) /* Generate Glissnal Niffis (7986) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
