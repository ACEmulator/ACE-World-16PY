...
VALUES (5728,  81,          1) /* MaxGeneratedObjects */
     ...
     , (5728, 143,  940741620) /* GeneratorStartTime - 10/24/1999 05:07:00 */
     , (5728, 144,  940838460) /* GeneratorEndTime - 10/25/1999 08:01:00 */;
...
VALUES (5728,   1, 0x0200026B) /* Setup */
     , (5728,   8, 0x06001066) /* Icon */;
...
VALUES (5728, 0.2, 5705, 900, 1, 1, 1, 4, -1, 0, 0, 0, -9.5, 1, 40, 0.642788, 0, 0, -0.766044) /* Generate Flicker (5705) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (5728, 0.8, 3692, 900, 1, 1, 1, 4, -1, 0, 0, 0, 0, 0, 40, 0.999048, 0, 0, -0.043619) /* Generate Black Stone (3692) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (5728, 0.9, 3692, 900, 1, 1, 1, 4, -1, 0, 0, 0, 7.5, 1.5, 40, 0.92388, 0, 0, -0.382684) /* Generate Black Stone (3692) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
