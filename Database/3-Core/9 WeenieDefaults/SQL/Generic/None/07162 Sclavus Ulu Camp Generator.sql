...
VALUES (7162,   1, 0x0200026B) /* Setup */
     , (7162,   8, 0x06001066) /* Icon */;
...
VALUES (7162, 0.2, 7110, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 5, 0, 0, 0.707107, 0, 0, -0.707107) /* Generate Ulu Sclavus (7110) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (7162, 0.4, 7110, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 0.4, 6.4, 0, 0.92388, 0, 0, -0.382684) /* Generate Ulu Sclavus (7110) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (7162, 0.6, 7110, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -3.4, 2.4, 0, 0, 0, 0, -1) /* Generate Ulu Sclavus (7110) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
