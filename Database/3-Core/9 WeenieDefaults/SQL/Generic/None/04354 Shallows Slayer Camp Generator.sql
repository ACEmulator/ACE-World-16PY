...
VALUES (4354, 0.5, 2579, 2700, 1, 1, 1, 4, -1, 0, 0, 0, 7, 1, 0, 0.95371693, 0, 0, -0.3007058) /* Generate Shallows Slayer (2579) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4354, 0.8, 2579, 2700, 1, 1, 1, 4, -1, 0, 0, 0, 0.4, 6, 0, 0.81915206, 0, 0, -0.57357645) /* Generate Shallows Slayer (2579) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
