...
VALUES ('4175', 'monougacampgen', 1) /* Generic */;
...
VALUES (4175, 0.2, 2612, 1800, 1, 4294967295, 1, 4, -1, 0, 0, 0, -4, -1, 0, -0.7071068, 0, 0, -0.7071068) /* Generate Outcast Monouga (2612) (x1 up to max of 4,294,967,295) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4175, 0.4, 2612, 1800, 1, 4294967295, 1, 4, -1, 0, 0, 0, 4.4, 4.4, 0, 0.8660254, 0, 0, -0.5) /* Generate Outcast Monouga (2612) (x1 up to max of 4,294,967,295) - Regenerate upon Destruction - Location to (re)Generate: Specific */
