...
VALUES (4345,   1, 0x0200026B) /* Setup */
     , (4345,   8, 0x06001066) /* Icon */;
...
VALUES (4345, 0.2, 4245, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 4, 0, 0, 0.953717, 0, 0, -0.300706) /* Generate Mite Snippet (4245) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4345, 0.6, 4245, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, -2.4, 0, 0, 0, 0, -1) /* Generate Mite Snippet (4245) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4345, 0.99, 4245, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 3, 0, 0, 0.92388, 0, 0, -0.382684) /* Generate Mite Snippet (4245) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4345, 1, 6117, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 0, 0, 0, 0.999048, 0, 0, -0.043619) /* Generate Pile of Long Sticks (6117) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
