...
VALUES (6400, 'testcoweventgen', 1) /* Generic */;
...
VALUES (6400, -1, 14, 10, 1, 1, 1, 4, -1, 0, 0, 0, 4, 0, 0, 1, 0, 0, 0) /* Generate Cow (14) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (6400, -1, 6400, 10, 1, 1, 1, 4, -1, 0, 0, 0, 0, 4, 0, 1, 0, 0, 0) /* Generate Test Cow Event Generator (6400) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
