...
VALUES (4282,   1, 0x0200026B) /* Setup */
     , (4282,   8, 0x06001066) /* Icon */;
...
VALUES (4282, 0.4, 23, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -4, -1, 0, -0.707107, 0, 0, -0.707107) /* Generate Virindi Servant (23) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4282, 0.6, 23, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, -1.4, 0, 0.996195, 0, 0, -0.087156) /* Generate Virindi Servant (23) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4282, 1, 1628, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2, 1.5, 0, 0, 0, 0, -1) /* Generate Tusker Slave (1628) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
