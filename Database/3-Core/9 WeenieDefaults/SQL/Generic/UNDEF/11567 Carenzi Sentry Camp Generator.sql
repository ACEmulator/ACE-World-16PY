...
VALUES (11567, 'carenzisentrycampgen-xp', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (11567, 001 /* NAME_STRING */, 'Carenzi Sentry Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (11567, 001 /* SETUP_DID */, 33557199)
     , (11567, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (11567, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (11567, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (11567, 093 /* PHYSICS_STATE_INT */, 1040 /* IGNORE_COLLISIONS_PS, GRAVITY_PS */)
     , (11567, 100 /* GENERATOR_TYPE_INT */, 1 /* Relative_GeneratorType */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (11567, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (11567, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (11567, 001 /* STUCK_BOOL */, True)
     , (11567, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (11567, 013 /* ETHEREAL_BOOL */, False)
     , (11567, 014 /* GRAVITY_STATUS_BOOL */, True)
     , (11567, 024 /* UI_HIDDEN_BOOL */, True);
