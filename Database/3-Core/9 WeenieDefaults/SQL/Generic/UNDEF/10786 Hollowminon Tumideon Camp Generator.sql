/* Weenie - Hollowminon Tumideon Camp Generator (10786) */
DELETE FROM weenie WHERE class_Id = 10786;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (10786, 'hollowminiontumideoncampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (10786, 001 /* NAME_STRING */, 'Hollowminon Tumideon Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (10786, 001 /* SETUP_DID */, 33555051)
     , (10786, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (10786, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (10786, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (10786, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (10786, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (10786, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (10786, 001 /* STUCK_BOOL */, True)
     , (10786, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (10786, 018 /* VISIBILITY_BOOL */, True);
