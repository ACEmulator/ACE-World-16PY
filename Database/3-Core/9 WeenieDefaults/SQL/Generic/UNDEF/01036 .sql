...
VALUES (1036, 'itemdaggergenerator', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1036, 001 /* NAME_STRING */, 'itemdaggergenerator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1036, 001 /* SETUP_DID */, 33555051)
     , (1036, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1036, 081 /* MAX_GENERATED_OBJECTS_INT */, 1)
     , (1036, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (1036, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1036, 041 /* REGENERATION_INTERVAL_FLOAT */, 450)
     , (1036, 043 /* GENERATOR_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1036, 001 /* STUCK_BOOL */, True)
     , (1036, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1036, 018 /* VISIBILITY_BOOL */, True);
