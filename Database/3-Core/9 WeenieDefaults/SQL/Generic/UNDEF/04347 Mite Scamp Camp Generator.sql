/* Weenie - Mite Scamp Camp Generator (4347) */
DELETE FROM weenie WHERE class_Id = 4347;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (4347, 'mitescampcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4347, 001 /* NAME_STRING */, 'Mite Scamp Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4347, 001 /* SETUP_DID */, 33555051)
     , (4347, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4347, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (4347, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (4347, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4347, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4347, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4347, 001 /* STUCK_BOOL */, True)
     , (4347, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4347, 018 /* VISIBILITY_BOOL */, True);
