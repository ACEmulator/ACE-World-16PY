/* Weenie - Erupt Lethe FX Gen (7358) */
DELETE FROM weenie WHERE class_Id = 7358;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (7358, 'eruptlethefxgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7358, 001 /* NAME_STRING */, 'Erupt Lethe FX Gen')
     , (7358, 034 /* GENERATOR_EVENT_STRING */, 'EruptLetheFXGen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7358, 001 /* SETUP_DID */, 33555051)
     , (7358, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7358, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (7358, 082 /* INIT_GENERATED_OBJECTS_INT */, 5)
     , (7358, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */)
     , (7358, 142 /* GENERATOR_TIME_TYPE_INT */, 3 /* Event_GeneratorTimeType */)
     , (7358, 145 /* GENERATOR_END_DESTRUCTION_TYPE_INT */, 2 /* Destroy_GeneratorDestruct */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7358, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7358, 043 /* GENERATOR_RADIUS_FLOAT */, 20)
     , (7358, 121 /* GENERATOR_INITIAL_DELAY_FLOAT */, 30);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7358, 001 /* STUCK_BOOL */, True)
     , (7358, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7358, 018 /* VISIBILITY_BOOL */, True);
