...
VALUES (19459, 'bonedumpinggen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (19459, 001 /* NAME_STRING */, 'bonedumpinggen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (19459, 001 /* SETUP_DID */, 33555051)
     , (19459, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (19459, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (19459, 082 /* INIT_GENERATED_OBJECTS_INT */, 0)
     , (19459, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (19459, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (19459, 043 /* GENERATOR_RADIUS_FLOAT */, 4);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (19459, 001 /* STUCK_BOOL */, True)
     , (19459, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (19459, 018 /* VISIBILITY_BOOL */, True);
