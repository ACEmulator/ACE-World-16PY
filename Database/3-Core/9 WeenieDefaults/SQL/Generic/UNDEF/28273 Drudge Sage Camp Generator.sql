/* Weenie - Drudge Sage Camp Generator (28273) */
DELETE FROM weenie WHERE class_Id = 28273;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (28273, 'drudgesagecampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (28273, 001 /* NAME_STRING */, 'Drudge Sage Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28273, 001 /* SETUP_DID */, 33555051)
     , (28273, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (28273, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (28273, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (28273, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (28273, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (28273, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (28273, 001 /* STUCK_BOOL */, True)
     , (28273, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (28273, 018 /* VISIBILITY_BOOL */, True);
