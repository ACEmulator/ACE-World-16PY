/* Weenie - Plasma Golem Camp Generator (7144) */
DELETE FROM weenie WHERE class_Id = 7144;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (7144, 'golemplasmacampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7144, 001 /* NAME_STRING */, 'Plasma Golem Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7144, 001 /* SETUP_DID */, 33555051)
     , (7144, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7144, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (7144, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (7144, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7144, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7144, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7144, 001 /* STUCK_BOOL */, True)
     , (7144, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7144, 018 /* VISIBILITY_BOOL */, True);
