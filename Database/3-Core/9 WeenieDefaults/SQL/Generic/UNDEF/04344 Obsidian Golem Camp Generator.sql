/* Weenie - Obsidian Golem Camp Generator (4344) */
DELETE FROM weenie WHERE class_Id = 4344;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (4344, 'golemobsidiancampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4344, 001 /* NAME_STRING */, 'Obsidian Golem Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4344, 001 /* SETUP_DID */, 33555051)
     , (4344, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4344, 081 /* MAX_GENERATED_OBJECTS_INT */, 2)
     , (4344, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (4344, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4344, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4344, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4344, 001 /* STUCK_BOOL */, True)
     , (4344, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4344, 018 /* VISIBILITY_BOOL */, True);
