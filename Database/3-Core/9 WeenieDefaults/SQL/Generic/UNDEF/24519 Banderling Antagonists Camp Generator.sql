/* Weenie - Banderling Antagonists Camp Generator (24519) */
DELETE FROM weenie WHERE class_Id = 24519;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (24519, 'banderlingantagonistscampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24519, 001 /* NAME_STRING */, 'Banderling Antagonists Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24519, 001 /* SETUP_DID */, 33555051)
     , (24519, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24519, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (24519, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (24519, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24519, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (24519, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24519, 001 /* STUCK_BOOL */, True)
     , (24519, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (24519, 018 /* VISIBILITY_BOOL */, True);
