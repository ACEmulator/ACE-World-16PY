...
VALUES (1993, 'drudgegroupgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1993, 001 /* NAME_STRING */, 'drudgegroupgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1993, 001 /* SETUP_DID */, 33555051)
     , (1993, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1993, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (1993, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (1993, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1993, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (1993, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1993, 001 /* STUCK_BOOL */, True)
     , (1993, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1993, 018 /* VISIBILITY_BOOL */, True);
