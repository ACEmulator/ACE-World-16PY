/* Weenie - Morgluuk Dead Kivik Lir Generator (28392) */
DELETE FROM weenie WHERE class_Id = 28392;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (28392, 'generatorkiviklirmorgluukdead', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (28392, 001 /* NAME_STRING */, 'Morgluuk Dead Kivik Lir Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28392, 001 /* SETUP_DID */, 33555051)
     , (28392, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (28392, 081 /* MAX_GENERATED_OBJECTS_INT */, 28)
     , (28392, 082 /* INIT_GENERATED_OBJECTS_INT */, 28)
     , (28392, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (28392, 041 /* REGENERATION_INTERVAL_FLOAT */, 300)
     , (28392, 043 /* GENERATOR_RADIUS_FLOAT */, 20);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (28392, 001 /* STUCK_BOOL */, True)
     , (28392, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (28392, 018 /* VISIBILITY_BOOL */, True);
