/* Weenie - Zaikhal Defense Platinum Legion Portal Gen (29460) */
DELETE FROM weenie WHERE class_Id = 29460;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (29460, 'generatoreventplatinumportal', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29460, 001 /* NAME_STRING */, 'Zaikhal Defense Platinum Legion Portal Gen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29460, 001 /* SETUP_DID */, 33555051)
     , (29460, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29460, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (29460, 082 /* INIT_GENERATED_OBJECTS_INT */, 5)
     , (29460, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29460, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (29460, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29460, 001 /* STUCK_BOOL */, True)
     , (29460, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (29460, 018 /* VISIBILITY_BOOL */, True);
