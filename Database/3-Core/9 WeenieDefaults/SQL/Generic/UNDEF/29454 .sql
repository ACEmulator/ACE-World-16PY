/* Weenie - generatoreventgoldkeepboss1 (29454) */
DELETE FROM weenie WHERE class_Id = 29454;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (29454, 'generatoreventgoldkeepboss1', /* Generic_WeenieType */ 1);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29454, 1, 'generatoreventgoldkeepboss1') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29454, 1, 33555051) /* SETUP_DID */
     , (29454, 8, 100667494) /* ICON_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29454, 81, 5) /* MAX_GENERATED_OBJECTS_INT */
     , (29454, 82, 5) /* INIT_GENERATED_OBJECTS_INT */
     , (29454, 93, 1044) /* PHYSICS_STATE_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29454, 41, 60) /* REGENERATION_INTERVAL_FLOAT */
     , (29454, 43, 3) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29454, 1, True) /* STUCK_BOOL */
     , (29454, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (29454, 18, True) /* VISIBILITY_BOOL */;
