...
VALUES (7166, 'shrethrendeathcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7166, 001 /* NAME_STRING */, 'shrethrendeathcampgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7166, 001 /* SETUP_DID */, 33555051)
     , (7166, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7166, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (7166, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (7166, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7166, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7166, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7166, 001 /* STUCK_BOOL */, True)
     , (7166, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7166, 018 /* VISIBILITY_BOOL */, True);
