/* Weenie - Zaikhal Defense Silver Legion Soldiers Gen (29466) */
DELETE FROM weenie WHERE class_Id = 29466;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (29466, 'generatoreventsilversoldiers', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29466, 001 /* NAME_STRING */, 'Zaikhal Defense Silver Legion Soldiers Gen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29466, 001 /* SETUP_DID */, 33555051)
     , (29466, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29466, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (29466, 082 /* INIT_GENERATED_OBJECTS_INT */, 5)
     , (29466, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29466, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (29466, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29466, 001 /* STUCK_BOOL */, True)
     , (29466, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (29466, 018 /* VISIBILITY_BOOL */, True);
