...
VALUES (4621, 'newbietownwatergen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4621, 001 /* NAME_STRING */, 'newbietownwatergen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4621, 001 /* SETUP_DID */, 33555051)
     , (4621, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4621, 081 /* MAX_GENERATED_OBJECTS_INT */, 1)
     , (4621, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (4621, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4621, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4621, 043 /* GENERATOR_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4621, 001 /* STUCK_BOOL */, True)
     , (4621, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4621, 018 /* VISIBILITY_BOOL */, True);
