...
VALUES (23500, 'olthoivanguardcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (23500, 001 /* NAME_STRING */, 'olthoivanguardcampgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (23500, 001 /* SETUP_DID */, 33555051)
     , (23500, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (23500, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (23500, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (23500, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (23500, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (23500, 043 /* GENERATOR_RADIUS_FLOAT */, 16);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (23500, 001 /* STUCK_BOOL */, True)
     , (23500, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (23500, 018 /* VISIBILITY_BOOL */, True);
