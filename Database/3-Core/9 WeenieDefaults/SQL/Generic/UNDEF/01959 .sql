...
VALUES (1959, 'extremedirelandsforestdrudgegen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1959, 001 /* NAME_STRING */, 'extremedirelandsforestdrudgegen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1959, 001 /* SETUP_DID */, 33555051)
     , (1959, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1959, 081 /* MAX_GENERATED_OBJECTS_INT */, 2)
     , (1959, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (1959, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1959, 041 /* REGENERATION_INTERVAL_FLOAT */, 600)
     , (1959, 043 /* GENERATOR_RADIUS_FLOAT */, 15);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1959, 001 /* STUCK_BOOL */, True)
     , (1959, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1959, 018 /* VISIBILITY_BOOL */, True);
