...
VALUES (24418, 'generatorasheroninvasionmidgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24418, 001 /* NAME_STRING */, 'generatorasheroninvasionmidgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24418, 001 /* SETUP_DID */, 33555051)
     , (24418, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24418, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (24418, 082 /* INIT_GENERATED_OBJECTS_INT */, 6)
     , (24418, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24418, 041 /* REGENERATION_INTERVAL_FLOAT */, 480)
     , (24418, 043 /* GENERATOR_RADIUS_FLOAT */, 10);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24418, 001 /* STUCK_BOOL */, True)
     , (24418, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (24418, 018 /* VISIBILITY_BOOL */, True);
