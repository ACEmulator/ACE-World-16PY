/* Weenie - Zaikhal Defense Silver Keep Boss 2 (29464) */
DELETE FROM weenie WHERE class_Id = 29464;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (29464, 'generatoreventsilverkeepboss2', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29464, 001 /* NAME_STRING */, 'Zaikhal Defense Silver Keep Boss 2');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29464, 001 /* SETUP_DID */, 33555051)
     , (29464, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29464, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (29464, 082 /* INIT_GENERATED_OBJECTS_INT */, 5)
     , (29464, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29464, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (29464, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29464, 001 /* STUCK_BOOL */, True)
     , (29464, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (29464, 018 /* VISIBILITY_BOOL */, True);
