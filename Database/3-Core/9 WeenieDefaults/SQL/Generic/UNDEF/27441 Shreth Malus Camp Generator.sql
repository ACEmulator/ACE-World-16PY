/* Weenie - Shreth Malus Camp Generator (27441) */
DELETE FROM weenie WHERE class_Id = 27441;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (27441, 'deepcavernsmargulgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (27441, 001 /* NAME_STRING */, 'Shreth Malus Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (27441, 001 /* SETUP_DID */, 33555051)
     , (27441, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (27441, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (27441, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (27441, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (27441, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (27441, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (27441, 001 /* STUCK_BOOL */, True)
     , (27441, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (27441, 018 /* VISIBILITY_BOOL */, True);
