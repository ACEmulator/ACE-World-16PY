/* Weenie - Banderling Savages Camp Generator (24520) */
DELETE FROM weenie WHERE class_Id = 24520;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (24520, 'banderlingsavagescampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24520, 001 /* NAME_STRING */, 'Banderling Savages Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24520, 001 /* SETUP_DID */, 33555051)
     , (24520, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24520, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (24520, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (24520, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24520, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (24520, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24520, 001 /* STUCK_BOOL */, True)
     , (24520, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (24520, 018 /* VISIBILITY_BOOL */, True);
