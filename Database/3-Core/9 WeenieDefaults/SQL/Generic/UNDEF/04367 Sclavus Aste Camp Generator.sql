/* Weenie - Sclavus Aste Camp Generator (4367) */
DELETE FROM weenie WHERE class_Id = 4367;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (4367, 'sclavusastecampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4367, 001 /* NAME_STRING */, 'Sclavus Aste Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4367, 001 /* SETUP_DID */, 33555051)
     , (4367, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4367, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (4367, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (4367, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4367, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4367, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4367, 001 /* STUCK_BOOL */, True)
     , (4367, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4367, 018 /* VISIBILITY_BOOL */, True);
