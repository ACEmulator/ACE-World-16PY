...
VALUES (23578, 'obsidianplainsdrudgecampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (23578, 001 /* NAME_STRING */, 'obsidianplainsdrudgecampgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (23578, 001 /* SETUP_DID */, 33555051)
     , (23578, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (23578, 081 /* MAX_GENERATED_OBJECTS_INT */, 8)
     , (23578, 082 /* INIT_GENERATED_OBJECTS_INT */, 5)
     , (23578, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (23578, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (23578, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (23578, 001 /* STUCK_BOOL */, True)
     , (23578, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (23578, 018 /* VISIBILITY_BOOL */, True);
