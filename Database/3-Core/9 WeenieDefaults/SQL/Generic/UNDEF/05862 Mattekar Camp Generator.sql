/* Weenie - Mattekar Camp Generator (5862) */
DELETE FROM weenie WHERE class_Id = 5862;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (5862, 'mattekarhoaryraregen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (5862, 001 /* NAME_STRING */, 'Mattekar Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (5862, 001 /* SETUP_DID */, 33555051)
     , (5862, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5862, 081 /* MAX_GENERATED_OBJECTS_INT */, 1)
     , (5862, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (5862, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5862, 041 /* REGENERATION_INTERVAL_FLOAT */, 30)
     , (5862, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5862, 001 /* STUCK_BOOL */, True)
     , (5862, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (5862, 018 /* VISIBILITY_BOOL */, True);
