...
DELETE FROM ace_weenie_class WHERE weenieClassId = 30941;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (30941, 'genmixedliveopspreactdextreme');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (30941, 0, 30941);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30941, 1, 'genmixedliveopspreactdextreme') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (30941, 1, 33555051) /* SETUP_DID */
     , (30941, 8, 100667494) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30941, 81, 15) /* MAX_GENERATED_OBJECTS_INT */
     , (30941, 82, 15) /* INIT_GENERATED_OBJECTS_INT */
     , (30941, 93, 1044) /* PHYSICS_STATE_INT */
     , (30941, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (30941, 41, 300) /* REGENERATION_INTERVAL_FLOAT */
     , (30941, 43, 15) /* GENERATOR_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (30941, 1, True) /* STUCK_BOOL */
     , (30941, 18, True) /* VISIBILITY_BOOL */
     , (30941, 74, True) /* GENERATOR_AUTOMATIC_DESTRUCTION_BOOL */
     , (30941, 11, True) /* IGNORE_COLLISIONS_BOOL */;
