...
VALUES (24526, 'monougacunningcruelcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24526, 001 /* NAME_STRING */, 'monougacunningcruelcampgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24526, 001 /* SETUP_DID */, 33555051)
     , (24526, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24526, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (24526, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (24526, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24526, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (24526, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24526, 001 /* STUCK_BOOL */, True)
     , (24526, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (24526, 018 /* VISIBILITY_BOOL */, True);
