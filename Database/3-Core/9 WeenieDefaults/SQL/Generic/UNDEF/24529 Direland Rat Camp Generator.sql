/* Weenie - Direland Rat Camp Generator (24529) */
DELETE FROM weenie WHERE class_Id = 24529;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (24529, 'ratdirelandcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (24529, 001 /* NAME_STRING */, 'Direland Rat Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (24529, 001 /* SETUP_DID */, 33555051)
     , (24529, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (24529, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (24529, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (24529, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24529, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (24529, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24529, 001 /* STUCK_BOOL */, True)
     , (24529, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (24529, 018 /* VISIBILITY_BOOL */, True);
