...
VALUES (8066, 'niffissephalcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8066, 001 /* NAME_STRING */, 'niffissephalcampgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8066, 001 /* SETUP_DID */, 33555051)
     , (8066, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8066, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (8066, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (8066, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8066, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (8066, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8066, 001 /* STUCK_BOOL */, True)
     , (8066, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (8066, 018 /* VISIBILITY_BOOL */, True);
