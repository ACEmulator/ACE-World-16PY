/* Weenie - Coral Golem Camp Generator (23620) */
DELETE FROM weenie WHERE class_Id = 23620;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (23620, 'golemcoralcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (23620, 001 /* NAME_STRING */, 'Coral Golem Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (23620, 001 /* SETUP_DID */, 33555051)
     , (23620, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (23620, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (23620, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (23620, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (23620, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (23620, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (23620, 001 /* STUCK_BOOL */, True)
     , (23620, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (23620, 018 /* VISIBILITY_BOOL */, True);
