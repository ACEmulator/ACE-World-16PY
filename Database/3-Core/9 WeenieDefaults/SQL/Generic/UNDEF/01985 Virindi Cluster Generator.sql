/* Weenie - Virindi Cluster Generator (1985) */
DELETE FROM weenie WHERE class_Id = 1985;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (1985, 'virindiclustergen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1985, 001 /* NAME_STRING */, 'Virindi Cluster Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1985, 001 /* SETUP_DID */, 33555051)
     , (1985, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1985, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (1985, 082 /* INIT_GENERATED_OBJECTS_INT */, 5)
     , (1985, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1985, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (1985, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1985, 001 /* STUCK_BOOL */, True)
     , (1985, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1985, 018 /* VISIBILITY_BOOL */, True);
