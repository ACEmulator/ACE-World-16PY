/* Weenie - High Mosswart Clump Generator (1995) */
DELETE FROM weenie WHERE class_Id = 1995;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (1995, 'highmosswartclumpgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1995, 001 /* NAME_STRING */, 'High Mosswart Clump Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1995, 001 /* SETUP_DID */, 33555051)
     , (1995, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1995, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (1995, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (1995, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1995, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (1995, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1995, 001 /* STUCK_BOOL */, True)
     , (1995, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1995, 018 /* VISIBILITY_BOOL */, True);
