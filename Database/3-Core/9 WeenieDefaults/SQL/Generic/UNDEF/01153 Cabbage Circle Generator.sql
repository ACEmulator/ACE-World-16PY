/* Weenie - Cabbage Circle Generator (1153) */
DELETE FROM weenie WHERE class_Id = 1153;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (1153, 'cabbagecirclegen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1153, 001 /* NAME_STRING */, 'Cabbage Circle Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1153, 001 /* SETUP_DID */, 33555051)
     , (1153, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1153, 081 /* MAX_GENERATED_OBJECTS_INT */, 30)
     , (1153, 082 /* INIT_GENERATED_OBJECTS_INT */, 15)
     , (1153, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1153, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (1153, 043 /* GENERATOR_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1153, 001 /* STUCK_BOOL */, True)
     , (1153, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1153, 018 /* VISIBILITY_BOOL */, True);
