/* Weenie - Reedshark Family Generator (2010) */
DELETE FROM weenie WHERE class_Id = 2010;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (2010, 'reedsharkfamilygen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (2010, 001 /* NAME_STRING */, 'Reedshark Family Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2010, 001 /* SETUP_DID */, 33555051)
     , (2010, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2010, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (2010, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (2010, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (2010, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (2010, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2010, 001 /* STUCK_BOOL */, True)
     , (2010, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (2010, 018 /* VISIBILITY_BOOL */, True);
