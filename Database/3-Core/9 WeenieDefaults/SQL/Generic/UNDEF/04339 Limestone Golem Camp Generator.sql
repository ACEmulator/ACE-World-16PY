/* Weenie - Limestone Golem Camp Generator (4339) */
DELETE FROM weenie WHERE class_Id = 4339;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (4339, 'golemlimestonecampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4339, 001 /* NAME_STRING */, 'Limestone Golem Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4339, 001 /* SETUP_DID */, 33555051)
     , (4339, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4339, 081 /* MAX_GENERATED_OBJECTS_INT */, 2)
     , (4339, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (4339, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4339, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4339, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4339, 001 /* STUCK_BOOL */, True)
     , (4339, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4339, 018 /* VISIBILITY_BOOL */, True);
