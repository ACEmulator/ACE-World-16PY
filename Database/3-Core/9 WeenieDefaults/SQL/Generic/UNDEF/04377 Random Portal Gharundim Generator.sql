/* Weenie - Random Portal Gharundim Generator (4377) */
...
VALUES (4377, 001 /* NAME_STRING */, 'Random Portal Gharundim Generator');
...
VALUES (4377, 0.111, 1032, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 0, 4, 0, 0.9537169, 0, 0, -0.3007058)/* Generate Portal to Zaikhal (x1 up to max of 1) - Destruction_RegenerationType - Specific_RegenLocationType */
     ...
     , (4377, 0.888, 8200, 2400, 1, 1, 1, 4, -1, 0, 0, 0, -2, 0, 0, 0.7071068, 0, 0, -0.7071068)/* Generate Floating City Portal Gen (BDEG) (x1 up to max of 1) - Destruction_RegenerationType - Specific_RegenLocationType */
