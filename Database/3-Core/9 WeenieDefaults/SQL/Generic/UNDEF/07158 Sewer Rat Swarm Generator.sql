/* Weenie - Sewer Rat Swarm Generator (7158) */
DELETE FROM weenie WHERE class_Id = 7158;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (7158, 'ratsewerswarmgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7158, 001 /* NAME_STRING */, 'Sewer Rat Swarm Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7158, 001 /* SETUP_DID */, 33555051)
     , (7158, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7158, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (7158, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (7158, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7158, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7158, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7158, 001 /* STUCK_BOOL */, True)
     , (7158, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7158, 018 /* VISIBILITY_BOOL */, True);
