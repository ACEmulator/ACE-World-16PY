...
VALUES (4316, 'mosswartbarkercampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4316, 001 /* NAME_STRING */, 'mosswartbarkercampgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4316, 001 /* SETUP_DID */, 33555051)
     , (4316, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4316, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (4316, 082 /* INIT_GENERATED_OBJECTS_INT */, 4)
     , (4316, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4316, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4316, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4316, 001 /* STUCK_BOOL */, True)
     , (4316, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4316, 018 /* VISIBILITY_BOOL */, True);
