...
VALUES (11197, 'northwestmaraeplateaumastergen-xp', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (11197, 001 /* NAME_STRING */, 'northwestmaraeplateaumastergen-xp');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (11197, 001 /* SETUP_DID */, 33555051)
     , (11197, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (11197, 081 /* MAX_GENERATED_OBJECTS_INT */, 6)
     , (11197, 082 /* INIT_GENERATED_OBJECTS_INT */, 6)
     , (11197, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (11197, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (11197, 043 /* GENERATOR_RADIUS_FLOAT */, 12);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (11197, 001 /* STUCK_BOOL */, True)
     , (11197, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (11197, 018 /* VISIBILITY_BOOL */, True);
