/* Weenie - Low A Gharundim Generator (1997) */
DELETE FROM weenie WHERE class_Id = 1997;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (1997, 'lowagharundimgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1997, 001 /* NAME_STRING */, 'Low A Gharundim Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1997, 001 /* SETUP_DID */, 33555051)
     , (1997, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1997, 081 /* MAX_GENERATED_OBJECTS_INT */, 1)
     , (1997, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (1997, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1997, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (1997, 043 /* GENERATOR_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1997, 001 /* STUCK_BOOL */, True)
     , (1997, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (1997, 018 /* VISIBILITY_BOOL */, True);
