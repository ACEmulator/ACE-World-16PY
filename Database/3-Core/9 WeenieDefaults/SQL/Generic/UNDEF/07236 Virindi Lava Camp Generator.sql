/* Weenie - Virindi Lava Camp Generator (7236) */
DELETE FROM weenie WHERE class_Id = 7236;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (7236, 'virindilavacampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7236, 001 /* NAME_STRING */, 'Virindi Lava Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7236, 001 /* SETUP_DID */, 33555051)
     , (7236, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7236, 081 /* MAX_GENERATED_OBJECTS_INT */, 5)
     , (7236, 082 /* INIT_GENERATED_OBJECTS_INT */, 3)
     , (7236, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7236, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7236, 043 /* GENERATOR_RADIUS_FLOAT */, 5);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7236, 001 /* STUCK_BOOL */, True)
     , (7236, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7236, 018 /* VISIBILITY_BOOL */, True);
