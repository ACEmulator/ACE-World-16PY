/* Weenie - Beta Low Phase 4 Gen (5729) */
DELETE FROM weenie WHERE class_Id = 5729;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (5729, 'betalowphase4gen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (5729, 001 /* NAME_STRING */, 'Beta Low Phase 4 Gen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (5729, 001 /* SETUP_DID */, 33555051)
     , (5729, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5729, 081 /* MAX_GENERATED_OBJECTS_INT */, 1)
     , (5729, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (5729, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */)
     , (5729, 142 /* GENERATOR_TIME_TYPE_INT */, 1 /* RealTime_GeneratorTimeType */)
     , (5729, 143 /* GENERATOR_START_TIME_INT */, 940741620 /* 10/24/1999 9:07:00 AM */)
     , (5729, 144 /* GENERATOR_END_TIME_INT */, 940838460 /* 10/25/1999 12:01:00 PM */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5729, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (5729, 043 /* GENERATOR_RADIUS_FLOAT */, 20);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5729, 001 /* STUCK_BOOL */, True)
     , (5729, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (5729, 018 /* VISIBILITY_BOOL */, True);
