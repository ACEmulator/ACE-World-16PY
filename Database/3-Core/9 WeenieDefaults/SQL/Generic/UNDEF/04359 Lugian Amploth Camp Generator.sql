/* Weenie - Lugian Amploth Camp Generator (4359) */
DELETE FROM weenie WHERE class_Id = 4359;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (4359, 'lugianamplothcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4359, 001 /* NAME_STRING */, 'Lugian Amploth Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4359, 001 /* SETUP_DID */, 33555051)
     , (4359, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4359, 081 /* MAX_GENERATED_OBJECTS_INT */, 2)
     , (4359, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (4359, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4359, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (4359, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4359, 001 /* STUCK_BOOL */, True)
     , (4359, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (4359, 018 /* VISIBILITY_BOOL */, True);
