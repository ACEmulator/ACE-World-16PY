...
VALUES (7231, 'junglebeach2mixgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7231, 001 /* NAME_STRING */, 'junglebeach2mixgen');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7231, 001 /* SETUP_DID */, 33555051)
     , (7231, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7231, 081 /* MAX_GENERATED_OBJECTS_INT */, 1)
     , (7231, 082 /* INIT_GENERATED_OBJECTS_INT */, 1)
     , (7231, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7231, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7231, 043 /* GENERATOR_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7231, 001 /* STUCK_BOOL */, True)
     , (7231, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7231, 018 /* VISIBILITY_BOOL */, True);
