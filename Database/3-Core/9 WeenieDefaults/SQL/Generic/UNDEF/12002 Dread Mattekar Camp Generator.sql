/* Weenie - Dread Mattekar Camp Generator (12002) */
DELETE FROM weenie WHERE class_Id = 12002;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (12002, 'mattekardreadcampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12002, 001 /* NAME_STRING */, 'Dread Mattekar Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (12002, 001 /* SETUP_DID */, 33555051)
     , (12002, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (12002, 081 /* MAX_GENERATED_OBJECTS_INT */, 2)
     , (12002, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (12002, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12002, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (12002, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (12002, 001 /* STUCK_BOOL */, True)
     , (12002, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (12002, 018 /* VISIBILITY_BOOL */, True);
