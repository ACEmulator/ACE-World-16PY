/* Weenie - Plate Armoredillo Camp Generator (7132) */
DELETE FROM weenie WHERE class_Id = 7132;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (7132, 'armoredilloplatecampgen', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7132, 001 /* NAME_STRING */, 'Plate Armoredillo Camp Generator');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7132, 001 /* SETUP_DID */, 33555051)
     , (7132, 008 /* ICON_DID */, 100667494);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7132, 081 /* MAX_GENERATED_OBJECTS_INT */, 3)
     , (7132, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (7132, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7132, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (7132, 043 /* GENERATOR_RADIUS_FLOAT */, 3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7132, 001 /* STUCK_BOOL */, True)
     , (7132, 011 /* IGNORE_COLLISIONS_BOOL */, True)
     , (7132, 018 /* VISIBILITY_BOOL */, True);
