...
VALUES (11174, 'skilltokenlifemagic-xp', /* Generic_WeenieType */ 1);
...
VALUES (11174, 16, 'A small, squarish piece of glass. This can be turned into the Tah of Timaru for a free one-point boost to your Life Magic skill. There are tesserae available for each skill in the game. If you don''t want a point of Life Magic, trade this tessera for another. You may only turn in five per character - so choose carefully!') /* LONG_DESC_STRING */
     , (11174, 1, 'Life Magic Tessera') /* NAME_STRING */
     , (11174, 15, 'A small, squarish piece of glass. This can be turned into the Tah of Timaru for a free one-point boost to your Life Magic skill. There are tesserae available for each skill in the game. If you don''t want a point of Life Magic, trade this tessera for another. You may only turn in five per character - so choose carefully!') /* SHORT_DESC_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (11174, 1, 33557218) /* SETUP_DID */
     , (11174, 3, 536870932) /* SOUND_TABLE_DID */
     , (11174, 36, 234881046) /* MUTATE_FILTER_DID */
     , (11174, 8, 100671804) /* ICON_DID */
     , (11174, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (11174, 9, 0) /* LOCATIONS_INT */
     ...
     , (11174, 150, 103) /* HOOK_PLACEMENT_INT */
     , (11174, 151, 2) /* HOOK_TYPE_INT */
     , (11174, 33, 1) /* BONDED_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (11174, 39, 2) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (11174, 22, True) /* INSCRIBABLE_BOOL */
     , (11174, 23, True) /* DESTROY_ON_SELL_BOOL */;
