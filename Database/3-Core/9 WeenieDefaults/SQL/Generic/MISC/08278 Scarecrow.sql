...
VALUES (8278, 'scarecrowshadyfake', 1 /* Generic_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8278, 001 /* NAME_STRING */, 'Scarecrow');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8278, 001 /* SETUP_DID */, 33556871)
     , (8278, 006 /* PALETTE_BASE_DID */, 67112967)
     , (8278, 007 /* CLOTHINGBASE_DID */, 268436084)
     , (8278, 008 /* ICON_DID */, 100671141);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8278, 001 /* ITEM_TYPE_INT */, 128 /* TYPE_MISC */)
     , (8278, 003 /* PALETTE_TEMPLATE_INT */, 76 /* ORANGE_PALETTE_TEMPLATE */)
     , (8278, 005 /* ENCUMB_VAL_INT */, 400)
     , (8278, 008 /* MASS_INT */, 200)
     , (8278, 016 /* ITEM_USEABLE_INT */, 1 /* USEABLE_NO */)
     , (8278, 019 /* VALUE_INT */, 0)
     , (8278, 081 /* MAX_GENERATED_OBJECTS_INT */, 4)
     , (8278, 082 /* INIT_GENERATED_OBJECTS_INT */, 2)
     , (8278, 093 /* PHYSICS_STATE_INT */, 1040 /* IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8278, 012 /* SHADE_FLOAT */, 0)
     , (8278, 041 /* REGENERATION_INTERVAL_FLOAT */, 60)
     , (8278, 043 /* GENERATOR_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8278, 001 /* STUCK_BOOL */, True)
     , (8278, 013 /* ETHEREAL_BOOL */, False);
