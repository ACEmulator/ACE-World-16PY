...
VALUES (855, 'npkswitch', 27, '2005-02-09 10:00:00') /* PKModifier */;
...
VALUES (855,  50,   10800) /* MinimumTimeSincePk */
     , (855,  54,       5) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (855,   1, 'Altar of Asheron') /* Name */
     , (855,  15, 'Using this altar will let you become one of Asheron''s Favored again, a Non-Player Killer protected by Asheron himself -- but to complete the process, you may not have killed anyone for three hours beforehand.') /* ShortDesc */
