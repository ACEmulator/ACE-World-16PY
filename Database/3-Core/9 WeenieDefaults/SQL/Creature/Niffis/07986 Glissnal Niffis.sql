...
VALUES (7986, 9,     0,  0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure */
     , (7986, 9, 10705,  0, 0, 0.03, False) /* Create Niffis Pearl (10705) for ContainTreasure */;
