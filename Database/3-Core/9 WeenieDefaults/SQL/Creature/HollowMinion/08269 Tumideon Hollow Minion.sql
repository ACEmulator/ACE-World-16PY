...
VALUES (8269, 001 /* SETUP_DID */, 33556792)
     ...
     , (8269, 035 /* DEATH_TREASURE_TYPE_DID */, 463 /* Loot Tier: 2 */);
...
VALUES (8269, 9, 9292, 0, 0, 0.04, False) /* Create Virindi Singularity Key for ContainTreasure_DestinationType */
     , (8269, 9, 0, 0, 0, 0.96, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
