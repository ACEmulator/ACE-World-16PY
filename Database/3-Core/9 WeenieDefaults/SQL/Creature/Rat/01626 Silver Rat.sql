...
VALUES (1626, 001 /* SETUP_DID */, 33554493)
     ...
     , (1626, 035 /* DEATH_TREASURE_TYPE_DID */, 457 /* Loot Tier: 2 */);
...
VALUES (1626, 9, 6876, 0, 0, 0.01, False) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (1626, 9, 0, 0, 0, 0.99, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
