...
VALUES (7107, 001 /* SETUP_DID */, 33554493)
     ...
     , (7107, 035 /* DEATH_TREASURE_TYPE_DID */, 456 /* Loot Tier: 3 */);
...
VALUES (7107, 9, 6876, 0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (7107, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure_DestinationType */;
