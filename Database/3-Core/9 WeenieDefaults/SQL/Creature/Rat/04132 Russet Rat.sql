...
VALUES (4132, 001 /* SETUP_DID */, 33554493)
     ...
     , (4132, 035 /* DEATH_TREASURE_TYPE_DID */, 459 /* Loot Tier: 1 */);
...
VALUES (4132, 9, 4134, 0, 0, 0.15, False) /* Create Russet Rat Tail for ContainTreasure_DestinationType */
     , (4132, 9, 0, 0, 0, 0.85, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
