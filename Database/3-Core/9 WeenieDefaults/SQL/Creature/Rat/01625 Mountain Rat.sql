...
VALUES (1625,  6, 0, 3, 0,  74, 0, 309.999532561601) /* MeleeDefense        Specialized */
     , (1625,  7, 0, 3, 0,  94, 0, 309.999532561601) /* MissileDefense      Specialized */
     , (1625, 13, 0, 3, 0, 100, 0, 309.999532561601) /* UnarmedCombat       Specialized */
     , (1625, 15, 0, 3, 0,  74, 0, 309.999532561601) /* MagicDefense        Specialized */
     , (1625, 20, 0, 2, 0,  50, 0, 309.999532561601) /* Deception           Trained */
     , (1625, 22, 0, 2, 0,  40, 0, 309.999532561601) /* Jump                Trained */
     , (1625, 24, 0, 2, 0,  40, 0, 309.999532561601) /* Run                 Trained */;
...
VALUES (1625,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,  0.175, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,  0.175, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1625, 9,     0,  0, 0, 0.93, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure */
     , (1625, 8,  5794,  0, 0, 0.07, False) /* Create Hot Pepper (5794) for Treasure */;
