...
VALUES (4243,   1,         16) /* ItemType - Creature */
     ...
     , (4243,  93,       1032) /* PhysicsState */
     , (4243, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (4243, 146,       7871) /* XpOverride */;
...
VALUES (4243,   1, 185, 0, 0) /* Strength */
     , (4243,   2, 160, 0, 0) /* Endurance */
     , (4243,   3, 140, 0, 0) /* Quickness */
     , (4243,   4, 120, 0, 0) /* Coordination */
     , (4243,   5,  70, 0, 0) /* Focus */
     , (4243,   6,  70, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (4243,   1,    40, 0, 0, 120) /* MaxHealth */
     , (4243,   3,   150, 0, 0, 310) /* MaxStamina */
     , (4243,   5,     0, 0, 0, 70) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (4243,  6, 0, 3, 0, 140, 0, 384.725435364325) /* MeleeDefense        Specialized */
     , (4243,  7, 0, 3, 0, 236, 0, 384.725435364325) /* MissileDefense      Specialized */
     , (4243, 12, 0, 3, 0, 180, 0, 384.725435364325) /* ThrownWeapon        Specialized */
     , (4243, 13, 0, 3, 0, 130, 0, 384.725435364325) /* UnarmedCombat       Specialized */
     , (4243, 15, 0, 3, 0, 165, 0, 384.725435364325) /* MagicDefense        Specialized */
     , (4243, 20, 0, 3, 0,  20, 0, 384.725435364325) /* Deception           Specialized */
     , (4243, 22, 0, 3, 0,  80, 0, 384.725435364325) /* Jump                Specialized */
     , (4243, 24, 0, 3, 0,  30, 0, 384.725435364325) /* Run                 Specialized */;
...
VALUES (4243,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4243,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (4243, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (4243, 2, 22542,  0, 0, 0, False) /* Create Fire Spines for Wield */
     , (4243, 9, 28888,  0, 0, 0.05, False) /* Create Chittick Head for ContainTreasure */;
