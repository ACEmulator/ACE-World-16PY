...
VALUES (11510, 001 /* SETUP_DID */, 33557117)
     ...
     /* Wield 25x Greater Fire Arrow (5305)   Chance: 100% */
     ...
     /* Wield 22x Greater Lightning Arrow (5308)   Chance: 100% */
     /* Wield  Yumi (363)   Chance: 14% */
     /* Wield 20x Greater Frost Arrow (5307)   Chance: 100% */
     /* Wield  Heavy Crossbow (311)   Chance: 14% */
     /* Wield 15x Greater Armor Piercing Quarrel (5318)   Chance: 100% */
     , (11510, 035 /* DEATH_TREASURE_TYPE_DID */, 451 /* Loot Tier: 2 */);
...
VALUES (11510, 001 /* ITEM_TYPE_INT */, 16 /* TYPE_CREATURE */)
     ...
     , (11510, 101 /* AI_ALLOWED_COMBAT_STYLE_INT */, 183 /* Unarmed_CombatStyle, OneHanded_CombatStyle, OneHandedAndShield_CombatStyle, Bow_CombatStyle, Crossbow_CombatStyle, ThrownWeapon_CombatStyle */)
...
VALUES (11510, 9, 11355, 0, 0, 0.03, False) /* Create Aun Pendant for ContainTreasure_DestinationType */
     , (11510, 9, 0, 0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */
     , (11510, 9, 6876, 0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (11510, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
