...
VALUES (7097, 'golemplatinum', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (7097,   1,       5) /* HeartbeatInterval */
     ...
     , (7097,   3,     1.2) /* HealthRate */
     , (7097,   4,     0.5) /* StaminaRate */
     , (7097,   5,       2) /* ManaRate */
     , (7097,   6,     0.1) /* HealthUponResurrection */
     , (7097,   7,    0.25) /* StaminaUponResurrection */
     , (7097,   8,     0.3) /* ManaUponResurrection */
     , (7097,  12,     0.5) /* Shade */
     , (7097,  13,     0.8) /* ArmorModVsSlash */
     , (7097,  14,     0.8) /* ArmorModVsPierce */
     , (7097,  15,     0.8) /* ArmorModVsBludgeon */
     ...
     , (7097,  34,     2.3) /* PowerupTime */
     , (7097,  64,    0.33) /* ResistSlash */
     , (7097,  65,    0.33) /* ResistPierce */
     , (7097,  66,     0.8) /* ResistBludgeon */
     , (7097,  67,    0.75) /* ResistFire */
     , (7097,  68,    0.75) /* ResistCold */
     , (7097,  69,     0.8) /* ResistAcid */
...
VALUES (7097,   1, 0x020007CA) /* Setup */
     ...
     , (7097,   3, 0x20000015) /* SoundTable */
     , (7097,   4, 0x30000008) /* CombatTable */
     , (7097,   6, 0x04000F47) /* PaletteBase */
     , (7097,   7, 0x10000487) /* ClothingBase */
...
VALUES (7097,   1, 390, 0, 0) /* Strength */
     , (7097,   2, 380, 0, 0) /* Endurance */
     , (7097,   3, 250, 0, 0) /* Quickness */
     , (7097,   4, 330, 0, 0) /* Coordination */
     , (7097,   5, 350, 0, 0) /* Focus */
     , (7097,   6, 400, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (7097,   1,   310, 0, 0, 500) /* MaxHealth */
     , (7097,   3,   220, 0, 0, 600) /* MaxStamina */
     , (7097,   5,   200, 0, 0, 600) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (7097,  6, 0, 3, 0, 300, 0, 519.1480999684758) /* MeleeDefense        Specialized */
     , (7097,  7, 0, 3, 0, 429, 0, 519.1480999684758) /* MissileDefense      Specialized */
     , (7097, 13, 0, 3, 0, 275, 0, 519.1480999684758) /* UnarmedCombat       Specialized */
     , (7097, 14, 0, 3, 0, 300, 0, 519.1480999684758) /* ArcaneLore          Specialized */
     , (7097, 15, 0, 3, 0, 265, 0, 519.1480999684758) /* MagicDefense        Specialized */
     , (7097, 20, 0, 3, 0, 100, 0, 519.1480999684758) /* Deception           Specialized */
     , (7097, 22, 0, 3, 0,  10, 0, 519.1480999684758) /* Jump                Specialized */
     , (7097, 24, 0, 3, 0,  10, 0, 519.1480999684758) /* Run                 Specialized */
     , (7097, 31, 0, 3, 0, 190, 0, 519.1480999684758) /* CreatureEnchantment Specialized */
     , (7097, 33, 0, 3, 0, 190, 0, 519.1480999684758) /* LifeMagic           Specialized */
     , (7097, 34, 0, 3, 0, 190, 0, 519.1480999684758) /* WarMagic            Specialized */;
...
VALUES (7097,  1265,   2.01)  /* Drain Mana Other VI */
     , (7097,    69,  2.055)  /* Shock Wave VI */
...
VALUES (7097,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7097, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7097,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7097,  5 /* HeartBeat */,  0.001, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7097,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
