...
VALUES (7392,   1,         16) /* ItemType - Creature */
     ...
     , (7392,  93,    4197384) /* PhysicsState */
     , (7392, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (7392, 146,     100000) /* XpOverride */;
...
VALUES (7392,  6, 0, 3, 0, 213, 0, 528.713805414837) /* MeleeDefense        Specialized */
     , (7392,  7, 0, 3, 0, 350, 0, 528.713805414837) /* MissileDefense      Specialized */
     , (7392, 13, 0, 3, 0, 183, 0, 528.713805414837) /* UnarmedCombat       Specialized */
     , (7392, 14, 0, 3, 0, 200, 0, 528.713805414837) /* ArcaneLore          Specialized */
     , (7392, 15, 0, 3, 0, 200, 0, 528.713805414837) /* MagicDefense        Specialized */
     , (7392, 20, 0, 3, 0, 100, 0, 528.713805414837) /* Deception           Specialized */
     , (7392, 22, 0, 3, 0,  10, 0, 528.713805414837) /* Jump                Specialized */
     , (7392, 24, 0, 3, 0,  10, 0, 528.713805414837) /* Run                 Specialized */
     , (7392, 31, 0, 3, 0, 120, 0, 528.713805414837) /* CreatureEnchantment Specialized */
     , (7392, 33, 0, 3, 0, 120, 0, 528.713805414837) /* LifeMagic           Specialized */
     , (7392, 34, 0, 3, 0, 120, 0, 528.713805414837) /* WarMagic            Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7392,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7392,  5 /* HeartBeat */,      1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7392, 9,     0,  0, 0, 0, False) /* Create Unknown for ContainTreasure */
     , (7392, 9,     0,  0, 0, 0.5, False) /* Create Unknown for ContainTreasure */
     , (7392, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (7392, 9,  6354,  0, 0, 0.5, False) /* Create Pyreal Nugget for ContainTreasure */
     , (7392, 9,  7399,  0, 0, 1, False) /* Create Black Boulder for ContainTreasure */
     , (7392, 9, 24477,  0, 0, 0.05, False) /* Create Sturdy Steel Key for ContainTreasure */;
