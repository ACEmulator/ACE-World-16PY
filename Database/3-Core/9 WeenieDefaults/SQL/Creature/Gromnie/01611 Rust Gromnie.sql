...
VALUES (1611, 001 /* SETUP_DID */, 33554487)
     ...
     , (1611, 035 /* DEATH_TREASURE_TYPE_DID */, 459 /* Loot Tier: 1 */);
...
VALUES (1611, 9, 28203, 0, 0, 0.05, False) /* Create Ruddy Gromnie Hide for ContainTreasure_DestinationType */
     , (1611, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */
