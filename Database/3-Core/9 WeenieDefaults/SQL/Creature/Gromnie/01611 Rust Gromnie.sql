...
VALUES (1611,   1,         16) /* ItemType - Creature */
     ...
     , (1611,  93,       1032) /* PhysicsState */
     , (1611, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1611, 146,        213) /* XpOverride */;
...
VALUES (1611,  6, 0, 3, 0,  30, 0, 309.362684691686) /* MeleeDefense        Specialized */
     , (1611,  7, 0, 3, 0,  48, 0, 309.362684691686) /* MissileDefense      Specialized */
     , (1611, 13, 0, 3, 0,  20, 0, 309.362684691686) /* UnarmedCombat       Specialized */
     , (1611, 15, 0, 3, 0,  39, 0, 309.362684691686) /* MagicDefense        Specialized */
     , (1611, 20, 0, 3, 0,   5, 0, 309.362684691686) /* Deception           Specialized */
     , (1611, 22, 0, 3, 0,  40, 0, 309.362684691686) /* Jump                Specialized */
     , (1611, 24, 0, 3, 0,  40, 0, 309.362684691686) /* Run                 Specialized */;
...
VALUES (1611,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1611,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1611,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1611,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1611, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (1611, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (1611, 9, 28203,  0, 0, 0.05, False) /* Create Ruddy Gromnie Hide for ContainTreasure */
     , (1611, 9, 28209,  0, 0, 0.05, False) /* Create Rust Gromnie Tooth for ContainTreasure */;
