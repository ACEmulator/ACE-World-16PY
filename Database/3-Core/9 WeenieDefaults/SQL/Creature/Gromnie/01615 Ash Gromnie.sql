...
VALUES (1615,   1,         16) /* ItemType - Creature */
     ...
     , (1615,  93,       1032) /* PhysicsState */
     , (1615, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1615, 146,       2306) /* XpOverride */;
...
VALUES (1615,  6, 0, 3, 0,  54, 0, 309.515676341429) /* MeleeDefense        Specialized */
     , (1615,  7, 0, 3, 0, 108, 0, 309.515676341429) /* MissileDefense      Specialized */
     , (1615, 13, 0, 3, 0,  80, 0, 309.515676341429) /* UnarmedCombat       Specialized */
     , (1615, 15, 0, 3, 0,  62, 0, 309.515676341429) /* MagicDefense        Specialized */
     , (1615, 20, 0, 3, 0,  50, 0, 309.515676341429) /* Deception           Specialized */
     , (1615, 22, 0, 3, 0,  40, 0, 309.515676341429) /* Jump                Specialized */
     , (1615, 24, 0, 3, 0,  20, 0, 309.515676341429) /* Run                 Specialized */;
...
VALUES (1615,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1615,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1615,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1615,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1615, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (1615, 9,     0,  0, 0, 0.99, False) /* Create Unknown for ContainTreasure */
     , (1615, 9,  3674,  0, 0, 0.05, False) /* Create Ash Gromnie Tooth for ContainTreasure */
     , (1615, 9,  6876,  0, 0, 0.01, False) /* Create Sturdy Iron Key for ContainTreasure */;
