...
VALUES (1210, 'mercenary', 10 /* Creature_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1210, 001 /* NAME_STRING */, 'Mercenary')
     , (1210, 003 /* SEX_STRING */, 'Male')
     , (1210, 004 /* HERITAGE_GROUP_STRING */, 'Aluvian');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1210, 001 /* SETUP_DID */, 33554433)
     , (1210, 002 /* MOTION_TABLE_DID */, 150994945)
     , (1210, 003 /* SOUND_TABLE_DID */, 536870913)
     , (1210, 004 /* COMBAT_TABLE_DID */, 805306368)
     , (1210, 008 /* ICON_DID */, 100667446)
     , (1210, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415236)
     , (1210, 032 /* WIELDED_TREASURE_TYPE_DID */, 433)
     ...
     /* Wield  Koujia Breastplate (6003) | Palette: RED_PALETTE_TEMPLATE (14)  | Chance: 33% */
     /* Wield  Koujia Breastplate (6003) | Palette: GREEN_PALETTE_TEMPLATE (8)  | Chance: 34% */
     /* Wield  Koujia Breastplate (6003) | Palette: BLUE_PALETTE_TEMPLATE (2)  | Chance: 33% */
     /* Wield  Koujia Sleeves (6005) | Palette: RED_PALETTE_TEMPLATE (14)  | Chance: 33% */
     /* Wield  Koujia Sleeves (6005) | Palette: GREEN_PALETTE_TEMPLATE (8)  | Chance: 34% */
     /* Wield  Koujia Sleeves (6005) | Palette: BLUE_PALETTE_TEMPLATE (2)  | Chance: 33% */
     /* Wield  Koujia Leggings (6004) | Palette: RED_PALETTE_TEMPLATE (14)  | Chance: 33% */
     /* Wield  Koujia Leggings (6004) | Palette: GREEN_PALETTE_TEMPLATE (8)  | Chance: 34% */
     /* Wield  Koujia Leggings (6004) | Palette: BLUE_PALETTE_TEMPLATE (2)  | Chance: 33% */
     ...
     /* Wield  Yaoji (23710)   | Chance: 15% */
     /* Wield  Fire Tachi (23707)   | Chance: 15% */
     /* Wield  Dagger (23669)   | Chance: 10% */
     /* Wield  Jambiya (22780)   | Chance: 10% */
     /* Wield  Khanjar (22783)   | Chance: 10% */
     /* Wield  Shield of the Simulacra (12155)   | Chance: 100% */
     , (1210, 035 /* DEATH_TREASURE_TYPE_DID */, 452 /* Loot Tier: 5 */);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1210, 001 /* ITEM_TYPE_INT */, 16 /* TYPE_CREATURE */)
     , (1210, 002 /* CREATURE_TYPE_INT */, 31 /* Human_CreatureType */)
     , (1210, 006 /* ITEMS_CAPACITY_INT */, -1)
     , (1210, 007 /* CONTAINERS_CAPACITY_INT */, -1)
     , (1210, 008 /* MASS_INT */, 120)
     , (1210, 016 /* ITEM_USEABLE_INT */, 1 /* USEABLE_NO */)
     , (1210, 025 /* LEVEL_INT */, 115)
     , (1210, 027 /* ARMOR_TYPE_INT */, 0)
     , (1210, 040 /* COMBAT_MODE_INT */, 2 /* MELEE_COMBAT_MODE */)
     , (1210, 068 /* TARGETING_TACTIC_INT */, 13)
     , (1210, 093 /* PHYSICS_STATE_INT */, 1032 /* REPORT_COLLISIONS_PS, GRAVITY_PS */)
     , (1210, 101 /* AI_ALLOWED_COMBAT_STYLE_INT */, 131 /* Unarmed_CombatStyle, OneHanded_CombatStyle, ThrownWeapon_CombatStyle */)
     , (1210, 133 /* SHOWABLE_ON_RADAR_INT */, 2 /* ShowMovement_RadarEnum */)
     , (1210, 146 /* XP_OVERRIDE_INT */, 24650);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (1210, 001 /* HEARTBEAT_INTERVAL_FLOAT */, 5)
     , (1210, 002 /* HEARTBEAT_TIMESTAMP_FLOAT */, 0)
     , (1210, 003 /* HEALTH_RATE_FLOAT */, 0.16)
     , (1210, 004 /* STAMINA_RATE_FLOAT */, 2.5)
     , (1210, 005 /* MANA_RATE_FLOAT */, 1)
     , (1210, 013 /* ARMOR_MOD_VS_SLASH_FLOAT */, 0.9)
     , (1210, 014 /* ARMOR_MOD_VS_PIERCE_FLOAT */, 1)
     , (1210, 015 /* ARMOR_MOD_VS_BLUDGEON_FLOAT */, 1.1)
     , (1210, 016 /* ARMOR_MOD_VS_COLD_FLOAT */, 0.4)
     , (1210, 017 /* ARMOR_MOD_VS_FIRE_FLOAT */, 0.4)
     , (1210, 018 /* ARMOR_MOD_VS_ACID_FLOAT */, 1)
     , (1210, 019 /* ARMOR_MOD_VS_ELECTRIC_FLOAT */, 0.6)
     , (1210, 031 /* VISUAL_AWARENESS_RANGE_FLOAT */, 30)
     , (1210, 064 /* RESIST_SLASH_FLOAT */, 0.35)
     , (1210, 065 /* RESIST_PIERCE_FLOAT */, 0.35)
     , (1210, 066 /* RESIST_BLUDGEON_FLOAT */, 0.35)
     , (1210, 067 /* RESIST_FIRE_FLOAT */, 0.35)
     , (1210, 068 /* RESIST_COLD_FLOAT */, 0.35)
     , (1210, 069 /* RESIST_ACID_FLOAT */, 0.35)
     , (1210, 070 /* RESIST_ELECTRIC_FLOAT */, 0.35)
     , (1210, 071 /* RESIST_HEALTH_BOOST_FLOAT */, 1)
     , (1210, 072 /* RESIST_STAMINA_DRAIN_FLOAT */, 1)
     , (1210, 073 /* RESIST_STAMINA_BOOST_FLOAT */, 1)
     , (1210, 074 /* RESIST_MANA_DRAIN_FLOAT */, 1)
     , (1210, 075 /* RESIST_MANA_BOOST_FLOAT */, 1)
     , (1210, 104 /* OBVIOUS_RADAR_RANGE_FLOAT */, 10)
     , (1210, 117 /* FOCUSED_PROBABILITY_FLOAT */, 0.5)
     , (1210, 125 /* RESIST_HEALTH_DRAIN_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1210, 001 /* STUCK_BOOL */, True)
     , (1210, 011 /* IGNORE_COLLISIONS_BOOL */, False)
     , (1210, 012 /* REPORT_COLLISIONS_BOOL */, True)
     , (1210, 013 /* ETHEREAL_BOOL */, False);
...
VALUES (1210, 2, 25557, 0, 0, 0, False) /* Create Eye Patch for Wield_DestinationType */
     ...
     , (1210, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 5 for ContainTreasure_DestinationType */
...
VALUES (1210, 2, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 160, 0, 298.956752857342) /* BOW_SKILL */
     , (1210, 3, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 160, 0, 298.956752857342) /* CROSSBOW_SKILL */
     , (1210, 4, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 0, 0, 298.956752857342) /* DAGGER_SKILL */
     , (1210, 6, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 275, 0, 298.956752857342) /* MELEE_DEFENSE_SKILL */
     , (1210, 7, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 400, 0, 298.956752857342) /* MISSILE_DEFENSE_SKILL */
     , (1210, 11, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 270, 0, 298.956752857342) /* SWORD_SKILL */
     , (1210, 12, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 160, 0, 298.956752857342) /* THROWN_WEAPON_SKILL */
     , (1210, 14, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 250, 0, 298.956752857342) /* ARCANE_LORE_SKILL */
     , (1210, 15, 0, 3 /* SPECIALIZED_SKILL_ADVANCEMENT_CLASS */, 0, 300, 0, 298.956752857342) /* MAGIC_DEFENSE_SKILL */;
