...
VALUES (10938,   1, 0x02000001) /* Setup */
     ...
     , (10938,  32,        427) /* WieldedTreasureType - 
                                   ...
                                   # Set: 3
                                   | 100.00% chance of Scored Amuli Coat (23782)
                                   # Set: 4
                                   | 100.00% chance of Plated Amuli Leggings (23789)
                                   # Set: 5
                                   | 100.00% chance of Imbued Helm of the Simulacra (12139)
                                   # Set: 6
                                   | 100.00% chance of Platemail Gauntlets (57) | Palette: Grey (9)
                                   # Set: 7
                                   | 100.00% chance of Sollerets (107) | Palette: Black (39)
                                   # Set: 8
                                   |  20.00% chance of Yumi (23734)
                                   |         with
                                   |            100.00% chance of 50x Deadly Lightning Arrow (15434)
                                   |  20.00% chance of Yumi (23734)
                                   |         with
                                   |            100.00% chance of 50x Deadly Acid Arrow (15430)
                                   |  20.00% chance of Yumi (23734)
                                   |         with
                                   |            100.00% chance of 50x Deadly Armor Piercing Arrow (15431)
                                   |  20.00% chance of Yumi (23734)
                                   |         with
                                   |            100.00% chance of 50x Deadly Frost Arrow (15437)
                                   |   5.00% chance of Weeping Bow (24199)
                                   |         with
                                   |            100.00% chance of 50x Deadly Lightning Arrow (15434)
                                   |   5.00% chance of Weeping Bow (24199)
                                   |         with
                                   ...
                                   |            100.00% chance of 50x Deadly Frost Arrow (15437)
                                   # Set: 9
                                   | 100.00% chance of Crescent Moons (24028)
                                   # Set: 10
...
VALUES (10938,  2, 0, 3, 0, 200, 0, 705.4965943564291) /* Bow                 Specialized */
     , (10938,  6, 0, 3, 0, 300, 0, 705.4965943564291) /* MeleeDefense        Specialized */
     , (10938,  7, 0, 3, 0, 400, 0, 705.4965943564291) /* MissileDefense      Specialized */
     , (10938, 13, 0, 3, 0, 200, 0, 705.4965943564291) /* UnarmedCombat       Specialized */
     , (10938, 14, 0, 3, 0, 250, 0, 705.4965943564291) /* ArcaneLore          Specialized */
     , (10938, 15, 0, 3, 0, 300, 0, 705.4965943564291) /* MagicDefense        Specialized */
     , (10938, 20, 0, 3, 0, 150, 0, 705.4965943564291) /* Deception           Specialized */
     , (10938, 24, 0, 3, 0,  20, 0, 705.4965943564291) /* Run                 Specialized */;
