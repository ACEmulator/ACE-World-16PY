...
DELETE FROM ace_weenie_class WHERE weenieClassId = 29042;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (29042, 'npcmizjiqoraidstopgap');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (29042, 0, 29042);
...
VALUES (29042, 1, 16) /* ITEM_TYPE_INT */
     ...
     , (29042, 9007, 10) /* Creature_WeenieType */;
...
VALUES (29042, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (29042, 8, 75) /* QUICKNESS_ATTRIBUTE */
     , (29042, 16, 400) /* FOCUS_ATTRIBUTE */
     , (29042, 32, 400) /* SELF_ATTRIBUTE */;

INSERT INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (29042, 64, 10) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (29042, 128, 10) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (29042, 256, 10) /* MAX_MANA_ATTRIBUTE_2ND */;
