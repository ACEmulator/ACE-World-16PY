...
VALUES (7182,   1, 0x02000992) /* Setup */
     , (7182,   2, 0x090000A0) /* MotionTable */
     , (7182,   3, 0x2000006A) /* SoundTable */
     , (7182,   4, 0x30000023) /* CombatTable */
     , (7182,   6, 0x04000FA8) /* PaletteBase */
     , (7182,   7, 0x10000276) /* ClothingBase */
     , (7182,   8, 0x06001ED1) /* Icon */
     , (7182,  22, 0x34000069) /* PhysicsEffectTable */
...
VALUES (7182,  1, 0, 3, 0,  90, 0, 522.4006260859366) /* Axe                 Specialized */
     , (7182,  5, 0, 3, 0,  90, 0, 522.4006260859366) /* Mace                Specialized */
     , (7182,  6, 0, 3, 0,  90, 0, 522.4006260859366) /* MeleeDefense        Specialized */
     , (7182,  7, 0, 3, 0,  90, 0, 522.4006260859366) /* MissileDefense      Specialized */
     , (7182,  9, 0, 3, 0,  90, 0, 522.4006260859366) /* Spear               Specialized */
     , (7182, 10, 0, 3, 0,  90, 0, 522.4006260859366) /* Staff               Specialized */
     , (7182, 11, 0, 3, 0,  90, 0, 522.4006260859366) /* Sword               Specialized */
     , (7182, 12, 0, 3, 0,  20, 0, 522.4006260859366) /* ThrownWeapon        Specialized */
     , (7182, 13, 0, 3, 0,  90, 0, 522.4006260859366) /* UnarmedCombat       Specialized */
     , (7182, 15, 0, 3, 0,  80, 0, 522.4006260859366) /* MagicDefense        Specialized */
     , (7182, 20, 0, 2, 0,  40, 0, 522.4006260859366) /* Deception           Trained */
     , (7182, 22, 0, 2, 0,  40, 0, 522.4006260859366) /* Jump                Trained */
     , (7182, 24, 0, 2, 0,  40, 0, 522.4006260859366) /* Run                 Trained */;
...
VALUES (7182,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7182,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7182,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7182,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7182,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7182,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7182,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
