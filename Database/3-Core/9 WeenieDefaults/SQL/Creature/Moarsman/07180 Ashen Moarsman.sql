...
VALUES (7180, 001 /* SETUP_DID */, 33556882)
     ...
     , (7180, 035 /* DEATH_TREASURE_TYPE_DID */, 463 /* Loot Tier: 2 */);
...
VALUES (7180, 9, 25561, 0, 0, 0.05, False) /* Create Moarsman Head for ContainTreasure_DestinationType */
     , (7180, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
