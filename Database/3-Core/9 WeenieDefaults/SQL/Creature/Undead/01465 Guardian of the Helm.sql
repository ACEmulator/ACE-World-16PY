...
VALUES (1465, 'undeadflaminghelm', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (1465,   1, 120, 0, 0) /* Strength */
     , (1465,   2, 125, 0, 0) /* Endurance */
     , (1465,   3,  90, 0, 0) /* Quickness */
     , (1465,   4,  95, 0, 0) /* Coordination */
     , (1465,   5, 120, 0, 0) /* Focus */
     , (1465,   6, 120, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1465,   1,    50, 0, 0, 113) /* MaxHealth */
     , (1465,   3,   150, 0, 0, 275) /* MaxStamina */
     , (1465,   5,   150, 0, 0, 270) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1465,  1, 0, 2, 0, 120, 0, 306.295762996415) /* Axe                 Trained */
     , (1465,  2, 0, 2, 0, 120, 0, 306.295762996415) /* Bow                 Trained */
     , (1465,  3, 0, 3, 0, 100, 0, 306.295762996415) /* Crossbow            Specialized */
     , (1465,  4, 0, 2, 0, 120, 0, 306.295762996415) /* Dagger              Trained */
     , (1465,  5, 0, 2, 0, 120, 0, 306.295762996415) /* Mace                Trained */
     , (1465,  6, 0, 3, 0, 120, 0, 306.295762996415) /* MeleeDefense        Specialized */
     , (1465,  7, 0, 2, 0, 100, 0, 306.295762996415) /* MissileDefense      Trained */
     , (1465,  9, 0, 2, 0, 100, 0, 306.295762996415) /* Spear               Trained */
     , (1465, 10, 0, 3, 0, 120, 0, 306.295762996415) /* Staff               Specialized */
     , (1465, 11, 0, 3, 0, 120, 0, 306.295762996415) /* Sword               Specialized */
     , (1465, 13, 0, 2, 0, 100, 0, 306.295762996415) /* UnarmedCombat       Trained */
     , (1465, 14, 0, 3, 0, 150, 0, 306.295762996415) /* ArcaneLore          Specialized */
     , (1465, 15, 0, 3, 0, 125, 0, 306.295762996415) /* MagicDefense        Specialized */
     , (1465, 20, 0, 2, 0,  55, 0, 306.295762996415) /* Deception           Trained */
     , (1465, 31, 0, 2, 0, 150, 0, 306.295762996415) /* CreatureEnchantment Trained */
     , (1465, 33, 0, 2, 0, 150, 0, 306.295762996415) /* LifeMagic           Trained */
     , (1465, 34, 0, 2, 0, 150, 0, 306.295762996415) /* WarMagic            Trained */;
...
VALUES (1465,  1252,   2.02)  /* Drain Stamina Other IV */
