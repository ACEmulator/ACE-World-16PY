...
VALUES (8122, 001 /* SETUP_DID */, 33554839)
     ...
     , (8122, 035 /* DEATH_TREASURE_TYPE_DID */, 451 /* Loot Tier: 2 */);
...
VALUES (8122, 10, 7973, 0, 0, 1, False) /* Create Flaming Tachi for WieldTreasure_DestinationType */
     ...
     , (8122, 9, 0, 0, 0, 0, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
