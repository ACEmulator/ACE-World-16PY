...
VALUES (9255, 001 /* SETUP_DID */, 33554433)
     ...
     , (9255, 035 /* DEATH_TREASURE_TYPE_DID */, 462 /* Loot Tier: 3 */);
...
VALUES (9255, 9, 9312, 0, 0, 0.04, False) /* Create A Small Mnemosyne for ContainTreasure_DestinationType */
     , (9255, 9, 0, 0, 0, 0.96, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure_DestinationType */;
