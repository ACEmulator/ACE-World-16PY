...
VALUES (7118, 001 /* SETUP_DID */, 33554433)
     ...
     , (7118, 035 /* DEATH_TREASURE_TYPE_DID */, 460 /* Loot Tier: 4 */);
...
VALUES (7118, 9, 6876, 0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (7118, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 4 for ContainTreasure_DestinationType */;
