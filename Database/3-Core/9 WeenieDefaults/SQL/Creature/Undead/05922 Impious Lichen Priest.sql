...
VALUES (5922, 001 /* SETUP_DID */, 33554839)
     ...
     , (5922, 035 /* DEATH_TREASURE_TYPE_DID */, 451 /* Loot Tier: 2 */);
...
VALUES (5922, 9, 5873, 0, 0, 0.01, False) /* Create Seal for ContainTreasure_DestinationType */
     , (5922, 9, 0, 0, 0, 0.99, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */
     ...
     , (5922, 9, 0, 0, 0, 0, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
