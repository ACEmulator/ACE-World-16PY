...
VALUES (1763, 001 /* SETUP_DID */, 33554433)
     ...
     , (1763, 035 /* DEATH_TREASURE_TYPE_DID */, 465 /* Loot Tier: 1 */);
...
VALUES (1763, 9, 9314, 0, 0, 0.03, False) /* Create A Tiny Mnemosyne for ContainTreasure_DestinationType */
     , (1763, 9, 0, 0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
