...
VALUES (1763,   1,         16) /* ItemType - Creature */
     ...
     , (1763,  93,       1032) /* PhysicsState */
     , (1763, 101,        183) /* AiAllowedCombatStyle */
     , (1763, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1763, 140,          1) /* AiOptions */
     , (1763, 146,        746) /* XpOverride */;
...
VALUES (1763,   1, 100, 0, 0) /* Strength */
     , (1763,   2,  90, 0, 0) /* Endurance */
     , (1763,   3,  60, 0, 0) /* Quickness */
     , (1763,   4,  60, 0, 0) /* Coordination */
     , (1763,   5,  55, 0, 0) /* Focus */
     , (1763,   6,  55, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1763,   1,    20, 0, 0, 65) /* MaxHealth */
     , (1763,   3,   200, 0, 0, 290) /* MaxStamina */
     , (1763,   5,     0, 0, 0, 55) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1763,  1, 0, 3, 0,  90, 0, 313.644941533544) /* Axe                 Specialized */
     , (1763,  2, 0, 3, 0,  80, 0, 313.644941533544) /* Bow                 Specialized */
     , (1763,  3, 0, 3, 0,  80, 0, 313.644941533544) /* Crossbow            Specialized */
     , (1763,  4, 0, 3, 0,  90, 0, 313.644941533544) /* Dagger              Specialized */
     , (1763,  5, 0, 3, 0,  90, 0, 313.644941533544) /* Mace                Specialized */
     , (1763,  6, 0, 3, 0,  50, 0, 313.644941533544) /* MeleeDefense        Specialized */
     , (1763,  7, 0, 3, 0,  68, 0, 313.644941533544) /* MissileDefense      Specialized */
     , (1763,  9, 0, 3, 0,  90, 0, 313.644941533544) /* Spear               Specialized */
     , (1763, 10, 0, 3, 0,  90, 0, 313.644941533544) /* Staff               Specialized */
     , (1763, 11, 0, 3, 0,  90, 0, 313.644941533544) /* Sword               Specialized */
     , (1763, 13, 0, 3, 0,  90, 0, 313.644941533544) /* UnarmedCombat       Specialized */
     , (1763, 14, 0, 2, 0, 200, 0, 313.644941533544) /* ArcaneLore          Trained */
     , (1763, 15, 0, 3, 0,  73, 0, 313.644941533544) /* MagicDefense        Specialized */
     , (1763, 20, 0, 2, 0,  90, 0, 313.644941533544) /* Deception           Trained */
     , (1763, 31, 0, 3, 0,  54, 0, 313.644941533544) /* CreatureEnchantment Specialized */
     , (1763, 33, 0, 3, 0,  54, 0, 313.644941533544) /* LifeMagic           Specialized */
     , (1763, 34, 0, 3, 0,  54, 0, 313.644941533544) /* WarMagic            Specialized */;
...
VALUES (1763,  5 /* HeartBeat */,  0.015, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1763,  5 /* HeartBeat */,   0.04, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1763,  5 /* HeartBeat */,  0.055, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1763,  5 /* HeartBeat */,   0.15, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1763, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (1763, 9,  9314,  0, 0, 0.03, False) /* Create A Tiny Mnemosyne for ContainTreasure */;
