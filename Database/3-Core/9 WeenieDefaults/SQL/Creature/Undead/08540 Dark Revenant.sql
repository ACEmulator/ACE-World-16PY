...
VALUES (8540, 001 /* SETUP_DID */, 33554839)
     ...
     , (8540, 035 /* DEATH_TREASURE_TYPE_DID */, 183 /* Loot Tier: 5 */);
...
VALUES (8540, 9, 6876, 0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure_DestinationType */
     , (8540, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 5 for ContainTreasure_DestinationType */;
