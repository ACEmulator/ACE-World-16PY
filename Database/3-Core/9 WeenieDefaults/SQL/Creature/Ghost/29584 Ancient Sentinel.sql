...
VALUES (29584,  6, 0, 3, 0, 273, 0, 2157.6273011590656) /* MeleeDefense        Specialized */
     , (29584,  7, 0, 3, 0, 364, 0, 2157.6273011590656) /* MissileDefense      Specialized */
     , (29584, 13, 0, 3, 0, 272, 0, 2157.6273011590656) /* UnarmedCombat       Specialized */
     , (29584, 14, 0, 3, 0, 300, 0, 2157.6273011590656) /* ArcaneLore          Specialized */
     , (29584, 15, 0, 3, 0, 163, 0, 2157.6273011590656) /* MagicDefense        Specialized */
     , (29584, 20, 0, 3, 0, 250, 0, 2157.6273011590656) /* Deception           Specialized */
     , (29584, 24, 0, 3, 0,  90, 0, 2157.6273011590656) /* Run                 Specialized */
     , (29584, 31, 0, 3, 0, 100, 0, 2157.6273011590656) /* CreatureEnchantment Specialized */
     , (29584, 33, 0, 3, 0, 100, 0, 2157.6273011590656) /* LifeMagic           Specialized */
     , (29584, 34, 0, 3, 0, 100, 0, 2157.6273011590656) /* WarMagic            Specialized */;
...
VALUES (29584,  1326,   2.04)  /* Imperil Other V */
     ...
     , (29584,    96,   2.05)  /* Whirling Blade V */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29584,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29584,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29584,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29584,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29584,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29584,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
