...
VALUES (29583,  16, 0x700F2003) /* ActivationTarget */;
...
VALUES (29583,  6, 0, 3, 0, 370, 0, 2157.4846274642055) /* MeleeDefense        Specialized */
     , (29583,  7, 0, 3, 0, 460, 0, 2157.4846274642055) /* MissileDefense      Specialized */
     , (29583, 13, 0, 3, 0, 353, 0, 2157.4846274642055) /* UnarmedCombat       Specialized */
     , (29583, 14, 0, 3, 0, 300, 0, 2157.4846274642055) /* ArcaneLore          Specialized */
     , (29583, 15, 0, 3, 0, 284, 0, 2157.4846274642055) /* MagicDefense        Specialized */
     , (29583, 20, 0, 3, 0, 250, 0, 2157.4846274642055) /* Deception           Specialized */
     , (29583, 24, 0, 3, 0,  90, 0, 2157.4846274642055) /* Run                 Specialized */
     , (29583, 31, 0, 3, 0, 255, 0, 2157.4846274642055) /* CreatureEnchantment Specialized */
     , (29583, 33, 0, 3, 0, 255, 0, 2157.4846274642055) /* LifeMagic           Specialized */
     , (29583, 34, 0, 3, 0, 255, 0, 2157.4846274642055) /* WarMagic            Specialized */;
...
VALUES (29583,   897,   2.02)  /* Healing Ineptitude Other VI */
     ...
     , (29583,    97,   2.05)  /* Whirling Blade VI */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29583,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29583,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29583,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29583,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29583,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29583,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
