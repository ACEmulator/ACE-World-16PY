...
VALUES (5595,  1, 0, 3, 0,   5, 0, 432.91977126602785) /* Axe                 Specialized */
     , (5595,  4, 0, 3, 0,   5, 0, 432.91977126602785) /* Dagger              Specialized */
     , (5595,  5, 0, 3, 0,   5, 0, 432.91977126602785) /* Mace                Specialized */
     , (5595,  6, 0, 3, 0,   5, 0, 432.91977126602785) /* MeleeDefense        Specialized */
     , (5595,  7, 0, 3, 0,  15, 0, 432.91977126602785) /* MissileDefense      Specialized */
     , (5595,  9, 0, 3, 0,   5, 0, 432.91977126602785) /* Spear               Specialized */
     , (5595, 10, 0, 3, 0,   5, 0, 432.91977126602785) /* Staff               Specialized */
     , (5595, 11, 0, 3, 0,   5, 0, 432.91977126602785) /* Sword               Specialized */
     , (5595, 13, 0, 3, 0,   5, 0, 432.91977126602785) /* UnarmedCombat       Specialized */
     , (5595, 15, 0, 3, 0,   5, 0, 432.91977126602785) /* MagicDefense        Specialized */
     , (5595, 24, 0, 2, 0,  40, 0, 432.91977126602785) /* Run                 Trained */;
...
VALUES (5595,  5 /* HeartBeat */,    0.8, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5595,  5 /* HeartBeat */,      1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5595,  5 /* HeartBeat */,    0.8, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5595,  5 /* HeartBeat */,      1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5595,  5 /* HeartBeat */,    0.8, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5595,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
