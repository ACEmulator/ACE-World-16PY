...
VALUES (1322,   1,         16) /* ItemType - Creature */
     ...
     , (1322,  68,          5) /* TargetingTactic */
     , (1322,  93,       1032) /* PhysicsState */
     , (1322, 101,        131) /* AiAllowedCombatStyle */
     , (1322, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1322, 146,         21) /* XpOverride */;
...
VALUES (1322,   1,       5) /* HeartbeatInterval */
     ...
     , (1322,   3,   0.067) /* HealthRate */
     , (1322,   4,       5) /* StaminaRate */
     , (1322,   5,       1) /* ManaRate */
     , (1322,  12,       1) /* Shade */
     , (1322,  13,     0.9) /* ArmorModVsSlash */
     , (1322,  14,       1) /* ArmorModVsPierce */
     , (1322,  15,     1.1) /* ArmorModVsBludgeon */
     , (1322,  16,     0.6) /* ArmorModVsCold */
     , (1322,  17,     0.6) /* ArmorModVsFire */
     , (1322,  18,       1) /* ArmorModVsAcid */
     , (1322,  19,     0.6) /* ArmorModVsElectric */
     , (1322,  31,      20) /* VisualAwarenessRange */
     , (1322,  34,       1) /* PowerupTime */
     , (1322,  36,       1) /* ChargeSpeed */
     , (1322,  39,     1.2) /* DefaultScale */
     , (1322,  64,    0.86) /* ResistSlash */
     , (1322,  65,    0.75) /* ResistPierce */
     , (1322,  66,    0.66) /* ResistBludgeon */
     , (1322,  67,    1.42) /* ResistFire */
     , (1322,  68,    1.42) /* ResistCold */
     , (1322,  69,    0.75) /* ResistAcid */
     , (1322,  70,    1.42) /* ResistElectric */
...
VALUES (1322,   1, 'Drudge Sneaker') /* Name */;
...
VALUES (1322,   1,   33556445) /* Setup */
     ...
     , (1322,  35,         83) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (1322,   1,  30, 0, 0) /* Strength */
     , (1322,   2,  35, 0, 0) /* Endurance */
     , (1322,   3,  35, 0, 0) /* Quickness */
     , (1322,   4,  50, 0, 0) /* Coordination */
     , (1322,   5,  30, 0, 0) /* Focus */
     , (1322,   6,  15, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1322,   1,     0, 0, 0, 18) /* MaxHealth */
     , (1322,   3,    50, 0, 0, 85) /* MaxStamina */
     , (1322,   5,     0, 0, 0, 15) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1322,  6, 0, 2, 0,  15, 0, 301.880599986804) /* MeleeDefense        Trained */
     , (1322,  7, 0, 2, 0,  15, 0, 301.880599986804) /* MissileDefense      Trained */
     , (1322, 13, 0, 2, 0,  15, 0, 301.880599986804) /* UnarmedCombat       Trained */
     , (1322, 15, 0, 2, 0,   5, 0, 301.880599986804) /* MagicDefense        Trained */
     , (1322, 24, 0, 2, 0,  40, 0, 301.880599986804) /* Run                 Trained */;
...
VALUES (1322,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (1322, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1322,  5 /* HeartBeat */,  0.045, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1322,  5 /* HeartBeat */,   0.09, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1322,  5 /* HeartBeat */,   0.19, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1322,  5 /* HeartBeat */,    0.2, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1322,  5 /* HeartBeat */,    0.1, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1322, 1,  1319,  0, 0, 0, False) /* Create Key for Contain */;
