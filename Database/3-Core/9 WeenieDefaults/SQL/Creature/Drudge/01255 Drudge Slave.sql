...
VALUES (1255,   1,         16) /* ItemType - Creature */
     ...
     , (1255,  93,       1032) /* PhysicsState */
     , (1255, 101,        131) /* AiAllowedCombatStyle */
     , (1255, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1255, 140,          1) /* AiOptions */
     , (1255, 146,       1137) /* XpOverride */;
...
VALUES (1255,   1, 'Drudge Slave') /* Name */;
...
VALUES (1255,  1, 0, 3, 0,  55, 0, 300.223273974913) /* Axe                 Specialized */
     , (1255,  4, 0, 3, 0,  40, 0, 300.223273974913) /* Dagger              Specialized */
     , (1255,  5, 0, 3, 0,  55, 0, 300.223273974913) /* Mace                Specialized */
     , (1255,  6, 0, 3, 0,  43, 0, 300.223273974913) /* MeleeDefense        Specialized */
     , (1255,  7, 0, 3, 0, 100, 0, 300.223273974913) /* MissileDefense      Specialized */
     , (1255,  9, 0, 3, 0,  55, 0, 300.223273974913) /* Spear               Specialized */
     , (1255, 10, 0, 3, 0,  55, 0, 300.223273974913) /* Staff               Specialized */
     , (1255, 11, 0, 3, 0,  55, 0, 300.223273974913) /* Sword               Specialized */
     , (1255, 13, 0, 3, 0,  55, 0, 300.223273974913) /* UnarmedCombat       Specialized */
     , (1255, 15, 0, 3, 0,  65, 0, 300.223273974913) /* MagicDefense        Specialized */
     , (1255, 20, 0, 3, 0,  50, 0, 300.223273974913) /* Deception           Specialized */
     , (1255, 24, 0, 3, 0,  55, 0, 300.223273974913) /* Run                 Specialized */;
...
VALUES (1255,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,   0.07, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,  0.095, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,   0.07, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,  0.095, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1255,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1255, 9,     0,  0, 0, 0, False) /* Create Unknown for ContainTreasure */
     , (1255, 9,  1265,  0, 0, 1, False) /* Create Key for ContainTreasure */;
