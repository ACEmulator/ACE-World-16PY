...
VALUES (7337,   1, 0x020007DD) /* Setup */
     , (7337,   2, 0x09000008) /* MotionTable */
     , (7337,   3, 0x20000007) /* SoundTable */
     , (7337,   4, 0x30000004) /* CombatTable */
     , (7337,   6, 0x04000F6C) /* PaletteBase */
     , (7337,   7, 0x10000203) /* ClothingBase */
     , (7337,   8, 0x06001035) /* Icon */
     , (7337,  22, 0x3400001A) /* PhysicsEffectTable */
...
VALUES (7337,  1, 0, 3, 0, 275, 0, 526.6415680007038) /* Axe                 Specialized */
     , (7337,  4, 0, 3, 0, 275, 0, 526.6415680007038) /* Dagger              Specialized */
     , (7337,  5, 0, 3, 0, 275, 0, 526.6415680007038) /* Mace                Specialized */
     , (7337,  6, 0, 3, 0, 280, 0, 526.6415680007038) /* MeleeDefense        Specialized */
     , (7337,  7, 0, 3, 0, 370, 0, 526.6415680007038) /* MissileDefense      Specialized */
     , (7337,  9, 0, 3, 0, 275, 0, 526.6415680007038) /* Spear               Specialized */
     , (7337, 10, 0, 3, 0, 275, 0, 526.6415680007038) /* Staff               Specialized */
     , (7337, 11, 0, 3, 0, 275, 0, 526.6415680007038) /* Sword               Specialized */
     , (7337, 13, 0, 3, 0, 275, 0, 526.6415680007038) /* UnarmedCombat       Specialized */
     , (7337, 14, 0, 2, 0, 350, 0, 526.6415680007038) /* ArcaneLore          Trained */
     , (7337, 15, 0, 3, 0, 249, 0, 526.6415680007038) /* MagicDefense        Specialized */
     , (7337, 20, 0, 2, 0, 120, 0, 526.6415680007038) /* Deception           Trained */
     , (7337, 24, 0, 2, 0,  55, 0, 526.6415680007038) /* Run                 Trained */
     , (7337, 31, 0, 3, 0, 100, 0, 526.6415680007038) /* CreatureEnchantment Specialized */
     , (7337, 33, 0, 3, 0, 100, 0, 526.6415680007038) /* LifeMagic           Specialized */
     , (7337, 34, 0, 3, 0, 100, 0, 526.6415680007038) /* WarMagic            Specialized */;
...
VALUES (7337,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,   0.07, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7337,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
