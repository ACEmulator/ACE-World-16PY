...
VALUES (5596,   1, 0x020007DD) /* Setup */
     , (5596,   2, 0x09000008) /* MotionTable */
     , (5596,   3, 0x20000007) /* SoundTable */
     , (5596,   4, 0x30000004) /* CombatTable */
     , (5596,   6, 0x04000F6C) /* PaletteBase */
     , (5596,   7, 0x10000204) /* ClothingBase */
     , (5596,   8, 0x06001035) /* Icon */
     , (5596,  22, 0x3400001A) /* PhysicsEffectTable */
...
VALUES (5596,  1, 0, 3, 0,  20, 0, 432.9762761816089) /* Axe                 Specialized */
     , (5596,  4, 0, 3, 0,  20, 0, 432.9762761816089) /* Dagger              Specialized */
     , (5596,  5, 0, 3, 0,  20, 0, 432.9762761816089) /* Mace                Specialized */
     , (5596,  6, 0, 3, 0,  28, 0, 432.9762761816089) /* MeleeDefense        Specialized */
     , (5596,  7, 0, 3, 0,  20, 0, 432.9762761816089) /* MissileDefense      Specialized */
     , (5596,  9, 0, 3, 0,  20, 0, 432.9762761816089) /* Spear               Specialized */
     , (5596, 10, 0, 3, 0,  20, 0, 432.9762761816089) /* Staff               Specialized */
     , (5596, 11, 0, 3, 0,  20, 0, 432.9762761816089) /* Sword               Specialized */
     , (5596, 13, 0, 3, 0,  20, 0, 432.9762761816089) /* UnarmedCombat       Specialized */
     , (5596, 15, 0, 3, 0,   8, 0, 432.9762761816089) /* MagicDefense        Specialized */
     , (5596, 20, 0, 2, 0,  15, 0, 432.9762761816089) /* Deception           Trained */
     , (5596, 24, 0, 2, 0,  40, 0, 432.9762761816089) /* Run                 Trained */;
...
VALUES (5596,  5 /* HeartBeat */,    0.8, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5596,  5 /* HeartBeat */,      1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5596,  5 /* HeartBeat */,    0.8, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5596,  5 /* HeartBeat */,      1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5596,  5 /* HeartBeat */,    0.8, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5596,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
