...
VALUES (1521,   1,         16) /* ItemType - Creature */
     ...
     , (1521,  93,       1032) /* PhysicsState */
     , (1521, 101,        131) /* AiAllowedCombatStyle */
     , (1521, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1521, 140,          1) /* AiOptions */
     , (1521, 146,         71) /* XpOverride */;
...
VALUES (1521,   1, 'Drudge Prowler') /* Name */;
...
VALUES (1521,  6, 0, 2, 0,  28, 0, 307.56013577414) /* MeleeDefense        Trained */
     , (1521,  7, 0, 2, 0,  20, 0, 307.56013577414) /* MissileDefense      Trained */
     , (1521, 13, 0, 2, 0,  28, 0, 307.56013577414) /* UnarmedCombat       Trained */
     , (1521, 15, 0, 2, 0,  10, 0, 307.56013577414) /* MagicDefense        Trained */
     , (1521, 20, 0, 2, 0,  50, 0, 307.56013577414) /* Deception           Trained */
     , (1521, 24, 0, 2, 0,  40, 0, 307.56013577414) /* Run                 Trained */;
...
VALUES (1521,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1521,  5 /* HeartBeat */,   0.14, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1521,  5 /* HeartBeat */,   0.19, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1521,  5 /* HeartBeat */,    0.2, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1521,  5 /* HeartBeat */,    0.1, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1521, 9,     0,  0, 0, 0, False) /* Create Unknown for ContainTreasure */
     , (1521, 9,  1531,  0, 0, 1, False) /* Create Cell Key for ContainTreasure */;
