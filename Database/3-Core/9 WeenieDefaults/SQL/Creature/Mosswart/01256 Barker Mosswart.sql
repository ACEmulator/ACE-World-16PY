...
VALUES (1256,   1,         16) /* ItemType - Creature */
     ...
     , (1256,  93,       1032) /* PhysicsState */
     , (1256, 101,        131) /* AiAllowedCombatStyle */
     , (1256, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1256, 146,        328) /* XpOverride */;
...
VALUES (1256,   1, 'Barker Mosswart') /* Name */;
...
VALUES (1256,  1, 0, 2, 0,  25, 0, 300.245419528896) /* Axe                 Trained */
     , (1256,  6, 0, 2, 0,  80, 0, 300.245419528896) /* MeleeDefense        Trained */
     , (1256,  7, 0, 2, 0,  60, 0, 300.245419528896) /* MissileDefense      Trained */
     , (1256, 13, 0, 2, 0,  50, 0, 300.245419528896) /* UnarmedCombat       Trained */
     , (1256, 15, 0, 2, 0,  80, 0, 300.245419528896) /* MagicDefense        Trained */
     , (1256, 20, 0, 2, 0,  50, 0, 300.245419528896) /* Deception           Trained */
     , (1256, 24, 0, 2, 0,  50, 0, 300.245419528896) /* Run                 Trained */;
...
VALUES (1256,  5 /* HeartBeat */,   0.09, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,   0.19, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,    0.2, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,    0.1, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1256, 1,  1267,  0, 0, 0, False) /* Create Key for Contain */;
