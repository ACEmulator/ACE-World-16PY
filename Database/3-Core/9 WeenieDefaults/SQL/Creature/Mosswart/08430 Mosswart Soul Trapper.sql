...
VALUES (8430, 001 /* SETUP_DID */, 33557327)
     ...
     /* Wield  Spear (23697)   | Chance: 35% */
     /* Wield  Tachi (23701)   | Chance: 25% */
     /* Wield  Yari (23731)   | Chance: 40% */
     , (8430, 035 /* DEATH_TREASURE_TYPE_DID */, 451 /* Loot Tier: 2 */);
...
VALUES (8430, 9, 3694, 0, 0, 0.25, False) /* Create Swamp Stone for ContainTreasure_DestinationType */
     , (8430, 9, 0, 0, 0, 0.75, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */
     , (8430, 9, 7825, 0, 0, 0.05, False) /* Create Brown Beans for ContainTreasure_DestinationType */
     , (8430, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */
     , (8430, 9, 15767, 0, 0, 0.02, False) /* Create Ruined Amulet of the Heart for ContainTreasure_DestinationType */
     , (8430, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
