...
VALUES (8428, 'mosswartidolater', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (8428,   1,       5) /* HeartbeatInterval */
     ...
     , (8428,   3,     0.4) /* HealthRate */
     , (8428,   4,       5) /* StaminaRate */
     , (8428,   5,       2) /* ManaRate */
     , (8428,  12,     0.5) /* Shade */
     , (8428,  13,    0.33) /* ArmorModVsSlash */
     , (8428,  14,    0.54) /* ArmorModVsPierce */
     , (8428,  15,    0.54) /* ArmorModVsBludgeon */
     , (8428,  16,    0.16) /* ArmorModVsCold */
     , (8428,  17,     0.4) /* ArmorModVsFire */
     , (8428,  18,     1.1) /* ArmorModVsAcid */
     , (8428,  19,     0.7) /* ArmorModVsElectric */
     , (8428,  31,      24) /* VisualAwarenessRange */
     , (8428,  34,       1) /* PowerupTime */
     , (8428,  36,       1) /* ChargeSpeed */
     , (8428,  39,     1.2) /* DefaultScale */
     , (8428,  64,    0.55) /* ResistSlash */
     , (8428,  65,     0.8) /* ResistPierce */
     , (8428,  66,     0.8) /* ResistBludgeon */
     , (8428,  67,       1) /* ResistFire */
     , (8428,  68,    0.38) /* ResistCold */
     , (8428,  69,     0.8) /* ResistAcid */
...
VALUES (8428,   1, 0x02000B4F) /* Setup */
     ...
     , (8428,   4, 0x30000005) /* CombatTable */
     , (8428,   6, 0x040011B8) /* PaletteBase */
     , (8428,   7, 0x10000346) /* ClothingBase */
...
VALUES (8428,   1, 120, 0, 0) /* Strength */
     ...
     , (8428,   3, 100, 0, 0) /* Quickness */
     , (8428,   4, 110, 0, 0) /* Coordination */
     , (8428,   5, 140, 0, 0) /* Focus */
     , (8428,   6, 150, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (8428,   1,    60, 0, 0, 120) /* MaxHealth */
     , (8428,   3,   150, 0, 0, 270) /* MaxStamina */
     , (8428,   5,    50, 0, 0, 200) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (8428,  1, 0, 3, 0, 125, 0, 586.4158014119924) /* Axe                 Specialized */
     , (8428,  2, 0, 3, 0, 125, 0, 586.4158014119924) /* Bow                 Specialized */
     , (8428,  3, 0, 3, 0, 125, 0, 586.4158014119924) /* Crossbow            Specialized */
     , (8428,  4, 0, 3, 0, 125, 0, 586.4158014119924) /* Dagger              Specialized */
     , (8428,  5, 0, 3, 0, 125, 0, 586.4158014119924) /* Mace                Specialized */
     , (8428,  6, 0, 3, 0,  90, 0, 586.4158014119924) /* MeleeDefense        Specialized */
     , (8428,  7, 0, 3, 0,  90, 0, 586.4158014119924) /* MissileDefense      Specialized */
     , (8428,  9, 0, 3, 0, 125, 0, 586.4158014119924) /* Spear               Specialized */
     , (8428, 10, 0, 3, 0, 125, 0, 586.4158014119924) /* Staff               Specialized */
     , (8428, 11, 0, 3, 0, 125, 0, 586.4158014119924) /* Sword               Specialized */
     , (8428, 13, 0, 3, 0, 125, 0, 586.4158014119924) /* UnarmedCombat       Specialized */
     , (8428, 14, 0, 3, 0, 170, 0, 586.4158014119924) /* ArcaneLore          Specialized */
     , (8428, 15, 0, 3, 0, 140, 0, 586.4158014119924) /* MagicDefense        Specialized */
     , (8428, 20, 0, 3, 0, 100, 0, 586.4158014119924) /* Deception           Specialized */
     , (8428, 24, 0, 3, 0,  40, 0, 586.4158014119924) /* Run                 Specialized */
     , (8428, 33, 0, 3, 0,  50, 0, 586.4158014119924) /* LifeMagic           Specialized */
     , (8428, 34, 0, 3, 0,  50, 0, 586.4158014119924) /* WarMagic            Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8428,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8428,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8428,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8428,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8428,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8428,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
