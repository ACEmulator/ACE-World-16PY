...
VALUES (5760, 001 /* SETUP_DID */, 33556221)
     ...
     , (5760, 035 /* DEATH_TREASURE_TYPE_DID */, 465 /* Loot Tier: 1 */);
...
VALUES (5760, 2, 5762, 9, 0, 0, False) /* Create Snowball for Wield_DestinationType */
     ...
     , (5760, 9, 0, 0, 0, 0.5, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
