...
VALUES (5766, 001 /* SETUP_DID */, 33556222)
     ...
     , (5766, 035 /* DEATH_TREASURE_TYPE_DID */, 465 /* Loot Tier: 1 */);
...
VALUES (5766, 2, 5769, 12, 0, 0, False) /* Create Iceball for Wield_DestinationType */
     ...
     , (5766, 9, 0, 0, 0, 0.9, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
