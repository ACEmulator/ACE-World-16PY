...
VALUES (5761,   1,         16) /* ItemType - Creature */
     ...
     , (5761,  93,       1032) /* PhysicsState */
     , (5761, 101,        131) /* AiAllowedCombatStyle */
     , (5761, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (5761, 140,          1) /* AiOptions */
     , (5761, 146,        382) /* XpOverride */;
...
VALUES (5761,  6, 0, 3, 0,  62, 0, 439.057446243851) /* MeleeDefense        Specialized */
     , (5761,  7, 0, 3, 0,  66, 0, 439.057446243851) /* MissileDefense      Specialized */
     , (5761, 12, 0, 3, 0,  10, 0, 439.057446243851) /* ThrownWeapon        Specialized */
     , (5761, 13, 0, 3, 0,  50, 0, 439.057446243851) /* UnarmedCombat       Specialized */
     , (5761, 14, 0, 3, 0,  80, 0, 439.057446243851) /* ArcaneLore          Specialized */
     , (5761, 15, 0, 3, 0,  16, 0, 439.057446243851) /* MagicDefense        Specialized */
     , (5761, 20, 0, 3, 0,   1, 0, 439.057446243851) /* Deception           Specialized */
     , (5761, 24, 0, 3, 0,  40, 0, 439.057446243851) /* Run                 Specialized */
     , (5761, 31, 0, 3, 0,  34, 0, 439.057446243851) /* CreatureEnchantment Specialized */
     , (5761, 33, 0, 3, 0,  34, 0, 439.057446243851) /* LifeMagic           Specialized */
     , (5761, 34, 0, 3, 0,  34, 0, 439.057446243851) /* WarMagic            Specialized */;
...
VALUES (5761,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5761,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5761,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5761,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (5761, 9,     0,  0, 0, 0.9, False) /* Create Unknown for ContainTreasure */
     , (5761, 1,  5758,  1, 0, 0, False) /* Create Carrot for Contain */
     , (5761, 2,  5762,  9, 0, 0, False) /* Create Snowball for Wield */
     , (5761, 1,  5768,  1, 0, 0, False) /* Create Poofy Snowball for Contain */
     , (5761, 9, 22825,  0, 0, 0.1, False) /* Create A Lump of Coal for ContainTreasure */;
