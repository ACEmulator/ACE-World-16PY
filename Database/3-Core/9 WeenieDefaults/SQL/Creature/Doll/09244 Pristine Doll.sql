...
VALUES (9244,  6, 0, 3, 0, 168, 0, 631.925929488354) /* MeleeDefense        Specialized */
     , (9244,  7, 0, 3, 0, 279, 0, 631.925929488354) /* MissileDefense      Specialized */
     , (9244, 13, 0, 3, 0, 113, 0, 631.925929488354) /* UnarmedCombat       Specialized */
     , (9244, 14, 0, 3, 0, 200, 0, 631.925929488354) /* ArcaneLore          Specialized */
     , (9244, 15, 0, 3, 0, 115, 0, 631.925929488354) /* MagicDefense        Specialized */
     , (9244, 20, 0, 2, 0, 100, 0, 631.925929488354) /* Deception           Trained */
     , (9244, 24, 0, 2, 0,  80, 0, 631.925929488354) /* Run                 Trained */
     , (9244, 31, 0, 3, 0, 100, 0, 631.925929488354) /* CreatureEnchantment Specialized */
     , (9244, 33, 0, 3, 0, 100, 0, 631.925929488354) /* LifeMagic           Specialized */
     , (9244, 34, 0, 3, 0, 100, 0, 631.925929488354) /* WarMagic            Specialized */;
...
VALUES (9244,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9244,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9244,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9244,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9244,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9244,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
