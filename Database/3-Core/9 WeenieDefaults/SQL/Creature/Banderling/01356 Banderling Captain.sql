...
VALUES (1356,   1,         16) /* ItemType - Creature */
     ...
     , (1356,  93,       1032) /* PhysicsState */
     , (1356, 101,        131) /* AiAllowedCombatStyle */
     , (1356, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (1356, 146,        518) /* XpOverride */;
...
VALUES (1356,   1, 100, 0, 0) /* Strength */
     , (1356,   2,  90, 0, 0) /* Endurance */
     , (1356,   3, 100, 0, 0) /* Quickness */
     , (1356,   4, 100, 0, 0) /* Coordination */
     , (1356,   5,  40, 0, 0) /* Focus */
     , (1356,   6,  45, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1356,   1,    45, 0, 0, 90) /* MaxHealth */
     , (1356,   3,   150, 0, 0, 240) /* MaxStamina */
     , (1356,   5,    25, 0, 0, 70) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1356,  2, 0, 2, 0,  60, 0, 302.362177957963) /* Bow                 Trained */
     , (1356,  3, 0, 2, 0,  60, 0, 302.362177957963) /* Crossbow            Trained */
     , (1356,  5, 0, 2, 0,  60, 0, 302.362177957963) /* Mace                Trained */
     , (1356,  6, 0, 2, 0,  50, 0, 302.362177957963) /* MeleeDefense        Trained */
     , (1356,  7, 0, 2, 0,  60, 0, 302.362177957963) /* MissileDefense      Trained */
     , (1356,  9, 0, 2, 0,  60, 0, 302.362177957963) /* Spear               Trained */
     , (1356, 10, 0, 2, 0,  60, 0, 302.362177957963) /* Staff               Trained */
     , (1356, 11, 0, 2, 0,  60, 0, 302.362177957963) /* Sword               Trained */
     , (1356, 12, 0, 2, 0,  20, 0, 302.362177957963) /* ThrownWeapon        Trained */
     , (1356, 13, 0, 2, 0,  60, 0, 302.362177957963) /* UnarmedCombat       Trained */
     , (1356, 14, 0, 2, 0,  50, 0, 302.362177957963) /* ArcaneLore          Trained */
     , (1356, 15, 0, 2, 0,  40, 0, 302.362177957963) /* MagicDefense        Trained */
     , (1356, 20, 0, 2, 0,  40, 0, 302.362177957963) /* Deception           Trained */
     , (1356, 22, 0, 3, 0,  80, 0, 302.362177957963) /* Jump                Specialized */
     , (1356, 24, 0, 2, 0,  60, 0, 302.362177957963) /* Run                 Trained */
     , (1356, 31, 0, 2, 0,  50, 0, 302.362177957963) /* CreatureEnchantment Trained */
     , (1356, 33, 0, 2, 0,  50, 0, 302.362177957963) /* LifeMagic           Trained */
     , (1356, 34, 0, 2, 0,  50, 0, 302.362177957963) /* WarMagic            Trained */;
...
VALUES (1356,  5 /* HeartBeat */,   0.09, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1356,  5 /* HeartBeat */,   0.19, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1356,  5 /* HeartBeat */,    0.2, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1356,  5 /* HeartBeat */,    0.1, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1356, 8,  1358,  0, 0, 1, False) /* Create Worn Key for Treasure */;
