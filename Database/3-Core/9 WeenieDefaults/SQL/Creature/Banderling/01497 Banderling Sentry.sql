...
VALUES (1497,   1, 0x02000E08) /* Setup */
     , (1497,   2, 0x09000007) /* MotionTable */
     , (1497,   3, 0x20000005) /* SoundTable */
     , (1497,   4, 0x30000002) /* CombatTable */
     , (1497,   6, 0x04001425) /* PaletteBase */
     , (1497,   7, 0x10000411) /* ClothingBase */
     , (1497,   8, 0x0600103D) /* Icon */
     , (1497,  22, 0x34000017) /* PhysicsEffectTable */
...
VALUES (1497,  5, 0, 2, 0,  60, 0, 307.0389862393056) /* Mace                Trained */
     , (1497,  6, 0, 2, 0,  80, 0, 307.0389862393056) /* MeleeDefense        Trained */
     , (1497,  7, 0, 2, 0,  50, 0, 307.0389862393056) /* MissileDefense      Trained */
     , (1497,  9, 0, 2, 0,  60, 0, 307.0389862393056) /* Spear               Trained */
     , (1497, 10, 0, 2, 0,  60, 0, 307.0389862393056) /* Staff               Trained */
     , (1497, 12, 0, 2, 0,  30, 0, 307.0389862393056) /* ThrownWeapon        Trained */
     , (1497, 13, 0, 2, 0,  60, 0, 307.0389862393056) /* UnarmedCombat       Trained */
     , (1497, 15, 0, 2, 0,  40, 0, 307.0389862393056) /* MagicDefense        Trained */
     , (1497, 22, 0, 3, 0,  40, 0, 307.0389862393056) /* Jump                Specialized */
     , (1497, 24, 0, 2, 0,  30, 0, 307.0389862393056) /* Run                 Trained */;
...
VALUES (1497,  5 /* HeartBeat */,   0.09, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1497,  5 /* HeartBeat */,   0.19, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1497,  5 /* HeartBeat */,    0.2, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1497,  5 /* HeartBeat */,    0.1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
