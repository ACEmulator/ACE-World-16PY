...
VALUES (1240,   1,         16) /* ItemType - Creature */
     ...
     , (1240,  93,       1032) /* PhysicsState */
     , (1240, 101,        131) /* AiAllowedCombatStyle */
     , (1240, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1240, 140,          1) /* AiOptions */
     , (1240, 146,       1741) /* XpOverride */;
...
VALUES (1240,   1, 'Banderling Ogre') /* Name */;
...
VALUES (1240,  5, 0, 3, 0,  90, 0, 299.674702462556) /* Mace                Specialized */
     , (1240,  6, 0, 3, 0,  74, 0, 299.674702462556) /* MeleeDefense        Specialized */
     , (1240,  7, 0, 3, 0, 120, 0, 299.674702462556) /* MissileDefense      Specialized */
     , (1240,  9, 0, 3, 0,  90, 0, 299.674702462556) /* Spear               Specialized */
     , (1240, 10, 0, 3, 0,  90, 0, 299.674702462556) /* Staff               Specialized */
     , (1240, 11, 0, 3, 0,  90, 0, 299.674702462556) /* Sword               Specialized */
     , (1240, 12, 0, 3, 0,  85, 0, 299.674702462556) /* ThrownWeapon        Specialized */
     , (1240, 13, 0, 3, 0,  90, 0, 299.674702462556) /* UnarmedCombat       Specialized */
     , (1240, 15, 0, 3, 0,  72, 0, 299.674702462556) /* MagicDefense        Specialized */
     , (1240, 20, 0, 3, 0,  40, 0, 299.674702462556) /* Deception           Specialized */
     , (1240, 22, 0, 3, 0,  40, 0, 299.674702462556) /* Jump                Specialized */
     , (1240, 24, 0, 3, 0,  40, 0, 299.674702462556) /* Run                 Specialized */;
...
VALUES (1240,  5 /* HeartBeat */,  0.045, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1240,  5 /* HeartBeat */,  0.095, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1240,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1240,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1240,  5 /* HeartBeat */,  0.045, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1240,  5 /* HeartBeat */,  0.095, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1240,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1240, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (1240, 1,    72,  0, 13, 0, False) /* Create Platemail Hauberk for Contain */
     , (1240, 1,  1247,  0, 0, 0, False) /* Create Key for Contain */
     , (1240, 1,  1437, 250, 0, 0, False) /* Create Fire Arrow for Contain */
     , (1240, 1,  1446,  3, 0, 0, False) /* Create Fire Auroch Meat for Contain */
     , (1240, 9,  3693,  0, 0, 0.05, False) /* Create Banderling Scalp for ContainTreasure */;
