...
VALUES (7332,   1,         16) /* ItemType - Creature */
     ...
     , (7332,  68,          3) /* TargetingTactic */
     , (7332,  93,       1032) /* PhysicsState */
     , (7332, 101,        131) /* AiAllowedCombatStyle */
     , (7332, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (7332, 140,          1) /* AiOptions */
     , (7332, 146,       1514) /* XpOverride */;
...
VALUES (7332,   1,   33558024) /* Setup */
     ...
     , (7332,   4,  805306370) /* CombatTable */
     , (7332,   6,   67114021) /* PaletteBase */
     , (7332,   7,  268436496) /* ClothingBase */
     , (7332,   8,  100667453) /* Icon */
     , (7332,  22,  872415255) /* PhysicsEffectTable */
     , (7332,  32,        270) /* WieldedTreasureType */
     , (7332,  35,        453) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (7332,   1, 130, 0, 0) /* Strength */
     , (7332,   2, 120, 0, 0) /* Endurance */
     , (7332,   3, 100, 0, 0) /* Quickness */
     , (7332,   4, 100, 0, 0) /* Coordination */
     , (7332,   5,  50, 0, 0) /* Focus */
     , (7332,   6,  50, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (7332,   1,    70, 0, 0, 130) /* MaxHealth */
     , (7332,   3,   200, 0, 0, 320) /* MaxStamina */
     , (7332,   5,    50, 0, 0, 100) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (7332,  5, 0, 3, 0,  90, 0, 526.259291951057) /* Mace                Specialized */
     , (7332,  6, 0, 3, 0,  66, 0, 526.259291951057) /* MeleeDefense        Specialized */
     , (7332,  7, 0, 3, 0, 114, 0, 526.259291951057) /* MissileDefense      Specialized */
     , (7332,  9, 0, 3, 0,  90, 0, 526.259291951057) /* Spear               Specialized */
     , (7332, 10, 0, 3, 0,  90, 0, 526.259291951057) /* Staff               Specialized */
     , (7332, 11, 0, 3, 0,  90, 0, 526.259291951057) /* Sword               Specialized */
     , (7332, 12, 0, 3, 0,  85, 0, 526.259291951057) /* ThrownWeapon        Specialized */
     , (7332, 13, 0, 3, 0,  90, 0, 526.259291951057) /* UnarmedCombat       Specialized */
     , (7332, 15, 0, 3, 0,  66, 0, 526.259291951057) /* MagicDefense        Specialized */
     , (7332, 20, 0, 3, 0,  40, 0, 526.259291951057) /* Deception           Specialized */
     , (7332, 22, 0, 3, 0,  40, 0, 526.259291951057) /* Jump                Specialized */
     , (7332, 24, 0, 3, 0,  40, 0, 526.259291951057) /* Run                 Specialized */;
...
VALUES (7332,  5 /* HeartBeat */,  0.045, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7332,  5 /* HeartBeat */,  0.095, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7332,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7332,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7332,  5 /* HeartBeat */,  0.045, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7332,  5 /* HeartBeat */,  0.095, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7332,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7332, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (7332, 9,  3693,  0, 0, 0.05, False) /* Create Banderling Scalp for ContainTreasure */;
