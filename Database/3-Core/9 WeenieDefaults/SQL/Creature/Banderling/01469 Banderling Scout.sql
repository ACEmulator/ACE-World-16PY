...
VALUES (1469,   1,         16) /* ItemType - Creature */
     ...
     , (1469,  93,       1032) /* PhysicsState */
     , (1469, 101,        131) /* AiAllowedCombatStyle */
     , (1469, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (1469, 140,          1) /* AiOptions */
     , (1469, 146,        369) /* XpOverride */;
...
VALUES (1469,   1,  80, 0, 0) /* Strength */
     , (1469,   2,  80, 0, 0) /* Endurance */
     , (1469,   3,  90, 0, 0) /* Quickness */
     , (1469,   4,  90, 0, 0) /* Coordination */
     , (1469,   5,  30, 0, 0) /* Focus */
     , (1469,   6,  30, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1469,   1,    10, 0, 0, 50) /* MaxHealth */
     , (1469,   3,   150, 0, 0, 230) /* MaxStamina */
     , (1469,   5,     0, 0, 0, 30) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1469,  1, 0, 3, 0,  30, 0, 306.488626496485) /* Axe                 Specialized */
     , (1469,  4, 0, 3, 0,  20, 0, 306.488626496485) /* Dagger              Specialized */
     , (1469,  5, 0, 3, 0,  30, 0, 306.488626496485) /* Mace                Specialized */
     , (1469,  6, 0, 3, 0,  20, 0, 306.488626496485) /* MeleeDefense        Specialized */
     , (1469,  7, 0, 3, 0,  54, 0, 306.488626496485) /* MissileDefense      Specialized */
     , (1469,  9, 0, 3, 0,  30, 0, 306.488626496485) /* Spear               Specialized */
     , (1469, 10, 0, 3, 0,  30, 0, 306.488626496485) /* Staff               Specialized */
     , (1469, 11, 0, 3, 0,  30, 0, 306.488626496485) /* Sword               Specialized */
     , (1469, 12, 0, 3, 0,  20, 0, 306.488626496485) /* ThrownWeapon        Specialized */
     , (1469, 13, 0, 3, 0,  30, 0, 306.488626496485) /* UnarmedCombat       Specialized */
     , (1469, 15, 0, 3, 0,  18, 0, 306.488626496485) /* MagicDefense        Specialized */
     , (1469, 22, 0, 3, 0,  80, 0, 306.488626496485) /* Jump                Specialized */
     , (1469, 24, 0, 2, 0,  60, 0, 306.488626496485) /* Run                 Trained */;
...
VALUES (1469,  5 /* HeartBeat */,  0.045, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1469,  5 /* HeartBeat */,  0.095, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1469,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1469,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1469,  5 /* HeartBeat */,  0.045, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1469,  5 /* HeartBeat */,  0.095, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1469,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1469, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (1469, 9,  7825,  0, 0, 0.03, False) /* Create Brown Beans for ContainTreasure */;
