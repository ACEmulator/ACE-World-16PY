...
VALUES (1241, 9,     0,  0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure */
     , (1241, 1,  1249,  0, 0, 0, False) /* Create Key (1249) for Contain */
