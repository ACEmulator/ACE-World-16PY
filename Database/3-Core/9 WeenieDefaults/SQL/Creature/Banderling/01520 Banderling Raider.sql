...
VALUES (1520,   1,         16) /* ItemType - Creature */
     ...
     , (1520,  93,       1032) /* PhysicsState */
     , (1520, 101,        131) /* AiAllowedCombatStyle */
     , (1520, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (1520, 140,          1) /* AiOptions */
     , (1520, 146,        358) /* XpOverride */;
...
VALUES (1520,   1, 'Banderling Raider') /* Name */;
...
VALUES (1520,  5 /* HeartBeat */,   0.09, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1520,  5 /* HeartBeat */,   0.19, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1520,  5 /* HeartBeat */,    0.2, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1520,  5 /* HeartBeat */,    0.1, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1520, 9,     0,  0, 0, 0, False) /* Create Unknown for ContainTreasure */
     , (1520, 9,  1533,  0, 0, 1, False) /* Create Small Rusted Key for ContainTreasure */;
