...
VALUES (6, 1, 80) /* STRENGTH_ATTRIBUTE */
     ...
     , (6, 3, 90) /* QUICKNESS_ATTRIBUTE */
     , (6, 5, 30) /* FOCUS_ATTRIBUTE */
     , (6, 6, 30) /* SELF_ATTRIBUTE */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`)
VALUES (6, 1, 10) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (6, 3, 150) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (6, 5, 0) /* MAX_MANA_ATTRIBUTE_2ND */;
