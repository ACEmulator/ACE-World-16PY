...
VALUES ('8538', 'grievverbaneherald', 10) /* Creature */;
...
VALUES (8538,   1,         16) /* ItemType - Creature */
     ...
     , (8538,  68,          3) /* TargetingTactic */
     , (8538,  72,         22) /* FriendType - Shadow */
     , (8538,  93,       1032) /* PhysicsState */
     , (8538, 101,        131) /* AiAllowedCombatStyle */
     , (8538, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (8538, 140,          1) /* AiOptions */
...
VALUES (8538,   1,   33556698) /* Setup */
     ...
     , (8538,  30,         85) /* PhysicsScript - BreatheFrost */
     , (8538,  31,       8533) /* LinkedPortalOne - Cathedral Ruins Portal */
     , (8538,  35,        315) /* DeathTreasureType */;
...
VALUES (8538,  6, 0, 3, 0, 110, 0, 592.012235801265) /* MeleeDefense        Specialized */
     , (8538,  7, 0, 3, 0, 200, 0, 592.012235801265) /* MissileDefense      Specialized */
     , (8538, 13, 0, 3, 0, 180, 0, 592.012235801265) /* UnarmedCombat       Specialized */
     , (8538, 14, 0, 3, 0, 220, 0, 592.012235801265) /* ArcaneLore          Specialized */
     , (8538, 15, 0, 3, 0, 270, 0, 592.012235801265) /* MagicDefense        Specialized */
     , (8538, 20, 0, 3, 0, 150, 0, 592.012235801265) /* Deception           Specialized */
     , (8538, 31, 0, 3, 0, 220, 0, 592.012235801265) /* CreatureEnchantment Specialized */
     , (8538, 33, 0, 3, 0, 220, 0, 592.012235801265) /* LifeMagic           Specialized */
     , (8538, 34, 0, 3, 0, 220, 0, 592.012235801265) /* WarMagic            Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
