...
VALUES (8264,   1, 0x02000041) /* Setup */
     ...
     , (8264,   4, 0x3000000D) /* CombatTable */
     , (8264,   6, 0x040009B2) /* PaletteBase */
     , (8264,   7, 0x100000C1) /* ClothingBase */
...
VALUES (8264,  6, 0, 2, 0, 180, 0, 577.2422547891175) /* MeleeDefense        Trained */
     , (8264,  7, 0, 2, 0, 100, 0, 577.2422547891175) /* MissileDefense      Trained */
     , (8264, 13, 0, 2, 0, 150, 0, 577.2422547891175) /* UnarmedCombat       Trained */
     , (8264, 14, 0, 2, 0, 230, 0, 577.2422547891175) /* ArcaneLore          Trained */
     , (8264, 15, 0, 2, 0, 187, 0, 577.2422547891175) /* MagicDefense        Trained */
     , (8264, 20, 0, 2, 0, 130, 0, 577.2422547891175) /* Deception           Trained */
     , (8264, 24, 0, 2, 0,  80, 0, 577.2422547891175) /* Run                 Trained */
     , (8264, 31, 0, 2, 0, 230, 0, 577.2422547891175) /* CreatureEnchantment Trained */
     , (8264, 33, 0, 2, 0, 200, 0, 577.2422547891175) /* LifeMagic           Trained */
     , (8264, 34, 0, 2, 0, 250, 0, 577.2422547891175) /* WarMagic            Trained */;
...
VALUES (8264,   137,  2.011)  /* Frost Volley V */
...
VALUES (8264,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
