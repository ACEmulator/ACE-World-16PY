...
VALUES ('8264', 'virindidirectorsotiris', 10) /* Creature */;
...
VALUES (8264,   1,         16) /* ItemType - Creature */
     ...
     , (8264,  25,         85) /* Level */
     , (8264,  27,          0) /* ArmorType */
     , (8264,  68,          3) /* TargetingTactic */
     , (8264,  93,       1032) /* PhysicsState */
     , (8264, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (8264, 140,          1) /* AiOptions */
...
VALUES (8264,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8264,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (8264, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (8264, 9,     0,  0, 0, 0.9, False) /* Create Unknown for ContainTreasure */
     , (8264, 9,  3698,  0, 0, 0.05, False) /* Create White Jewel for ContainTreasure */
     , (8264, 9,  8154,  0, 0, 0.1, False) /* Create Broken Virindi Mask for ContainTreasure */
     , (8264, 8,  8261,  1, 0, 0, False) /* Create Sotiris Obsidian Shard for Treasure */;
