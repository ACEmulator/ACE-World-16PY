...
VALUES (8264, 9,     0,  0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 4 for ContainTreasure */
     ...
     , (8264, 8,  8261,  1, 0, 0, False) /* Create Sotiris Obsidian Shard (8261) for Treasure */;
