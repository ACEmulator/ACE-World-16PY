...
VALUES (5686, 9,     0,  0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 4 for ContainTreasure */
     ...
     , (5686, 1,  5680,  0, 0, 1, False) /* Create Torn Journal (5680) for Contain */
