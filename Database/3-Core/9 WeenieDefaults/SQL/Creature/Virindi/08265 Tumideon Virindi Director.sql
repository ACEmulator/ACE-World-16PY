...
VALUES (8265,  6, 0, 2, 0, 180, 0, 577.309494659208) /* MeleeDefense        Trained */
     , (8265,  7, 0, 2, 0, 100, 0, 577.309494659208) /* MissileDefense      Trained */
     , (8265, 13, 0, 2, 0, 150, 0, 577.309494659208) /* UnarmedCombat       Trained */
     , (8265, 14, 0, 2, 0, 230, 0, 577.309494659208) /* ArcaneLore          Trained */
     , (8265, 15, 0, 2, 0, 187, 0, 577.309494659208) /* MagicDefense        Trained */
     , (8265, 20, 0, 2, 0, 130, 0, 577.309494659208) /* Deception           Trained */
     , (8265, 24, 0, 2, 0,  80, 0, 577.309494659208) /* Run                 Trained */
     , (8265, 31, 0, 2, 0, 230, 0, 577.309494659208) /* CreatureEnchantment Trained */
     , (8265, 33, 0, 2, 0, 200, 0, 577.309494659208) /* LifeMagic           Trained */
     , (8265, 34, 0, 2, 0, 250, 0, 577.309494659208) /* WarMagic            Trained */;
...
VALUES (8265,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8265,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8265,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8265,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8265,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8265,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (8265, 8,  8263,  1, 0, 0, False) /* Create Tumideon Obsidian Shard (8263) for Treasure */
     , (8265, 9,     0,  0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 4 for ContainTreasure */
