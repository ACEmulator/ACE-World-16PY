...
VALUES ('8545', 'virindiobserverherald', 10) /* Creature */;
...
VALUES (8545,   1,         16) /* ItemType - Creature */
     ...
     , (8545,  27,          0) /* ArmorType */
     , (8545,  67,          2) /* Tolerance */
     , (8545,  68,          3) /* TargetingTactic */
     , (8545,  93,       1032) /* PhysicsState */
     , (8545, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (8545, 140,          1) /* AiOptions */
...
VALUES (8545,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8545,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8545,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8545,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8545,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8545,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (8545, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (8545, 9,     0,  0, 0, 0.98, False) /* Create Unknown for ContainTreasure */
     , (8545, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (8545, 9,  6876,  0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure */
     , (8545, 9,  7604,  0, 0, 0.05, False) /* Create Yellow Jewel for ContainTreasure */
     , (8545, 9, 25340,  0, 0, 0.03, False) /* Create Broken Virindi Observer Mask for ContainTreasure */;
