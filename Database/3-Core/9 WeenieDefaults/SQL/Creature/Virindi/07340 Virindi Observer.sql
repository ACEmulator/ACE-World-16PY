...
VALUES (7340,   1,       5) /* HeartbeatInterval */
     ...
     , (7340,  16,    0.72) /* ArmorModVsCold */
     , (7340,  17,       1) /* ArmorModVsFire */
     , (7340,  18,       1) /* ArmorModVsAcid */
     , (7340,  19,    0.72) /* ArmorModVsElectric */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7340,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7340,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7340,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7340,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7340,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7340,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7340, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (7340, 9,     0,  0, 0, 0.98, False) /* Create Unknown for ContainTreasure */
     , (7340, 9,     0,  0, 0, 0.98, False) /* Create Unknown for ContainTreasure */
     , (7340, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (7340, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (7340, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (7340, 9,  6876,  0, 0, 0.02, False) /* Create Sturdy Iron Key for ContainTreasure */
     , (7340, 9,  7604,  0, 0, 0.05, False) /* Create Yellow Jewel for ContainTreasure */
     , (7340, 9,  9290,  0, 0, 0.03, False) /* Create Virindi Directive Key for ContainTreasure */
     , (7340, 9,  9292,  0, 0, 0.02, False) /* Create Virindi Singularity Key for ContainTreasure */
     , (7340, 9, 20863,  0, 0, 0.03, False) /* Create Virindi Stamp for ContainTreasure */
     , (7340, 9, 25340,  0, 0, 0.03, False) /* Create Broken Virindi Observer Mask for ContainTreasure */;
