...
VALUES (10744,  4, 0, 2, 0, 100, 0, 693.3272684618373) /* Dagger              Trained */
     , (10744,  6, 0, 2, 0, 180, 0, 693.3272684618373) /* MeleeDefense        Trained */
     , (10744,  7, 0, 2, 0, 100, 0, 693.3272684618373) /* MissileDefense      Trained */
     , (10744, 13, 0, 2, 0, 150, 0, 693.3272684618373) /* UnarmedCombat       Trained */
     , (10744, 14, 0, 2, 0, 190, 0, 693.3272684618373) /* ArcaneLore          Trained */
     , (10744, 15, 0, 2, 0, 187, 0, 693.3272684618373) /* MagicDefense        Trained */
     , (10744, 20, 0, 2, 0, 250, 0, 693.3272684618373) /* Deception           Trained */
     , (10744, 24, 0, 2, 0,  80, 0, 693.3272684618373) /* Run                 Trained */
     , (10744, 31, 0, 2, 0, 125, 0, 693.3272684618373) /* CreatureEnchantment Trained */
     , (10744, 33, 0, 2, 0, 100, 0, 693.3272684618373) /* LifeMagic           Trained */
     , (10744, 34, 0, 2, 0, 150, 0, 693.3272684618373) /* WarMagic            Trained */;
...
VALUES (10744,   136,   2.02)  /* Frost Volley IV */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (10744,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (10744,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (10744,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (10744,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (10744,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (10744,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
