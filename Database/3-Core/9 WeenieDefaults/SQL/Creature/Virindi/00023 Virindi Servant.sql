...
VALUES (23,   1,         16) /* ItemType - Creature */
     ...
     , (23,  93,       1032) /* PhysicsState */
     , (23, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (23, 140,          1) /* AiOptions */
     , (23, 146,       7638) /* XpOverride */;
...
VALUES (23,  4, 0, 3, 0,   0, 0, 273.865870105496) /* Dagger              Specialized */
     , (23,  6, 0, 3, 0, 100, 0, 273.865870105496) /* MeleeDefense        Specialized */
     , (23,  7, 0, 3, 0, 200, 0, 273.865870105496) /* MissileDefense      Specialized */
     , (23, 13, 0, 3, 0, 150, 0, 273.865870105496) /* UnarmedCombat       Specialized */
     , (23, 14, 0, 2, 0, 190, 0, 273.865870105496) /* ArcaneLore          Trained */
     , (23, 15, 0, 3, 0, 100, 0, 273.865870105496) /* MagicDefense        Specialized */
     , (23, 20, 0, 2, 0, 250, 0, 273.865870105496) /* Deception           Trained */
     , (23, 24, 0, 2, 0,  80, 0, 273.865870105496) /* Run                 Trained */
     , (23, 31, 0, 3, 0,  35, 0, 273.865870105496) /* CreatureEnchantment Specialized */
     , (23, 33, 0, 3, 0,  35, 0, 273.865870105496) /* LifeMagic           Specialized */
     , (23, 34, 0, 3, 0,  35, 0, 273.865870105496) /* WarMagic            Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (23,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (23,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (23,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (23,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (23,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (23,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (23, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (23, 9,     0,  0, 0, 0.99, False) /* Create Unknown for ContainTreasure */
     , (23, 9,     0,  0, 0, 0.97, False) /* Create Unknown for ContainTreasure */
     , (23, 9,     0,  0, 0, 0.99, False) /* Create Unknown for ContainTreasure */
     , (23, 9,  3696,  0, 0, 0.05, False) /* Create Blue Gem for ContainTreasure */
     , (23, 9,  6876,  0, 0, 0.01, False) /* Create Sturdy Iron Key for ContainTreasure */
     , (23, 9,  9290,  0, 0, 0.01, False) /* Create Virindi Directive Key for ContainTreasure */
     , (23, 9,  9291,  0, 0, 0.03, False) /* Create Virindi Master Key for ContainTreasure */;
