...
VALUES (9325,   1, 0x02000041) /* Setup */
     , (9325,   2, 0x09000028) /* MotionTable */
     , (9325,   3, 0x20000012) /* SoundTable */
     , (9325,   4, 0x3000000D) /* CombatTable */
     , (9325,   6, 0x040009B2) /* PaletteBase */
     , (9325,   7, 0x100000C1) /* ClothingBase */
     , (9325,   8, 0x06001227) /* Icon */
     , (9325,  22, 0x34000029) /* PhysicsEffectTable */
...
VALUES (9325,  6, 0, 2, 0, 180, 0, 635.3395382799498) /* MeleeDefense        Trained */
     , (9325,  7, 0, 2, 0, 100, 0, 635.3395382799498) /* MissileDefense      Trained */
     , (9325, 13, 0, 2, 0, 150, 0, 635.3395382799498) /* UnarmedCombat       Trained */
     , (9325, 14, 0, 2, 0, 230, 0, 635.3395382799498) /* ArcaneLore          Trained */
     , (9325, 15, 0, 2, 0, 187, 0, 635.3395382799498) /* MagicDefense        Trained */
     , (9325, 20, 0, 2, 0, 130, 0, 635.3395382799498) /* Deception           Trained */
     , (9325, 24, 0, 2, 0,  80, 0, 635.3395382799498) /* Run                 Trained */
     , (9325, 31, 0, 2, 0, 230, 0, 635.3395382799498) /* CreatureEnchantment Trained */
     , (9325, 33, 0, 2, 0, 200, 0, 635.3395382799498) /* LifeMagic           Trained */
     , (9325, 34, 0, 2, 0, 250, 0, 635.3395382799498) /* WarMagic            Trained */;
...
VALUES (9325,   137,  2.011)  /* Frost Volley V */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9325,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9325,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9325,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9325,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9325,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9325,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
