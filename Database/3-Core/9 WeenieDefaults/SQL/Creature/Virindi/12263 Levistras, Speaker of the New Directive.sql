...
VALUES (12263,  6, 0, 2, 0, 220, 0, 799.2734092358672) /* MeleeDefense        Trained */
     , (12263,  7, 0, 2, 0, 250, 0, 799.2734092358672) /* MissileDefense      Trained */
     , (12263, 13, 0, 2, 0, 150, 0, 799.2734092358672) /* UnarmedCombat       Trained */
     , (12263, 14, 0, 2, 0, 230, 0, 799.2734092358672) /* ArcaneLore          Trained */
     , (12263, 15, 0, 2, 0, 250, 0, 799.2734092358672) /* MagicDefense        Trained */
     , (12263, 20, 0, 2, 0, 130, 0, 799.2734092358672) /* Deception           Trained */
     , (12263, 24, 0, 2, 0,  80, 0, 799.2734092358672) /* Run                 Trained */
     , (12263, 31, 0, 2, 0, 230, 0, 799.2734092358672) /* CreatureEnchantment Trained */
     , (12263, 33, 0, 2, 0, 200, 0, 799.2734092358672) /* LifeMagic           Trained */
     , (12263, 34, 0, 2, 0, 250, 0, 799.2734092358672) /* WarMagic            Trained */;
...
VALUES (12263,   137,  2.011)  /* Frost Volley V */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (12263,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (12263,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (12263,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (12263,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (12263,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (12263,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
