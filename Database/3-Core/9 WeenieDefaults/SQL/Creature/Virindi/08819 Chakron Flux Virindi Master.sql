...
VALUES (8819, 001 /* SETUP_DID */, 33556982)
     ...
     , (8819, 035 /* DEATH_TREASURE_TYPE_DID */, 355 /* Loot Tier: 5 */);
...
VALUES (8819, 9, 7604, 0, 0, 0.05, False) /* Create Yellow Jewel for ContainTreasure_DestinationType */
     , (8819, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 5 for ContainTreasure_DestinationType */
     ...
     , (8819, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 5 for ContainTreasure_DestinationType */;
