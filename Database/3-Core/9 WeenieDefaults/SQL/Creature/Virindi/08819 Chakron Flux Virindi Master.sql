...
VALUES (8819,  6, 0, 3, 0, 275, 0, 607.898540647933) /* MeleeDefense        Specialized */
     , (8819,  7, 0, 3, 0, 385, 0, 607.898540647933) /* MissileDefense      Specialized */
     , (8819, 13, 0, 3, 0, 300, 0, 607.898540647933) /* UnarmedCombat       Specialized */
     , (8819, 15, 0, 3, 0, 265, 0, 607.898540647933) /* MagicDefense        Specialized */
     , (8819, 20, 0, 3, 0, 250, 0, 607.898540647933) /* Deception           Specialized */
     , (8819, 24, 0, 3, 0,  90, 0, 607.898540647933) /* Run                 Specialized */
     , (8819, 31, 0, 3, 0, 200, 0, 607.898540647933) /* CreatureEnchantment Specialized */
     , (8819, 33, 0, 3, 0, 200, 0, 607.898540647933) /* LifeMagic           Specialized */
     , (8819, 34, 0, 3, 0, 200, 0, 607.898540647933) /* WarMagic            Specialized */;
...
VALUES (8819,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8819,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8819,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8819,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8819,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8819,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (8819, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (8819, 9,     0,  0, 0, 0.95, False) /* Create Unknown for ContainTreasure */
     , (8819, 9,     0,  0, 0, 0.98, False) /* Create Unknown for ContainTreasure */
     , (8819, 9,  7604,  0, 0, 0.05, False) /* Create Yellow Jewel for ContainTreasure */
     , (8819, 9,  9292,  0, 0, 0.05, False) /* Create Virindi Singularity Key for ContainTreasure */
     , (8819, 9, 24477,  0, 0, 0.02, False) /* Create Sturdy Steel Key for ContainTreasure */;
