...
VALUES (9326,   1, 0x02000041) /* Setup */
     , (9326,   2, 0x09000028) /* MotionTable */
     , (9326,   3, 0x20000012) /* SoundTable */
     , (9326,   4, 0x3000000D) /* CombatTable */
     , (9326,   6, 0x040009B2) /* PaletteBase */
     , (9326,   7, 0x100000C1) /* ClothingBase */
     , (9326,   8, 0x06001227) /* Icon */
     , (9326,  22, 0x34000029) /* PhysicsEffectTable */
...
VALUES (9326,  6, 0, 3, 0, 200, 0, 635.4440098824806) /* MeleeDefense        Specialized */
     , (9326,  7, 0, 3, 0, 300, 0, 635.4440098824806) /* MissileDefense      Specialized */
     , (9326, 13, 0, 3, 0, 150, 0, 635.4440098824806) /* UnarmedCombat       Specialized */
     , (9326, 14, 0, 3, 0, 300, 0, 635.4440098824806) /* ArcaneLore          Specialized */
     , (9326, 15, 0, 3, 0, 240, 0, 635.4440098824806) /* MagicDefense        Specialized */
     , (9326, 20, 0, 3, 0, 250, 0, 635.4440098824806) /* Deception           Specialized */
     , (9326, 24, 0, 3, 0,  90, 0, 635.4440098824806) /* Run                 Specialized */
     , (9326, 31, 0, 3, 0, 300, 0, 635.4440098824806) /* CreatureEnchantment Specialized */
     , (9326, 33, 0, 3, 0, 300, 0, 635.4440098824806) /* LifeMagic           Specialized */
     , (9326, 34, 0, 3, 0, 300, 0, 635.4440098824806) /* WarMagic            Specialized */;
...
VALUES (9326,    84,  2.105)  /* Flame Bolt V */
     , (9326,    68,  2.105)  /* Shock Wave V */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,   0.02, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,   0.04, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,   0.09, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,  0.115, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9326,  5 /* HeartBeat */,   0.14, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
