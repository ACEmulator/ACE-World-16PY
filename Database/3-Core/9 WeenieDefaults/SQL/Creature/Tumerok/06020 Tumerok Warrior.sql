...
VALUES ('6020', 'tumerokwarriorarchernofall', 10) /* Creature */;
...
VALUES (6020,   1,         16) /* ItemType - Creature */
     ...
     , (6020,  25,         26) /* Level */
     , (6020,  27,          0) /* ArmorType */
     , (6020,  68,          3) /* TargetingTactic */
     , (6020,  93,    4195336) /* PhysicsState */
     , (6020, 101,        183) /* AiAllowedCombatStyle */
     , (6020, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (6020, 140,          1) /* AiOptions */
...
VALUES (6020, 8,   301,  0, 0, 0.06, False) /* Create Battle Axe for Treasure */
     , (6020, 8,   308,  0, 0, 0.06, False) /* Create Budiaq for Treasure */
     , (6020, 8,   313,  0, 0, 0.06, False) /* Create Dabus for Treasure */
     , (6020, 8,   324,  0, 0, 0.05, False) /* Create Kaskara for Treasure */
     , (6020, 8,   331,  0, 0, 0.07, False) /* Create Mace for Treasure */
     , (6020, 8,   336,  0, 0, 0.05, False) /* Create Ono for Treasure */
     , (6020, 8,   339,  0, 0, 0.1, False) /* Create Scimitar for Treasure */
     , (6020, 8,   340,  0, 0, 0.05, False) /* Create Shamshir for Treasure */
     , (6020, 8,   344,  0, 0, 0.05, False) /* Create Silifi for Treasure */
     , (6020, 8,   348,  0, 0, 0.07, False) /* Create Spear for Treasure */
     , (6020, 8,   351,  0, 0, 0.05, False) /* Create Long Sword for Treasure */
     , (6020, 8,   353,  0, 0, 0.05, False) /* Create Tachi for Treasure */
     , (6020, 8,   356,  0, 0, 0.06, False) /* Create Tofun for Treasure */
     , (6020, 8,   359,  0, 0, 0.1, False) /* Create War Hammer for Treasure */
     , (6020, 8,   362,  0, 0, 0.1, False) /* Create Yari for Treasure */;
