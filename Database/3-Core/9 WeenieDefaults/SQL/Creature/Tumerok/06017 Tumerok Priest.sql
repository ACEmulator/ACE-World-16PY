...
VALUES (6017, 001 /* SETUP_DID */, 33554496)
     ...
     , (6017, 035 /* DEATH_TREASURE_TYPE_DID */, 450 /* Loot Tier: 3 */);
...
VALUES (6017, 9, 7825, 0, 0, 0.03, False) /* Create Brown Beans for ContainTreasure_DestinationType */
     , (6017, 9, 0, 0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure_DestinationType */;
