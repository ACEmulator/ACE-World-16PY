...
VALUES (4100,   1,         16) /* ItemType - Creature */
     ...
     , (4100,  93,       1032) /* PhysicsState */
     , (4100, 101,        183) /* AiAllowedCombatStyle */
     , (4100, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (4100, 140,          1) /* AiOptions */
     , (4100, 146,       2533) /* XpOverride */;
...
VALUES (4100,  1, 0, 3, 0,  90, 0, 379.552881388239) /* Axe                 Specialized */
     , (4100,  2, 0, 3, 0,  90, 0, 379.552881388239) /* Bow                 Specialized */
     , (4100,  3, 0, 3, 0,  90, 0, 379.552881388239) /* Crossbow            Specialized */
     , (4100,  4, 0, 3, 0,  90, 0, 379.552881388239) /* Dagger              Specialized */
     , (4100,  5, 0, 3, 0,  90, 0, 379.552881388239) /* Mace                Specialized */
     , (4100,  6, 0, 3, 0,  72, 0, 379.552881388239) /* MeleeDefense        Specialized */
     , (4100,  7, 0, 3, 0, 111, 0, 379.552881388239) /* MissileDefense      Specialized */
     , (4100,  9, 0, 3, 0,  90, 0, 379.552881388239) /* Spear               Specialized */
     , (4100, 11, 0, 3, 0,  90, 0, 379.552881388239) /* Sword               Specialized */
     , (4100, 13, 0, 3, 0,  90, 0, 379.552881388239) /* UnarmedCombat       Specialized */
     , (4100, 14, 0, 3, 0, 140, 0, 379.552881388239) /* ArcaneLore          Specialized */
     , (4100, 15, 0, 3, 0,  84, 0, 379.552881388239) /* MagicDefense        Specialized */
     , (4100, 20, 0, 3, 0,  30, 0, 379.552881388239) /* Deception           Specialized */
     , (4100, 24, 0, 3, 0,  50, 0, 379.552881388239) /* Run                 Specialized */
     , (4100, 31, 0, 3, 0,  66, 0, 379.552881388239) /* CreatureEnchantment Specialized */
     , (4100, 33, 0, 3, 0,  66, 0, 379.552881388239) /* LifeMagic           Specialized */
     , (4100, 34, 0, 3, 0,  66, 0, 379.552881388239) /* WarMagic            Specialized */;
...
VALUES (4100, 8,   301,  0, 0, 0.06, False) /* Create Battle Axe for Treasure */
     , (4100, 8,   308,  0, 0, 0.06, False) /* Create Budiaq for Treasure */
     , (4100, 8,   313,  0, 0, 0.06, False) /* Create Dabus for Treasure */
     , (4100, 8,   324,  0, 0, 0.05, False) /* Create Kaskara for Treasure */
     , (4100, 8,   331,  0, 0, 0.07, False) /* Create Mace for Treasure */
     , (4100, 8,   336,  0, 0, 0.05, False) /* Create Ono for Treasure */
     , (4100, 8,   339,  0, 0, 0.1, False) /* Create Scimitar for Treasure */
     , (4100, 8,   340,  0, 0, 0.05, False) /* Create Shamshir for Treasure */
     , (4100, 8,   344,  0, 0, 0.05, False) /* Create Silifi for Treasure */
     , (4100, 8,   348,  0, 0, 0.07, False) /* Create Spear for Treasure */
     , (4100, 8,   351,  0, 0, 0.05, False) /* Create Long Sword for Treasure */
     , (4100, 8,   353,  0, 0, 0.05, False) /* Create Tachi for Treasure */
     , (4100, 8,   356,  0, 0, 0.06, False) /* Create Tofun for Treasure */
     , (4100, 8,   359,  0, 0, 0.1, False) /* Create War Hammer for Treasure */
     , (4100, 8,   362,  0, 0, 0.1, False) /* Create Yari for Treasure */;
