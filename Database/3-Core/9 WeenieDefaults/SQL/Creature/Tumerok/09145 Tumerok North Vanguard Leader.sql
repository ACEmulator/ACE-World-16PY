...
VALUES (9145, 9,     0,  0, 0, 0, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 5 for ContainTreasure */
     , (9145, 9,  9136,  0, 0, 1, False) /* Create Vanguard Leader's Amulet (9136) for ContainTreasure */
     , (9145, 2,  9138,  0, 0, 1, False) /* Create Vanguard Leader's Morningstar (9138) for Wield */;
