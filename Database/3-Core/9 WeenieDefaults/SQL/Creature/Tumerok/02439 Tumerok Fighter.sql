...
VALUES (2439, 001 /* SETUP_DID */, 33554496)
     ...
     , (2439, 035 /* DEATH_TREASURE_TYPE_DID */, 453 /* Loot Tier: 1 */);
...
VALUES (2439, 9, 20855, 0, 0, 0.03, False) /* Create Alchemy Stamp for ContainTreasure_DestinationType */
     , (2439, 9, 0, 0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
