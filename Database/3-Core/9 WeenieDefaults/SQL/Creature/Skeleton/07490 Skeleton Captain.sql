...
VALUES ('7490', 'skeletoncaptain-nofall', 10) /* Creature */;
...
VALUES (7490,   1,         16) /* ItemType - Creature */
     ...
     , (7490,  68,          5) /* TargetingTactic */
     , (7490,  93,    4195336) /* PhysicsState */
     , (7490, 101,        183) /* AiAllowedCombatStyle */
     , (7490, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (7490, 140,          1) /* AiOptions */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7490,  5 /* HeartBeat */,    0.8, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7490, 9,     0,  0, 0, 0.9, False) /* Create Unknown for ContainTreasure */
     , (7490, 9,  3687,  0, 0, 0.1, False) /* Create Skeleton's Skull for ContainTreasure */;
