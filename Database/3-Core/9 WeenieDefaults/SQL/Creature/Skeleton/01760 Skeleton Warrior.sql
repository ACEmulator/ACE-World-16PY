...
VALUES (1760, 001 /* SETUP_DID */, 33554521)
     ...
     , (1760, 035 /* DEATH_TREASURE_TYPE_DID */, 453 /* Loot Tier: 1 */);
...
VALUES (1760, 001 /* ITEM_TYPE_INT */, 16 /* TYPE_CREATURE */)
     ...
     , (1760, 101 /* AI_ALLOWED_COMBAT_STYLE_INT */, 183 /* Unarmed_CombatStyle, OneHanded_CombatStyle, OneHandedAndShield_CombatStyle, Bow_CombatStyle, Crossbow_CombatStyle, ThrownWeapon_CombatStyle */)
...
VALUES (1760, 9, 3687, 0, 0, 0.05, False) /* Create Skeleton's Skull for ContainTreasure_DestinationType */
     , (1760, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */
     , (1760, 9, 9314, 0, 0, 0.06, False) /* Create A Tiny Mnemosyne for ContainTreasure_DestinationType */
     , (1760, 9, 0, 0, 0, 0.94, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */
     , (1760, 9, 22047, 0, 0, 0.1, False) /* Create Skeletal Torso for ContainTreasure_DestinationType */
     , (1760, 9, 0, 0, 0, 0.9, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */
