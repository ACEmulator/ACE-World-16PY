...
VALUES (2575,   1,         16) /* ItemType - Creature */
     ...
     , (2575,  93,    4195336) /* PhysicsState */
     , (2575, 101,        131) /* AiAllowedCombatStyle */
     , (2575, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (2575, 140,          1) /* AiOptions */
     , (2575, 146,       1880) /* XpOverride */;
...
VALUES (2575,  5, 0, 3, 0,  50, 0, 336.02787416699) /* Mace                Specialized */
     , (2575,  6, 0, 3, 0,  66, 0, 336.02787416699) /* MeleeDefense        Specialized */
     , (2575,  7, 0, 3, 0, 102, 0, 336.02787416699) /* MissileDefense      Specialized */
     , (2575,  9, 0, 3, 0,  50, 0, 336.02787416699) /* Spear               Specialized */
     , (2575, 10, 0, 3, 0,  50, 0, 336.02787416699) /* Staff               Specialized */
     , (2575, 11, 0, 3, 0,  50, 0, 336.02787416699) /* Sword               Specialized */
     , (2575, 12, 0, 3, 0,  20, 0, 336.02787416699) /* ThrownWeapon        Specialized */
     , (2575, 13, 0, 3, 0,  50, 0, 336.02787416699) /* UnarmedCombat       Specialized */
     , (2575, 15, 0, 3, 0,  74, 0, 336.02787416699) /* MagicDefense        Specialized */
     , (2575, 20, 0, 3, 0,  70, 0, 336.02787416699) /* Deception           Specialized */
     , (2575, 22, 0, 3, 0,  30, 0, 336.02787416699) /* Jump                Specialized */
     , (2575, 24, 0, 3, 0,  60, 0, 336.02787416699) /* Run                 Specialized */;
...
VALUES (2575,  5 /* HeartBeat */,  0.045, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2575,  5 /* HeartBeat */,  0.095, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2575,  5 /* HeartBeat */,  0.045, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2575,  5 /* HeartBeat */,  0.095, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (2575, 9,     0,  0, 0, 0.94, False) /* Create Unknown for ContainTreasure */
     , (2575, 9, 12253,  0, 0, 0.06, False) /* Create Monougat for ContainTreasure */;
