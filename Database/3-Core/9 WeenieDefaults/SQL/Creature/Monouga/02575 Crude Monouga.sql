...
VALUES (2575, 001 /* SETUP_DID */, 33555199)
     ...
     , (2575, 035 /* DEATH_TREASURE_TYPE_DID */, 453 /* Loot Tier: 1 */);
...
VALUES (2575, 9, 12253, 0, 0, 0.06, False) /* Create Monougat for ContainTreasure_DestinationType */
     , (2575, 9, 0, 0, 0, 0.94, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
