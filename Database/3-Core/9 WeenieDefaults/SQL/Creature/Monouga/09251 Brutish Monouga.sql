...
VALUES (9251, 001 /* SETUP_DID */, 33555199)
     ...
     , (9251, 035 /* DEATH_TREASURE_TYPE_DID */, 451 /* Loot Tier: 2 */);
...
VALUES (9251, 9, 12253, 0, 0, 0.09, False) /* Create Monougat for ContainTreasure_DestinationType */
     , (9251, 9, 0, 0, 0, 0.91, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */
     , (9251, 9, 15772, 0, 0, 0.02, False) /* Create Ruined Amulet of the Pugilist for ContainTreasure_DestinationType */
     , (9251, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
