...
VALUES (4212, 001 /* SETUP_DID */, 33555199)
     ...
     , (4212, 035 /* DEATH_TREASURE_TYPE_DID */, 32 /* Loot Tier: 6 */);
...
VALUES (4212, 001 /* ITEM_TYPE_INT */, 16 /* TYPE_CREATURE */)
     ...
     , (4212, 101 /* AI_ALLOWED_COMBAT_STYLE_INT */, 131 /* Unarmed_CombatStyle, OneHanded_CombatStyle, ThrownWeapon_CombatStyle */)
...
VALUES (4212, 9, 23108, 0, 0, 0.1, False) /* Create Twisted Dark Key for ContainTreasure_DestinationType */
     , (4212, 9, 0, 0, 0, 0.9, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 6 for ContainTreasure_DestinationType */
     , (4212, 9, 23107, 0, 0, 0.05, False) /* Create Mangled Dark Key for ContainTreasure_DestinationType */
     , (4212, 9, 0, 0, 0, 0.95, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 6 for ContainTreasure_DestinationType */
     , (4212, 9, 12253, 10, 0, 0.25, False) /* Create Monougat for ContainTreasure_DestinationType */
     , (4212, 9, 0, 0, 0, 0.75, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 6 for ContainTreasure_DestinationType */;
