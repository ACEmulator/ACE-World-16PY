...
VALUES (12135, 9,     0,  0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure */
     , (12135, 2,  5850,  0, 9, 0, False) /* Create Faran Robe (5850) for Wield */
