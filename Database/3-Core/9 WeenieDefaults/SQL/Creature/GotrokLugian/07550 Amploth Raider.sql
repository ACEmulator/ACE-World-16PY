...
VALUES (7550,   1,         16) /* ItemType - Creature */
     ...
     , (7550,  93,       1032) /* PhysicsState */
     , (7550, 101,        131) /* AiAllowedCombatStyle */
     , (7550, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (7550, 140,          1) /* AiOptions */
     , (7550, 146,       2000) /* XpOverride */;
...
VALUES (7550,  1, 0, 2, 0,  70, 0, 537.191799300602) /* Axe                 Trained */
     , (7550,  5, 0, 2, 0,  70, 0, 537.191799300602) /* Mace                Trained */
     , (7550,  6, 0, 2, 0,  50, 0, 537.191799300602) /* MeleeDefense        Trained */
     , (7550,  7, 0, 2, 0,  70, 0, 537.191799300602) /* MissileDefense      Trained */
     , (7550, 12, 0, 2, 0,  70, 0, 537.191799300602) /* ThrownWeapon        Trained */
     , (7550, 13, 0, 2, 0,  70, 0, 537.191799300602) /* UnarmedCombat       Trained */
     , (7550, 15, 0, 3, 0, 999, 0, 537.191799300602) /* MagicDefense        Specialized */
     , (7550, 20, 0, 2, 0,  40, 0, 537.191799300602) /* Deception           Trained */
     , (7550, 22, 0, 2, 0, 100, 0, 537.191799300602) /* Jump                Trained */
     , (7550, 24, 0, 2, 0,  30, 0, 537.191799300602) /* Run                 Trained */;
...
VALUES (7550,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7550,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7550,  5 /* HeartBeat */,  0.125, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7550,  5 /* HeartBeat */,  0.025, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7550,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7550,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7550,  5 /* HeartBeat */,  0.125, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7550, 9,     0,  0, 0, 0.98, False) /* Create Unknown for ContainTreasure */
     , (7550, 9,     0,  0, 0, 0.8, False) /* Create Unknown for ContainTreasure */
     , (7550, 9,  7042,  0, 0, 0.02, False) /* Create Small Lugian Sinew for ContainTreasure */
     , (7550, 9,  7549,  0, 0, 0.2, False) /* Create Lugian Pick Axe for ContainTreasure */;
