...
VALUES (8140,   1,         16) /* ItemType - Creature */
     ...
     , (8140,  93,       1032) /* PhysicsState */
     , (8140, 101,        131) /* AiAllowedCombatStyle */
     , (8140, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (8140, 140,          1) /* AiOptions */
     , (8140, 146,       4301) /* XpOverride */;
...
VALUES (8140,  1, 0, 3, 0,  70, 0, 571.218271445643) /* Axe                 Specialized */
     , (8140,  5, 0, 3, 0,  70, 0, 571.218271445643) /* Mace                Specialized */
     , (8140,  6, 0, 3, 0, 115, 0, 571.218271445643) /* MeleeDefense        Specialized */
     , (8140,  7, 0, 3, 0, 210, 0, 571.218271445643) /* MissileDefense      Specialized */
     , (8140, 12, 0, 3, 0,  70, 0, 571.218271445643) /* ThrownWeapon        Specialized */
     , (8140, 13, 0, 3, 0,  70, 0, 571.218271445643) /* UnarmedCombat       Specialized */
     , (8140, 15, 0, 3, 0, 155, 0, 571.218271445643) /* MagicDefense        Specialized */
     , (8140, 20, 0, 2, 0,  25, 0, 571.218271445643) /* Deception           Trained */
     , (8140, 22, 0, 2, 0, 140, 0, 571.218271445643) /* Jump                Trained */
     , (8140, 24, 0, 2, 0,  50, 0, 571.218271445643) /* Run                 Trained */;
...
VALUES (8140,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.125, NULL, 2147483708 /* UaNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.025, NULL, 2147483710 /* MeleeNoShieldAttack */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.125, NULL, 2147483709 /* Standing */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
