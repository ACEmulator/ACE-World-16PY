...
VALUES (8034, 'soulcrystalcaulnalain', /* Creature_WeenieType */ 10);
...
VALUES (8034, 16, 4, 0, 0, 220, 220, 220, 220, 220, 264, 238, 22000, 0, 2, 0.3, 0.4, 0.25, 0.3, 0.4, 0.25, 0.6, 0.5, 0.25, 0.6, 0.5, 0.25) /* TORSO */
     , (8034, 0, 4, 50, 0.75, 200, 200, 200, 200, 200, 240, 216, 20000, 0, 1, 0.5, 0.2, 0, 0.5, 0.2, 0, 0, 0, 0, 0, 0, 0) /* HEAD */
...
VALUES (8034, 33, 0, 3, 0, 350, 0, 566.672437996232) /* LIFE_MAGIC_SKILL */
     , (8034, 34, 0, 3, 0, 350, 0, 566.672437996232) /* WAR_MAGIC_SKILL */
     , (8034, 6, 0, 3, 0, 150, 0, 566.672437996232) /* MELEE_DEFENSE_SKILL */
     , (8034, 31, 0, 3, 0, 350, 0, 566.672437996232) /* CREATURE_ENCHANTMENT_SKILL */
     , (8034, 15, 0, 3, 0, 300, 0, 566.672437996232) /* MAGIC_DEFENSE_SKILL */
     , (8034, 7, 0, 3, 0, 300, 0, 566.672437996232) /* MISSILE_DEFENSE_SKILL */
     , (8034, 13, 0, 3, 0, 150, 0, 566.672437996232) /* UNARMED_COMBAT_SKILL */
     , (8034, 20, 0, 3, 0, 100, 0, 566.672437996232) /* DECEPTION_SKILL */
     , (8034, 24, 0, 2, 0, 10, 0, 566.672437996232) /* RUN_SKILL */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `probability`, `category`, `emote_Set_Id`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8034, 1, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL) /* Death_EmoteCategory */;

INSERT INTO `weenie_properties_emote_action` (`object_Id`, `emote_Category`, `emote_Set_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8034, 3, 0, 0, 16, 0, 1, NULL, '%s has shattered the Caulnalain Soul Crystal! The crystal''s released energy ripples across the landscape of Dereth, causing fluxes along the island''s ley lines!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) /* WorldBroadcast_EmoteType */;
