...
VALUES (6041, 001 /* SETUP_DID */, 33556226)
     ...
     , (6041, 035 /* DEATH_TREASURE_TYPE_DID */, 462 /* Loot Tier: 3 */);
...
VALUES (6041, 9, 6056, 0, 0, 0.02, False) /* Create Small Shard for ContainTreasure_DestinationType */
     , (6041, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure_DestinationType */;
