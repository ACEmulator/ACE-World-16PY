...
VALUES (8014, 001 /* SETUP_DID */, 33556729)
     ...
     , (8014, 035 /* DEATH_TREASURE_TYPE_DID */, 463 /* Loot Tier: 2 */);
...
VALUES (8014, 9, 6057, 0, 0, 0.02, False) /* Create Tiny Shard for ContainTreasure_DestinationType */
     , (8014, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */
     ...
     , (8014, 9, 0, 0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
