...
VALUES (5891, 001 /* SETUP_DID */, 33556224)
     ...
     , (5891, 035 /* DEATH_TREASURE_TYPE_DID */, 464 /* Loot Tier: 5 */);
...
VALUES (5891, 1, 5904, 1, 0, 0, False) /* Create Crystal Device for Contain_DestinationType */
     ...
     , (5891, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 5 for ContainTreasure_DestinationType */;
