...
VALUES (8405, 'fireelementalflammanofall', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (8405,   1,       5) /* HeartbeatInterval */
     ...
     , (8405,   3,     0.7) /* HealthRate */
     , (8405,   4,     0.5) /* StaminaRate */
     , (8405,   5,       2) /* ManaRate */
     , (8405,  13,    0.73) /* ArmorModVsSlash */
     , (8405,  14,    0.73) /* ArmorModVsPierce */
     , (8405,  15,    0.73) /* ArmorModVsBludgeon */
     , (8405,  16,       1) /* ArmorModVsCold */
     , (8405,  17,     100) /* ArmorModVsFire */
     , (8405,  18,    0.78) /* ArmorModVsAcid */
     , (8405,  19,     0.6) /* ArmorModVsElectric */
     , (8405,  31,      20) /* VisualAwarenessRange */
     , (8405,  39,     1.3) /* DefaultScale */
     , (8405,  64,     0.4) /* ResistSlash */
     , (8405,  65,     0.4) /* ResistPierce */
     , (8405,  66,     0.4) /* ResistBludgeon */
     , (8405,  67,       0) /* ResistFire */
     , (8405,  68,       1) /* ResistCold */
     , (8405,  69,     0.5) /* ResistAcid */
     , (8405,  70,     0.1) /* ResistElectric */
...
VALUES (8405,   1, 0x020006A3) /* Setup */
     ...
     , (8405,   4, 0x30000000) /* CombatTable */
     , (8405,   8, 0x06001B42) /* Icon */
     , (8405,  22, 0x34000070) /* PhysicsEffectTable */
     , (8405,  35,        463) /* DeathTreasureType - Loot Tier: 2 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (8405,   1, 145, 0, 0) /* Strength */
     , (8405,   2, 130, 0, 0) /* Endurance */
     , (8405,   3, 190, 0, 0) /* Quickness */
     , (8405,   4, 180, 0, 0) /* Coordination */
     , (8405,   5, 130, 0, 0) /* Focus */
     , (8405,   6, 180, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (8405,   1,    70, 0, 0, 135) /* MaxHealth */
     , (8405,   3,   200, 0, 0, 330) /* MaxStamina */
     , (8405,   5,   200, 0, 0, 380) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (8405,  6, 0, 3, 0, 126, 0, 585.4863963402564) /* MeleeDefense        Specialized */
     , (8405,  7, 0, 3, 0, 260, 0, 585.4863963402564) /* MissileDefense      Specialized */
     , (8405, 13, 0, 3, 0, 140, 0, 585.4863963402564) /* UnarmedCombat       Specialized */
     , (8405, 14, 0, 2, 0, 130, 0, 585.4863963402564) /* ArcaneLore          Trained */
     , (8405, 15, 0, 3, 0, 152, 0, 585.4863963402564) /* MagicDefense        Specialized */
     , (8405, 20, 0, 2, 0, 100, 0, 585.4863963402564) /* Deception           Trained */
     , (8405, 24, 0, 2, 0,  80, 0, 585.4863963402564) /* Run                 Trained */
     , (8405, 31, 0, 3, 0,  75, 0, 585.4863963402564) /* CreatureEnchantment Specialized */
     , (8405, 33, 0, 3, 0,  75, 0, 585.4863963402564) /* LifeMagic           Specialized */
     , (8405, 34, 0, 3, 0,  75, 0, 585.4863963402564) /* WarMagic            Specialized */;
