...
VALUES (7607,   1, 170, 0, 0) /* Strength */
     , (7607,   2, 120, 0, 0) /* Endurance */
     , (7607,   3, 190, 0, 0) /* Quickness */
     , (7607,   4, 180, 0, 0) /* Coordination */
     , (7607,   5, 180, 0, 0) /* Focus */
     , (7607,   6, 190, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (7607,   1,   130, 0, 0, 190) /* MaxHealth */
     , (7607,   3,   200, 0, 0, 320) /* MaxStamina */
     , (7607,   5,   300, 0, 0, 490) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (7607,  6, 0, 3, 0, 189, 0, 541.132159556608) /* MeleeDefense        Specialized */
     , (7607,  7, 0, 3, 0, 300, 0, 541.132159556608) /* MissileDefense      Specialized */
     , (7607, 12, 0, 3, 0, 200, 0, 541.132159556608) /* ThrownWeapon        Specialized */
     , (7607, 13, 0, 3, 0, 130, 0, 541.132159556608) /* UnarmedCombat       Specialized */
     , (7607, 14, 0, 3, 0, 140, 0, 541.132159556608) /* ArcaneLore          Specialized */
     , (7607, 15, 0, 3, 0, 200, 0, 541.132159556608) /* MagicDefense        Specialized */
     , (7607, 20, 0, 3, 0, 180, 0, 541.132159556608) /* Deception           Specialized */
     , (7607, 24, 0, 3, 0,  95, 0, 541.132159556608) /* Run                 Specialized */
     , (7607, 31, 0, 3, 0, 105, 0, 541.132159556608) /* CreatureEnchantment Specialized */
     , (7607, 33, 0, 3, 0, 105, 0, 541.132159556608) /* LifeMagic           Specialized */
     , (7607, 34, 0, 3, 0, 105, 0, 541.132159556608) /* WarMagic            Specialized */;
...
VALUES (7607, 2,  5709,  3, 0, 0, False) /* Create Ball of fire (5709) for Wield */
     , (7607, 9,     0,  0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure */
