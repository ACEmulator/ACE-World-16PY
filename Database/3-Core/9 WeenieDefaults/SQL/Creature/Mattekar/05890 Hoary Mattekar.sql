...
VALUES (5890, 001 /* SETUP_DID */, 33555590)
     ...
     , (5890, 035 /* DEATH_TREASURE_TYPE_DID */, 456 /* Loot Tier: 3 */);
...
VALUES (5890, 9, 5892, 0, 0, 0.03, False) /* Create Hoary Mattekar Hide for ContainTreasure_DestinationType */
     , (5890, 9, 0, 0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure_DestinationType */;
