...
VALUES (9401, 001 /* SETUP_DID */, 33555590)
     ...
     , (9401, 035 /* DEATH_TREASURE_TYPE_DID */, 457 /* Loot Tier: 2 */);
...
VALUES (9401, 9, 9413, 0, 0, 0.02, False) /* Create Dread Mattekar Paw for ContainTreasure_DestinationType */
     , (9401, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
