...
VALUES (9400, 001 /* SETUP_DID */, 33555590)
     ...
     , (9400, 035 /* DEATH_TREASURE_TYPE_DID */, 457 /* Loot Tier: 2 */);
...
VALUES (9400, 9, 9412, 0, 0, 0.02, False) /* Create Dire Mattekar Paw for ContainTreasure_DestinationType */
     , (9400, 9, 0, 0, 0, 0.98, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 2 for ContainTreasure_DestinationType */;
