...
VALUES (6540, 9,     0,  0, 0, 0.99, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure */
     , (6540, 9,  6058,  0, 0, 0.01, False) /* Create Dark Shard (6058) for ContainTreasure */;
