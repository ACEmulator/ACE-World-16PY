...
VALUES (6832, 9,     0,  0, 0, 0.97, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 3 for ContainTreasure */
     , (6832, 9,  6059,  0, 0, 0.03, False) /* Create Dark Sliver (6059) for ContainTreasure */
     , (6832, 8,  6818,  0, 0, 1, False) /* Create Spire Key Chunk - Sawato (6818) for Treasure */;
