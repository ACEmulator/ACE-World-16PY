...
VALUES (6535, 001 /* SETUP_DID */, 33554433)
     ...
     , (6535, 035 /* DEATH_TREASURE_TYPE_DID */, 465 /* Loot Tier: 1 */);
...
VALUES (6535, 9, 6060, 0, 0, 0.01, False) /* Create Dark Speck for ContainTreasure_DestinationType */
     , (6535, 9, 0, 0, 0, 0.99, False) /* Create RANDOMLY GENERATED TREASURE from Loot Tier 1 for ContainTreasure_DestinationType */;
