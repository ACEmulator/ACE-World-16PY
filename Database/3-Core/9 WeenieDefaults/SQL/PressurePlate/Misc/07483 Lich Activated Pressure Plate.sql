...
VALUES (7483,   1, 0x02000450) /* Setup */
     , (7483,   2, 0x09000021) /* MotionTable */
     , (7483,   8, 0x060012D2) /* Icon */
     , (7483,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (7483,  16, 0x00000000) /* ActivationTarget */;
...
VALUES (7483, -1, 7820, 480, 1, 1, 1, 4, -1, 0, 0, 0, -1, 0, 0, 0.707107, 0, 0, -0.707107) /* Generate Lich (7820) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (7483, -1, 7820, 480, 1, 1, 1, 4, -1, 0, 0, 0, 1, 0, 0, 0, 0, 0, -1) /* Generate Lich (7820) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
