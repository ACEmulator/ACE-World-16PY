...
VALUES ('2623', 'tradenote1000', 51) /* Stackable */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2623,   1,     262144) /* ItemType - PromissoryNote */
     , (2623,   5,          5) /* EncumbranceVal */
     , (2623,   8,          5) /* Mass */
     , (2623,   9,          0) /* ValidLocations - None */
     , (2623,  11,        100) /* MaxStackSize */
     , (2623,  12,          1) /* StackSize */
     , (2623,  13,          5) /* StackUnitEncumbrance */
     , (2623,  14,          5) /* StackUnitMass */
     , (2623,  15,       1000) /* StackUnitValue */
     , (2623,  16,          1) /* ItemUseable - No */
     , (2623,  19,       1000) /* Value */
     , (2623,  33,          1) /* Bonded - Bonded */
     , (2623,  93,       1044) /* PhysicsState */;
