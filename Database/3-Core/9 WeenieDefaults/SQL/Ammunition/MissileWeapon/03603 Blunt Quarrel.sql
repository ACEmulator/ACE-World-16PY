...
VALUES (3603, 'boltblunt', 5, '2005-02-09 10:00:00') /* Ammunition */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (3603,   1,        256) /* ItemType - MissileWeapon */
     , (3603,   3,         20) /* PaletteTemplate - Silver */
     , (3603,   5,         10) /* EncumbranceVal */
     , (3603,   8,          2) /* Mass */
     , (3603,   9,    8388608) /* ValidLocations - MissileAmmo */
     , (3603,  11,        250) /* MaxStackSize */
     , (3603,  12,          1) /* StackSize */
     , (3603,  13,         10) /* StackUnitEncumbrance */
...
VALUES (3603,  22,    0.25) /* DamageVariance */
