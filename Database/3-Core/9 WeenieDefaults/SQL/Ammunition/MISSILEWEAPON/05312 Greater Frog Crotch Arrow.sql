...
VALUES ('5312', 'arrowgreaterfrogcrotch', 5) /* Ammunition */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5312,   1,        256) /* ItemType - MissileWeapon */
     , (5312,   3,         77) /* PaletteTemplate - BlueGreen */
     , (5312,   5,         10) /* EncumbranceVal */
     , (5312,   8,          2) /* Mass */
     , (5312,   9,    8388608) /* ValidLocations - MissileAmmo */
     , (5312,  11,        250) /* MaxStackSize */
     , (5312,  12,          1) /* StackSize */
     , (5312,  13,         10) /* StackUnitEncumbrance */
