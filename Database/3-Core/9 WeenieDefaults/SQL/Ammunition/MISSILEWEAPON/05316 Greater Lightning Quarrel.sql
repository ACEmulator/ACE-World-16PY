...
VALUES (5316, 'boltgreaterelectric', 5, '2005-02-09 10:00:00') /* Ammunition */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5316,   1,        256) /* ItemType - MissileWeapon */
     , (5316,   3,         82) /* PaletteTemplate - PinkPurple */
     , (5316,   5,         10) /* EncumbranceVal */
     , (5316,   8,          2) /* Mass */
     , (5316,   9,    8388608) /* ValidLocations - MissileAmmo */
     , (5316,  11,        250) /* MaxStackSize */
     , (5316,  12,          1) /* StackSize */
     , (5316,  13,         10) /* StackUnitEncumbrance */
...
VALUES (5316,  22,    0.25) /* DamageVariance */
