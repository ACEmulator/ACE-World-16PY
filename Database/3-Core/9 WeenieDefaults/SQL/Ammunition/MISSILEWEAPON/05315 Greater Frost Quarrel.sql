...
VALUES ('5315', 'boltgreaterfrost', 5) /* Ammunition */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5315,   1,        256) /* ItemType - MissileWeapon */
     , (5315,   3,          2) /* PaletteTemplate - Blue */
     , (5315,   5,         10) /* EncumbranceVal */
     , (5315,   8,          2) /* Mass */
     , (5315,   9,    8388608) /* ValidLocations - MissileAmmo */
     , (5315,  11,        250) /* MaxStackSize */
     , (5315,  12,          1) /* StackSize */
     , (5315,  13,         10) /* StackUnitEncumbrance */
...
VALUES (5315,  22,    0.25) /* DamageVariance */
