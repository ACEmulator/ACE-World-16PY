...
VALUES (2591, 'shirtpuffy', /* Clothing_WeenieType */ 2);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (2591, 1, 'Shirt') /* NAME_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2591, 1, 33554644) /* SETUP_DID */
     , (2591, 3, 536870932) /* SOUND_TABLE_DID */
     , (2591, 36, 234881046) /* MUTATE_FILTER_DID */
     , (2591, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (2591, 6, 67108990) /* PALETTE_BASE_DID */
     , (2591, 7, 268435710) /* CLOTHINGBASE_DID */
     , (2591, 8, 100667376) /* ICON_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2591, 9, 30) /* LOCATIONS_INT */
     , (2591, 1, 4) /* ITEM_TYPE_INT */
     , (2591, 27, 1) /* ARMOR_TYPE_INT */
     , (2591, 19, 15) /* VALUE_INT */
     , (2591, 3, 8) /* PALETTE_TEMPLATE_INT */
     ...
     , (2591, 169, 201328144) /* TSYS_MUTATION_DATA_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (2591, 12, 0.66) /* SHADE_FLOAT */
...
VALUES (2591, 100, True) /* DYABLE_BOOL */
