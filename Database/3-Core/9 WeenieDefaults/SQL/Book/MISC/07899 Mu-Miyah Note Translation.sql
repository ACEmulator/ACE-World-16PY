...
VALUES (7899, 'septmumiyahnotetranslated', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (7899, 001 /* NAME_STRING */, 'Mu-Miyah Note Translation')
     , (7899, 014 /* USE_STRING */, 'Use this item to read it.')
     , (7899, 015 /* SHORT_DESC_STRING */, 'The translation of a message carried by a Mu-Miyah.')
     , (7899, 016 /* LONG_DESC_STRING */, 'The translation of a message carried by a Mu-Miyah.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (7899, 001 /* SETUP_DID */, 33554773)
     , (7899, 003 /* SOUND_TABLE_DID */, 536870932)
     , (7899, 008 /* ICON_DID */, 100668176)
     , (7899, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7899, 001 /* ITEM_TYPE_INT */, 128 /* TYPE_MISC */)
     , (7899, 005 /* ENCUMB_VAL_INT */, 25)
     , (7899, 008 /* MASS_INT */, 5)
     , (7899, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (7899, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (7899, 019 /* VALUE_INT */, 20)
     , (7899, 033 /* BONDED_INT */, 1 /* Bonded_BondedStatus */)
     , (7899, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7899, 054 /* USE_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7899, 022 /* INSCRIBABLE_BOOL */, False)
     , (7899, 023 /* DESTROY_ON_SELL_BOOL */, True);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (7899, 12, 1000) /* Book Data */;
