...
VALUES (8853, 0, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 1, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 2, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 3, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 4, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 5, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 6, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 7, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, 'When the explorers rushed to destroy it, the crystal defended itself with powerful magics. Many were slain, but in the end the Isparians prevailed. Abrim of Morningthaw chronicled the final battle against the Work in his tale "Return to Frore," which became a bestseller at the capital towns of Cragstone, Hebian-To, and Zaikhal.
...
')
     , (8853, 8, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
...
')
     , (8853, 9, 0xFFFFFFFF, 'Jaiph Rainshadow', 'prewritten', False, '
