...
')
     , (24108, 3, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'architecture once prominent on Ireth Lassel, 
...
')
     , (24108, 6, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'prior to this, the Third Age of Lore. We are constantly rediscovering ancient ruins of cultures that time has swallowed or swept away...
...
')
     , (24108, 7, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'The next research trip will be lead by Delacim. I''ll make sure to send both Yaeve and Raem along, as they can both draw further and perhaps more resolute conclusion by further exposure to the denizens of the world. Though the focus will not be placed upon the Tonk but on the Banderlings, a race to which we will not expose ourselves, I think that it will offer more insight to all three theories.
');
