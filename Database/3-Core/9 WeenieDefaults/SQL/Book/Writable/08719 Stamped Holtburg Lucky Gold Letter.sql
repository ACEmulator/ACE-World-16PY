...
VALUES (8719, 0, 0xFFFFFFFF, '', 'prewritten', False, 'Once this rare Gold Letter is stamped with a Town Stamp, it can be turned into an authorized Society Agent for a reward. Look in the Book of Quests for New Explorers to start on your way. Any of the Society Agents who are catering to new arrivals  in the nine Nexus towns maybe be contacted to obtain this guide
')
     , (8719, 1, 0xFFFFFFFF, '', 'prewritten', False, '"I intend no offense to my esteemed friend Olivier, but Banderlings serve only one purpose for me: to harass me as I race to Glendon Wood from Zaikhal in order to make my dinner date with the angelic Kristina.  Sometimes it seems as all the creatures of Dereth conspire to prevent me from fulfilling my social obligations."
