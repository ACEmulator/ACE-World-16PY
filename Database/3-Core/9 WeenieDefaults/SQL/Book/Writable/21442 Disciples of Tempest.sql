...
VALUES (21442,   1, 0x020009C1) /* Setup */
     , (21442,   3, 0x20000014) /* SoundTable */
     , (21442,   7, 0x100003EA) /* ClothingBase */
     , (21442,   8, 0x060027C3) /* Icon */
     , (21442,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (21442, 20, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (21442, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'There is much to be said for energy and the correlation to treachery. There is also much to be said for intelligence and the application of that intelligence into something that leads to greatness. 
...
')
     , (21442, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Within the walls of my home shall these books remain, until such a time that they are no longer necessary as a - (Translator note: Whether this area is an omission or another in the strange oddities that I have found throughout these tomes I do not know. Regardless it can be seen as how one would not see the warnings that are presented herein.)
')
     , (21442, 2, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Discoveries of the Blessed Tempest
...
')
     , (21442, 6, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'When one undergoes the process to anchor the soul to a body that will not decay they remove the life force from the self but leave the energy, and essence of themselves behind, within the vessel.
...
')
     , (21442, 7, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Being threatened with extinction changes your view slightly and so when we heeded the Master''s call we cared very little about consequence and focused more upon the immediate benefit. Eternity is forever. This is not a misnomer. It is a misdirection. 
...
')
     , (21442, 8, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'But that remnant of the self is lost to echo for eternity upon the wind, in the soil, in the halls where they walked.
...
')
     , (21442, 11, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We are taught to command them if we wish to command the Heiromantic arts, and given the tools early on to partake in the most brutal and grueling of the magical arts. But we are not told of where the power that flows through you to perform the art comes from.
...
')
     , (21442, 15, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We have begun to map them and at the same moment entrenched ourselves in the study of solidification to better grasp what it is we are attempting to do.
...
')
     , (21442, 16, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'At first there was no practical application for such but soon we realized that if we were sworn to an aspect of the existing elements we would be able to draw enough of the Blood into a form that would be the epitome of that element and thus draw one step closer to achieving the goal of giving rise the oldest being that this world has known.
...
')
     , (21442, 17, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Soon we shall have mastered the summoning of these beings and use them as we use golems, and the effect will be less costly. For while you have attuned your spirit to such a being you may use it to sense what lies around it, thus they are a nearly imperceptible scout force.
...
')
     , (21442, 18, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '(Translator Note: The voice shifts here.)
...
')
     , (21442, 19, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'within mnemosynes. Tiny boxes created for the specific purpose of harvesting. Of course they are collected, and put in a place of safe keeping.
