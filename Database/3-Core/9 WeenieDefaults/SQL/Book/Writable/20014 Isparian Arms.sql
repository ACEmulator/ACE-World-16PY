...
VALUES (20014, 0, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Isparian Arms
...
')
     , (20014, 1, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'this manuscript is written with an air of haste.
...
')
     , (20014, 2, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Our first efforts involved the use of Olthoi Ichor and later Grievver Ichor. Neither did anything more than reduce the ingot to slag.
...
')
     , (20014, 3, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'succeeded at devising a spell that would do just that and hold our elixirs. Hiro, can explain that in more detail than I.
...
')
     , (20014, 4, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Purpose
...
')
     , (20014, 5, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'By the end of a two week deliberation, during which Nuhmudira argued her point so well, that nearly all of the Arcanum agreed that the greatest threat to us on Dereth was indeed the Empyrean, it was decided that we would branch into several different arms.
...
Spellcrafters
')
     , (20014, 6, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'And Tinkerers.
...
')
     , (20014, 7, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'When Nuhmudira succeeding in loosing so much of the power that had been locked away into the metals we though that she had succeeded at what she wanted.
...
')
     , (20014, 8, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'over this news.
...
Frustrating.
')
     , (20014, 9, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Resolution
...
')
     , (20014, 10, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'I glanced up and saw his long white beard and amber eyes, Lord Asheron Realadain.
...
')
     , (20014, 11, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'He has made efforts to explain what we could not fathom and I have learned from him.
...
Ciandra
')
     , (20014, 12, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Diamond Oil
...
')
     , (20014, 13, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'To craft it we will need powdered chorizite and the mana from the place that Asheron opens. The oil will then be prepared.
...
')
     , (20014, 14, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Weapon Infusion
...
')
     , (20014, 15, 0xFFFFFFFF, 'Ciandra ', 'prewritten', False, 'You should obtain one of four qualities for weapons as well.
...
')
     , (20014, 16, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'This is a process that Nuhmudira was searching for, but Lord Asheron was kind enough to show us.
...
')
     , (20014, 17, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Once the heart has been imbued with the oil find one who can carve keys and ask them to craft the altered Diamond Heart for you. The result should be a tool that will fit perfectly into the weapon to remove any of the elemental stones.
