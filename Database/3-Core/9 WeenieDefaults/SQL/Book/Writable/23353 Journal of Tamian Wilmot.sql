...
VALUES (23353,   1, 0x02000153) /* Setup */
     , (23353,   3, 0x20000014) /* SoundTable */
     , (23353,   8, 0x060029D7) /* Icon */
     , (23353,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (23353, 11, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (23353, 0, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, 'I love to draw and for this reason she will never love me.  I favor the sketching of designs over the heft of a blade. Thus, she will not love me.
...
')
     , (23353, 1, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, ' I jumped in after you. I could hear our parent''s cries fading behind me as if smothered by a down blanket.  Fortunately for us, they followed soon after.
...
')
     , (23353, 2, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, 'smell of your hair. They say love is of the heart, but why is it whenever you are close my stomach jumps like it is filled with all the rabbits that dwell around Rithwic? Yet, I could never tell you.
...
')
     , (23353, 3, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, 'buildings. Fate has denied me this. This world values not such a skill.
...
')
     , (23353, 6, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, 'can only be imagined now! You had to go then, but for the remainder of that day my happiness knew no bounds.
...
')
     , (23353, 7, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, 'looked at him...
...
')
     , (23353, 10, 0xFFFFFFFF, 'Tamian Wilmot', 'prewritten', False, 'Did you even know I had left?
