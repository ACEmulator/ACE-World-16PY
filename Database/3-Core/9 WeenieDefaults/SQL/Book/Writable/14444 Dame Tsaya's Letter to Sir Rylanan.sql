...
VALUES (14444, 0, 0xFFFFFFFF, 'Dame Tsaya', 'prewritten', False, 'Sir Rylanan,
...
')
     , (14444, 2, 0xFFFFFFFF, 'Dame Tsaya', 'prewritten', False, 'What''s more, Sir Tenshin has written me with news from Shoushi. It seems strange happenings are not unique to Yaraq at this time. I include the text from his message below.
...
***
')
     , (14444, 3, 0xFFFFFFFF, 'Dame Tsaya', 'prewritten', False, '(Copy of a letter to Dame Tsaya from Sir Tenshin)
...
')
     , (14444, 4, 0xFFFFFFFF, 'Dame Tsaya', 'prewritten', False, 'After interviewing the farmer, the bearer of this message found a trap door towards the rear of his house, leading down to a seeminly innocuous cellar. However, a large cache of weapons was found behind a hidden doorway as well as stacks of Guard uniforms.
