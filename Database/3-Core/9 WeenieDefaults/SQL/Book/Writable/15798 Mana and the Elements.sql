...
VALUES (15798,   1, 0x020009C1) /* Setup */
     ...
     , (15798,   7, 0x10000388) /* ClothingBase */
...
')
     , (15798, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We shall not fail. For it is the blood of the righteous. Our truths shall purge the Yalaini from the world, and bring again the reign of the Gelid.
...
')
     , (15798, 2, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'They have likened us to the reign of the one that cannot be named. Having listened to the whispers from the Blood itself, seeking to join with it, rather than prove its master.
...
')
     , (15798, 3, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We will pull from the blood, the essence of its parts, and go to the Throne with bloody swords in hand, to rip the throat from the usurper, ending his reign of deceit and cruelty and freeing the memory of our kin.
...
')
     , (15798, 4, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We know only what we know, and tread with due caution into the unknown.
')
     , (15798, 5, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Blood of the World
...
')
     , (15798, 6, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Blood of the World
...
')
     , (15798, 7, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Our search for the remaining focal points has begun. Then the construction of the collection devices will begin.
...
')
     , (15798, 8, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Summoning
...
revolt
')
     , (15798, 9, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'proclivity toward intelligent and rational thought, not the best quality in a subordinate race.
...
black ritual
')
     , (15798, 10, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'in death we will prevail
...
')
     , (15798, 11, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Study of this condition

unbelievable qualities
')
     , (15798, 12, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '(Twenty pages are nothing more than charred nubs. The final page remains somewhat intact, but the ashes and charcoal that have been smeared across it over the millenia have left only one passage readable.)
