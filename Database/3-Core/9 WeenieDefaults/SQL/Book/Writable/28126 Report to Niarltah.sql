...
VALUES (28126,   1, 0x02000154) /* Setup */
     , (28126,   3, 0x20000014) /* SoundTable */
     , (28126,   8, 0x0600104E) /* Icon */
     , (28126,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (28126, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (28126, 0, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'After the success of the last report, we have decided that all future missives will be handled in such a manner. Torgluuk has yet to make mention if he is aware of our machinations.

Ikakhe
')
     , (28126, 1, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Translation
...
')
     , (28126, 2, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'They consume the mucor and know much of what transpires across the world. They come to think of The Sleeping One as the underground swamp in which they live. Dark, potent and pock marked with pustules of filth. They herald a time when it will crack the world and a flood will carry them to the surface to bring vengeance to their enemies.
')
     , (28126, 3, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'The Burun in the great swamps continue to preach the tales of The Sleeping One, but lack of mucor and poisoning from various molds, fungus and algae that are now used to enact rites drive many of the surface dwelling Burun mad. They envision their god as an amorphous pustule of slick muck covered in pustules that vomit putrescence onto the world. The madness is spared of a small contingent of Burun that have access to the mucor. This group of Burun adhere to The Sleeping One''s true form as the watcher in the sky.
')
     , (28126, 4, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Fiazhat, without the guidance of their gods, continue to show reverence to those that brought them to the height of this world. Spoken tradition gives way to a written tradition. Cities are built once more and the temples crafted to their gods are returned to former splendor. Storytellers become the voice of the gods and are chosen as leaders for their people. Wars are forgotten and the Burun become an afterthought of Fiazhat culture in the ensuing five thousand cycles.
');
