...
VALUES (21093, 0, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'When Asheron first came into the Consortium, I was amazed. He offered us knowledge beyond everything we had begun to comprehend thus far and he directed our attentions to some shortcomings. 
...
')
     , (21093, 1, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'language as explained to us by Asheron. It means; that which reduces, or at least that is the closest conversion in Roulean.
...
')
     , (21093, 2, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Basics
...
')
     , (21093, 3, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Qualities
...
')
     , (21093, 4, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'was used to craft the object. Typically these are metals, stones, cloths and gems.
...
')
     , (21093, 5, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Ust would mean that all other objects placed within would need to be made of wool in order for the process to work.
...
')
     , (21093, 7, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'amazing thing about this process is that the Ust recognizes when there are items mixed with materials. When instances such as this arise it will obtain the quantity and average workmansip quality of the items and add them to the existing materials. 
...
')
     , (21093, 8, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'amount of items used. 
...
')
     , (21093, 9, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'for example is an excellent source of insulation from the cold. It''s no surprise then that it will affect the level of cold protection that armor offers. 
...
')
     , (21093, 10, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'working on direct applications, and item tinkerers work with the generic applications such as weight, and value of objects. Again without training in one of these areas, it will not be possible for a person to apply materials.
...
')
     , (21093, 11, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'the application.
...
')
     , (21093, 12, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, 'Second, lesser quality wokrmanship items are easier to improve as they were not that well crafted to begin with. The more close to perfect an item is the harder it will be to improve.
...
')
     , (21093, 13, 0xFFFFFFFF, 'Ciandra', 'prewritten', False, '
');
