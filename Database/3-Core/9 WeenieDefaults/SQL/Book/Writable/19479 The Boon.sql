...
VALUES (19479, 'booknuhmudirasboon', 8, '2005-02-09 10:00:00') /* Book */;
...
')
     , (19479, 1, 0xFFFFFFFF, 'Numudira', 'prewritten', False, 'the upkeep and placement of the covenant stones before our homes. This world is ours, Isparians, and as such we should do our best to make it so.
...
')
     , (19479, 2, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'I digress.
...
')
     , (19479, 3, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'It became apparent quickly that the varying grades of metal allowed for easier use of the imbued spells, but that the spells themselves were weakened by the metal. The charge of the magic however did not fade.
...
')
     , (19479, 4, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'Since that time, other studies have consumed my efforts and I have taught Hiro the secrets of the spell. He shall take on the resposibility of infusing my gift to the Isparian peoples.

Nuhmudira 
')
     , (19479, 5, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'Nuhmudira''s Boon
...
')
     , (19479, 6, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'a cycle of the moons, but no more than that of each type for each person that comes to me. I will need to rest after doing such.
...
')
     , (19479, 7, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'There are three grades of pyreal that have been used. For ease of recognition we have made them into discernable colors: red, blue and green.
...
')
     , (19479, 8, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'To create the object, I must be given the unimbued version of the neckpiece. I will then infuse the piece with the power of Nuhmudira''s spell. After this it will be prepared for the addition of an elixir that is the concentrated form of a School of the Left Hand.
...
')
     , (19479, 9, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'onto the neckpiece.
...
')
     , (19479, 10, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'Elixir of Might - Enhances Strength
...
')
     , (19479, 11, 0xFFFFFFFF, 'Hiro', 'prewritten', False, 'Elixir of Misty Form - Provides protection from Bludgeoning devices and spells.
