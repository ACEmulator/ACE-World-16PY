...
VALUES (24106,   1, 0x020009C1) /* Setup */
     , (24106,   3, 0x20000014) /* SoundTable */
     , (24106,   8, 0x06001F05) /* Icon */
     , (24106,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24106, 3, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24106, 0, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'Aurlanaa, the last of the Gromnatross has left our world. Still they do not see what they have become.
...
')
     , (24106, 2, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'from Adja''s hand is true, am I then the last champion? Am I the only being in the universe that sees that the Light is dying?
