...
VALUES (28125,   1, 0x02000154) /* Setup */
     , (28125,   3, 0x20000014) /* SoundTable */
     , (28125,   8, 0x0600104E) /* Icon */
     , (28125,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (28125, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (28125, 0, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Niarltah. Torgluuk appears to be catching on that the book is disappearing when he rests. There has been an increased guard watching his belongings. We have been able to obtain the book but our translation must be hurried. We have begun to list the happenings in a more formalized standard. It appears that this book is a record of all the knowledge of the mucor on the Burun homeworld.

Ikakhe
')
     , (28125, 1, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Translation
...
')
     , (28125, 2, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Burun beg of their god, The Sleeping One and are rewarded by rains that begin to turn the dry lands of the iallootu to mire. The Fiazhat, without the dry land begin to suffer and the world begins to become a swamp world again. Fiazhat cluster together begging to their silent gods for assistance. Their prayers do not go unanswered.
')
     , (28125, 3, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'The mucor senses a shift in the world. The magic transported by the false gods of the Fiazhat causes a catastrophic shift at the core of the world. Earthquakes tear open and swallow the swamps into subterranean lairs then close over again in the ensuing madness. Burun are split into two pairs surface dwellers and those that were drawn into the deep mire without the light of The Sleepless One.
')
     , (28125, 4, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'The climate shift causes the rains to cease and the land begins to burn once more. 
