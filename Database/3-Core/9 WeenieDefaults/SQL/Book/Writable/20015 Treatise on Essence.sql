...
VALUES (20015, 0, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'I have for too long now, sat removed from you, turning a blind eye to the horrors that you have been subjected to so recently. 
...
')
     , (20015, 1, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'Magic is. There is no way around that, and here on Ireth Lassel, Dereth, to you and the other Isparians, the fields of magic and lines that run beneath Auberean are strongest. 
...
')
     , (20015, 3, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'I have not spent much time in studying them. During the height of our age, my attentions were elsewhere, and their resurgence at the defeat of Bael''zharon made them appear as though they were something that my people had inadvertently stifled when we first trapped the Hopeslayer. So it was nothing more than a boon for you and yours when the magic of the world surged with power.

But now, I wonder.

I have watched these placed and see something odd.
')
     , (20015, 4, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'The workmanship is reminiscent of the Gelid Age. When those that once lived on the Gelid Plain struggled and toiled to reestablish their hold on the world against the Yalain and our allies. Their effort, you have seen before in the great work at Frore. A device established to syphon, the power of something else...

I shall not go into a history lesson there. 

Essence is as magic is. It is an all encompassing force that can be broken
')
     , (20015, 5, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'into to structured categories that are described by the various schools that you possess. To you and the other Isparians, there are four schools.
...
')
     , (20015, 6, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'Thus far it is only Nuhmudira and the altered human, Candeth Martine that have grasped the higher concepts of magic, and put them into use.
...
')
     , (20015, 7, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'Elementals are an aspect of essence, coalesced, given form and given consciousness by a master. This practice took place within a very small sect of beings eons ago. Those beings were destroyed utterly, by their kin. The Gelid.
...
')
     , (20015, 8, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'you take into account the process by which it appears that they were made.
...
')
     , (20015, 9, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'The power instead was redirected into the masters of the "elemental", and the elemental itself. 
...
')
     , (20015, 10, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'Fortunately, the Gelid quelled this renegade faction. 
...
')
     , (20015, 11, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'awaken this long dead practice. He is unawares of the damage that he could possibly wreak. Or he consciously wishes to see this world destroyed.
...
')
     , (20015, 12, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'As hypocrtical as this may sound, I am opening a way to a font of essence. There you will collect pure mana so that you may forge new weapons from pyreal to better combat the enemies that will rise to face you. Use it wisely.
