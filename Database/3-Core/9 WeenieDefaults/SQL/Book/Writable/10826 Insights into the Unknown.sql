...
')
     , (10826, 5, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'Claude''s mission to observe and interact with the flesh puppets proved a useful source of knowledge.  The more the Quiddity learned, the more it feared and loathed the humans and the chaos they represent.  The Quiddity began to explore the feasibility of a move to neutralize or eradicate the humans, lest their taint spread.  Plans were proposed and evaluated, but no action was taken.  In this, as in all things, the Quiddity would move cautiously.
')
     , (10826, 6, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'Others already in this realm, however, reacted differently.  Levistras, a Director who had been in-realm for quite some time, long enough to give itself a name, began to form an agenda of its own.  It saw humans as both a threat and as its salvation.  With its newfound autonomy, Levistras entertained the notion of breaking free from the Quiddity and forming its own home, its own Singularity, in the realm.
')
     , (10826, 7, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'A mongrelized notion, to be sure, and evidence of incomplete thought-processes, but a notion that held appeal for other Directors, those given the greatest autonomy and perhaps those with the most to gain if granted independence from the Quiddity.
 
Levistras helped several other Directors make a significant break from our unity.
')
     , (10826, 8, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'This rebellion was made possible, ironically, with the help of the humans, at the time when they were rallying themselves to defeat the Dark Walker.  Apparently, Levistras came into contact with a being named Asheron.  Asheron was the last remnant of the former masters of this realm, who had powers over location and space similar to our own.  The history of these "Empyrean" is an interesting story itself, one that still bears investigation.  But this is not the story I relate now.
')
     , (10826, 9, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'This Asheron has taken it upon himself to be the protector of the humans who found themselves in this realm.  He lent the humans aid when his enemy, the Dark Walker as we know him, began a campaign to conquer the realm and destroy their race.  Asheron made overtures to others who held power in the
...
')
     , (10826, 10, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'The humans stole a piece of the fragment and Asheron used its energies to strike a critically weakening blow against the Dark Walker.
...
')
     , (10826, 11, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'The human contact with the fragment also accelerated the decay in order among our ranks of agents, to the ultimate profit of Levistras rebel Directors -- Directors apparently already far into taint, easily swayed with wild suppositions and faulty logic.

')
     , (10826, 12, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, '
...
')
     , (10826, 13, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'But still they persist, and they labor in their deluded belief that they will some day achieve independence and ultimate power.
...
')
     , (10826, 14, 0xFFFFFFFF, 'Lythusser', 'prewritten', False, 'Another researcher named Lacandrillar was similarly brought low by humans.  Both of these were denied re-assimilation, their energies released to the void, given to oblivion.
