...
VALUES (24112,   1, 0x020009C1) /* Setup */
     , (24112,   3, 0x20000014) /* SoundTable */
     , (24112,   8, 0x06001F05) /* Icon */
     , (24112,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24112, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24112, 0, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'Mournful disaster struck as we breached the world of those things. We have catalogued them as Olthoi in our libraries, and the warden shall be informed of their existence. But my heart shall never recover.
...
')
     , (24112, 1, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'watched as those whom they new as children grew old and passed away to the dust from whence they were born.
...
')
     , (24112, 3, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'communication away from their masters. In a sense they remind me of Gaerlan, unfaceted, flat, base and depraved with a sense only for survival, at all costs. (Translator''s note: This line was scratched over once as though to be stricken. Personally I agree with Asheron here.)
...
')
     , (24112, 4, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'Delacim was my hope. Now he is gone. I, the servant of the Light, am alone to bear the weight again.
');
