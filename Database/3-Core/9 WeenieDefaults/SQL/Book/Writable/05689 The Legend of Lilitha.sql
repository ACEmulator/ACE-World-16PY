...
VALUES (5689, 0, 0xFFFFFFFF, 'Legend of Lilitha', 'prewritten', False, 'Both hated and revered she was, Lilitha the Hunter.  In the early days of Elysa Strathelar''s reign, Lilitha refused to be bound by duty or conscience, and plunged without care into the dark woods of Tiofor.  Leaving behind all else, she traveled with bow and arrow into the wilds, slaying all manner of beasts and creatures - and even the people who sought to oppose her, it is said.  So she earned the name Hunter.
')
     , (5689, 1, 0xFFFFFFFF, 'Legend of Lilitha', 'prewritten', False, 'Monsters'' teeth and horns she collected, and wore them upon herself.  Gromnie teeth she turned into arrow heads; auroch horn she turned into spears.  She is even said to have worn a helm crafted from a slain Olthoi, and of this she was most proud.  But these were the days when she still occasionally returned to town, to drink and brag and spin her tales - and those days grew few and even fewer as time passed.
')
     , (5689, 2, 0xFFFFFFFF, 'Legend of Lilitha', 'prewritten', False, 'It is said that she was the first to explore Mount Esper, but its beauty held her not, and she traveled on.
...
')
     , (5689, 3, 0xFFFFFFFF, 'Legend of Lilitha', 'prewritten', False, 'It is said that she was the first to travel through the Direlands, even before Alatar Locke, but nothing there could resist her arrows, and so she traveled on.
')
     , (5689, 4, 0xFFFFFFFF, 'Legend of Lilitha', 'prewritten', False, 'Now, in these later days, few remember Lilitha the Hunter.  It is said some of the earliest arrows she used can be found still: cast-off arrows which she made, used, and abandoned back in the days in which she still came back to town to drink and brag and spin her tales.  Where is she now?  No one knows.  Perhaps she has traveled on, with her arrows and her wild love of the hunt, into the next life.
');
