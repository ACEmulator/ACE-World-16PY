...
VALUES (24118,   1, 0x020009C1) /* Setup */
     , (24118,   3, 0x20000014) /* SoundTable */
     , (24118,   8, 0x06001F05) /* Icon */
     , (24118,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24118, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24118, 0, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'Delacim,
...
')
     , (24118, 1, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'of dulling or tarnishing the facts with the much of generations and stirring hate where none once lay. I have lived lifetimes as you have learned. Those years transpire and grow heavier upon my frame. Never had I thought a mother''s kiss could weigh so heavily on the heart of her child.
...
')
     , (24118, 2, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'I give you now the knowledge as it was handed to me, by those who remembered the days before when we were still beings of purity and grace. 
...
')
     , (24118, 3, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'As darkness draws about light
...
')
     , (24118, 5, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'There was but Light and Darkness;
And then Auberean.
...
')
     , (24118, 6, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'So the Darkness lay
Still and silent
