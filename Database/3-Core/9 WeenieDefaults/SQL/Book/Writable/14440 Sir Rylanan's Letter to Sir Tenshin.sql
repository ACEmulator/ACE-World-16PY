...
VALUES (14440, 0, 0xFFFFFFFF, 'Sir Rylanan', 'prewritten', False, 'Sir Tenshin,
...
')
     , (14440, 2, 0xFFFFFFFF, 'Sir Rylanan', 'prewritten', False, 'verbatim so as not to lose the urgency of her words.
...
***
')
     , (14440, 3, 0xFFFFFFFF, 'Sir Rylanan', 'prewritten', False, '(Copy of the letter from Dame Tsaya to Sir Rylanan)
...
')
     , (14440, 4, 0xFFFFFFFF, 'Sir Rylanan', 'prewritten', False, 'attacked on all sides by a party of Hollow Minions, who were obviously lying in ambush for unwary explorers. There was a terrible device in the depths of the Halls, ostensibly created to extract  a living being''s vitals from his own skin, leaving only a perfect human epidermis. One such human husk has been delivered to me, and I must report that the ghastly sight of it has not left me unshaken. I have reserved the remains for proper burial--I cannot imagine the final tortures this poor soul must have been subject to before his final passing.
')
     , (14440, 5, 0xFFFFFFFF, 'Sir Rylanan', 'prewritten', False, 'What disturbs me the most is that I cannot discern a purpose for these atrocities. Who could find a need for these revolting trophies?
