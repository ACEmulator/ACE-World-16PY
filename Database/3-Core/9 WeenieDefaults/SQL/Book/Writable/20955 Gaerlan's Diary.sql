...
VALUES (20955, 0, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'My brother and I have just returned from Aerlinthe. He was there to see that the portals were showing no odd signs of decay, or alteration. Of course I had my own reasons for being there. 
...
')
     , (20955, 1, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'No matter really, a simple reference to my badge of office and he silences. It angers me that due to his reticence in spending time with me, to foster my strength and understanding, I still fail. I could have much easier access to that temple.
...
')
     , (20955, 2, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Odd that the others that are Asheron''s students never question his age, or his position or how he came by such great knowledge. These things do not simply just occur.
...
')
     , (20955, 3, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'intention of dying before I complete my work.
...
')
     , (20955, 4, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Such an extension shows that I have already garnered much worth in his eyes. Enough that when I bring him to the temple he will surely find it within his breadth to name me a court vizier, perhaps more.
...
')
     , (20955, 7, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'excercise undertaken by the Nali, and the Emperor. Further study showed no sign of recent activity. Thick dust weighed heavy on the silent corpses. No activity had taken place at that place in months, perhaps years.
...
')
     , (20955, 8, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'to begins translations of the titles I was met by a breeze. Air funneled in through a small break in the bookcase. There was a room beyond. 
...
')
     , (20955, 9, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'culture. Chill passages twisted deeper into the earth, until I reached a site of a cave-in. Debris blocked normal passage leaving only a small crawlspace.  
...
')
     , (20955, 10, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'unique aspects to each were the position of  corpses. Perhaps those that were once its defenders. It was a maze, a maze of madness and death. Still there was more to discover. 
...
')
     , (20955, 11, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Regarding this as a breakthrough of sorts I attempted further scrying of the crystal. I found beings, perhaps not beings, perhaps memories...something...trapped within. All imprisoned there. Trapped it would seem, forever. A particularly cruel and effective prison.
...
')
     , (20955, 13, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'As well I have found four great cisterns beneath the Menhir. These too are linked.
...
')
     , (20955, 14, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'So it shall be.
...
')
     , (20955, 15, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Many years have passed since our youth. When we went to Aerlinthe that first time we were equals. He built the portal structure, while I visited the foundries and made my discovery. Now, he surpasses me in every way. 
...
')
     , (20955, 16, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'to activate the portal home. We shall have precious time to return as always. The same speech again and again. How his adepts do not go mad I cannot fathom. He dodders.
...
')
     , (20955, 17, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'was already known to me. Hardly worth notice as far as I am concerned. I have intention of giving the Emperor an army of his own that is obedient, malleable, and devastating. Until I am prepared however, I must continue to keep my efforts quiet.
...
')
     , (20955, 18, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Asheron eschewed the question and focused back on our visit offworld.
...
')
     , (20955, 19, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'ichor. The boy is dying. Earlier today he  ventured too close to one of the prolific fungi covering the fetid landscape. The thing issued a sporule cloud into the air and the boy was caught within the blast.
...
')
     , (20955, 20, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'within his lungs. 
...
')
     , (20955, 21, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Days have passed since it happened but the incident is still fresh within my mind. Burned there. Etched. Seared forever in my memory. A stain, a blotch on my thoughts, on my very soul.
...
')
     , (20955, 22, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Our expedition progressed. A makeshift gurney was crafted to carry the dead adept, and we pressed further.
...
')
     , (20955, 23, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'moisture gathered fungi grew at an alarming rate, and to even more alarming heights.
...
')
     , (20955, 24, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'horror and disease. Vile rivers of steaming, stinking, water gurgled along, half-choked by fungal growth. 
...
')
     , (20955, 26, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'the light around itself to blend in with the cap of the fungus it rested upon. Akin to a cricket, a simple insect, the thing was much larger of course, yet acted in the same ways. 
...
')
     , (20955, 27, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'them into a jagged mouth. Its wings fluttered open every once and again stirring the sporules. Its faceted eyes rested on either side of the mouth, ever vigilant of the putrid landscape.
...
')
     , (20955, 28, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'wail burst forth. I heard Asheron scream. I heard Delacim scream, and as I turned I saw the bipedal thing in all its fury.
...
')
     , (20955, 29, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'break through to the things mind to make it peaceful. All this in the space of an instant.
...
')
     , (20955, 30, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'brothers body.
...
')
     , (20955, 32, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'what caused the other beast to attack. Suspicion must first be removed from me.
...
')
     , (20955, 33, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'own guard and three adepts from Asheron''s Lyceum at Knorr. I carry a device that will lead me home, and I have studied Delacim''s notes on planar magic and collapsing portals. Time is my benefactor now. A little more time, and I will have my revenge.
...
')
     , (20955, 34, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Delacim.
...
')
     , (20955, 35, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'The Emperor listened. Yet he had been set to course by one of my reports. These things would be a force the likes of which had never been seen. We could rule any with these creatures at our command. Asheron''s argument failed and he was here now. 
...
It is done.
')
     , (20955, 36, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'I must be sure to retain every detail. Every minor scent, emotion and progression that occurred. You are avenged my brother, avenged.
...
')
     , (20955, 37, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'the cavity near where we had camped. Our guardians, hurriedly readied their weapons and locked their shields together, forming a tight circle about us as Asheron created a magical dome to ward off physical blows.
...
')
     , (20955, 38, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'splashed over them. Then we could see them for the monstrosities that they truly were. 
...
')
     , (20955, 39, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'to back grew thinner and more streamlined. One approached our position and afforded us a closer look.
...
')
     , (20955, 40, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'The chittering grew louder, and the earth shook. From the area where the glowing eyes, still hidden amongst the fungal fields and dawn dark sky, there came a shrill sound like that of the watcher Olthoi that
...
')
     , (20955, 41, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'land. It was only then that we saw the magnitude of our situation. 
...
')
     , (20955, 42, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'carapace, had thin chitin that shielded their insides. The winged terrors that had earlier surveyed our band flew above the mass dipping from time to time to lift smaller "shock troops" into the air where they hovered.
...
')
     , (20955, 43, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'as their head. The "eyes" which we had seen were actually mottled spots of phosphorescent hair that covered their legs in round patches. They made no noise, but twitched erratically. 
...
')
     , (20955, 44, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'came to a fine point that looked capable of piercing the strongest ship armor of the Imperial fleet.
...
')
     , (20955, 45, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'broken and a foul smelling green acid leaked from the wound. The thing squealed madly as it struggled to right itself onto a shattered leg.
...
')
     , (20955, 46, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'the length of the attacking insectoids bodies. Those olthoi fortunate enough to close into striking distance were met with an even swifter and fouler death. 
...
')
     , (20955, 49, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'still squirmed and wriggled within an arms reach. The soldiers swatted its pincers aside with their shields until they could be manacled properly. 
...
')
     , (20955, 50, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'foul. Light preserve us, oh dear Light preserve us." We did, leaving the old man there to cover our escape.
...
')
     , (20955, 51, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'as though the heavens had been torn asunder.
...
')
     , (20955, 52, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'feigned ignorance of the portal''s collapse and joined them in a frantic search for research on creating a portal back to the world. After an hour, they became disheartened and abandoned their search. They too understood the old man was gone.
...
')
     , (20955, 53, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Our world is no longer ours. It is overrun by a feeble species we discovered some years before the Olthoi swarmed through Knorr. Though they bear a resemblance to us in physical appearance, they are miniscule and meek in the capacity to harness magic. They think that there are but four schools of magic.
...
')
     , (20955, 54, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'fail. 
...
')
     , (20955, 55, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'now in.
...
')
     , (20955, 57, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'commonality with me, hatred of Asheron. Though hers is a more uniform hatred of all our race. Nevertheless she will be used.
...
')
     , (20955, 58, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'I have found a place guarded by the same undead that first built the cisterns. They defend an object that seems to fit as a device to pilot the temple. I have set a thrall to collecting the necessary object for constructing these devices.
...
')
     , (20955, 59, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'command. It shall hear my voice only and bow to my commands. Then I shall wrest this world from Asheron, and wipe these vermin from the world. 
