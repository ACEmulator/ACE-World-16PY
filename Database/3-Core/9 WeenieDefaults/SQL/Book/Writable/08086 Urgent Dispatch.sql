...
VALUES (8086, 0, 0xFFFFFFFF, 'Sahoni Arsanc', 'prewritten', False, '
My lord Anadil,
...
')
     , (8086, 1, 0xFFFFFFFF, 'Sahoni Arsanc', 'prewritten', False, '
...
')
     , (8086, 2, 0xFFFFFFFF, 'Sahoni Arsanc', 'prewritten', False, '
...
')
     , (8086, 5, 0xFFFFFFFF, 'Sahoni Arsanc', 'prewritten', False, 'My lord, I now command a much-depleted force, consisting of the weaker and wounded common soldiery. I do fear we no longer have sufficient force to hold this facility from the servants of the Enemy. I pray you to speed reinforcement, lest the next sally dislodge us utterly. We expect a fresh assault from the upper levels at any moment. I will send this note to you through our last surviving enchanter, Lord Pleridarc of-

I hear now the clatter of renewed combat. The shouts are foreign. They may be in the tongue of the outlanders.
')
     , (8086, 6, 0xFFFFFFFF, 'Sahoni Arsanc', 'prewritten', False, '
