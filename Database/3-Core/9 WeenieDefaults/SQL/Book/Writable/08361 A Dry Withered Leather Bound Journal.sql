...
VALUES (8361, 0, 0xFFFFFFFF, '', 'prewritten', False, 'To whomever may find this:
...
')
     , (8361, 5, 0xFFFFFFFF, '', 'prewritten', False, 'The near constant physical exertion, almost to the point of exhaustion,  left me unable to truly ponder the circumstances of recent events. 
...
')
     , (8361, 6, 0xFFFFFFFF, '', 'prewritten', False, 'Many hours and miles passed beneath our feet, and yet step for step was matched by our pursuers for most of the way.  What desire lurked beneath those misshapen bodies to fuel such effort?
...
')
     , (8361, 7, 0xFFFFFFFF, '', 'prewritten', False, 'homeland.  And yet if they did have such bloodlust towards each other, would we not have seen it before this?
...
')
     , (8361, 12, 0xFFFFFFFF, '', 'prewritten', False, 'Perhaps the rock has some sort of similar importance for the Banderlings.  I wish I knew more about them, but if you receive this note than please try to find a Olivier  Rognath, who resides in Eastham, on the eastern coast of Dereth.  While he is not a full fledged Explorer in the Society, he has been a close ally to our purposes.  He is also far more knowledgeable about Banderlings than I am, although of course even experts on our new neighbors know little.
')
     , (8361, 13, 0xFFFFFFFF, '', 'prewritten', False, 'But if you find this note, and its brother, please journey there to see him.  Maybe he can shed some light on what has been transpiring here.  
