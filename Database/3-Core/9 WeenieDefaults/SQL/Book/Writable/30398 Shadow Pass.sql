...
VALUES (30398, 0, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'The fighting was fierce today. Not that such carnage is unusual for this war, but this is the first time since our arrival that I personally have seen so many die in the course of a single day. 
...
')
     , (30398, 1, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'But the pass was the easiest and quickest way to the outpost, and Sir Furlaine believed that Varicci would never send his troops to such a reputedly haunted place. Eleonora hated the decision. She argued with him for more than an hour. But the command belonged to Sir Furlaine. She had no choice but to accede.  
...
')
     , (30398, 2, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'The Loyalists were perched on the valley wall. They had a clear shot at us. Their arrows fell upon us like rain. Oh, the horror of it. They gave no warning cry, no offer to turn and flee. They simply fired. 
...
')
     , (30398, 3, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'Eleonora took up a dead knight''s shield and retrieved Furlaine''s banner. She gathered the knights around her, shouting over the screams of the dying. They lifted their shields so that the arrows could not get through. Those of us without shields either took them from the dead or huddled close to a shielded knight. 
...
')
     , (30398, 4, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'to the bottom were quickly dispatched by Varicci''s marksmen. 
...
')
     , (30398, 5, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'she dropped her shield and let forth a fierce volley of fire that melted the knights in their armor. This blast gave our men time to scramble to their feet and begin their attack in force. 
...
')
     , (30398, 6, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'our company all knew the story of Eleonora''s victory over Prince Renlen at Lord Marden''s tournament. But hearing stories and seeing them in action are two very different experiences. 
...
')
     , (30398, 8, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'He spat up at her. "Kingslayer wench," he growled. 
...
')
     , (30398, 10, 0xFFFFFFFF, 'Carlo di Cenza', 'prewritten', False, 'I just hope some of us are still alive when he gets it. 
');
