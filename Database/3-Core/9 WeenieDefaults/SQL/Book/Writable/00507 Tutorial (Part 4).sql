...
VALUES (507,   1, 0x02000290) /* Setup */
     , (507,   8, 0x060012D3) /* Icon */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (507, 4, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (507, 0, 0xFFFFFFFF, ' ', 'prewritten', False, 'Tutorial / Part 4 of 5 
...
(more)
')
     , (507, 1, 0xFFFFFFFF, ' ', 'prewritten', False, 'Pay close attention to your surroundings and your compass, and don''t rush through them. It''s easy to lose your bearings. The exit is normally located in the same room as you entered.

Dungeons are also full of vicious creatures. To deal with them, you should ARM yourself.
(more)
')
     , (507, 2, 0xFFFFFFFF, ' ', 'prewritten', False, 'To arm yourself, open your inventory panel and drag a weapon from the inventory to the WEAPON SLOT.
...
(more)
')
     , (507, 3, 0xFFFFFFFF, ' ', 'prewritten', False, 'If you have a shield, drag it to the SHIELD SLOT, to the left of the character''s image on the inventory panel.
