...
VALUES (6414,   1, 0x02000155) /* Setup */
     , (6414,   3, 0x20000014) /* SoundTable */
     , (6414,   8, 0x06001310) /* Icon */
     , (6414,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6414, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6414, 0, 0xFFFFFFFF, 'Decree', 'prewritten', False, 'My People,
...
')
     , (6414, 1, 0xFFFFFFFF, 'Decree', 'prewritten', False, 'The region will be unfit for visitation for centuries hence. After over five hundred years of terror and struggle, the night is again occupied by only Alb''arel, Rez''arel, and the stars.
')
     , (6414, 2, 0xFFFFFFFF, 'Decree', 'prewritten', False, 'We are weary, my people, and stained with too much blood. Now is the time for us to drop our weapons and armor, to sleep the sleep of the just for a night, and awaken to make the world anew. Our people once were scholars, enjoying a golden age of peace and enlightenment. I should like to see that glittering world of my childhood again.
')
     , (6414, 3, 0xFFFFFFFF, 'Decree', 'prewritten', False, 'To this end, I require the chevairds and common warriors of Caerlin''s army to turn over the weapons created by Lord Atlan and Lady Maila. They are powerful and deadly things, and before any man or woman succumbs to the temptation to abuse them, I shall see them broken, scattered, and buried in secure vaults across the face of Ireth Lassel. I pray we may never see the need for such foul devices again. We have all of us lost too great and too dear.
')
     , (6414, 4, 0xFFFFFFFF, 'Decree', 'prewritten', False, 'I am in mourning. Forgive my brevity.
