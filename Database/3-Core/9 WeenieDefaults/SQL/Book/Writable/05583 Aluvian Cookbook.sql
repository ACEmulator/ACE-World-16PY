...
VALUES (5583,   1, 0x02000153) /* Setup */
...
VALUES (5583, 0, 0xFFFFFFFF, 'Breads & Cakes', 'prewritten', False, 'BREAD & CAKES
...
(cont''d)
')
     , (5583, 1, 0xFFFFFFFF, 'Cheese', 'prewritten', False, 'BREAD & CAKES (cont''d)
...
')
     , (5583, 2, 0xFFFFFFFF, 'Meat & Fried Food', 'prewritten', False, 'MEAT & FRIED FOOD
...
')
     , (5583, 3, 0xFFFFFFFF, 'Pies & Stews', 'prewritten', False, 'PIES & STEWS
...
')
     , (5583, 4, 0xFFFFFFFF, 'Cabbages & Pickling', 'prewritten', False, 'CABBAGES & PICKLING
...
')
     , (5583, 5, 0xFFFFFFFF, 'Oils', 'prewritten', False, 'OILS
