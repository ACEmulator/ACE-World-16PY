...
VALUES (505,   1, 0x02000290) /* Setup */
     , (505,   8, 0x060012D3) /* Icon */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (505, 6, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (505, 0, 0xFFFFFFFF, ' ', 'prewritten', False, 'Tutorial / Part 2 of 5 
...
(more)
')
     , (505, 1, 0xFFFFFFFF, ' ', 'prewritten', False, 'To PUT DOWN an item, drag it from the inventory panel to the 3D view.
...
(more)
')
     , (505, 2, 0xFFFFFFFF, ' ', 'prewritten', False, 'Some icons actually represent stacks of multiple items. You''ll recognize one of these by a number in the item''s name. You can split off a part of this stack by dragging the slider next to the item''s name, and then dragging the icon to a new location.
(more)
')
     , (505, 3, 0xFFFFFFFF, ' ', 'prewritten', False, 'Shopkeepers buy and sell a number of items. To get a shopkeeper''s attention, double-click on him or her.
...
(more)
')
     , (505, 4, 0xFFFFFFFF, ' ', 'prewritten', False, 'New characters start with only 100 pyreals (coins). Spend them wisely.
...
(more)
')
     , (505, 5, 0xFFFFFFFF, ' ', 'prewritten', False, 'When you''re finished with your shopping, leave the store and head east toward the swirling purple portal in the midst of the ruins.
