...
')
     , (5704, 4, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, '
...
')
     , (5704, 13, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'Master Jojii replied, "The shield is ignorance, which has stopped many a blow against your beliefs before.  The sword of insight will cut through the shield of ignorance - but only if wielded by a true seeker.  Similarly, my teaching is the shield of truth, which, if held by a true seeker, will stop the deadly sword of ignorance.  So you see that it is the heart of the wielder that matters, not the strength of the weapons."
')
     , (5704, 14, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'The Master Monk of the Ryu Jou Gai said to Master Jojii as a test, "The Dragon, the Unicorn, and the Firebird are living, moving Elders.  Can four dead, still Stones be of use to Mankind?"
')
     , (5704, 15, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'Master Jojii replied, "The Four Stones give life to the living, and their principles live within human hearts.  The living Elders are alive in and of themselves, and because of this cannot live within others.  Which is more useful, that which is dead and used for life, or that which is alive and does not contribute to life?"
')
     , (5704, 16, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'The Master Monk of the Ryu Jou Gai said to Master Jojii as a test, "The Dragon of Power gave power to the people of the Sho.  What power will your Four Stones offer us?"
...
')
     , (5704, 17, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'The Master Monk of the Ryu Jou Gai replied, "I do not see their value, nor do I see the truth they lead to.  I do not see why your Four Stones of Humility, Discipline, Detachment, and Compassion are useful to us.  I reject your teachings utterly."
')
     , (5704, 18, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'As soon as he had said these words, the Dragon struck the Master Monk of the Ryu Jou Gai dead, for even the fickle Dragon is subject to the laws of Heaven and to the rules of truth.  Master Jojii bowed his head and prayed for the slain Master Monk, and then went on to teach his wisdom at the Dragon Temple, the Unicorn Temple, and the Firebird Temple.
')
     , (5704, 19, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, '[From that time, those who followed the Dragon, the Unicorn, and the Firebird all began to see the wisdom of Master Jojii''s teachings.  Here is the telling of the death of Master Jojii, an oral tradition that has been passed from teacher to teacher for hundreds of years.]
...
')
     , (5704, 22, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'Let compassion be in your every thought and action, as you strive to help others in their paths.  Without compassion you will never be able to enter the gates of Heaven, even if they be held wide open for you, for your eyes will be blind to them."

And then, smiling, he passed on.
')
     , (5704, 23, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, '[But students of the Dragon Temple, Unicorn Temple, and Firebird Temple did not heed his admonition, and each Temple took to only one path. The Dragon Temple took up the call of Discipline, and the Unicorn Temple took up the call of Compassion, and the Firebird Temple took up the call of Detachment.  Since none focused on Humility, Master Jojii''s most fervent followers founded the Jojii Zhen Gai, the Order of Jojii, to preserve the truths of humility.
')
     , (5704, 24, 0xFFFFFFFF, 'The Teachings of Jojii', 'prewritten', False, 'We, of the Jojii Zhen Gai, recognize that all Four Stones must be studied and learned by anyone seeking rest in Paradise, but we know that, so long as Mankind is flawed, each person will tend to cling to but one facet.  In the hopes of one day unifying the Four Stones into the perfection of humanity, we wait.]
');
