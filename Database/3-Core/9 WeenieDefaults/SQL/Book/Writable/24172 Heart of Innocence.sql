...
VALUES (24172,   1, 0x02000155) /* Setup */
     , (24172,   3, 0x20000014) /* SoundTable */
     , (24172,   8, 0x06001310) /* Icon */
     , (24172,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24172, 2, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24172, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Oswald,
...
')
     , (24172, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'lose you.
