...
VALUES (23110, 0, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'My freedom of the control and watchful eye of Singularity is complete. My efforts have proven to be well directed as the furthering of my personal cause for the betterment of the all has begun to spread across the minions that were set to administer and assist me in my new capacity at this laboratory. 
...
')
     , (23110, 1, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'realm of the "energy source" to conduct several such experiments. Those results will be posted in future documentation. This document will serve as an introduction. The Singualriy must be informed as to how the "energy source" was discovered, so that they can understand the power that such an energy source represents to the Quiddity.
...
')
     , (23110, 2, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'with the Hea without knowledge of the Collector also lead to discoveries that spurred thoughts of enhancing the mana receptors of "bestials". At the moment of success the renegades loyal to the New Singualrity and their misguided leader Levistras caused my immediate return to and subsequent censure by the Singularity. 
...
')
     , (23110, 4, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Agents of the "energy source" traversed about its form but none left the collective. Most appeared briefly to be devoured back within the "energy source" itself. Time was stagnant though ever present as though eternity and discontinuance were held in a tenuous balance.
...
')
     , (23110, 5, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'As time was not consistent within this realm I was free to expirement with entities that seemed to be part of the "energy source".  Shards from the Quiddity seemed to dissipate quickly within near proximity to the "energy source" but while in connection to my form they remained the pulsing consistency they always had.
...
')
     , (23110, 7, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'known about my heightened understanding and coneptualization of the place of the self within the all, cleansing would have appeared the only option. 
...
')
     , (23110, 8, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Since my return I have carefully made advances into my research with the "energy source" aware that the Quiddity''s agents were monitoring my efforts carefully. Until recently when I was able to sever clean the baleful stare of the Agents of the Quiddity and operate with impunity.
...
')
     , (23110, 9, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'I am allowing time to transpire before I allow Masters to become exposed to the energy source. But I have become enamoured with the possibilities of what can be accomplished with other races exposed to this same "energy source". Thus we have begun to expose those races which have proven to be receptive to our modification in the past.
...
')
     , (23110, 11, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'world. Once enemies of the "Light Child" and the Singularity have proven to come to heel once infused with shard of the Quiddity. Though a madness seems to infect their corporeal forms and taint their thought processes they have proven thus far to be formidable allies.
...
')
     , (23110, 12, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'crumble in upon itself under the weight of the enlightened forces with such fervent loyalty to the Singularity. The "Light Child" would crumble and we would obtain that which we have endeavoured after since our calling to this shallow.
');
