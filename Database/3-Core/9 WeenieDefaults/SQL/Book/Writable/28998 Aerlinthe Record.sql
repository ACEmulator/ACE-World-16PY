...
VALUES (28998,   1, 0x02000153) /* Setup */
     , (28998,   3, 0x20000014) /* SoundTable */
     , (28998,   8, 0x060012D5) /* Icon */
     , (28998,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (28998, 32, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (28998, 0, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 1, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 2, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'RE 222: Loritane sends sixteen great ocean-galleons and two skyships to the island, carrying the supplies necessary to build a mining outpost. Lord Loritane and Lady Raina accompany the vessels in Tinoriel.
...
')
     , (28998, 3, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 4, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 5, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 6, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 9, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 10, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 11, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 12, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 13, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 14, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 15, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 16, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'RE 895: Aurlanaa leaves her aerie on the peak of Cunara. She meets several other gromnatross south of Aerlinthe, and they ascend, disappearing into the heavens. No gromnatross are seen on Auberean for twenty-two years.
...
')
     , (28998, 17, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 18, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 19, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 20, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 11: A daughter, Alhallie, is born to Caerlin and Clari. A Festival Year is declared in Elancia and Aerlinthe.
...
')
     , (28998, 21, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 22, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 275: The legendary traveling entertainer Surinna Thrasyl stops at Aerlinthe.
...
')
     , (28998, 23, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 25, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 450: After the census, Emperor Caerlin announces that Tentael has a population of over one million, most under the age of 400. Aerlinthe''s population is less than 100, but nearly 1000 golems work the forges at any time.
...
')
     , (28998, 26, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 464: The new forges are completed. Due to the distance between them and the magma flows, production is less than half of that before the collapse.
...
')
     , (28998, 27, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 513: The Great Northern Tempest. Mages hold off the worst of the storm for three days. The Naarcaerel Reef is ripped apart by storm-tides.
...
')
     , (28998, 28, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 29, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 30, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'HE 239: The Nali relocates from Aventin to Tentael at the invitation of Emperor Kellin.
...
')
     , (28998, 31, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
