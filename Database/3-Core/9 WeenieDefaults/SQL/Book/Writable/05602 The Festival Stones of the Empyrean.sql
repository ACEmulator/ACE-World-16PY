...
VALUES (5602, 0, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, '
...
')
     , (5602, 1, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, '
...
')
     , (5602, 2, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Seedsow can be found in the woods to the west of the fortress of Lytelthorpe.  Look near 0.5N, 46.1E.
...
')
     , (5602, 3, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Thistledown overlooks Cragstone Falls from the western bank, near 27.7N, 42.9E.  Obviously, the Empyrean appreciated the magnificence of the view.  I am reassured of their aesthetic sense.
...
')
     , (5602, 4, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Frostfell stands in the Stonehold Valley, far beyond the northwest reaches of the Tiofor Wood; 69.3N, 15.1W.  There is a minor peasant community nearby.
...
')
     , (5602, 5, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Coldeve awaits the bold at 83.5S, 48.5E, near a town of little importance.  This Stone rests upon a cliff, overlooking a magnificent channel which leads in from the sea.
...
')
     , (5602, 6, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Morntide overlooks the surrounding plains from a hill west of Nanto''s Blue Ghost Falls, near 53.1S, 78.1E.
...
')
     , (5602, 7, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Evensong guards the shore of the river we call Prosper, near Holtburg at 42.1N, 36.5E.  This stone seems to lie near the end of the ruins of a temple complex built over the river.  The presence of a monolithic head statue suggests that this was not a temple in the favor of the High Empyrean -- but that is a lesson for another day.
')
     , (5602, 8, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Gloaming lies at approximately 4.3S, 70.7W. This stone lies within the heart of the Direlands, and we can only speculate what those lands may have been like long ago.
...
')
     , (5602, 9, 0xFFFFFFFF, 'Alatar Locke', 'prewritten', False, 'The Stone of Foredawn lies east of Shoushi, near 33.9S, 75.7E.  This Stone appears to be the only one whose attendant temple facilities have survived the depredations of time.
');
