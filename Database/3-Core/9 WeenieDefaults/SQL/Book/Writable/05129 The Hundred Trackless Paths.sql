...
VALUES (5129, 0, 0xFFFFFFFF, '', 'prewritten', False, 'Khaymahlai
...
(more)
')
     , (5129, 1, 0xFFFFFFFF, '', 'prewritten', False, 'On the edge of the bank there appeared a village, beaten to a pale brown by the sun.  On the bank sat a traveler, who dipped a skin into the river, filled it, and brought it to his lips.
...
(more)
')
     , (5129, 2, 0xFFFFFFFF, '', 'prewritten', False, '''This village is mine, stranger,'' said Hayyaz.  ''If you wish to drink my water and live, you must do me homage.''  From the shadowed doorways, the lost eyes of children and women reflected torchlight.
...
')
     , (5129, 3, 0xFFFFFFFF, '', 'prewritten', False, '''Forgive me,'' the traveler said, and rose to his feet.  ''I am new to these lands.  I shall return that which I have taken unearned.''  And at that, he doused the demon Hayyaz with the water from his skin, and with a terrible cry, it was no more.
...
')
     , (5129, 4, 0xFFFFFFFF, '', 'prewritten', False, 'A woman, frail from sun and work, stumbled from the nearest hut, and cried, ''Who are you, who has delivered us?''
