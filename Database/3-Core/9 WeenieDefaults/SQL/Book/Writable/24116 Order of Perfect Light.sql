...
')
     , (24116, 1, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'none had ever bore witness. 
...
')
     , (24116, 2, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'I feel as though a crime that has roots extending deep into the framework of our society has the strings behind this appointment.
...
')
     , (24116, 4, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'my father''s discovery. We have stoked the forges deep within the heart of Knorr all the years that I have sat as its Lord as well.
...
')
     , (24116, 5, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'Dark. There they shall remain until they are needed again.
...
')
     , (24116, 6, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'At the Barracks of Knorr they shall be recognized as the true warriors. Within the halls of Knorr they shall be known as the defenders of the Lyceum and they shall serve as my army should we fall to a time of war.
...
')
     , (24116, 7, 0xFFFFFFFF, 'Lord Asheron', 'prewritten', False, 'order where corruption would attempt to gain footholds.
