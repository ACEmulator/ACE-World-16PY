...
VALUES (28122, 0, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Torgluuk has assumed a shorter schedule. This has allowed us to take the book more consistently but for shorter periods. We endeavor to complete the translation for you.

Ikakhe
')
     , (28122, 1, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Translation
...
')
     , (28122, 2, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'It took on a life its own, a new life of glowing embers that fed into the water and reinforced the strength of the world. They left and returned for hundreds of cycles; still unseen by their servants, still known by the mucor and the Burun.
