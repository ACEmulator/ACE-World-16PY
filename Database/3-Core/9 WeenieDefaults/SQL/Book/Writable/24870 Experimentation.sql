...
VALUES (24870, 0, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Greetings. If you are in possession of this missive then you have chosen to assist in the collection of the entity known as the Harbinger. I thank you for your offer and welcome any assistance that you may be able to provide.
...
')
     , (24870, 1, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'As you are likely aware, the Virindi loyal to my cause have shunned the Quiddity''s yoke, and have begun attempts to ascertain the truths of the self.  Vincadi has become adept at expression and free thought.
...
')
     , (24870, 6, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Many of the new variants that have made an appearance on the surface of this physical plane have been my doing, other are not. I wish a collection of minor specimens so that I may track down these specimens in their natural habitat when the proclivity to test these subjects arises. The greatest of these specimens is the entity that you Isparians refer to as the Harbinger.
...
')
     , (24870, 7, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Vincadi will collect these objects and has been given the necessary understanding to reward you greatly for your efforts. Should you choose to accept this undertaking read further. If not, cease.
...
')
     , (24870, 10, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Drudge Bloodletter Charm = Bow
...
')
     , (24870, 11, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Banderling Slayer Scalp = Fletching
...
')
     , (24870, 12, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'As you can see each of the items you harvest from these creatures corresponds to a skill that you might have knowledge of. Choose one and only one and I will assist you on reaching your maximum, natural, potential. If you are already at your maximum natural potential then Vincadi''s efforts will fail, he is not as experienced as I and cannot bring you beyond your natural
potential.
...
')
     , (24870, 13, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Be warned that we have enemies. These enemies have established a network of tunnels of their own. We have assaulted their efforts to ensure that the specimen can be collected without being corrupted, in turn they have invaded our access points.
...
')
     , (24870, 14, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Once we become aware of the Harbinger entity''s destruction we will summon forth a portal for you to utilize.
...
Aerbax
')
     , (24870, 15, 0xFFFFFFFF, '', 'prewritten', False, '
');
