...
')
     , (23369, 4, 0xFFFFFFFF, 'Leandra', 'prewritten', False, 'When my apprentice wielded the shield, an aura not unlike that of a hollow device sprung forth from the Aegis, surrounding him with a magical glow.
