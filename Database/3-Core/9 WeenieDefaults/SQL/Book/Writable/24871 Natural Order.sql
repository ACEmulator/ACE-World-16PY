...
VALUES (24871, 0, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'Children of Ispar,
...
')
     , (24871, 1, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'I have provided for you where I can, creating new lifestones, and continuing to garner knowledge of Empyrean culture, to learn why they faltered and ultimately were destroyed.
...
')
     , (24871, 2, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'I have also learned that this being, having been removed from the mana streams, is slowly draining the magic from this world. If it is not returned to the place where it was intended to rest, it will ultimately tear this world asunder.
...
')
     , (24871, 3, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'While the Harbinger in it''s physical form is relatively weak in comparison to other creatures, its magical essence is potent. It was the reason that Yanshi burned so quickly.
...
')
     , (24871, 4, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'While this may at first appear as a boon, as the enemies that prowl this land would also be affected, it would mean that the tenacity, and numbers of our enemies would overwhelm us, relegating us to a position of subservience. I will not see that happen.
...
')
     , (24871, 5, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'I have informed him that the items collected and handed to him should represent a skill. These are the items that I desire and the skill that they will represent to Issk:
...
')
     , (24871, 6, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'Olthoi Mutilator Head = Sword
...
')
     , (24871, 7, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'Drudge Bloodletter Charm = Bow
...
')
     , (24871, 8, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'Drudge Ravener Guts = Leadership
...
')
     , (24871, 11, 0xFFFFFFFF, 'Nuhmudira', 'prewritten', False, 'Returning the Harbinger into the mana streams of the world will be a slow process, one that must be done cautiously. I thank you for your efforts in advance. It is through the wisdom and strength of others like you that we shall this aberration returned to where it belongs.
