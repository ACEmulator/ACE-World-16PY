...
VALUES (23116,   1, 0x02000153) /* Setup */
     , (23116,   3, 0x20000014) /* SoundTable */
     , (23116,   8, 0x060012D5) /* Icon */
     , (23116,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (23116, 16, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (23116, 0, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker.
...
')
     , (23116, 1, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Stimuli will be introduced to the grey matter through contact of a physical nature, visual stimuli, and audial stimuli. Should these methods fail, introduction of grey matter will continue until goals are achieved or the subject destroys itself.
...
')
     , (23116, 2, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker.
...
')
     , (23116, 3, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker.
...
')
     , (23116, 4, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 5, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test subject: Alpha male tusker
...
')
     , (23116, 6, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 7, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test subject: Alpha male tusker
...
')
     , (23116, 8, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 9, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 10, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 11, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 12, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'invited the "outlanders" to my laboratory to let them bear witness to my creation. Yet I wonder now if there will be time.
...
')
     , (23116, 13, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Test Subject: Alpha male tusker
...
')
     , (23116, 14, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'until I have faced them and returned without cleansing.
...
')
     , (23116, 15, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Conclusion:
