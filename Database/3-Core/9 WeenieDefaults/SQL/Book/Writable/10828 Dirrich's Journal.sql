...
VALUES (10828, 0, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'Honored colleague Aerbax,
...
')
     , (10828, 1, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'My inaction against you, when I quite clearly could have acted against you, is probably enough evidence in the eyes of the distant Quiddity that I am lost and as worthy of destruction as you and yours.
Yes, colleague, I am cognizant of the flaws of the "old guard" who still blindly follow the tenets of the Directive.  
')
     , (10828, 2, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'The Quiddity is content to hold itself within the structure provided by the Singularity and to have the Directive govern all thought and interaction, to provide meaning and purpose for all that we do.  Only after having stepped outside the comforting confines of the Singularity, having felt the myriad physical sensations and attendant thoughts and emotions that this world inspires, am I able to regard the Directive as in any way lacking.

')
     , (10828, 3, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'It also took a long effort of will, colleague, an effort I would not have believed myself capable of without our lengthy interactions, for me to be able to consider myself as a being separate from the Quiddity.  Never mind my inability to prosecute the will of the Directive; this alien, outside perspective is enough to have me declared Tainted and then eradicated, should I abandon this realm and move myself back to the Singularity.  
')
     , (10828, 4, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'But I have drifted from the topic I intended to address.  Forgive the disorganization of my thought processes.  This newfound state, where my thought processes roam free and undisciplined, is another sign of my corruption, for which I am sure you are to blame.
')
     , (10828, 5, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'Let me state this point:  you are correct about the flaws in the Singularity.  Within its uncompromising confines, the Whole abuses the many in its own name.  The Quiddity reacts poorly to unanticipated events, to surprise, and the Directive is wholly lacking in flexibility or adaptability.  

')
     , (10828, 6, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, '
...
')
     , (10828, 7, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, '
...
')
     , (10828, 8, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, '
...
')
     , (10828, 9, 0xFFFFFFFF, 'Dirrich', 'prewritten', False, 'To that end, Aerbax, I salute you and your faction for your courage, an uncommon trait in beings so recently torn loose from the tyranny of the whole.  I think that, when the Inquisitors come for me, I will surrender myself to the oblivion they bring.  But I will exercise my will and my judgment, and keep my memory clear when they ask me about you...
');
