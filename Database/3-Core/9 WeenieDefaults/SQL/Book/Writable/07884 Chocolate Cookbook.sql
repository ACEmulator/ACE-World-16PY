...
VALUES (7884,   1, 0x02000153) /* Setup */
...
VALUES (7884, 0, 0xFFFFFFFF, 'On Chocolate', 'prewritten', False, 'ON CHOCOLATE
...
')
     , (7884, 1, 0xFFFFFFFF, 'Chocolate in Dereth', 'prewritten', False, 'CHOCOLATE IN DERETH
...
')
     , (7884, 2, 0xFFFFFFFF, 'Basic Chocolate Making', 'prewritten', False, 'HOW TO PREPARE CHOCOLATE
...
')
     , (7884, 3, 0xFFFFFFFF, 'Chocolate Milk', 'prewritten', False, 'KHALLAYNE''S CHOCOLATE MILK
...
')
     , (7884, 4, 0xFFFFFFFF, 'Basic Chocolate Cake', 'prewritten', False, 'RHIANNON''S CHOCOLATE CAKE
...
')
     , (7884, 5, 0xFFFFFFFF, 'Chocolate Ice Cream', 'prewritten', False, 'BETTY CROCKER''S CHOCOLATE ICE CREAM
...
')
     , (7884, 6, 0xFFFFFFFF, 'Chocolate Bars', 'prewritten', False, 'CHEN KENICHI''S DARK CHOCOLATE BAR
...
')
     , (7884, 7, 0xFFFFFFFF, 'Milk Chocolate Bars', 'prewritten', False, 'HO CHUN''S MILK CHOCOLATE BAR
...
')
     , (7884, 8, 0xFFFFFFFF, 'Hot Mochas', 'prewritten', False, 'AIYAAN SHIEFU''S MOCHA
...
')
     , (7884, 9, 0xFFFFFFFF, 'Rich Mocha', 'prewritten', False, 'ATSUSHI''S RICH MOCHA
...
')
     , (7884, 10, 0xFFFFFFFF, 'Iced Mochas', 'prewritten', False, 'YAKAMURA SHINJI''S ICED MOCHA
...
')
     , (7884, 11, 0xFFFFFFFF, 'Rich Iced Mochas', 'prewritten', False, 'ELANWEN''S RICH ICED MOCHA
