...
VALUES (8081, 0, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 1, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 2, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 3, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
And hungry.
...
')
     , (8081, 4, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'It took all the determination I could muster to utter those words. Having said them, I could only stare at the ground beneath my feet. Utterly ashamed. Utterly beaten.
...
')
     , (8081, 5, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'His companion laid a hand on the speaker''s arm and rumbled, "Perhaps a few pennies? Surely, Genda-san, we can spare..."
...
')
     , (8081, 6, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 7, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 8, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'This must be ''The Grotto.'' This must be where the warriors went to fight with the monsters and so earn bread and coin. But I was no warrior. I had no confidence whatsoever in the strange abilities I''d found while wandering the corridors of that stone tower my first day in this alien land. And as for the magic I''d discovered, what was that worth?  There were monsters beyond that spinning blue circle. I didn''t know how I knew, but I knew.

Monsters.  

Death.
')
     , (8081, 9, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 10, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
What?
')
     , (8081, 11, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 12, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 13, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'My resolve to end my life crumbled. I wanted only to flee, to see no more. But my feet wouldn''t move. I stood there, trembling, sobbing. Wanting to be home in my bed, awaking to hear Mama bustling about making breakfast.
...
')
     , (8081, 14, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 15, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 16, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'She was exhausted, badly hurt. Yet she didn''t hesitate for a moment. With a snarl she came flying at the demon that was about to rend me. The little sword in her hand slashed and the demon howled its sudden anger and pain. It forgot me... for the moment... and turned on this new morsel, a red light burning in its bulbous, evil eyes.
...
')
     , (8081, 17, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 20, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 21, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 22, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 23, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'This postscript deals with something that happened... I''ve lost track of the day. Months ago now. I was in Arwic, shopping for supplies at Guthima''s. I was heading for the portal back to Tou Tou when I remembered that it had been almost six months since Obunaga''s arrival. That called for some kind of anniversary celebration. Since it''s impossible to calculate birthdays here, I further decided that the celebration I now planned called for the exchange of gifts. The Carsmad''s smithy was close at hand. Perhaps I could find a new blade or some other warrior''s toy to delight my brother.
')
     , (8081, 24, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'The crowd of shoppers at the main counter - the one facing the square - was too large so I walked around the building to the back window. There were only three people there. They were standing close enough to each othern and were talking in such familiar, friendly tones that I knew they were together. Two of them, a man and a woman, were obviously warriors. The third member of the trio was a mage, like myself. From the sigil on his robes I could read that he was an Adept of both War and Creature magic. I bowed to him as one bows to an equal,a bow he gravely returned in equal degree before resuming his contemplation of the array of daggers that Cateril had laid
')
     , (8081, 25, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, 'out.
...
')
     , (8081, 26, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
...
')
     , (8081, 27, 0xFFFFFFFF, 'Nandesu Ka of Leafcull', 'prewritten', False, '
