...
VALUES (5680, 0, 0xFFFFFFFF, 'Cambarth', 'prewritten', False, '4th of Frostfell, 13th Year of Exile
...
')
     , (5680, 1, 0xFFFFFFFF, 'Cambarth', 'prewritten', False, '"Sarvaen" floated in the room, the ragged trailings of its cloak fluttering, and explained that it had need for the unique crystals I had discovered in the mountain.  Its voice was... Ah, but I lack the words.  Deep it was, and oddly cadenced.  It was beyond question not a man''s voice, and sounded as if it came through a tunnel, or from the grave.  Straight-faced, I asked what it offered in turn.  At this, one violet-draped "arm" rose and placed a gem upon the table.  I did not see its hand for the folds of the cloak.
')
     , (5680, 2, 0xFFFFFFFF, 'Cambarth', 'prewritten', False, 'It was a ruby; large, flawless, and more finely cut than any stone I have ever seen.  I have not the words to do justice to this amazing artifact.
...
')
     , (5680, 3, 0xFFFFFFFF, 'Cambarth', 'prewritten', False, 'At this, Asjan''s nerve snapped, and he ran from the room shrieking hysterically.  The Thing turned to mark his passage, and I believe I saw a flash of violet-blue light from behind the corner of its bizarre mask.
...
')
     , (5680, 4, 0xFFFFFFFF, 'Cambarth', 'prewritten', False, 'I do not trust this Thing by any account. But one cannot argue with the profit - which is, after all, why I am in this hellish place!
')
     , (5680, 5, 0xFFFFFFFF, 'Cambarth', 'prewritten', False, '7th Frostfell
