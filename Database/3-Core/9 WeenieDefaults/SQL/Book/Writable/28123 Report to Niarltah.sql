...
VALUES (28123, 0, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Torgluuk maintains his short schedule, as a result we''ve needed to work quicker and the book has seemed to lengthen. We are trying Niarltah.

Ikakhe
')
     , (28123, 1, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Translation
...
')
     , (28123, 2, 0xFFFFFFFF, 'Ikakhe', 'prewritten', False, 'Burun turn to eating the flesh of their brothers to consume their souls and purge the defilers of The Sleeping One''s way from the world. Teachings of this way become common place and the Burun clutches become maddened with power. They enact great rites to call the tears of the sleeping one and rains fall for a full cycle.
