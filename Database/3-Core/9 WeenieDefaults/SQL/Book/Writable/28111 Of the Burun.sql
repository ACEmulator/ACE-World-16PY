...
VALUES (28111,   1, 0x02000155) /* Setup */
     , (28111,   3, 0x20000014) /* SoundTable */
     , (28111,   8, 0x06001310) /* Icon */
     , (28111,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (28111, 4, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (28111, 0, 0xFFFFFFFF, 'Aun Laokhe', 'prewritten', False, 'Thus far our findings speak to the souring of the land. The mosswarts indigenous to Ezheret-Hazhatu have always been closely tied to the spirits of the land, much like we Tonk. They are not as advanced and their culture lacks the wisdom to heed many of the warnings, but they are driven more by the feelings of the spirit than we are. Often times they have migrated from an area before it became ravaged by storm because they felt the changes more than learned of them.
')
     , (28111, 1, 0xFFFFFFFF, 'Aun Laokhe', 'prewritten', False, 'This supports the idea that the Burun are causing some changes in the world that will bring about some time of ill if they are not stopped.
