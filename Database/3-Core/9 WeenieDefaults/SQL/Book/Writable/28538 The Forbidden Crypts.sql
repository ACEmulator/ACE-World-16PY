...
VALUES (28538,   1, 0x02000155) /* Setup */
     , (28538,   3, 0x20000014) /* SoundTable */
     , (28538,   8, 0x060030A3) /* Icon */
     , (28538,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (28538, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (28538, 0, 0xFFFFFFFF, 'A "friend" from Al-Jalima', 'prewritten', False, '
