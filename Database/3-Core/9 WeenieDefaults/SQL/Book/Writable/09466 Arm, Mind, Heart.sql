...
VALUES (9466, 0, 0xFFFFFFFF, 'Lugian Translator of Linvak Tukal', 'prewritten', False, '"Anything can be built with the calm and righteous application of strength."
...
')
     , (9466, 1, 0xFFFFFFFF, 'Lugian Translator of Linvak Tukal', 'prewritten', False, 'You must be focused.  A builder starts with a just cause, but he must not allow passions to adulterate the building.  Know where you are strong, know where you are weak.  Know and be at peace with the knowing.
...
')
     , (9466, 2, 0xFFFFFFFF, 'Lugian Translator of Linvak Tukal', 'prewritten', False, 'Strength.  Focus.  Purity.  These are the tools we have to ward off decay.  Let each be a thick root of our society.  Each tenet is powerful alone, but a society that entwines them shall never fall.  Never fall.
')
     , (9466, 3, 0xFFFFFFFF, 'Lugian Translator of Linvak Tukal', 'prewritten', False, '[Translation Note:  These words were written by Lauriagnel, the First Matriarch, for a speech to the Assembly of Elders over two thousand years ago, shortly after the Prime Compact was formed.  Less than a year after her speech, she and her family were killed in the Liberty Rebellion, leading to the period known as the Ceaseless Night, which lasted for over a hundred years, until the Second Compact was formed.
')
     , (9466, 4, 0xFFFFFFFF, 'Lugian Translator of Linvak Tukal', 'prewritten', False, 'The Traditions of the Heart, the Mind, and the Arm, while having only a small following during the Ceaseless Night, have enjoyed a large resurgence after the Second Compact.  Even on this new world, where the Second Compact has become largely meaningless, the Traditions survive.]
');
