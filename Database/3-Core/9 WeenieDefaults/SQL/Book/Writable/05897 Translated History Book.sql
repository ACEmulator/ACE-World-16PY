...
VALUES (5897,   1, 0x02000153) /* Setup */
     , (5897,   3, 0x20000014) /* SoundTable */
     , (5897,   8, 0x060012D5) /* Icon */
     , (5897,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5897, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5897, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '
...
(more)
')
     , (5897, 1, 0xFFFFFFFF, '', 'prewritten', False, '
...
(more)
')
     , (5897, 2, 0xFFFFFFFF, '', 'prewritten', False, '
...
')
     , (5897, 3, 0xFFFFFFFF, '', 'prewritten', False, '
...
')
     , (5897, 4, 0xFFFFFFFF, '', 'prewritten', False, '
