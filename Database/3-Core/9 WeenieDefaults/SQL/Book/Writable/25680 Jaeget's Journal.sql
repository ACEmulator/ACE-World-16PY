...
')
     , (25680, 1, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'He promised something meaningful and worthwhile out of life. I have to admit that sounds a deal more satisfying than how my brother and I are living now.
...
')
     , (25680, 2, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'So, when Bewren wasn''t looking, I pocketed the pamphlet and attached jewel, and my brother and I continued on past the initiate.
---
...
')
     , (25680, 3, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'I have made up my mind; I am going to crush this calling stone and invite the Raven Hand to take me. And, I think while they are here I will ask him to take my brother as well. 
...
---
')
     , (25680, 4, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'Last night I crushed the calling stone and several members of the Raven Hand arrived shortly there after. 
...
')
     , (25680, 5, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'After I had time to place the few belongings the Order allowed me to bring, they began to question me, to get a feel for where my skills would best be put to use, no doubt.
...
---
')
     , (25680, 6, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'Today one of the priests pulled me aside and told me my purpose. Since I had a lot of skill with hides and curing, I was set to the task of flask crafting. 
...
')
     , (25680, 7, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'They issued me a kerchief to cover my mouth and nose with and tasked me with creating a flask that could hold a potently enchanted beaker of Olthoi Ichor.
...
---
')
     , (25680, 8, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'The past week has been exhausting, but fun. So much fun I can''t remember why I even second-guessed coming here in the first place. 
...
')
     , (25680, 9, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'During our mid-day meal, the High Priests told us of the capture an interloper named Bewren. They said he was trying to escape with our sculpting secrets.
...
')
     , (25680, 10, 0xFFFFFFFF, 'Jaeget', 'prewritten', False, 'They said the intruder, Bewren, would be properly punished and then released from our home. That is enough for me, and none of my concern. 
