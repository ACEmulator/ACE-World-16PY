...
VALUES (24358, 0, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'The Olthoi they have struck terror into my heart ever since my first steps on the blasted landscapes of their home world. In that first excursion I lost much. 
...
')
     , (24358, 4, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'world and I fought her. 
...
')
     , (24358, 5, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'In all, over twenty variations were collected and many more catalogued before they captured the Queen.
...
')
     , (24358, 6, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'something that drove a deeper fear into my being:  recognition.  She knew me.  I could tell by the way that her eyes fixated upon me and held there gaze until I left her presence.  The way they bore into me like flame.
...
')
     , (24358, 7, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'sac upon her arrival and though she was injured it did not slow the progress.
...
')
     , (24358, 12, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'of until...
...
')
     , (24358, 13, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'halls of my people. 
...
')
     , (24358, 14, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'But now, as it was when the Queen of the Olthoi first asserted herself over the hordes that poured through the portals from their world to this, I am stricken with an illness that drives the mana from me, making the access of higher magics impossible.  The Olthoi have bred another variant of their leeches. 
...
')
     , (24358, 15, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'Then we must band together and prepare for this menace.  For if she is returned and alive then I fear only the worst.
...
')
     , (24358, 16, 0xFFFFFFFF, 'Asheron', 'prewritten', False, 'then everything that I have worked for and all that I have done in this life has been for naught. 
