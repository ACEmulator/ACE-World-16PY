...
')
     , (24193, 2, 0xFFFFFFFF, 'Oswald', 'prewritten', False, 'I earned the respect of many people by ridding this world of Gertah. I handed out countless baubles and goods to those that I met in my many travels across Dereth and then, for a time, I became a recluse.
...
')
     , (24193, 4, 0xFFFFFFFF, 'Oswald', 'prewritten', False, 'There is a legend that the power of one''s blood could be transferred from one being to another via potent rituals, but since I am not mystically given I''d never thought about being able to perform such rites.
...
')
     , (24193, 5, 0xFFFFFFFF, 'Oswald', 'prewritten', False, 'So I set about collecting the trappings. You''ve undoubtedly found the clues that lead to the final object that was required, a sacrifice. 
...
')
     , (24193, 6, 0xFFFFFFFF, 'Oswald', 'prewritten', False, 'Further, she has sacrificed a pleasant life for one that deals with the maddening details of political intrigue and personal slander. I have to admire someone that would place themselves in such a position.
...
')
     , (24193, 7, 0xFFFFFFFF, 'Oswald', 'prewritten', False, 'at some point in their sorry lives. And for what? For the ability to call himself a mayor and run a town? No, no. You see what Jaleh was really after was something far greater, I will leave the particulars for you investigative types to fill in.
...
')
     , (24193, 8, 0xFFFFFFFF, 'Oswald', 'prewritten', False, 'His price was already dictated, I simply found a way to benefit from his punishment.
');
