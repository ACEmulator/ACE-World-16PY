...
VALUES (5691, 0, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'My dear historian, I must confess that I nearly sent your request back to you with a simple refusal.
...
')
     , (5691, 3, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'At first we expected to hear the chittering of angry Olthoi, but we soon realized the still air lacked the characteristic smell of Olthoi.
...
')
     , (5691, 4, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'Long ago, we guessed, people had lived here.  Perhaps not the most wealthy of people, but people nonetheless.  And where people had lived before, we could live now.
...
')
     , (5691, 5, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'So it was that we moved into the Underground City.  Our numbers slowly grew, for we would sneak back to the mainland in search of other escaped slaves, then bring them back with us.  In the City, we repaired the furniture that we found, or made our own. 
...
')
     , (5691, 6, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'Those were happy days, of laughter and song and hope.  The laughter was strained, the song was born of desperation, and the hope too often tasted of madness, but nonetheless, we were living free.
...
')
     , (5691, 7, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'The rest of the story is already known, and I shall not repeat it.  I will only write of what befell the halls of the Underground City after the Olthoi were finally vanquished.
...
')
     , (5691, 8, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'For some reason, I had thought the Underground City would become what it had once obviously been: a bustling city of people.  For awhile, it was almost such.  But I was, in the end, wrong.  Few who remembered the horror of Olthoi enslavement wanted to continue living underground.  
...
')
     , (5691, 9, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'I believe that Thorsten''s soul is now free; that he is elsewhere now, perhaps even at High King Pwyll''s side.  Olthoi Lake is now known as Lake Blessed; the island is now called the Isle of Tears.  Thorsten even has a town named for him, right on the shores of Lake Blessed.  But it still pains me when I hear of what has become of his burial place, the Underground City.
')
     , (5691, 10, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'For years it lay abandoned once more.  Reports came that monsters had taken up residence within it.  I sent soldiers to clear it, but soon after this was done, new monsters moved in.
...
')
     , (5691, 11, 0xFFFFFFFF, 'Elysa Strathelar', 'prewritten', False, 'So, that is the story of the Underground City.  I trust you to see that this story, and others like it, are not lost.
