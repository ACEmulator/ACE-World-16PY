...
VALUES (8638,   1, 0x02000153) /* Setup */
...
VALUES (8638, 0, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
                         ...
                         Natalie the Scribe     
')
     , (8638, 1, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
...
')
     , (8638, 2, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, 'It was during these times that the hope within our hearts was the most fragile.  The Olthoi were capable of anticipating the actions of any slave with crystalline clarity, and had foiled many different escape attempts by coordinating their movements as if guided by one mind.  It seemed as if all the things that Zenzaburou had talked about would never come to fruition when a strange earthquake occurred.  After the rocks had finished shifting, and the tunnels had been flooded with dust, they decided to act.  They quickly organized the other slaves, guiding them away from their Olthoi taskmasters under the cover of darkness.
')
     , (8638, 3, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
...
')
     , (8638, 4, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
...
')
     , (8638, 5, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
...
')
     , (8638, 6, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
...
')
     , (8638, 7, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
...
')
     , (8638, 8, 0xFFFFFFFF, 'Natalie the Scribe', 'prewritten', False, '
