...
VALUES (21444, 0, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Entry 1
...
')
     , (21444, 1, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'for them. However seeing as it likely they were fully aware of the consequences, there is nothing within me that would lend itself toward compassion.
...
')
     , (21444, 2, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'It has taken some time to master the intricacies of writing in such a fashion, but I think that my efforts have progressed well.
...
')
     , (21444, 5, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'your mind. 
...
')
     , (21444, 6, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'timid.
...
')
     , (21444, 7, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'The three books of Falatacot design I had left on my desk were placed neatly back into the shelves where they had been originally found. My inspection of the area gave no trace of any other person''s passage, so I can only assume that the spirits that dwell within this place decided that they must act as caretakers. Quite the oddity, perhaps I shall set a golem to watch the goings-on here.

Entry 5

')
     , (21444, 8, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'After the discovery of the other library on the mainland of Ireth Lassel, this place has seemed pale by comparison. The tomes within this place are mostly rote history, with no flare for originality. That was until today.
...
')
     , (21444, 11, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'While the intentions of the undead are plainly the eradication of the Yalain and Haebrous people, my cause is far tamer. Thus I am free of the taint that they called upon themselves.
...
')
     , (21444, 16, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Entry 7
...
')
     , (21444, 17, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'There must be anchors set in the citadel to draw upon the mana streams when I have harnessed their energy. Then I will be able to set about finding the remnants of the Disciples.
...
')
     , (21444, 19, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Entry 9
...
')
     , (21444, 20, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'At their head I have placed myself, a commander that will use them as the forward guard of the Cerulean Throne''s armies.
...
')
     , (21444, 21, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Yes dust has gathered and cobwebs have climbed into areas that were once clear, but unlike so many other things, it is just as I remember it. The wailing of the spirits here brings me a calm now and a remembrance of the work I started long ago.
...
')
     , (21444, 27, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'They are feeble, but among them then I found one that had taken up the mantle of the Falatacot. She was devious and cruel, deserving of a most severe punishment. So I set about finding her. She was easily found and, with the assistance of one of Martine''s minions, I have been able to lead her to the library in the mountains. I go to greet her today.
')
     , (21444, 28, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, '(Translator''s Note: This account did not appear until brought near candlelight. As I passed the pages closer to the flame they came into view. I have taken the liberty of tracing them for you. It is unlikely that the author realized it was penned.)
...
')
     , (21444, 30, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'the wall. Her bones snap and begin to liquefy. She stifles a scream for a moment and then wails like the vermin she is. As I approach closer I smile. She weeps.
...
')
     , (21444, 31, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'These books long ago became purposeless to me and their destruction will be no great loss. Kai cries at the doorway until I command him to return to the outer foyer, to welcome more... guests.
...
')
     , (21444, 32, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'The moment it places her form on the top of the column, it crumples to the ground. The draining has begun. It will take longer should people choose to save her, but that divine torture is my reward for removing such a threat from the world.
')
     , (21444, 33, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Entry 11
...
')
     , (21444, 34, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'The power can no longer be contained within that tiny essence. Now they will rise and serve their master, and then when the time is right, their forms will weakened by the vermin. I will take them into the Elemental Hall and draw them into the one that existed at the dawn of time.
...
')
     , (21444, 35, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'To think that the Emperor believed that Asheron would be the salvation of our race is laughable. His greatest spell locked us away in the world between worlds. He is nothing more than a charlatan with a weakness to be exploited by wretched creatures that would make better pets than masters of this world.
...
')
     , (21444, 36, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'It is unimaginable that her people could have decided to let the woman live. Such pity is the thing of folly.
...
')
     , (21444, 37, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'How could they have done this? Now we are all doomed. It will grow, and it will manifest into a being that is like a god spoken of as founding this world. There will be no force that will stand before it that will not fall. Without a master, it will unravel this world.
...
')
     , (21444, 38, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'Armed with Iasparailaun I will cleave their flesh when they arrive. Amusing how their people are responsible for the creation of these weapons. Once I hace dispatched them I will make an attempt to right was has been undone.
')
     , (21444, 39, 0xFFFFFFFF, 'Gaerlan', 'prewritten', False, 'But I can sense Martine coming for me. I can sense Asheron lives, even though I cannot see him.
