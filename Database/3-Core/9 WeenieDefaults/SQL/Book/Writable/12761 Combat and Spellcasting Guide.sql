...
VALUES (12761, 0, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'COMBAT
...
')
     , (12761, 1, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'Select a target by clicking on it or its dot on the compass.
...
(Click on the green arrow to read more!)
')
     , (12761, 2, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'Your target''s health is displayed below its name in the bottom-right corner of the screen. When your target runs out of health, it will die. Double-click on its corpse to check for loot!
...
(Click on the green arrow to read more!)
')
     , (12761, 3, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'To see what a spell does, appraise it with the magnifying glass, or right-click on it.
...
(Click on the green arrow to read more!)
')
     , (12761, 4, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'Watch the blue mana bar at the top of the screen. If it runs out, you can''t cast spells.
