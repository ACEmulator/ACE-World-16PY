...
VALUES (8653,   1, 0x02000153) /* Setup */
     , (8653,   3, 0x20000014) /* SoundTable */
     , (8653,   8, 0x060012D5) /* Icon */
     , (8653,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8653, 7, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8653, 0, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
...
')
     , (8653, 1, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
...
')
     , (8653, 2, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
...
')
     , (8653, 3, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
...
')
     , (8653, 4, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
...
')
     , (8653, 5, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
...
')
     , (8653, 6, 0xFFFFFFFF, 'Gillian the Hunter', 'prewritten', False, '
