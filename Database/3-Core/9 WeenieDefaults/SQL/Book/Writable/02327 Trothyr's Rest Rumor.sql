...
VALUES (2327, 0, 0xFFFFFFFF, 'Rumor about Trothyr''s Rest', 'prewritten', False, '
...
(more)
')
     , (2327, 1, 0xFFFFFFFF, '', 'prewritten', False, 'He was full of fear and muttered something about the swelling ranks of evil, so he went in haste and secrecy.  That was Trothyr''s way; hot-headed and overly proud was he, as well as quick to suspect evil and treachery without proof.
...
(more)
')
     , (2327, 2, 0xFFFFFFFF, '', 'prewritten', False, 'There, he said, lay a sure sign of Asheron''s forgiveness to what he called murderers.  Then he spoke no more, and I buried him myself under the open sky.
');
