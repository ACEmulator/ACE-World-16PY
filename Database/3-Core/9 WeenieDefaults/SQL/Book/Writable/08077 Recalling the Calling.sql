...
VALUES (8077, 0, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 1, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 2, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 3, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 4, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 5, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 8, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"Sounds good."
...
')
     , (8077, 9, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"Tell me, Anjwar," he said, leaning against a still-warm rock beneath our blanket of stars, "What do you remember of Ispar?"
...
')
     , (8077, 10, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"What did you leave behind? Do you miss it?"
...
')
     , (8077, 11, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 13, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
                                 * * *
...
')
     , (8077, 14, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"Anjie, what is the purpose of our people?" she would say as our fathers'' voices echoed from the adjacent room, like a pair of lufaq fighting for control of their pride on the desert tundra.
...
')
     , (8077, 15, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'Though Satresha never liked the idea of fate, I was fascinated with it. That is not what I meant this time. "That is a doubly sharpened simi, Anjwar," she would say, averting her gaze. "We cannot control our fate."
...
')
     , (8077, 16, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'One by one my older friends married their own betrothed, happily starting their lives in a manner that I would most likely never see. I would become like my father, I presumed, steadfastly driven to whatever goal fell into my sights.
...
')
     , (8077, 17, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"Have you finished your chores?"
...
')
     , (8077, 18, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'But something was already happening. Civil war. How could I choose sides? My family or my own beliefs? So, I did nothing; perhaps the most civil thing that can be done during such a war.
...
')
     , (8077, 19, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"There will be fighting."
...
')
     , (8077, 20, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 22, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'I turned my attention skyward, past the lazy clouds overhead to the star-studded night sky. "I wonder if we can see Ispar''s sun from here," I said. It was a thought I''d had many times but only now felt compelled to express.
...
')
     , (8077, 23, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"You talk about Ispar as if it were gone."
...
')
     , (8077, 24, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"You are confusing me Anjwar."
...
')
     , (8077, 27, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 28, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'We decided to try our luck along the river, heading downstream and westward towards the sea. The going was a little easier, though we crossed paths with a shadow adult and child at one point. Even then, the adult attacked us viciously so that the child quickly followed suit. I kept the larger one entangled with my flaming weapon while Kell dispatched the child. It gave a sickening cry as it fell and even having heard it a hundred times before, my heart cried out with that child. The adult turned to take revenge on Kell, who was far too weakened to handle an angered shadow. I took the advantage and seared a hole through its back.
')
     , (8077, 29, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'Carefully dousing my weapon with a water-filled sheath, I bent over to examine the shadow. "Why do you hate us so?" I mumbled to the dead body. "You and your kind... I just don''t understand."
...
')
     , (8077, 30, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'I splashed my staff across the gentle stream at a passing fish. "Shadows do not have children. They are children who became shadows."
...
')
     , (8077, 31, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'I nodded. "Isparians must survive as well."
...
')
     , (8077, 32, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"Fairness comes from what you make of things. We were brought here to defend this world, Kell, yet it does nothing to defend us.  It is only fair if you even the odds yourself."
...
')
     , (8077, 33, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'No one person is told what he or she is to do in Dereth. They are just brought here. I met a few of the townspeople, acquainted myself with some of the vendors in Yanshi where I arrived, and everyone had a different idea about why it was that we were summoned. Some thought it was to start a new life, as I first thought. Others saw it as an opportunity. Still others viewed it as our chance to put behind us the corruption and greed we Isparians had left behind. To them, we all were the chosen ones. Some even think it was all just an accident.
')
     , (8077, 34, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 35, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 36, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 37, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'I found out quickly there were a lot of things I could not kill. I discovered death and how painful it could be but also how quickly it could be forgotten. I learned to fight, I mean really fight well, thanks to him. He showed me what was dangerous, where to track the creatures I could kill, gave me what I needed to survive, including the skill needed for Sho weapons such as the nekode. Soon, I was fighting things on my own. I was learning where towns were being built and where to buy the supplies I needed. At last, Maneyen knew I didn''t need him any more and went to battle the things I could only aspire to kill. He was far more skilled than I was.
')
     , (8077, 38, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'And even though I had learned so much under Maneyen''s tutelage, I learned a lot more on my own. Much of the time, I learned the hard way. Sometimes, I wanted to give up and go back. I had made my choice, however. Dereth was my home now.
...
')
     , (8077, 39, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 41, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 42, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 43, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
                                 * * *
...
')
     , (8077, 44, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 45, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'Kell, I had learned, liked to talk. Even while he was out gathering wood for our campsite, he was talking my proverbial ear off. I merely relaxed at the water''s edge, hoping to spot a fish for dinner, letting him ask question after question.
...
')
     , (8077, 46, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '''I dunno. You seem pretty good at killing stuff.''
...
')
     , (8077, 47, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '''Sorry,'' came his familiar inner voice at last, ''I encountered a pack of banders.''
...
')
     , (8077, 48, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 49, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 53, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 54, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 55, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 56, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
                                    * * *
...
"I miss it too."
')
     , (8077, 57, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 58, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '"But doesn''t that leaving behind of things set us free?"
...
')
     , (8077, 59, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 60, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, '
...
')
     , (8077, 61, 0xFFFFFFFF, 'Anjwar al-Jaenth of Morningthaw', 'prewritten', False, 'I nodded and reached into my pack for the items we would need. "Let me start with a few spells on that spear of yours," I said smiling. There was still a glimmer of hope yet for this one. "Look out shadows, here comes Kell."
