...
VALUES (25405,   1, 0x02000153) /* Setup */
     , (25405,   3, 0x20000014) /* SoundTable */
     , (25405,   8, 0x060012D5) /* Icon */
     , (25405,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25405, 2, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (25405, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'First, I must apologize for the loss of the original book, but once I started the translation the pages began... wilting.
...
')
     , (25405, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'accurately translate was "Song". The other words appear to be using modifiers in either the beginning of the words, or at the end of the words, or possibly in the middle.
