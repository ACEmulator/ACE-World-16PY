...
VALUES (21438,   1, 0x020009C1) /* Setup */
     , (21438,   3, 0x20000014) /* SoundTable */
     , (21438,   7, 0x100003E8) /* ClothingBase */
     , (21438,   8, 0x060027C1) /* Icon */
     , (21438,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (21438, 11, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (21438, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Disciples of Strife
...
')
     , (21438, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Oddly, this Canon was well composed and much more rigid than those of their brethren. 
...
')
     , (21438, 5, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'In the fires that burn beneath the mountains of the world we shall make our home. There we will become one with the flame and allow it to nurture our flesh as it burns away our impurity. In the heat we shall swelter and forge our minds solid. 
...
')
     , (21438, 8, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We are the forward guard the glory and the divine holy flame that purges the wicked before us.
')
     , (21438, 9, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '(Translator Note: The first voice returns here.)
...
')
     , (21438, 10, 0xFFFFFFFF, '', 'prewritten', False, '
');
