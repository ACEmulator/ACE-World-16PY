...
VALUES (8718, 0, 0xFFFFFFFF, '', 'prewritten', False, 'Once this Red Letter is stamped with a Town Stamp, it can be turned into an authorized Society Agent for a reward. Look in the Book of Quests for New Explorers to start on your way. Any of the Society Agents who are catering to new arrivals  in the nine Nexus towns maybe be contacted to obtain this guide.
')
     , (8718, 1, 0xFFFFFFFF, '', 'prewritten', False, '"The day of the picnic was quite sublime.  Men and women relaxing in the sun, much food and drink and merriment to be had by all.  I dare say it would have been an unqualified success if those unpleasant Skeleton Warriors with their bows hadn''t showed up."
