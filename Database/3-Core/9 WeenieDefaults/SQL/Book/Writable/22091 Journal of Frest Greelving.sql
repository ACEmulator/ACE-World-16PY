...
')
     , (22091, 3, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'I crept down the stairs expecting I knew not what, yet somehow to be anticipating the 
...
')
     , (22091, 4, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'I stopped, looking around, as I had noticed a movement out of the corner of my eye. I was standing by a painting, that of a scribe studying scrolls. I turned to look at the 
...
')
     , (22091, 5, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'into his skull, leaving open, gaping pits.  It was a gaunt visage of something that may have been a man once but had died a long time ago in agony and was still screaming.  I stumbled back from the picture, tripping over a chair. Falling backwards, it seemed the horror was now leaping out of the painting, reaching for me with withered fingers, the flesh hanging off the bones.  I rolled over, trying to get back on my feet, sheer panic flowing through me. Jumping up, I whirled round to face the creature but there was nothing there.  

The painting hung peacefully, the scribe 
')
     , (22091, 6, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'placidly studying the scrolls. Taking a deep breath, I backed away, my heart pounding in my chest.  Had I imagined it?  Perhaps it was a product of a bit of undercooked reedshark steak in my belly?
...
')
     , (22091, 7, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'The next day when I went down there I noticed that a particular spot in one of the northwest room was much colder than the rest of the structure. I could see no water leaks, no openings of any kind and had there been any openings certainly no air could be circulating so deep underground. I went down there that afternoon to check on matters again and saw a fine drudge mask I had had crafted for me to wear at festivals was lying on the floor.  It had apparently fallen off its hook. 
...
')
     , (22091, 9, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'tearing open the grassy skin of the earth from within like maggots emerging from a rotting apple. They come boiling out of the ground, wielding sharp weapons, searching for prey with rotting, blind eye sockets.
...
')
     , (22091, 10, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'stench that hung in the air in that very spot. Sleep would not come again to me that night or the next. 
...
')
     , (22091, 15, 0xFFFFFFFF, 'Frest Greelving', 'prewritten', False, 'assure myself nothing foul was in pursuit of me. Several of the windows of the mansion were blazing with a cold, evil light. In one window there stood a figure looking out at me, the decaying thing from my bedroom. It was grinning at me. An inhuman grin of triumph and utter madness.
