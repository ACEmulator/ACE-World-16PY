...
VALUES (29004, 'bookroads4', 8, '2005-02-09 10:00:00') /* Book */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29004,   1,       8192) /* ItemType - Writable */
     , (29004,   5,        160) /* EncumbranceVal */
     , (29004,   8,        200) /* Mass */
     , (29004,   9,          0) /* ValidLocations - None */
     , (29004,  16,          8) /* ItemUseable - Contained */
     , (29004,  19,         90) /* Value */
     , (29004,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29004,  22, False) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29004,  39,    1.22) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29004,   1, 'Aerlinthe Record') /* Name */
     , (29004,  15, 'A translation of an Empyrean text.') /* ShortDesc */
     , (29004,  16, 'A translation of an Empyrean text found on Aerlinthe Island.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29004,   1, 0x02000153) /* Setup */
     , (29004,   3, 0x20000014) /* SoundTable */
     , (29004,   8, 0x060012D5) /* Icon */
     , (29004,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (29004, 32, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (29004, 0, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 1, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 2, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'RE 222: Loritane sends sixteen great ocean-galleons and two skyships to the island, carrying the supplies necessary to build a mining outpost. Lord Loritane and Lady Raina accompany the vessels in Tinoriel.
...
')
     , (29004, 3, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 4, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 5, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 6, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 9, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 10, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 11, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 12, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 13, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 14, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 15, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 16, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'RE 895: Aurlanaa leaves her aerie on the peak of Cunara. She meets several other gromnatross south of Aerlinthe, and they ascend, disappearing into the heavens. No gromnatross are seen on Auberean for twenty-two years.
...
')
     , (29004, 17, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 18, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 19, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 20, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 11: A daughter, Alhallie, is born to Caerlin and Clari. A Festival Year is declared in Elancia and Aerlinthe.
...
')
     , (29004, 21, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 22, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 275: The legendary traveling entertainer Surinna Thrasyl stops at Aerlinthe.
...
')
     , (29004, 23, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 25, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 450: After the census, Emperor Caerlin announces that Tentael has a population of over one million, most under the age of 400. Aerlinthe''s population is less than 100, but nearly 1000 golems work the forges at any time.
...
')
     , (29004, 26, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 464: The new forges are completed. Due to the distance between them and the magma flows, production is less than half of that before the collapse.
...
')
     , (29004, 27, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'TE 513: The Great Northern Tempest. Mages hold off the worst of the storm for three days. The Naarcaerel Reef is ripped apart by storm-tides.
...
')
     , (29004, 28, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 29, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 30, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, 'HE 239: The Nali relocates from Aventin to Tentael at the invitation of Emperor Kellin.
...
')
     , (29004, 31, 0xFFFFFFFF, 'Tale of Years', 'prewritten', False, '
