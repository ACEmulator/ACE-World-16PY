...
VALUES (21440, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Disciples of Stasis
...
')
     , (21440, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Regardless of their transgressions, an effort must be made to preserve their actions, lest someone else follow their path and lead the whole world (Translator''s Note: The sentence does not end here, but a fragment of the page has been torn free.) It is also for the sake of preserving some of the discoveries that were made as the Disciples strode ever closer to perfecting their art.

What follows henceforth are their words. Learn them well.

-G-
')
     , (21440, 2, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Brothers, our art is incomplete. As we gave ourselves over to the magic taught to us by our kin from the west we did not fully understand the implications of our action. Now we grow weaker as the bond between our mind and body grows weak. These are the truths that have been sheltered from us, hidden away by the Master.
...
')
     , (21440, 3, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Our brother-kin from the west called to the voices that sang out in the great River of the World, and they were answered. We too must call to the voices that sing within the River, and ask them for assistance. 
...
')
     , (21440, 4, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Doctrine of Stasis
...
')
     , (21440, 5, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We shall give that form life.
...
')
     , (21440, 6, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Beneath the world, away from the eyes of the Master and his followers, away from the Cerulean Crested Armies, we shall build devices that will draw the Blood forth and give it the form of Stasis.  With our magic we shall conceal the form from the world until it is prepared. In the cisterns we build we shall draw from the Blood and create its children. They shall be tasked to its defense and we shall see that they are given the minds to do so.

')
     , (21440, 7, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Stray from this course and your mind shall be quickened away. The judgment shall be passed, and in the place of forgetting you shall be stripped of what you are and cast out as merely bone.
...
')
     , (21440, 8, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Above, we have built the temple as was instructed by Arakae. There we will begin our Rites and summon forth the form of Stasis, and create his children, the elements of frost.
...
')
     , (21440, 9, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Then he shall be loosed from the prison to wander the world as a soulless being for the rest of eternity.
...
')
     , (21440, 10, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Report 4
...
')
     , (21440, 11, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'This bodes ill, as we have found several spies from the Master already within our ranks. It appears our exodus was not as shrouded as we believed.
...
')
     , (21440, 12, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We will house them instead in the Library where they might still be defended well.
...
')
     , (21440, 13, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'There were more, but the details were not necessary. Arakae for all of his wiles fell eventually. My warriors were far too powerful for him. As we swept aside the Disciples leaving the Ministers to answer for their treason he wailed like a child. 
...
')
     , (21440, 14, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'My beloved was quite cruel when she dispatched of him.

One last note and this book shall be placed into my library.
')
     , (21440, 15, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Heretic Journal
...
')
     , (21440, 16, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'At one point I must confess that I was intrigued by his claims. He said that he had discovered that the songs sung from the world were nothing more than emanations of the same foe that drew away one of us some years back. He also had reasoned that we had forgotten something else long ago.
...
Arakae
')
     , (21440, 17, 0xFFFFFFFF, '', 'prewritten', False, '
');
