...
VALUES (25576,   1, 0x02000153) /* Setup */
     , (25576,   3, 0x20000014) /* SoundTable */
     , (25576,   8, 0x060012D5) /* Icon */
     , (25576,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25576, 7, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (25576, 0, 0xFFFFFFFF, 'Translated by Diyas al-Yat', 'prewritten', False, 'Our discussion today was pleasant. The mirror provides me with a unique perspective with regards to my accomplishments. There is no judgment. Our talents are unique and  provide an equilibrium I find unmatched. 
...
')
     , (25576, 1, 0xFFFFFFFF, 'Translated by Diyas al-Yat', 'prewritten', False, 'I feel fortunate to have brought the possibility of completion to so many others. 
...
')
     , (25576, 6, 0xFFFFFFFF, 'Translated by Diyas al-Yat', 'prewritten', False, 'Today we reached an accord to continue study on only successful subjects until an answer to this conundrum can be established.
');
