...
VALUES (24472, 0, 0xFFFFFFFF, 'Harker', 'prewritten', False, 'Solclaim 2nd Firstday, 14 P.Y.
...
')
     , (24472, 2, 0xFFFFFFFF, 'Harker', 'prewritten', False, 'Solclaim 2nd Starday, 14 P.Y.
...
')
     , (24472, 3, 0xFFFFFFFF, 'Harker', 'prewritten', False, 'Of course, as I write this I am getting ready to go down there again. The rest of the boys don''t need to worry about it and I can handle myself.
...
')
     , (24472, 4, 0xFFFFFFFF, 'Harker', 'prewritten', False, 'I am going back tonight now that the work for the day is done.
');
