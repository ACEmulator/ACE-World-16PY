...
')
     , (5696, 3, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'She went along, though the other warriors scorned and avoided her, calling her a wanton girl who did not know her own station. Even so, Ibriya was in the front of the throng when it assembled before the silver gates of Fasair''s manor.
...
')
     , (5696, 4, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Instead, he raised his hands, each festooned with rings of gold and turquoise, and bellowed for silence.
...
')
     , (5696, 5, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"You may have heard of the death of the swordsman, Ulyush al-Nadur," continued the Mu''allim. Most of the warriors nodded knowingly: Ulyush, one of the most renowned fighters in the kingdom, had perished barely a month ago, in the jaws of the Beast of Hawwun - which is itself a tale of note, but not for the telling now.
...
')
     , (5696, 6, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'The messengers had said nothing of this, and there was some consternation among the ranks. Many of the warriors already had wives, and a number were already promised. And while it was true, in those days as in these, that a man was not limited to one wife, nor a woman to one husband, it was not fitting for a Mu''allim''s daughter to be anything but a man''s First Wife. Of the scores who had come to Qush, more than a hundred had made the journey in vain.
')
     , (5696, 7, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"Why did you not tell us this?" asked one of the older men, a grizzled veteran who already had three wives and a small host of children. "I have come a hundred leagues from my home, and for nothing!"
...
')
     , (5696, 8, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'I understand that many of you cannot compete, and I am sure that others will not wish to do so. I will make recompense for your inconvenience: half a hundred pieces of gold to each man who does not enter the tournament, and my hospitality from now until the tournament is done."
...
')
     , (5696, 9, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'He also kept out those who were given to too much drink: there was a feast that night at the manor, with much boasting and freely flowing wine, and when the seneschal came around at dawn the next day, calling for those who wished to enter to gather in the courtyard, the men who had drunk too much were in no shape to do so. Thus, the scribes'' lists of those who were to enter the tourney bore only seventy-three names.
')
     , (5696, 10, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'One of those was Ibriya bint Raglan.
...
')
     , (5696, 15, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'He smiled. "I did this morning. Now, I am not so sure."
...
')
     , (5696, 19, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'The Ox began to tire. After a few minutes he was breathing with his mouth open; he chased her for a few more, and soon was covered in sweat. It became harder and harder for him to keep pace with her, even though she slowed her pace to keep tempting him onward. At last  his weapon drooped, and he doubled over, hands on knees, wheezing. She finished him with two quick strokes, the second of which struck the side of his head and would have shorn it in two if her sword had been real. He crumpled to the ground, senseless.
')
     , (5696, 20, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Then she was one of ten, with the final round to come that evening. The Mu''allim''s seneschal sought her out at the midday meal, and doubled his master''s offer. She sent him away, but not before striking him across the face for trying to bribe her.
')
     , (5696, 21, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'The second-to-last round was different from the first three: instead of a man-on-man duel, it was to be an open melee. All the remaining combatants gathered at the fighting grounds, armed with sword and shield. The seneschal himself took the judge''s place, and Ibriya''s spirit sank: not only were the nine men who would fight with her eyeing her with disdain, but she knew the seneschal would not ignore what had passed between them earlier.
')
     , (5696, 22, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"The fighting will continue until all but two are defeated," the seneschal proclaimed, and smiled venomously at her.
')
     , (5696, 23, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'The fight was fast and brutal. The men battled Ibriya in twos and threes. She fought back like a madwoman, and emerged bloody, bruised and exhausted... but still standing. Of the ten who had fought in the melee, the only two who remained were Zaqim al-Farabad, a young lord from the eastern mountains, and Ibriya bint Raglan. The seneschal decreed them victors - though he looked as though he had bitten into a lemon when he spoke Ibriya''s name - and declared that they were to fight in the final bout an hour after dusk, with the Mu''allim himself to judge.
')
     , (5696, 24, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Some say Fasair exiled the seneschal from his lands after that melee; others say he had him killed. Whatever the case, none of the combatants saw him again.
...
')
     , (5696, 27, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'He took the onyx goblet from the nearest servant. Zaqim took the malachite, and Ibriya the lapis. They raised the cups in salute, and drank - all save Ibriya. "I''m afraid I do not drink wine before battle," she told the Mu''allim, bowing, then poured it upon the ground. "Instead I offer it as a libation, in tribute to your daughter''s grace, my lord."
')
     , (5696, 28, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Those who were present that night say the grin on Fasair''s face seemed to freeze then, but only for a moment. Then, with a nod to Ibriya, he resumed his seat, and the servants collected the goblets. To this day, no one is certain what was in the lapis cup, but many are sure they know nonetheless.

"Begin," the Mu''allim said, no longer smiling at all.
')
     , (5696, 29, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Ibriya and Zaqim touched swords in salute, then began to trade blows. It went slowly at first, more a careful dance than a fight - especially strange after the vicious melee, earlier that day . They delved the depth of each other''s skill, striking and parrying, noting strengths and seeking weaknesses. After a while of this they parted, weapons quivering in their hands, and began to circle each other, looking for the right opening. An unspoken signal passed between them, and they rushed at each other, blades awhirl.
')
     , (5696, 30, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Then the unthinkable happened. Zaqim al-Farabad tripped.
...
')
     , (5696, 31, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'The crowd murmured, and the Mu''allim shifted in his seat as Zaqim rose. Ibriya stood by, waiting patiently, while he retrieved his sword. Only when he was armed again did the fight resume. Zaqim was humbled, however, and before long Ibriya''s puissance drove him to his knees. He struggled to rise, and could not.

"Hold," he told her. "I am done. I yield - you are the victor of this match, and the tournament besides."
')
     , (5696, 32, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'A silence settled over the field, and once again Ibriya helped Zaqim rise. When he was on his feet, she went to stand before the Mu''allim, and dropped to one knee. She said nothing.

Fasair looked down upon her, at a loss. "This cannot be," he said. "I will not have it. You cannot wed my daughter, girl."
')
     , (5696, 33, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"I do not wish to wed her," said Ibriya. "But you did offer me her hand, and I would take it - not for myself, but for her. She is her own woman now, not yours to give like chattel. I have won her in fair combat, and so give her freedom. She, and no one else, shall choose her husband."
')
     , (5696, 34, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'There was great uproar at this, and the Mu''allim''s face turned as dark as wine. "This is unthinkable!" he thundered. "You have won this tournament through deceit and trickery, Ibriya bint Raglan! I disqualify you! Come forward, Zaqim al-Farabad."
')
     , (5696, 35, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'But Zaqim shook his head. "No, my lord," he said. "She defeated me fairly - you saw how, even when I fell, she did not strike me down. Ibriya is the victor, and I will not take her place."
')
     , (5696, 36, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'At this, the other warriors began to clash their swords against their shields and shout their approval. Fasair had eliminated the most dishonorable suitors before the games began, and none of those who had fought in the tournament wanted to sully their names by taking Lashanda to wife after meeting defeat.
')
     , (5696, 37, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"What I want of you is not so difficult, my lord," Ibriya declared. "I only ask that you trust your daughter to make her own choice."

"And if she chooses poorly?" the Mu''allim contended. "She is my only child. What will become of my name?"
')
     , (5696, 38, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"What would become of your name if it were learned you did not give the victor of this tournament her due?" Ibriya returned. "There are many people here, my lord. Word of such things has a habit of spreading."
')
     , (5696, 39, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Fasair thought on this, and knew he was beaten. His shoulders slumped. "Very well," he relented. "Lashanda shall marry the man of her choosing. But know this - if the husband she picks does not satisfy me, I will sire another heir, and grant my title and holdings to him."

"Your judgment is fair, my lord," Ibriya said, and bowed.
')
     , (5696, 40, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'During the feast after the final battle, Lashanda bint Fasair appeared before the combatants, her head covered with a turban, as was custom for unwed ladies at the time. It was the first time most of them had seen her, and they were breathtaken by her grace and beauty. "If I had known," many a man said to nodding comrades, "I would have fought all the harder."
')
     , (5696, 41, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Lashanda sat at her father''s right side throughout the feast; on his left sat Ibriya, for it was her right as victor to dine in that place of honor. The Mu''allim did not speak to her, or to anyone else: he only sat in stony silence and picked restlessly at his food. At last, when the servants cleared the last dishes away, he rose and turned to his daughter. "My child," he told her, "a victor has emerged from the field of battle to claim your hand."
')
     , (5696, 42, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'When Ibriya rose from her seat, Lashanda looked at her in pure, open-mouthed surprise, which turned to joy as Ibriya explained her wishes. Tearfully, the two women embraced.

"Now, my child," the Mu''allim pronounced, "I ask you to choose: who will you wed?"
')
     , (5696, 43, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'Every man in the room leaned forward expectantly: warriors, courtiers, even the servants. Lashanda''s lips parted in a radiant smile.

"I choose no one," she said.
')
     , (5696, 44, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'The noise that rose shook the rafters of the great dining hall. Men shouted and pounded their fists upon tables. Fasair himself shook with rage. "What!" he bellowed.
')
     , (5696, 45, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, '"I choose no one," Lashanda repeated, unperturbed. "I am still in mourning for Ulyush, and will not take a husband simply because a wedding is planned. In time, I will choose one - I have no intention of becoming a spinster, Father. But not while my love''s body is still fresh in its tomb."
')
     , (5696, 46, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'And so, in the end, there was no wedding that summer. The next year, however, she did choose a husband - Zaqim al-Farabad, as it turned out - and the celebrations lasted for days. The Mu''allim even invited Ibriya bint Raglan to stand upon the dais at the ceremony, for the tale of her triumph at the games had traveled the length of the land.
')
     , (5696, 47, 0xFFFFFFFF, 'Lashanda''s Hand', 'prewritten', False, 'His messengers could not find her, however, though they wandered afar, for she had vanished that winter, delving deep into the ruins of al-Shaghra, the City Which Rises. But that tale is for another day.
');
