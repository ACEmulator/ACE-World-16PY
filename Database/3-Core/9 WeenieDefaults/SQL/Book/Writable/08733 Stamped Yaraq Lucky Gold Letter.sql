...
VALUES (8733, 0, 0xFFFFFFFF, '', 'prewritten', False, 'Once this rare Gold Letter is stamped with a Town Stamp, it can be turned into an authorized Society Agent for a reward. Look in the Book of Quests for New Explorers to start on your way. Any of the Society Agents who are catering to new arrivals  in the nine Nexus towns maybe be contacted to obtain this guide
')
     , (8733, 1, 0xFFFFFFFF, '', 'prewritten', False, '"There are Members of my Society who do not understand that we must all stick together in these most trying circumstances.  But they will come to understand.  Of that I feel certain."
