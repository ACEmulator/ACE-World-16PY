...
VALUES (24122,   1, 0x020009C1) /* Setup */
     , (24122,   3, 0x20000014) /* SoundTable */
     , (24122,   8, 0x06001F05) /* Icon */
     , (24122,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24122, 7, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24122, 0, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'Alb''arel ascendant, Rez''arel descendant Day 4
...
')
     , (24122, 1, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'this journal serve as memoriam of our efforts as we stand now against this crest of purple and black that has so swiftly torn through our ranks.
...
')
     , (24122, 2, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'shaping it to her will. 
...
')
     , (24122, 3, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'They are canny tacticians, placing smaller shock troops at the fore, these smaller beast found holes in our ranks where saw none. The smallest with large rear legs and a screech like the howl of undead in the swamps of Ireth Lassel proved to nullify our magical aptitudes, shirking aside the gifts of Illusion (Translator''s Note: This is my most educated guess at the meaning of the words Ignae Fatae) piercing the veil that covered the door to upper and lower chambers of the barracks proper. Once within the largest marshaled the field issuing orders through chirps and motions of their top most pincers. The Golem 
')
     , (24122, 4, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'guardians fell first as though the things had faced them in the upper lairs.
...
')
     , (24122, 5, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'Handfuls escaped deeper within the barracks but access to the conveyances to the other portions of Knorr were sealed by a torrent of the chitinous creatures. We four, Daelyn, Faerla, Haedu, and myself escaped within this room and vowed to stand our ground; holding true to our oaths.
...
')
     , (24122, 6, 0xFFFFFFFF, 'Caemryn, Initiate of Perfect Light', 'prewritten', False, 'Alb''arel ascendant, Rez''arel descendant Day 6
