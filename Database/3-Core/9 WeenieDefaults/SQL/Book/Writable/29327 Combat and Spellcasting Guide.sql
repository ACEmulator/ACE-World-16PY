...
VALUES (29327, 'booksalvagingacademy', 8, '2005-02-09 10:00:00') /* Book */;
...
VALUES (29327, 0, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'COMBAT
...
')
     , (29327, 1, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'Select a target by clicking on it or its dot on the compass.
...
(Click on the green arrow to read more!)
')
     , (29327, 2, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'Your target''s health is displayed below its name in the bottom-right corner of the screen. When your target runs out of health, it will die. Double-click on its corpse to check for loot!
...
(Click on the green arrow to read more!)
')
     , (29327, 3, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'To see what a spell does, appraise it with the magnifying glass, or right-click on it.
...
(Click on the green arrow to read more!)
')
     , (29327, 4, 0xFFFFFFFF, 'Training Master', 'prewritten', False, 'Watch the blue mana bar at the top of the screen. If it runs out, you can''t cast spells.
