...
')
     , (5692, 10, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'And I also remember how there were some men and women dressed in gleaming armor, and wielding blades that glowed with magic.  Whence those came from, I myself do not know, but I am sure you have heard rumors enough about that.
')
     , (5692, 11, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'My mother immediately joined the revolt.  She snatched up a dagger from a fallen man and tied it to her stirring stick.  I followed her through some long corridors until we came to a vast lake of gruel - or so it seemed to me - and I remember how she slit open every white worm she could reach, piercing them through and shredding them apart while she laughed and cried at the same time.  Then she left me in the care of an older child, and she went running after the others.
')
     , (5692, 12, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'She later told me that she reached the deepest chamber of the Olthoi nest, where Elysa Strathelar and Thorsten Cragstone battled the giant Queen of the Olthoi.  I have wished many times since that I could have seen that battle, but I do know I am glad I did not see the terrible and final blow that struck Thorsten Cragstone.  That I am glad to have missed, and I wish it had never happened.  But I did hear they fought valiantly, to make High King Pwyll himself proud.
')
     , (5692, 13, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'Yes, it is quite true that when the Queen of the Olthoi was slain, the entire Olthoi race was thrown into disorder.  I saw our once intently watchful masters now running in mindless circles, or curled up and quivering upon their backs, or aimlessly cutting at empty air.  
')
     , (5692, 14, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'Of course they are not quite so mindless now, but they have never returned to their former intelligence since their Queen''s death.  So it was that back then, right after her demise, they were quite mad with confusion, and we could walk right past many with no harm, or kill them with relative ease.
...
')
     , (5692, 15, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'We came out into the open air at dawn; for some of us, it was the first real exposure to the above-ground world.  Had my mother not described sunlight to me, surely I would have been just as terrified as some of the other children.  But I remember standing in the brilliant light upon an open grassy field, just staring and staring and staring.  Dreamlike, is the only way I can describe it.  Like entering a whole new world.
')
     , (5692, 16, 0xFFFFFFFF, 'The Days of the Olthoi', 'prewritten', False, 'Would I go to our homelands, to Aluvia, you ask?  I should like to visit, if ever such a thing were to become possible.  I have no memories of it at all, though my mother certainly told me of its wonders: the great cities, the vast seas.  Yet I still remember the wondrous feeling of standing in that open field, blinking at that first dawn.  And, of course, I have lived my entire life here, helping to fight off the beasts and settle the land.  I think, perhaps, that I will stay here.
');
