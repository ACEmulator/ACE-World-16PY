...
VALUES (21436, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'The most sinister and vile of the four Disciples, those sworn to Corrosion were already befouled when they were within the camps of my people. They struggled even then for a modicum of acceptance. They were the most depraved of our kind. Some thought them fallen to shadow, but they reviled the shadow more than they reviled the Yalain. 
...
-G-
')
     , (21436, 3, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Doctrine of Corrosion
...
We are the poison.
')
     , (21436, 4, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'We are the blight. 
We are the horror.
We are the wretched.
...
')
     , (21436, 7, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'It is the Blood revolting against us. We are tired of the efforts and we grow weary of the world. Our minds are cluttered with new voices and a silent madness has begun to seep into our people. This cave becomes more a tomb as the day''s progress and still there is no hope of our completing the cistern properly. We require a way to sustain ourselves but there is no way for us to do so. Our flesh melts within this horrific place, and though we are born to live in the harshest clime our flesh is still weak against the power of Corrosion.
')
     , (21436, 8, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Only one device has been placed, and that is at the highest point in the cistern. The lower we transcend the more foul the air becomes and quicker we rot away. We are losing sense of self and our forms all at once. Damned be we cursed few.

The Wretched

A bubbling mass called out to our workers. It leapt toward us and splashed itself against us. 
')
     , (21436, 9, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Half our numbers were consumed, and the other half were scarred severely enough that we needed to sequester their forms in a place where they will grow more maddened and finally fade into nothing. It is a more piteous death for them, or so we believe. 
...
')
     , (21436, 10, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'stymied and could not find their feet to run. Those that allowed the terror to consume what vestige of a soul they had left found themselves drowning in a see of putrescent agony.
...
')
     , (21436, 11, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Screams echoed in the lower halls and as we ran from that place and sealed the door with a stone thick enough to hold the strongest survivor at bay indefinitely we heard the voice of Corrosion call again.
...
')
     , (21436, 12, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '(Translator''s Note: The first voice returns here.)
