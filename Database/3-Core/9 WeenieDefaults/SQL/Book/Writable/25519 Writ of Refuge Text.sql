...
VALUES (25519,   1, 0x02000153) /* Setup */
...
VALUES (25519, 0, 0xFFFFFFFF, '', 'prewritten', False, 'Writ of Refuge
...
')
     , (25519, 1, 0xFFFFFFFF, '', 'prewritten', False, 'Greetings, Fellow Isparians.  
...
')
     , (25519, 2, 0xFFFFFFFF, '', 'prewritten', False, 'From tribes, we have moved to cities.  A charitable description.  Towns, really.  Poor and pale remembrances of our homes back in Ispar.  But build them we did.  Progress.  Of a kind.
...
')
     , (25519, 3, 0xFFFFFFFF, '', 'prewritten', False, 'So claim and tend.  Nurture and grow.  Your homes await you, children of Ispar.  Present this Writ to the Covenant Crystals we have installed in front of the homes.  And Dereth shall be yours.
...
')
     , (25519, 4, 0xFFFFFFFF, '', 'prewritten', False, 'Our Agents of the Arcanum will be stationed in every major town on mainland Dereth.  As our needs change, so will what we require for the Writ.  Be vigilant, and may you never know surprise.

Before I go, permit me one lesson of history: 
')
     , (25519, 5, 0xFFFFFFFF, '', 'prewritten', False, 'The quotation at the top of a Writ comes from a text I have with me from Tirethas.  It contains the stories of a people who presaged the Gharun''dim and the Rouleans, back in the earliest days of Milantean glory.  Their name, Kael Arran, translated into our tongue means "desert dancers." 
