...
VALUES (25679, 0, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'While we were fur hunting on the Marescent Plateau yesterday, Jaeget and I were approached by a man proclaiming to be capable of making our lives meaningful. 
...
')
     , (25679, 1, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'Poor Jaeget wasn''t alive on Ispar but four years, so luckily he didn''t have to confront any of those types. 
...
---
')
     , (25679, 2, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'Jaeget has done nothing but yammer on about the Order of the Raven Hand since we ran across the recruiter on Marae nearly a week ago. 

What''s worse, his being taken with their beliefs has hurt business. 

We don''t have nearly enough hides to sell as we used to. 
')
     , (25679, 3, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'I would suggest another trip to Marae, though I fear bringing him there would only further advance his desire to join the Raven Hand.
...
--
')
     , (25679, 4, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'I awoke only briefly last night to see my cot surrounded by several men swathed in dark cloaks. In the background I could see them embracing Jaeget and then everything went dark.
...
')
     , (25679, 5, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'His tale was one of woe, though after learning of his previous accommodations, this place seemed more hospitable than what he had previously... but only slightly.
...
---
')
     , (25679, 6, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'I''ve been here for some time now, and I am tired of being here. I have no weapons, no lock picks, and no way of getting both my brother and I out of here safely. 
...
')
     , (25679, 7, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'When the guard comes to deliver our meal, I will liberate his key-ring and escape after curfew has gone into effect. On my way out, I will glean what information I can from the surrounding temple and note where entrances and exits are.
...
---
')
     , (25679, 8, 0xFFFFFFFF, 'Bewren', 'prewritten', False, 'Even now my head spins and charcoal-black cysts are beginning to form on my arms and face... I do not know what they did to me, but I know what they plan.  I have been moved away from Twitch and placed in some interim holding cell. Looking out into the room, I can see a pit of some sort.
