...
VALUES (5856,   1, 0x02000153) /* Setup */
...
VALUES (5856, 0, 0xFFFFFFFF, '', 'prewritten', False, 'This book is dedicated to aspiring chefs who are tired of the basics.
...
')
     , (5856, 1, 0xFFFFFFFF, 'Carrot Soup', 'prewritten', False, 'CAROL''S CARROT SOUP
...
')
     , (5856, 2, 0xFFFFFFFF, 'Carrot Cake', 'prewritten', False, 'KAKORI''S CARROT CAKE
...
')
     , (5856, 3, 0xFFFFFFFF, 'Famous Pizza', 'prewritten', False, 'DANI THE CRAZED''S FAMOUS PIZZA
...
')
     , (5856, 4, 0xFFFFFFFF, 'Hot Sauce & Cinnamon', 'prewritten', False, 'REGARDING HOT SAUCE AND CINNAMON
...
')
     , (5856, 5, 0xFFFFFFFF, 'Hot Kimchi', 'prewritten', False, 'RASZAGAL AND TASSADAR''S HOT KIMCHI
...
')
     , (5856, 6, 0xFFFFFFFF, 'Spiced Apple Pie', 'prewritten', False, 'FIREDEMON''S SPICED APPLE PIE
...
')
     , (5856, 7, 0xFFFFFFFF, 'Fruitcake (Seasonal)', 'prewritten', False, 'BORTIN''S FRUITCAKE (SEASONAL)
...
(cont''d)
')
     , (5856, 8, 0xFFFFFFFF, 'Fruitcake (Seasonal)', 'prewritten', False, 'BORTIN''S FRUITCAKE (cont''d)
...
')
     , (5856, 9, 0xFFFFFFFF, 'Holtburgers', 'prewritten', False, 'FOSTER''S FAVORITE: HOLTBURGERS
...
')
     , (5856, 10, 0xFFFFFFFF, 'Applesauce', 'prewritten', False, 'SCHOLARS'' APPLESAUCE
...
')
     , (5856, 11, 0xFFFFFFFF, 'Ice Cream', 'prewritten', False, 'EVERYONE LOVES ICE CREAM
...
')
     , (5856, 12, 0xFFFFFFFF, 'Pumpkin Soup and Pie', 'prewritten', False, 'FESTIVE PUMPKIN SOUP AND PIE
