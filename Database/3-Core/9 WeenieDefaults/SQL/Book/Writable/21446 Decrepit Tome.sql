...
VALUES (21446,   1, 0x020009C1) /* Setup */
     , (21446,   3, 0x20000014) /* SoundTable */
     , (21446,   7, 0x100003EB) /* ClothingBase */
     , (21446,   8, 0x060027C4) /* Icon */
     , (21446,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (21446, 13, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (21446, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '(Translator''s Note 1: It is important to note that this book seems to be written directly to the page by a Dericost hand, but the tone of the writing makes it appear as though it was written at stages, perhaps over a long time and in the sub-conscious of the writer. It is as if the words contained herein began as thoughts that found their way to the page by some magical means, without any writing instrument. Also of note is the texture of the pages. It is not paper, at least no paper that I have ever encountered.)
')
     , (21446, 1, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '...and they swarmed. There was no end to the battle. They came from everywhere, consumed our throne and buried us beneath the world like outcasts. 
...
')
     , (21446, 2, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Others still abandoned our cause and wandered into the wilderness, finding solace in the recesses of the world, where the very core and essence ran closest to the surface. We were disparate, and weak.
...
')
     , (21446, 3, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'There is no need for such any longer. Hot and cold are no longer perceptible. But we have found that there are times when the knowledge and memories that were once our own dwindle and become lost forever in the great abyss.
...
')
     , (21446, 4, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'stream of power beneath the world. But still they traffic with a magic that is, until now, unknown and untapped. We monitor their progress from within this place.
...
')
     , (21446, 7, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'In the darkness something stirs,
...
')
     , (21446, 9, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Aerfalle shall watch this one.
...
')
     , (21446, 10, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'Slumbering beneath the soil
...
')
     , (21446, 12, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'And when the darkness comes again, I shall ever be awake. We know our role. See it done.
