...
VALUES (6437, 0, 0xFFFFFFFF, 'INTRODUCTION', 'prewritten', False, 'All weddings are special events of great personal importance.  They call for a deep and lasting commitment between two people, and should not be entered into lightly.  That said, the joys and happiness of marriage await!
...
(cont.)
')
     , (6437, 1, 0xFFFFFFFF, 'INTRODUCTION', 'prewritten', False, 'It is suggested that all participants read this book thoroughly and have their spoken material prepared beforehand.
')
     , (6437, 2, 0xFFFFFFFF, 'ARRANGEMENTS', 'prewritten', False, 'To schedule a wedding, bride and groom must set a location (complete with map coordinates), time, and date, and all other relevant information.
...
')
     , (6437, 3, 0xFFFFFFFF, 'THE BEGINNING', 'prewritten', False, 'Before the ceremony, the Officiator provides the participants the rings, emblems, and gems, and gives them time to examine and inscribe them.
...
')
     , (6437, 4, 0xFFFFFFFF, 'OF FREE WILL', 'prewritten', False, 'Officiator: <bride>, are you here of your own free will?
...
[Pause]
')
     , (6437, 5, 0xFFFFFFFF, 'THE GROOM''S VOWS', 'prewritten', False, 'Officiator: <groom>, do you take <bride> to be your lawfully wedded wife?
...
(cont.)
')
     , (6437, 6, 0xFFFFFFFF, 'THE GROOM''S VOWS', 'prewritten', False, 'Officiator: Do you promise to remain faithful unto her, to support her, to be her finest friend, through all trials and tribulations, joys and victories?
...
')
     , (6437, 7, 0xFFFFFFFF, 'THE BRIDE''S VOWS', 'prewritten', False, 'Officiator: <bride>, do you take <groom> to be your lawfully wedded husband?
...
(cont.)
')
     , (6437, 8, 0xFFFFFFFF, 'THE BRIDE''S VOWS', 'prewritten', False, 'Officiator: Do you promise to remain faithful unto him, to support him, to be his finest friend, through all trials and tribulations, joys and victories?
...
')
     , (6437, 9, 0xFFFFFFFF, 'THE INTENTIONS', 'prewritten', False, 'Officiator: <bride>, please share with us your loving intentions toward <groom>.
