...
VALUES (28112, 0, 0xFFFFFFFF, 'Translated by Aun Laokhe', 'prewritten', False, '
Brother,
...
')
     , (28112, 1, 0xFFFFFFFF, 'Translated by Aun Laokhe', 'prewritten', False, 'Our efforts to carve the potent fungus from their flesh has failed. Each attempt renders the affected immobile and eventually kills them. If the Kukuur find their way across the vast beyond we will be hard pressed to hold the Guruk beneath our sway.
...
')
     , (28112, 2, 0xFFFFFFFF, 'Translated by Aun Laokhe', 'prewritten', False, 'What purpose will they serve then other than enemies that will need to be cleansed in The Sleeping One''s name.  Listen to me in this matter. Slaughter them now and hang their carcasses on the borders of our new world as a warning to all others.
...
')
     , (28112, 3, 0xFFFFFFFF, 'Translated by Aun Laokhe', 'prewritten', False, 'I do not think that they are from this area, as they seem to be out of sorts in many instances. But, they walk to and fro and do not scent our blood as they did on Bur. Perhaps they are not aware of our presence.
