...
VALUES (8360, 0, 0xFFFFFFFF, '', 'prewritten', False, 'To whomever may find this, please give to Olivier Rognath.  The last I saw of him, he resided in Eastham:
...
')
     , (8360, 1, 0xFFFFFFFF, '', 'prewritten', False, 'Who could have imagined a world in which death is no longer the end of one''s thoughts and experiences but merely a temporary stage in between?  Unless, one day, it changes...but useless for me to think of that now.
...
')
     , (8360, 2, 0xFFFFFFFF, '', 'prewritten', False, 'Sir Alayne had sent me to a relatively new Mosswart outpost to take notes on general Mosswart life, and to see if I could verify whether there were any sort of organized movement amongst the creatures, and if so, why.
