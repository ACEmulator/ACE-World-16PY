...
VALUES (30830,   1, 0x02000155) /* Setup */
     , (30830,   3, 0x20000014) /* SoundTable */
     , (30830,   8, 0x0600106F) /* Icon */
     , (30830,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (30830, 2, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (30830, 0, 0xFFFFFFFF, 'Kerrak', 'prewritten', False, 'Though the attack on Linvak Tukal ultimately proved a failure, you have not earned the ire of the Great One that you might have feared. The beast has been taken. Preparations are now underway.
...
')
     , (30830, 1, 0xFFFFFFFF, 'Kerrak', 'prewritten', False, 'I shall deliver the beast to the Great One. When its work is done, we shall finish our assault. But such preparations take time. I will be gone for at least one more revolution. You must maintain your position. You must keep the portal safe.
