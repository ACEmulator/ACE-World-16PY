...
')
     , (5701, 2, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'But Koji remembered the Dragon''s fickleness.  "But, oh Bairyuu," she said, "I do not seek power.  I do not want it."
...
')
     , (5701, 3, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'Koji bowed her head and said, "Then I will conquer myself in those five years, that I may win over Power.  I shall not use it in those five years, lest I lose to Temptation."  And so it was the Koji started down the path of Discipline.
')
     , (5701, 4, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'For five years, Koji trained herself in mind and body and heart.  At the end of five years, Koji was traveling back to the Dragon Temple near the capital.  Along the way, she came to a mountain.  She could not go around, for to either side were rivers, and so she had to climb.  As the noonday sun beat down upon her, the voice of the Bairyuu said, "Call now for your Power, little Koji.  With Power, you could soon leap over this small hill and be on your way."
')
     , (5701, 5, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, '"No," said Koji, "for effort and toil is the way of Man, and I have no right to avoid it."  And she went on her way, and climbed over the mountain.  Thus Koji showed her own Humility.
...
')
     , (5701, 6, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, '"No," said Koji.  "I have enough provisions for my journey; I do not need apples to make it, as delicious as they look."  And she went on her way, eating her own supplies, and leaving the apples behind.  Thus, she chose Detachment.
')
     , (5701, 7, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'Then Koji was walking toward the capital, when she came upon a badly beaten man lying beside the road.  She tried carrying him, but soon she tired.  She knew, though, that unless she took the man to the city, he might die.  Then the voice of Bairyuu said, "Call now for your Power, little Koji.  With Power, you could pick up the man and carry him easily to the capital."
')
     , (5701, 8, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, '"Yet, this would mean that I have lost to Power, by using it," thought Koji.  "But no, that is not as important as this person''s life. I must use what I can to save him.  I call upon Power and I shall face the Dragon''s maw myself."
...
')
     , (5701, 9, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'Koji now went bravely to the Temple of the Dragon of Power.  There, the Bairyuu appeared before her again, and said in triumph, "You have used the Power of the Dragon at last.  The Dragon has at last won over you, and Temptation has won over your Discipline!"
')
     , (5701, 10, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'But a greater voice than the Bairyuu''s replied, "You fool, white serpent, you do not understand.  Koji has won over herself, Discipline has won over Temptation, and true Power has won over false Power. Koji has maintained the Four Stones of Discipline, Humility, Detachment, and Compassion; even her single use of Power was not for her own sake, but because she placed another''s welfare over her own. Now, begone, Bairyuu!"
')
     , (5701, 11, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'The Bairyuu hissed once and fled.
...
')
     , (5701, 12, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, '"But did you not know?" said the voice.  "The Power has always been there with you; it has only been made visible to you now."

"I do not want it, however," said Koji.  "Everyone knows how fickle Power is."
')
     , (5701, 13, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'The voice replied, "Power is a double-edged sword, a terrible force which devours alive its master when used selfishly, but which reveals its true glory when used for selfless and compassionate ends.  That is why the Dragon is said to be so fickle: because the hearts of people are thus."
')
     , (5701, 14, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, '"Oh, I see," said Koji.  "The Dragon of Power really is a Heavenly sibling to the Unicorn of Grace and the Firebird of Splendor.  It is just that, unlike Grace or Splendor, which flee from corruption, he Dragon turns against corruption."

"Yes," replied the voice.  "It is in the nature of Power to do so, if it is not kept true to its purpose."
')
     , (5701, 15, 0xFFFFFFFF, 'Koji and the Dragon', 'prewritten', False, 'Koji then understood and went on her way.  It is said that, even though she had found the Dragon''s Power, only those who followed the Four Stones of Jojii could see it within her, so carefully did she use it.
