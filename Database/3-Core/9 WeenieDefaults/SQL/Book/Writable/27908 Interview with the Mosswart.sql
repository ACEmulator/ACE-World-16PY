...
VALUES (27908, 0, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, 'Seedsow, 15 P.Y.
...
')
     , (27908, 1, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, 'I think we all know how that turned out.
...
')
     , (27908, 2, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, 'Imagine my surprise when my nephew Ardry claimed to have been approached by a Mosswart in Hebian-To for the purpose of exchanging goods!
...
')
     , (27908, 7, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, 'A few even went above and beyond and defended Bleeargh from the pack of Burun that was following him! Bleeargh was very impressed with this. His eyes opened wide when he said, "Some Isparian help Bleeargh fight big nasties! They is true friends of Mosswarts."
...
')
     , (27908, 8, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, 'One set had a smiling Mosswart face carved on the front. 
...
')
     , (27908, 9, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, '"These is mourning stones. Mosswarts give these to each other when sad thing happens, like death of many Mosswarts by big nasties. Sometimes when I go to big blue rock, I no have as many mourning stones when I get there. This be good, then Isparians can take mourning stones and be sad that they not help me!" 
')
     , (27908, 10, 0xFFFFFFFF, 'Aliester the Loquacious', 'prewritten', False, 'As we were speaking, we were attacked by two Burun - Ardry believes that they were scouts of some sort. He held them off as Bleeargh and I fled. Realizing that he was in danger, I opened a portal to Zaikhal and coaxed him through it. 
