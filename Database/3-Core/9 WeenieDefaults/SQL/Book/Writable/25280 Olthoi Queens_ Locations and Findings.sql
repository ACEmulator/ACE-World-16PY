...
')
     , (25280, 2, 0xFFFFFFFF, 'Antius Blackmoor', 'prewritten', False, 'I then traveled southward, after scouring much of the plains. I found myself entering the direland swamp and assailed by a host of scents that I had never encountered before. Immediately I thought that there must have been an Olthoi Queen about and prepared to search for more defendable ground. I was disappointed when I found that there was evidence that a Queen was nearby, yet nowhere to be found.

I then made my way further south. There I found more evidence of an Olthoi Queen to 
')
     , (25280, 3, 0xFFFFFFFF, 'Antius Blackmoor', 'prewritten', False, 'the southeast of the Obsidian Plains. She had roosted in one of the craters within the southeastern direlands. Again however, there was no sign of her presence any longer.
...
31.9S 88.7W
')
     , (25280, 5, 0xFFFFFFFF, 'Antius Blackmoor', 'prewritten', False, 'They should allow you to find the Queens more easily, but it is difficult to know whether they are willing to come back to the surface.
