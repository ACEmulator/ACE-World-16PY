...
')
     , (23118, 2, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'implant took naturally to the beast.
...
')
     , (23118, 3, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'After a moon cycle the beast was nothing like it had been. It had taken on a bipedal stance, grown arm structures a torso rippling with meat structure beneath a partially furred hide. Twisted and dark with physical prowess and a ferocity unmatched. I returned to find 3 enhanced Puppets destroyed and 2 fighting for continued existence. The mattekar was destroyed without further discovery.
...
')
     , (23118, 4, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'moon cycle waxed. During that time I witnessed the transformation.
...
')
     , (23118, 5, 0xFFFFFFFF, 'Aerbax', 'prewritten', False, 'Puppets were taken by surprise as the assault began. I, however, was prepared. The mattekar was dispatched without chance for further discovery. I have decided to hold other specimens in stasis until further thought can be alotted to alteration of this sort.
');
