...
VALUES (7921,   1, 0x02000155) /* Setup */
     , (7921,   3, 0x20000014) /* SoundTable */
     , (7921,   8, 0x06001310) /* Icon */
     , (7921,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (7921, 9, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (7921, 0, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '
...
')
     , (7921, 3, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '
...
')
     , (7921, 4, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '
...
')
     , (7921, 5, 0xFFFFFFFF, 'Unknown', 'prewritten', False, 'had with the outlanders proves it, though they seem not to have recovered their previous strength yet.
...
')
     , (7921, 8, 0xFFFFFFFF, 'Unknown', 'prewritten', False, '
