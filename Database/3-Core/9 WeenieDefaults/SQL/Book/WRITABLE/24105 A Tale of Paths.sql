...
VALUES (24105, 22, False) /* INSCRIBABLE_BOOL */
     , (24105, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (24105, 0, 'Syltyn Rillon', 'prewritten', 4294967295, False, 'A Tale of Paths
...
')
     , (24105, 1, '', 'prewritten', 4294967295, False, 'Perhaps it was the ale, perhaps it was fate, he found himself walking towards the blacksmith shop across the square. Approaching the shop he saw one customer standing at the window, a female in green mire armor. She turned then and he marvelled at bright green eyes and blazing red hair that seemed to light up the square. She smiled.  He bowed, quite elegantly he thought, rather clumsily she thought, yet in a charming way. They began talking. Such was their first meeting.

She had a strange dream the second night of her journey. She was walking east along
')
     , (24105, 2, '', 'prewritten', 4294967295, False, 'a road when a bright red and blue bird landed in front of her then flew off to her left, cawing madly as a crow would. She turned towards it and found Altas was standing in front of her. He beckoned to her, then stepped aside. Behind him was Aerlinthe Island. Not any particular part of Aerlinthe Island, she just knew it was all of Aerlinthe Island right in front of her. The island was covered with the red and blue birds. The cawing noise was incessant.
...
')
     , (24105, 4, '', 'prewritten', 4294967295, False, 'blacksmith''s shop. Syretta opened the door, greeted Rundiscar the Weaponsmith and went to Getram the Armorer who was standing in front of his forge. He laid out four swords on the window facing the town square and another four on the opposite window, offering that she examine each one. She tested the heft of each weapon, the keenness of the blade. She examined several, did not find them to her liking and moved to the other window. It was uncomfortably hot, the heat of the forge seemed to be baking the entire left side of her body. Syretta quickly examined one on
')
     , (24105, 5, '', 'prewritten', 4294967295, False, 'that window, then moved further away from the blazing forge and picked up the second in that row. The hilt of the sword fit her hand perfectly, the balance was superb. The last two swords on display looked to be the wrong length. The one she held should do nicely. 
...
')
     , (24105, 10, '', 'prewritten', 4294967295, False, 'leg of her journey but she could get a bit of a start on it yet tonight.
