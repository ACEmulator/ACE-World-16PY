...
VALUES (5129, 16, 'A faded copy of Volume 7 of The Hundred Trackless Paths by Khaymahlai.') /* LONG_DESC_STRING */
     , (5129, 1, 'The Hundred Trackless Paths') /* NAME_STRING */
     , (5129, 33, 'Book100Paths7Quest') /* QUEST_STRING */
     , (5129, 15, 'A faded volume of The Hundred Trackless Paths by Khaymahlai.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5129, 1, 33554771) /* SETUP_DID */
     , (5129, 3, 536870932) /* SOUND_TABLE_DID */
     , (5129, 8, 100668117) /* ICON_DID */
     , (5129, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5129, 33, 1) /* BONDED_INT */
     , (5129, 9, 0) /* LOCATIONS_INT */
...
VALUES (5129, 39, 1.22) /* DEFAULT_SCALE_FLOAT */
     , (5129, 54, 0.3) /* USE_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (5129, 22, False) /* INSCRIBABLE_BOOL */
     , (5129, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (5129, 0, '', 'prewritten', 4294967295, False, 'Khaymahlai
...
(more)
')
     , (5129, 1, '', 'prewritten', 4294967295, False, 'On the edge of the bank there appeared a village, beaten to a pale brown by the sun.  On the bank sat a traveler, who dipped a skin into the river, filled it, and brought it to his lips.
...
(more)
')
     , (5129, 2, '', 'prewritten', 4294967295, False, '''This village is mine, stranger,'' said Hayyaz.  ''If you wish to drink my water and live, you must do me homage.''  From the shadowed doorways, the lost eyes of children and women reflected torchlight.
...
')
     , (5129, 3, '', 'prewritten', 4294967295, False, '''Forgive me,'' the traveler said, and rose to his feet.  ''I am new to these lands.  I shall return that which I have taken unearned.''  And at that, he doused the demon Hayyaz with the water from his skin, and with a terrible cry, it was no more.
...
')
     , (5129, 4, '', 'prewritten', 4294967295, False, 'A woman, frail from sun and work, stumbled from the nearest hut, and cried, ''Who are you, who has delivered us?''
