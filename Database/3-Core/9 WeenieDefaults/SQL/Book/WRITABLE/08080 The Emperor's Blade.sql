...
VALUES (8080, 'shocontestbook2', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8080, 001 /* NAME_STRING */, 'The Emperor''s Blade');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8080, 001 /* SETUP_DID */, 33554771)
     , (8080, 003 /* SOUND_TABLE_DID */, 536870932)
     , (8080, 008 /* ICON_DID */, 100670970)
     , (8080, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8080, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (8080, 005 /* ENCUMB_VAL_INT */, 160)
     , (8080, 008 /* MASS_INT */, 200)
     , (8080, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (8080, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (8080, 019 /* VALUE_INT */, 90)
     , (8080, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8080, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8080, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8080, 64, 1000) /* Book Data */;
