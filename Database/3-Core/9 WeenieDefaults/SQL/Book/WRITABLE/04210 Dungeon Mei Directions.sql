...
VALUES (4210, 'directionsdungeonmei', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4210, 001 /* NAME_STRING */, 'Dungeon Mei Directions');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4210, 001 /* SETUP_DID */, 33554773)
     , (4210, 003 /* SOUND_TABLE_DID */, 536870932)
     , (4210, 008 /* ICON_DID */, 100675748)
     , (4210, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4210, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (4210, 005 /* ENCUMB_VAL_INT */, 25)
     , (4210, 008 /* MASS_INT */, 5)
     , (4210, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (4210, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (4210, 019 /* VALUE_INT */, 5)
     , (4210, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4210, 054 /* USE_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4210, 022 /* INSCRIBABLE_BOOL */, False);
