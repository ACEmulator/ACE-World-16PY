...
VALUES (11683, 'bookguidebook', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (11683, 001 /* NAME_STRING */, 'A Portal-Jumper''s Guide to Dereth')
     , (11683, 016 /* LONG_DESC_STRING */, 'A reassuringly thick book, packed with advice for those new to Dereth');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (11683, 001 /* SETUP_DID */, 33554771)
     , (11683, 003 /* SOUND_TABLE_DID */, 536870932)
     , (11683, 008 /* ICON_DID */, 100668117)
     , (11683, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (11683, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (11683, 005 /* ENCUMB_VAL_INT */, 100)
     , (11683, 008 /* MASS_INT */, 275)
     , (11683, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (11683, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (11683, 019 /* VALUE_INT */, 10)
     , (11683, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (11683, 039 /* DEFAULT_SCALE_FLOAT */, 1.22)
     , (11683, 054 /* USE_RADIUS_FLOAT */, 0.3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (11683, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (11683, 8, 1000) /* Book Data */;
