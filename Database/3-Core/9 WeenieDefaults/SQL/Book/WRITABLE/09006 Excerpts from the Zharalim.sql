...
VALUES (9006, 'bookmonolithwar', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (9006, 001 /* NAME_STRING */, 'Excerpts from the Zharalim')
     , (9006, 015 /* SHORT_DESC_STRING */, 'A leatherbound book.')
     , (9006, 016 /* LONG_DESC_STRING */, 'A finely made book, bound in leather.  Its pages are written in the finest caligraphy, and the words are written with flourishes.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (9006, 001 /* SETUP_DID */, 33554771)
     , (9006, 003 /* SOUND_TABLE_DID */, 536870932)
     , (9006, 008 /* ICON_DID */, 100668117)
     , (9006, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (9006, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (9006, 005 /* ENCUMB_VAL_INT */, 160)
     , (9006, 008 /* MASS_INT */, 200)
     , (9006, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (9006, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (9006, 019 /* VALUE_INT */, 90)
     , (9006, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (9006, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9006, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (9006, 5, 1000) /* Book Data */;
