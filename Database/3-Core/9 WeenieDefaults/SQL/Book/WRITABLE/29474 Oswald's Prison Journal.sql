...
VALUES (29474, 'bookoswaldprisonjournal', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29474, 001 /* NAME_STRING */, 'Oswald''s Prison Journal')
     , (29474, 015 /* SHORT_DESC_STRING */, 'A book.')
     , (29474, 016 /* LONG_DESC_STRING */, 'A book written by Yuan Hanzu regarding composite bows. ');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29474, 001 /* SETUP_DID */, 33554771)
     , (29474, 003 /* SOUND_TABLE_DID */, 536870932)
     , (29474, 008 /* ICON_DID */, 100668117)
     , (29474, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29474, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (29474, 005 /* ENCUMB_VAL_INT */, 160)
     , (29474, 008 /* MASS_INT */, 230)
     , (29474, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (29474, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (29474, 019 /* VALUE_INT */, 0)
     , (29474, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29474, 039 /* DEFAULT_SCALE_FLOAT */, 1.22)
     , (29474, 054 /* USE_RADIUS_FLOAT */, 0.3);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29474, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (29474, 6, 1000) /* Book Data */;

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (29474, 0, 4294967295, '', 'prewritten', False, 'Yuan Hanzu
