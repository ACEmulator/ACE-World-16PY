...
VALUES (25980, 'notezharalimmaster', /* Book_WeenieType */ 8);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (25980, 1, 'Zharalim Master''s Journal') /* NAME_STRING */
     , (25980, 33, 'PickedUpZharalimMasterJournal') /* QUEST_STRING */
     , (25980, 15, 'A journal written by Zharalim Master Yaral. Several pages have been damaged, but the bulk of the book appears intact.') /* SHORT_DESC_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (25980, 1, 33554771) /* SETUP_DID */
     , (25980, 3, 536870932) /* SOUND_TABLE_DID */
     , (25980, 8, 100675686) /* ICON_DID */
     , (25980, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (25980, 9, 0) /* LOCATIONS_INT */
...
VALUES (25980, 22, False) /* INSCRIBABLE_BOOL */;
