/* Weenie - Zharalim Master's Journal (25980) */
DELETE FROM weenie WHERE class_Id = 25980;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (25980, 'notezharalimmaster', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (25980, 001 /* NAME_STRING */, 'Zharalim Master''s Journal')
     , (25980, 015 /* SHORT_DESC_STRING */, 'A journal written by Zharalim Master Yaral. Several pages have been damaged, but the bulk of the book appears intact.')
     , (25980, 033 /* QUEST_STRING */, 'PickedUpZharalimMasterJournal');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (25980, 001 /* SETUP_DID */, 33554771)
     , (25980, 003 /* SOUND_TABLE_DID */, 536870932)
     , (25980, 008 /* ICON_DID */, 100675686)
     , (25980, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (25980, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (25980, 005 /* ENCUMB_VAL_INT */, 25)
     , (25980, 008 /* MASS_INT */, 5)
     , (25980, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (25980, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (25980, 019 /* VALUE_INT */, 5)
     , (25980, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (25980, 054 /* USE_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (25980, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25980, 8, 1000) /* Book Data */;
