...
VALUES (9007, 'bookminesofdespairlore', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (9007, 001 /* NAME_STRING */, 'Bound Book')
     , (9007, 015 /* SHORT_DESC_STRING */, 'A written history of the Mines of Despair.')
     , (9007, 016 /* LONG_DESC_STRING */, 'A written history of the Mines of Despair.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (9007, 001 /* SETUP_DID */, 33554771)
     , (9007, 003 /* SOUND_TABLE_DID */, 536870932)
     , (9007, 008 /* ICON_DID */, 100668117)
     , (9007, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (9007, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (9007, 005 /* ENCUMB_VAL_INT */, 10)
     , (9007, 008 /* MASS_INT */, 10)
     , (9007, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (9007, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (9007, 019 /* VALUE_INT */, 0)
     , (9007, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (9007, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9007, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (9007, 6, 1000) /* Book Data */;
