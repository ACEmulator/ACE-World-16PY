...
DELETE FROM ace_weenie_class WHERE weenieClassId = 28129;

INSERT INTO ace_weenie_class (`weenieClassId`, `weenieClassDescription`)
VALUES (28129, 'reportikakhe11');

INSERT INTO `ace_object` (`aceObjectId`, `aceObjectDescriptionFlags`, `weenieClassId`)
VALUES (28129, 0, 28129);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (28129, 1, 'Report to Niarltah') /* NAME_STRING */
     , (28129, 33, 'NoteBurunHistory10') /* QUEST_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (28129, 1, 33554772) /* SETUP_DID */
     , (28129, 3, 536870932) /* SOUND_TABLE_DID */
     , (28129, 8, 100667470) /* ICON_DID */
     , (28129, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28129, 33, 1) /* BONDED_INT */
     , (28129, 9, 0) /* LOCATIONS_INT */
     , (28129, 1, 8192) /* ITEM_TYPE_INT */
     , (28129, 93, 1044) /* PHYSICS_STATE_INT */
     , (28129, 5, 25) /* ENCUMB_VAL_INT */
     , (28129, 16, 8) /* ITEM_USEABLE_INT */
     , (28129, 8, 5) /* MASS_INT */
     , (28129, 19, 10) /* VALUE_INT */
     , (28129, 114, 1) /* ATTUNED_INT */
     , (28129, 174, 11) /* APPRAISAL_PAGES_INT */
     , (28129, 175, 11) /* APPRAISAL_MAX_PAGES_INT */
     , (28129, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (28129, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (28129, 39, 1.22) /* DEFAULT_SCALE_FLOAT */
     , (28129, 54, 0.3) /* USE_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (28129, 22, False) /* INSCRIBABLE_BOOL */
     , (28129, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (28129, 0, 'Ikakhe', 'prewritten', 4294967295, False, 'We have just finished our final translation, but it is not the end of the book. Torgluuk has become aware of us. He was waiting when we returned the book this day. There was an unspoken threat in the way he stood before us. Without the ability to harm him, we thought we would be better served to not press the issue. He said if we wish to know what is written within the remainder of the book all we need do is ask.

Ikakhe
')
     , (28129, 1, 'Ikakhe', 'prewritten', 4294967295, False, 'Translation
...
')
     , (28129, 2, 'Ikakhe', 'prewritten', 4294967295, False, 'Kukuur are the ruling caste, bloated by powerful magic gifted to them by The Sleeping One, they are the leaders of the clutches and maintain tight control over the small minded Guruk.
...
')
     , (28129, 3, 'Ikakhe', 'prewritten', 4294967295, False, 'Ruuk watching their brethren become meals to their larger cousins begin to speak of revolt.
