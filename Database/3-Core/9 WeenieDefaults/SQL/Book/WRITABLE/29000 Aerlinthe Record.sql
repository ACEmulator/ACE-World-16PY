...
VALUES (29000, 'bookroads2', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29000, 001 /* NAME_STRING */, 'Aerlinthe Record')
     , (29000, 015 /* SHORT_DESC_STRING */, 'A translation of an Empyrean text.')
     , (29000, 016 /* LONG_DESC_STRING */, 'A translation of an Empyrean text found on Aerlinthe Island.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29000, 001 /* SETUP_DID */, 33554771)
     , (29000, 003 /* SOUND_TABLE_DID */, 536870932)
     , (29000, 008 /* ICON_DID */, 100668117)
     , (29000, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29000, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (29000, 005 /* ENCUMB_VAL_INT */, 160)
     , (29000, 008 /* MASS_INT */, 200)
     , (29000, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (29000, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (29000, 019 /* VALUE_INT */, 90)
     , (29000, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29000, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29000, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (29000, 32, 1000) /* Book Data */;
