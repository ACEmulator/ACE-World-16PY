...
VALUES (30985, 001 /* NAME_STRING */, 'Name Me Please')
     , (30985, 015 /* SHORT_DESC_STRING */, 'Short description does not show up in game.')
     , (30985, 016 /* LONG_DESC_STRING */, 'Long description shows up when players ID an item.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (30985, 001 /* SETUP_DID */, 33554771)
     , (30985, 003 /* SOUND_TABLE_DID */, 536870932)
     , (30985, 008 /* ICON_DID */, 100668117)
