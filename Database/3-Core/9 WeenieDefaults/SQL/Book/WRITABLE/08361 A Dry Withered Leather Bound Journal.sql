...
VALUES (8361, 'bookmartine2', /* Book_WeenieType */ 8);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8361, 1, 'A Dry Withered Leather Bound Journal') /* NAME_STRING */
     , (8361, 15, 'A journal inscribed by Sir Candeth Martine') /* SHORT_DESC_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8361, 1, 33554771) /* SETUP_DID */
     , (8361, 3, 536870932) /* SOUND_TABLE_DID */
     , (8361, 8, 100668117) /* ICON_DID */
     , (8361, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8361, 9, 0) /* LOCATIONS_INT */
...
VALUES (8361, 22, False) /* INSCRIBABLE_BOOL */;
