...
VALUES (8079, 'shocontestbook1', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8079, 001 /* NAME_STRING */, 'Loka Jii Learns to Hunt');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8079, 001 /* SETUP_DID */, 33554771)
     , (8079, 003 /* SOUND_TABLE_DID */, 536870932)
     , (8079, 008 /* ICON_DID */, 100670970)
     , (8079, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8079, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (8079, 005 /* ENCUMB_VAL_INT */, 160)
     , (8079, 008 /* MASS_INT */, 200)
     , (8079, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (8079, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (8079, 019 /* VALUE_INT */, 90)
     , (8079, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8079, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8079, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8079, 14, 1000) /* Book Data */;
