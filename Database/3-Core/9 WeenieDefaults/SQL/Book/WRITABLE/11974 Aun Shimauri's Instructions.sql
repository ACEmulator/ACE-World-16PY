...
VALUES (11974, 22, True) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (11974, 0, 'Aun Shimauri', 'prewritten', 4294967295, False, 'I place my Keh in your hands. I listen like the Forest. I know like the Mountain. I speak like the River. I place my Keh in your hands. I listen to the Truth. I speak the Truth. I place my Keh in your hands. Here are my words true.
...
')
     , (11974, 1, 'Aun Shimauri', 'prewritten', 4294967295, False, 'behind them. Splayed in every direction between the ikatans lay grass and root and flower, a lush and verdant skin which rippled with each wind''s breath.
...
')
     , (11974, 7, 'Aun Shimauri', 'prewritten', 4294967295, False, 'two of you and yours.  But what happened there is not for your ears to hear, nor the ears of any, until the day you listen to my Life Tale.  
...
')
     , (11974, 8, 'Aun Shimauri', 'prewritten', 4294967295, False, 'before, the mountain did not seem to hunger for my words or for any other thing.  It merely sat there, large and solid, as if it had always been there and always would be.
...
')
     , (11974, 9, 'Aun Shimauri', 'prewritten', 4294967295, False, 'when I was still a childling, what the name of my Mother had been, before she had beome Puh. My father would never speak of her, and I long ago learned to stop asking.  And then I knew.  I knew her name.  And I also knew why she had chosen my father over his brother, Telakanua, and how their continued rivalry forced her eventually onto the path that would lead her to be outcast from the tribe, never more to be seen or heard.
...
')
     , (11974, 10, 'Aun Shimauri', 'prewritten', 4294967295, False, 'been lost. I knew the answer to the Riddle of Kaleh, I knew why it had still not been solved.  I knew how many people wished me direct harm and their names.  I knew why the moon is round.  I knew...
...
')
     , (11974, 11, 'Aun Shimauri', 'prewritten', 4294967295, False, 'knowledge hurt very much. 
...
')
     , (11974, 12, 'Aun Shimauri', 'prewritten', 4294967295, False, 'lifted with the sight of my people in a time before the Wharu had come.  "And when the Tonk came into being on the First Day, my eldest brother was there to know that it had happened, and that it was good.
...
')
     , (11974, 13, 'Aun Shimauri', 'prewritten', 4294967295, False, 'away with my hand, only then did I see my hand covered in my lifeblood.
...
')
     , (11974, 16, 'Aun Shimauri', 'prewritten', 4294967295, False, 'that you were not meant to know.  You may not leave here with those particular gifts."  And I could feel the knowledge leaving my head.  No longer did I know why the moon was round, and what the answer to Riddle of Kaleh would be.  But surely he would not take...
...
')
     , (11974, 17, 'Aun Shimauri', 'prewritten', 4294967295, False, 'fell to silence.  I opened my eyes but Audetaunga was gone.
...
***
')
     , (11974, 18, 'Aun Shimauri', 'prewritten', 4294967295, False, 'Two nights ago, my dreamwalk led me to the banks of a river.  Wide and sinuous it was, a blue sparkled serpent that flashed as it undulated from one end of the horizon to the other.  At some places the river was peaceful and calm, its soft pulses chirping with the mischievous breezes overhead .  At other places the river surged and sprinted, white rapids crashing into stony outcrops on the river floor. There were fish knifing up through the surface and splashing back down to the river depths, and large black birds that would occasionally follow the fish down and bring it back up as an unwilling guest to a 
')
     , (11974, 19, 'Aun Shimauri', 'prewritten', 4294967295, False, 'daytime meal.  There were dragonflies and frogs and small sea-snakes, and along the banks of the river there were grasses and flowers and baby carenzi, and all of them chirping and squawking and burbling, one large symphony of wind and air, water and life.
...
')
     , (11974, 22, 'Aun Shimauri', 'prewritten', 4294967295, False, 'voice filled my head.
...
')
     , (11974, 23, 'Aun Shimauri', 'prewritten', 4294967295, False, 'sky to the earth and to all who dwell in between.
...
')
     , (11974, 26, 'Aun Shimauri', 'prewritten', 4294967295, False, 'sing, nor the mouths of any, until the day I tell my Life Tale.
...
')
     , (11974, 27, 'Aun Shimauri', 'prewritten', 4294967295, False, 'be, forever flowing and sharing and spreading joy.
...
')
     , (11974, 28, 'Aun Shimauri', 'prewritten', 4294967295, False, 'morning. I just thought it had always been yellow."  And you might have been angry at the Sun for playing tricks on you, although eventually you would realize that the Sun may do and go and turn colors as it wishes, and much the fool you would be to offer it challenge.
...
***
')
     , (11974, 31, 'Aun Shimauri', 'prewritten', 4294967295, False, 'I did not know how long I had been walking.  And although I came upon many a wood, and mountains, and rivers, I felt no need to approach any of them.  I knew I needed more walking, and so walk I did.
...
')
     , (11974, 33, 'Aun Shimauri', 'prewritten', 4294967295, False, 'again. And I could see darkness creeping over my land, blacking out all the colors and life of my Palenqual.  And the darkness did not stop there, but kept on crawling and seething in all directions, a black roiling flood that stretched from horizon to horizon.  Blackness overcoming the world.  Was this to be our fate?  Did our destiny end here in the darkness?
...
')
     , (11974, 34, 'Aun Shimauri', 'prewritten', 4294967295, False, 'Palenqual''s face once more shone beneath me, except now her face was an actual face.  She was smiling.  And as I stared at that smiling face, a face I thought I could gaze at forever, it started to approach me.  And as it did, I realized the face was attached to a head, the head to a body, and that body, that beautiful body, was walking towards me up through the sky.
...
')
     , (11974, 35, 'Aun Shimauri', 'prewritten', 4294967295, False, 'Why would this be so?  How could she let it happen?  Thoughts were rushing too fast in my head for me to be able to speak.  She was still smiling.  "But the people will survive, Little Shim.  They will survive.  You have my promise on this.  The darkness will come, and we will be lost and saved and lost again in the darkness.  But we will survive.
...
')
     , (11974, 36, 'Aun Shimauri', 'prewritten', 4294967295, False, 'hissing steam.  I knew that we would meet, and I knew what I would say.
...
')
     , (11974, 37, 'Aun Shimauri', 'prewritten', 4294967295, False, 'I had no idea what she referred to.  Games?  Parts to play?  It made no sense.  But her voice, her voice would stay with me forever.
