...
VALUES (28120, 'reportikakhe2', /* Book_WeenieType */ 8);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (28120, 1, 'Report to Niarltah') /* NAME_STRING */
     , (28120, 33, 'NoteBurunHistory1') /* QUEST_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28120, 1, 33554772) /* SETUP_DID */
     , (28120, 3, 536870932) /* SOUND_TABLE_DID */
     , (28120, 8, 100667470) /* ICON_DID */
     , (28120, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (28120, 33, 1) /* BONDED_INT */
     , (28120, 9, 0) /* LOCATIONS_INT */
     ...
     , (28120, 114, 1) /* ATTUNED_INT */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (28120, 39, 1.22) /* DEFAULT_SCALE_FLOAT */
     , (28120, 54, 0.3) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (28120, 22, False) /* INSCRIBABLE_BOOL */
     , (28120, 23, True) /* DESTROY_ON_SELL_BOOL */;
