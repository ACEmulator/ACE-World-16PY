/* Weenie - General History of Dereth Vol. II (8854) */
DELETE FROM weenie WHERE class_Id = 8854;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (8854, 'histjan00', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (8854, 001 /* NAME_STRING */, 'General History of Dereth Vol. II');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8854, 001 /* SETUP_DID */, 33554771)
     , (8854, 003 /* SOUND_TABLE_DID */, 536870932)
     , (8854, 008 /* ICON_DID */, 100668117)
     , (8854, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8854, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (8854, 005 /* ENCUMB_VAL_INT */, 10)
     , (8854, 008 /* MASS_INT */, 10)
     , (8854, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (8854, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (8854, 019 /* VALUE_INT */, 0)
     , (8854, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8854, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8854, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8854, 3, 1000) /* Book Data */;
