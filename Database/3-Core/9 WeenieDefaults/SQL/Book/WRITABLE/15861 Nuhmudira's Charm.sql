...
VALUES (15861, 16, 'A tome. The pages of this book have been hastily placed within the binding. The first page shows the picture of an altar, or dias.') /* LONG_DESC_STRING */
     , (15861, 1, 'Nuhmudira''s Charm') /* NAME_STRING */
     , (15861, 15, 'A tome. The pages of this book have been hastily placed within the binding.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15861, 1, 33556929) /* SETUP_DID */
     , (15861, 3, 536870932) /* SOUND_TABLE_DID */
     , (15861, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (15861, 6, 67113005) /* PALETTE_BASE_DID */
     , (15861, 7, 268436360) /* CLOTHINGBASE_DID */
     , (15861, 8, 100672803) /* ICON_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15861, 33, 0) /* BONDED_INT */
     , (15861, 9, 0) /* LOCATIONS_INT */
     , (15861, 1, 8192) /* ITEM_TYPE_INT */
     , (15861, 19, 0) /* VALUE_INT */
     , (15861, 3, 8) /* PALETTE_TEMPLATE_INT */
...
VALUES (15861, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (15861, 0, 'Nuhmudira', 'prewritten', 4294967295, False, 'He means to seal me within this place for eternity. How could I have been so blind. 
...
')
     , (15861, 1, 'Nuhmudira', 'prewritten', 4294967295, False, 'A lesson is learned as the pain begins to spread through me. Never trust...anyone other than yourself. He thinks that I will shrivel so quickly within this cell. 
...
')
     , (15861, 2, 'Nuhmudira', 'prewritten', 4294967295, False, 'She collects the red hair, turning white, from her head. Twisting, tightening, tying frayed end to frayed end in tedious precision, strand by strand. The pain must be felt in order for the magic to take hold. 
...
')
     , (15861, 3, 'Nuhmudira', 'prewritten', 4294967295, False, 'Her hand cups to pool the blood. Her fingers twist the braided strands of hair fashioning a point to make the writing and etching precise.
...
')
     , (15861, 5, 'Nuhmudira', 'prewritten', 4294967295, False, 'The star must have the number of cardinal points, and the subsidiary points corresponding to the paths of true magic. Twelve points drawn from her blood, in concert with the timbre of her breathing.
...
')
     , (15861, 7, 'Nuhmudira', 'prewritten', 4294967295, False, 'One final word spoken, and the final breath released. The spell woven into the pages. The blood and pain are thrown onto the pile of lifeless wood, and her chants call to the life she has spread upon the fallen wood. 
