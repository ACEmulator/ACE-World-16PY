...
DELETE FROM ace_weenie_class WHERE weenieClassId = 29004;
...
VALUES (29004, 16, 'A translation of an Empyrean text found on Aerlinthe Island.') /* LONG_DESC_STRING */
     , (29004, 1, 'Aerlinthe Record') /* NAME_STRING */
     , (29004, 15, 'A translation of an Empyrean text.') /* SHORT_DESC_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (29004, 1, 33554771) /* SETUP_DID */
     , (29004, 3, 536870932) /* SOUND_TABLE_DID */
     , (29004, 8, 100668117) /* ICON_DID */
     , (29004, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (29004, 9, 0) /* LOCATIONS_INT */
     , (29004, 1, 8192) /* ITEM_TYPE_INT */
     , (29004, 93, 1044) /* PHYSICS_STATE_INT */
     , (29004, 5, 160) /* ENCUMB_VAL_INT */
     , (29004, 16, 8) /* ITEM_USEABLE_INT */
     , (29004, 8, 200) /* MASS_INT */
     , (29004, 19, 90) /* VALUE_INT */
     , (29004, 174, 32) /* APPRAISAL_PAGES_INT */
     , (29004, 175, 32) /* APPRAISAL_MAX_PAGES_INT */
     , (29004, 22, 1000) /* AVAILABLE_CHARACTER_INT */
     , (29004, 9007, 8) /* Book_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (29004, 39, 1.22) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (29004, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (29004, 0, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 1, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 2, 'Tale of Years', 'prewritten', 4294967295, False, 'RE 222: Loritane sends sixteen great ocean-galleons and two skyships to the island, carrying the supplies necessary to build a mining outpost. Lord Loritane and Lady Raina accompany the vessels in Tinoriel.
...
')
     , (29004, 3, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 4, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 5, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 6, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 9, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 10, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 11, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 12, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 13, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 14, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 15, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 16, 'Tale of Years', 'prewritten', 4294967295, False, 'RE 895: Aurlanaa leaves her aerie on the peak of Cunara. She meets several other gromnatross south of Aerlinthe, and they ascend, disappearing into the heavens. No gromnatross are seen on Auberean for twenty-two years.
...
')
     , (29004, 17, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 18, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 19, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 20, 'Tale of Years', 'prewritten', 4294967295, False, 'TE 11: A daughter, Alhallie, is born to Caerlin and Clari. A Festival Year is declared in Elancia and Aerlinthe.
...
')
     , (29004, 21, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 22, 'Tale of Years', 'prewritten', 4294967295, False, 'TE 275: The legendary traveling entertainer Surinna Thrasyl stops at Aerlinthe.
...
')
     , (29004, 23, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 25, 'Tale of Years', 'prewritten', 4294967295, False, 'TE 450: After the census, Emperor Caerlin announces that Tentael has a population of over one million, most under the age of 400. Aerlinthe''s population is less than 100, but nearly 1000 golems work the forges at any time.
...
')
     , (29004, 26, 'Tale of Years', 'prewritten', 4294967295, False, 'TE 464: The new forges are completed. Due to the distance between them and the magma flows, production is less than half of that before the collapse.
...
')
     , (29004, 27, 'Tale of Years', 'prewritten', 4294967295, False, 'TE 513: The Great Northern Tempest. Mages hold off the worst of the storm for three days. The Naarcaerel Reef is ripped apart by storm-tides.
...
')
     , (29004, 28, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 29, 'Tale of Years', 'prewritten', 4294967295, False, '
...
')
     , (29004, 30, 'Tale of Years', 'prewritten', 4294967295, False, 'HE 239: The Nali relocates from Aventin to Tentael at the invitation of Emperor Kellin.
...
')
     , (29004, 31, 'Tale of Years', 'prewritten', 4294967295, False, '
