/* Weenie - Aerlinthe Record (29004) */
DELETE FROM weenie WHERE class_Id = 29004;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (29004, 'bookroads4', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29004, 001 /* NAME_STRING */, 'Aerlinthe Record')
     , (29004, 015 /* SHORT_DESC_STRING */, 'A translation of an Empyrean text.')
     , (29004, 016 /* LONG_DESC_STRING */, 'A translation of an Empyrean text found on Aerlinthe Island.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29004, 001 /* SETUP_DID */, 33554771)
     , (29004, 003 /* SOUND_TABLE_DID */, 536870932)
     , (29004, 008 /* ICON_DID */, 100668117)
     , (29004, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29004, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (29004, 005 /* ENCUMB_VAL_INT */, 160)
     , (29004, 008 /* MASS_INT */, 200)
     , (29004, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (29004, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (29004, 019 /* VALUE_INT */, 90)
     , (29004, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29004, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29004, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (29004, 32, 1000) /* Book Data */;

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (29004, 0, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 1, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 2, 4294967295, 'Tale of Years', 'prewritten', False, 'RE 222: Loritane sends sixteen great ocean-galleons and two skyships to the island, carrying the supplies necessary to build a mining outpost. Lord Loritane and Lady Raina accompany the vessels in Tinoriel.
...
')
     , (29004, 3, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 4, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 5, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 6, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 9, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 10, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 11, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 12, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 13, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 14, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 15, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 16, 4294967295, 'Tale of Years', 'prewritten', False, 'RE 895: Aurlanaa leaves her aerie on the peak of Cunara. She meets several other gromnatross south of Aerlinthe, and they ascend, disappearing into the heavens. No gromnatross are seen on Auberean for twenty-two years.
...
')
     , (29004, 17, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 18, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 19, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 20, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 11: A daughter, Alhallie, is born to Caerlin and Clari. A Festival Year is declared in Elancia and Aerlinthe.
...
')
     , (29004, 21, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 22, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 275: The legendary traveling entertainer Surinna Thrasyl stops at Aerlinthe.
...
')
     , (29004, 23, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 25, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 450: After the census, Emperor Caerlin announces that Tentael has a population of over one million, most under the age of 400. Aerlinthe''s population is less than 100, but nearly 1000 golems work the forges at any time.
...
')
     , (29004, 26, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 464: The new forges are completed. Due to the distance between them and the magma flows, production is less than half of that before the collapse.
...
')
     , (29004, 27, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 513: The Great Northern Tempest. Mages hold off the worst of the storm for three days. The Naarcaerel Reef is ripped apart by storm-tides.
...
')
     , (29004, 28, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 29, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29004, 30, 4294967295, 'Tale of Years', 'prewritten', False, 'HE 239: The Nali relocates from Aventin to Tentael at the invitation of Emperor Kellin.
...
')
     , (29004, 31, 4294967295, 'Tale of Years', 'prewritten', False, '
