...
VALUES (10826, 'writingdiplomat', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (10826, 001 /* NAME_STRING */, 'Insights into the Unknown')
     , (10826, 014 /* USE_STRING */, 'Use this item to read it.')
     , (10826, 015 /* SHORT_DESC_STRING */, 'A parchment of fine writing.')
     , (10826, 016 /* LONG_DESC_STRING */, 'A parchment of fine writing, translated with an even hand.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (10826, 001 /* SETUP_DID */, 33554773)
     , (10826, 003 /* SOUND_TABLE_DID */, 536870932)
     , (10826, 008 /* ICON_DID */, 100668176)
     , (10826, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (10826, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (10826, 005 /* ENCUMB_VAL_INT */, 5)
     , (10826, 008 /* MASS_INT */, 5)
     , (10826, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (10826, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (10826, 019 /* VALUE_INT */, 0)
     , (10826, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (10826, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (10826, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (10826, 16, 1000) /* Book Data */;
