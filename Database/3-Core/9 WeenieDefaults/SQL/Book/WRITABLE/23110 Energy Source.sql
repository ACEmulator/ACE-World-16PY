...
VALUES (23110, 'noteaerbaxenergysource', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (23110, 001 /* NAME_STRING */, 'Energy Source');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (23110, 001 /* SETUP_DID */, 33554771)
     , (23110, 003 /* SOUND_TABLE_DID */, 536870932)
     , (23110, 008 /* ICON_DID */, 100668117)
     , (23110, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (23110, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (23110, 005 /* ENCUMB_VAL_INT */, 160)
     , (23110, 008 /* MASS_INT */, 200)
     , (23110, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (23110, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (23110, 019 /* VALUE_INT */, 90)
     , (23110, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (23110, 039 /* DEFAULT_SCALE_FLOAT */, 1.22);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (23110, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (23110, 13, 1000) /* Book Data */;

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (23110, 0, 4294967295, 'Aerbax', 'prewritten', False, 'My freedom of the control and watchful eye of Singularity is complete. My efforts have proven to be well directed as the furthering of my personal cause for the betterment of the all has begun to spread across the minions that were set to administer and assist me in my new capacity at this laboratory. 
...
')
     , (23110, 1, 4294967295, 'Aerbax', 'prewritten', False, 'realm of the "energy source" to conduct several such experiments. Those results will be posted in future documentation. This document will serve as an introduction. The Singualriy must be informed as to how the "energy source" was discovered, so that they can understand the power that such an energy source represents to the Quiddity.
...
')
     , (23110, 2, 4294967295, 'Aerbax', 'prewritten', False, 'with the Hea without knowledge of the Collector also lead to discoveries that spurred thoughts of enhancing the mana receptors of "bestials". At the moment of success the renegades loyal to the New Singualrity and their misguided leader Levistras caused my immediate return to and subsequent censure by the Singularity. 
...
')
     , (23110, 4, 4294967295, 'Aerbax', 'prewritten', False, 'Agents of the "energy source" traversed about its form but none left the collective. Most appeared briefly to be devoured back within the "energy source" itself. Time was stagnant though ever present as though eternity and discontinuance were held in a tenuous balance.
...
')
     , (23110, 5, 4294967295, 'Aerbax', 'prewritten', False, 'As time was not consistent within this realm I was free to expirement with entities that seemed to be part of the "energy source".  Shards from the Quiddity seemed to dissipate quickly within near proximity to the "energy source" but while in connection to my form they remained the pulsing consistency they always had.
...
')
     , (23110, 7, 4294967295, 'Aerbax', 'prewritten', False, 'known about my heightened understanding and coneptualization of the place of the self within the all, cleansing would have appeared the only option. 
...
')
     , (23110, 8, 4294967295, 'Aerbax', 'prewritten', False, 'Since my return I have carefully made advances into my research with the "energy source" aware that the Quiddity''s agents were monitoring my efforts carefully. Until recently when I was able to sever clean the baleful stare of the Agents of the Quiddity and operate with impunity.
...
')
     , (23110, 9, 4294967295, 'Aerbax', 'prewritten', False, 'I am allowing time to transpire before I allow Masters to become exposed to the energy source. But I have become enamoured with the possibilities of what can be accomplished with other races exposed to this same "energy source". Thus we have begun to expose those races which have proven to be receptive to our modification in the past.
...
')
     , (23110, 11, 4294967295, 'Aerbax', 'prewritten', False, 'world. Once enemies of the "Light Child" and the Singularity have proven to come to heel once infused with shard of the Quiddity. Though a madness seems to infect their corporeal forms and taint their thought processes they have proven thus far to be formidable allies.
...
')
     , (23110, 12, 4294967295, 'Aerbax', 'prewritten', False, 'crumble in upon itself under the weight of the enlightened forces with such fervent loyalty to the Singularity. The "Light Child" would crumble and we would obtain that which we have endeavoured after since our calling to this shallow.
');
