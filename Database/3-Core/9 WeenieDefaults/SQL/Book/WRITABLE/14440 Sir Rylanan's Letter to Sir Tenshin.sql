/* Weenie - Sir Rylanan's Letter to Sir Tenshin (14440) */
...
VALUES (14440, 1, False) /* STUCK_BOOL */
     , (14440, 22, False) /* INSCRIBABLE_BOOL */
     , (14440, 23, True) /* DESTROY_ON_SELL_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (14440, 0, 'Sir Rylanan', 'prewritten', 4294967295, False, 'Sir Tenshin,
...
')
     , (14440, 2, 'Sir Rylanan', 'prewritten', 4294967295, False, 'verbatim so as not to lose the urgency of her words.
...
***
')
     , (14440, 3, 'Sir Rylanan', 'prewritten', 4294967295, False, '(Copy of the letter from Dame Tsaya to Sir Rylanan)
...
')
     , (14440, 4, 'Sir Rylanan', 'prewritten', 4294967295, False, 'attacked on all sides by a party of Hollow Minions, who were obviously lying in ambush for unwary explorers. There was a terrible device in the depths of the Halls, ostensibly created to extract  a living being''s vitals from his own skin, leaving only a perfect human epidermis. One such human husk has been delivered to me, and I must report that the ghastly sight of it has not left me unshaken. I have reserved the remains for proper burial--I cannot imagine the final tortures this poor soul must have been subject to before his final passing.
')
     , (14440, 5, 'Sir Rylanan', 'prewritten', 4294967295, False, 'What disturbs me the most is that I cannot discern a purpose for these atrocities. Who could find a need for these revolting trophies?
