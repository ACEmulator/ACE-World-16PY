...
VALUES (5147, 16, 'A book written by Abrim of Morningthaw, one of the adventurers who rediscovered the Lost City of Frore, and destroyed the powerful magical artifact at its heart.') /* LONG_DESC_STRING */
     , (5147, 1, 'Return to Frore') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5147, 1, 33554771) /* SETUP_DID */
     , (5147, 3, 536870932) /* SOUND_TABLE_DID */
     , (5147, 8, 100670970) /* ICON_DID */
     , (5147, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5147, 9, 0) /* LOCATIONS_INT */
...
VALUES (5147, 22, False) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_properties_book` (`aceObjectId`, `page`, `authorName`, `authorAccount`, `authorId`, `ignoreAuthor`, `pageText`)
VALUES (5147, 0, 'Fanzen San', 'prewritten', 4294967295, False, '
Introduction
...
')
     , (5147, 1, 'Fanzen San', 'prewritten', 4294967295, False, '
...
')
     , (5147, 2, 'Abrim of Morningthaw', 'prewritten', 4294967295, False, '
...
')
     , (5147, 3, 'Abrim of Morningthaw', 'prewritten', 4294967295, False, '
...
')
     , (5147, 4, 'Abrim of Morningthaw', 'prewritten', 4294967295, False, '
...
')
     , (5147, 5, 'Abrim of Morningthaw', 'prewritten', 4294967295, False, '
...
')
     , (5147, 6, 'Abrim of Morningthaw', 'prewritten', 4294967295, False, '
...
')
     , (5147, 7, 'Abrim of Morningthaw', 'prewritten', 4294967295, False, '
