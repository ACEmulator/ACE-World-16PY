/* Weenie - Return to Frore (5147) */
DELETE FROM weenie WHERE class_Id = 5147;

INSERT INTO weenie (`class_Id`, `class_Name`, `type`)
VALUES (5147, 'storyfrore', 8 /* Book_WeenieType */);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (5147, 001 /* NAME_STRING */, 'Return to Frore')
     , (5147, 016 /* LONG_DESC_STRING */, 'A book written by Abrim of Morningthaw, one of the adventurers who rediscovered the Lost City of Frore, and destroyed the powerful magical artifact at its heart.');

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (5147, 001 /* SETUP_DID */, 33554771)
     , (5147, 003 /* SOUND_TABLE_DID */, 536870932)
     , (5147, 008 /* ICON_DID */, 100670970)
     , (5147, 022 /* PHYSICS_EFFECT_TABLE_DID */, 872415275);

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5147, 001 /* ITEM_TYPE_INT */, 8192 /* TYPE_WRITABLE */)
     , (5147, 005 /* ENCUMB_VAL_INT */, 100)
     , (5147, 008 /* MASS_INT */, 80)
     , (5147, 009 /* LOCATIONS_INT */, 0 /* NONE_LOC */)
     , (5147, 016 /* ITEM_USEABLE_INT */, 8 /* USEABLE_CONTAINED */)
     , (5147, 019 /* VALUE_INT */, 35)
     , (5147, 093 /* PHYSICS_STATE_INT */, 1044 /* ETHEREAL_PS, IGNORE_COLLISIONS_PS, GRAVITY_PS */);

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5147, 054 /* USE_RADIUS_FLOAT */, 1);

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5147, 022 /* INSCRIBABLE_BOOL */, False);

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5147, 8, 1000) /* Book Data */;
