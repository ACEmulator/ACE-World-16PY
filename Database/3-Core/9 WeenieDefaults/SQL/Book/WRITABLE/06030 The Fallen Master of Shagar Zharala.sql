...
VALUES (6030, 'bookmountainfortressfallenmaster', /* Book_WeenieType */ 8);

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (6030, 16, 'A book from the private chambers of Hamud ibn Rafik.') /* LONG_DESC_STRING */
     , (6030, 1, 'The Fallen Master of Shagar Zharala') /* NAME_STRING */
     , (6030, 15, 'A book from the private chambers of Hamud ibn Rafik.') /* SHORT_DESC_STRING */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (6030, 1, 33554772) /* SETUP_DID */
     , (6030, 3, 536870932) /* SOUND_TABLE_DID */
     , (6030, 8, 100667470) /* ICON_DID */
     , (6030, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (6030, 9, 0) /* LOCATIONS_INT */
...
VALUES (6030, 39, 1.22) /* DEFAULT_SCALE_FLOAT */
     , (6030, 54, 1) /* USE_RADIUS_FLOAT */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6030, 1, True) /* STUCK_BOOL */
     , (6030, 22, False) /* INSCRIBABLE_BOOL */;
