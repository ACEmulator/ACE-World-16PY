...
VALUES (20977, 'lightningboltgravity', 33, '2005-02-09 10:00:00') /* ProjectileSpell */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (20977,   8,         25) /* Mass */
     , (20977,   9,          0) /* ValidLocations - None */
     , (20977,  66,          0) /* CheckpointStatus */
     , (20977,  93,     134164) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity, LightingOn, Inelastic */;
