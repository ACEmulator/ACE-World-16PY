...
VALUES (4539, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (4539, 3, 55) /* QUICKNESS_ATTRIBUTE */
     , (4539, 5, 50) /* FOCUS_ATTRIBUTE */
     , (4539, 6, 45) /* SELF_ATTRIBUTE */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`)
VALUES (4539, 1, 10) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (4539, 3, 10) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (4539, 5, 15) /* MAX_MANA_ATTRIBUTE_2ND */;
