...
VALUES (2307, 1, 20) /* STRENGTH_ATTRIBUTE */
     ...
     , (2307, 3, 75) /* QUICKNESS_ATTRIBUTE */
     , (2307, 5, 90) /* FOCUS_ATTRIBUTE */
     , (2307, 6, 65) /* SELF_ATTRIBUTE */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`)
VALUES (2307, 1, 50) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (2307, 3, 50) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (2307, 5, 70) /* MAX_MANA_ATTRIBUTE_2ND */;
