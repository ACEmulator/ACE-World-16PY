...
VALUES (1812, 1, 90) /* STRENGTH_ATTRIBUTE */
     ...
     , (1812, 3, 120) /* QUICKNESS_ATTRIBUTE */
     , (1812, 5, 90) /* FOCUS_ATTRIBUTE */
     , (1812, 6, 65) /* SELF_ATTRIBUTE */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`)
VALUES (1812, 1, 100) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1812, 3, 200) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1812, 5, 100) /* MAX_MANA_ATTRIBUTE_2ND */;
